...
def add_keyword_plan(customer_id)
  ...
  create_keyword_plan_adgroup_keywords(client, customer_id, plan_ad_group)
...
def create_keyword_plan_adgroup_keywords(client, customer_id, plan_ad_group)
  ...
  response.results.each do |result|
    puts "Created adgroup keyword for keyword plan: #{result.resource_name}"
  end
end
