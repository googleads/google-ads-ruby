...
# To create a flights feed, run the add_flights_feed.rb example.
# This example is specific to feeds of type DYNAMIC_FLIGHT.
...
def remove_flights_feed_item_attribute_value(
  customer_id,
  feed_id,
  feed_item_id,
