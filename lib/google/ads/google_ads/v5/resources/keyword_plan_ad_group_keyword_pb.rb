...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v5/resources/keyword_plan_ad_group_keyword.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v5.resources.KeywordPlanAdGroupKeyword" do
...
module Google
  module Ads
    module GoogleAds
      module V5
        module Resources
          KeywordPlanAdGroupKeyword = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v5.resources.KeywordPlanAdGroupKeyword").msgclass
        end
      end
    end
  end
