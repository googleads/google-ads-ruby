...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v5/resources/account_budget_proposal.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v5.resources.AccountBudgetProposal" do
      ...
      optional :proposal_type, :enum, 4, "google.ads.googleads.v5.enums.AccountBudgetProposalTypeEnum.AccountBudgetProposalType"
      optional :status, :enum, 15, "google.ads.googleads.v5.enums.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatus"
      ...
      oneof :proposed_start_time do
        ...
        optional :proposed_start_time_type, :enum, 7, "google.ads.googleads.v5.enums.TimeTypeEnum.TimeType"
      end
      ...
      oneof :approved_end_time do
        ...
        optional :approved_end_time_type, :enum, 22, "google.ads.googleads.v5.enums.TimeTypeEnum.TimeType"
      end
      oneof :proposed_spending_limit do
        optional :proposed_spending_limit_micros, :message, 10, "google.protobuf.Int64Value"
        optional :proposed_spending_limit_type, :enum, 11, "google.ads.googleads.v5.enums.SpendingLimitTypeEnum.SpendingLimitType"
      end
      oneof :approved_spending_limit do
        optional :approved_spending_limit_micros, :message, 23, "google.protobuf.Int64Value"
        optional :approved_spending_limit_type, :enum, 24, "google.ads.googleads.v5.enums.SpendingLimitTypeEnum.SpendingLimitType"
      end
    end
  end
end
...
module Google
  module Ads
    module GoogleAds
      module V5
        module Resources
          AccountBudgetProposal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v5.resources.AccountBudgetProposal").msgclass
        end
      end
    end
  end
