...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v5/resources/video.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v5.resources.Video" do
...
module Google
  module Ads
    module GoogleAds
      module V5
        module Resources
          Video = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v5.resources.Video").msgclass
        end
      end
    end
  end
