...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v5/resources/campaign_draft.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v5.resources.CampaignDraft" do
      ...
      optional :status, :enum, 6, "google.ads.googleads.v5.enums.CampaignDraftStatusEnum.CampaignDraftStatus"
...
module Google
  module Ads
    module GoogleAds
      module V5
        module Resources
          CampaignDraft = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v5.resources.CampaignDraft").msgclass
        end
      end
    end
  end
