...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v5/common/segments.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v5.common.Segments" do
      optional :ad_network_type, :enum, 3, "google.ads.googleads.v5.enums.AdNetworkTypeEnum.AdNetworkType"
      optional :budget_campaign_association_status, :message, 134, "google.ads.googleads.v5.common.BudgetCampaignAssociationStatus"
      optional :click_type, :enum, 26, "google.ads.googleads.v5.enums.ClickTypeEnum.ClickType"
      proto3_optional :conversion_action, :string, 113
      optional :conversion_action_category, :enum, 53, "google.ads.googleads.v5.enums.ConversionActionCategoryEnum.ConversionActionCategory"
      proto3_optional :conversion_action_name, :string, 114
      proto3_optional :conversion_adjustment, :bool, 115
      optional :conversion_attribution_event_type, :enum, 2, "google.ads.googleads.v5.enums.ConversionAttributionEventTypeEnum.ConversionAttributionEventType"
      optional :conversion_lag_bucket, :enum, 50, "google.ads.googleads.v5.enums.ConversionLagBucketEnum.ConversionLagBucket"
      optional :conversion_or_adjustment_lag_bucket, :enum, 51, "google.ads.googleads.v5.enums.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucket"
      proto3_optional :date, :string, 79
      optional :day_of_week, :enum, 5, "google.ads.googleads.v5.enums.DayOfWeekEnum.DayOfWeek"
      optional :device, :enum, 1, "google.ads.googleads.v5.enums.DeviceEnum.Device"
      optional :external_conversion_source, :enum, 55, "google.ads.googleads.v5.enums.ExternalConversionSourceEnum.ExternalConversionSource"
      ...
      optional :hotel_check_in_day_of_week, :enum, 9, "google.ads.googleads.v5.enums.DayOfWeekEnum.DayOfWeek"
      proto3_optional :hotel_city, :string, 82
      proto3_optional :hotel_class, :int32, 83
      proto3_optional :hotel_country, :string, 84
      optional :hotel_date_selection_type, :enum, 13, "google.ads.googleads.v5.enums.HotelDateSelectionTypeEnum.HotelDateSelectionType"
      proto3_optional :hotel_length_of_stay, :int32, 85
      proto3_optional :hotel_rate_rule_id, :string, 86
      optional :hotel_rate_type, :enum, 74, "google.ads.googleads.v5.enums.HotelRateTypeEnum.HotelRateType"
      optional :hotel_price_bucket, :enum, 78, "google.ads.googleads.v5.enums.HotelPriceBucketEnum.HotelPriceBucket"
      proto3_optional :hotel_state, :string, 87
      proto3_optional :hour, :int32, 88
      proto3_optional :interaction_on_this_extension, :bool, 89
      optional :keyword, :message, 61, "google.ads.googleads.v5.common.Keyword"
      proto3_optional :month, :string, 90
      optional :month_of_year, :enum, 18, "google.ads.googleads.v5.enums.MonthOfYearEnum.MonthOfYear"
      proto3_optional :partner_hotel_id, :string, 91
      optional :placeholder_type, :enum, 20, "google.ads.googleads.v5.enums.PlaceholderTypeEnum.PlaceholderType"
      ...
      optional :product_channel, :enum, 30, "google.ads.googleads.v5.enums.ProductChannelEnum.ProductChannel"
      optional :product_channel_exclusivity, :enum, 31, "google.ads.googleads.v5.enums.ProductChannelExclusivityEnum.ProductChannelExclusivity"
      optional :product_condition, :enum, 32, "google.ads.googleads.v5.enums.ProductConditionEnum.ProductCondition"
      ...
      optional :search_engine_results_page_type, :enum, 70, "google.ads.googleads.v5.enums.SearchEngineResultsPageTypeEnum.SearchEngineResultsPageType"
      optional :search_term_match_type, :enum, 22, "google.ads.googleads.v5.enums.SearchTermMatchTypeEnum.SearchTermMatchType"
      optional :slot, :enum, 23, "google.ads.googleads.v5.enums.SlotEnum.Slot"
      proto3_optional :webpage, :string, 129
      proto3_optional :week, :string, 130
      proto3_optional :year, :int32, 131
    end
    add_message "google.ads.googleads.v5.common.Keyword" do
      proto3_optional :ad_group_criterion, :string, 3
      optional :info, :message, 2, "google.ads.googleads.v5.common.KeywordInfo"
    end
    add_message "google.ads.googleads.v5.common.BudgetCampaignAssociationStatus" do
      proto3_optional :campaign, :string, 1
      optional :status, :enum, 2, "google.ads.googleads.v5.enums.BudgetCampaignAssociationStatusEnum.BudgetCampaignAssociationStatus"
    end
  end
end
...
module Google
  module Ads
    module GoogleAds
      module V5
        module Common
          Segments = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v5.common.Segments").msgclass
          Keyword = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v5.common.Keyword").msgclass
          BudgetCampaignAssociationStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v5.common.BudgetCampaignAssociationStatus").msgclass
        end
      end
    end
  end
