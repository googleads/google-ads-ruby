...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v5/enums/reach_plan_age_range.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v5.enums.ReachPlanAgeRangeEnum" do
    end
    add_enum "google.ads.googleads.v5.enums.ReachPlanAgeRangeEnum.ReachPlanAgeRange" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V5
        module Enums
          ReachPlanAgeRangeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v5.enums.ReachPlanAgeRangeEnum").msgclass
          ReachPlanAgeRangeEnum::ReachPlanAgeRange = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v5.enums.ReachPlanAgeRangeEnum.ReachPlanAgeRange").enummodule
        end
      end
    end
  end
