        ...
        module Services
          module CustomerManagerLinkService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V5::Services::CustomerManagerLinkService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V5::Services::CustomerManagerLinkService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V5::Services::CustomerManagerLinkService::Client.new
              #
              # To create a new CustomerManagerLinkService client with a custom
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V5::Services::CustomerManagerLinkService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/google_ads/v5/services/customer_manager_link_service_services_pb"
                ...
                @customer_manager_link_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V5::Services::CustomerManagerLinkService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V5::Services::GetCustomerManagerLinkRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V5::Services::GetCustomerManagerLinkRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V5::Resources::CustomerManagerLink]
              ...
              def get_customer_manager_link request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V5::Services::GetCustomerManagerLinkRequest
              ...
              #   {::Google::Ads::GoogleAds::V5::Services::MutateCustomerManagerLinkRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V5::Services::MutateCustomerManagerLinkRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param operations [::Array<::Google::Ads::GoogleAds::V5::Services::CustomerManagerLinkOperation, ::Hash>]
              #     Required. The list of operations to perform on individual customer manager links.
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V5::Services::MutateCustomerManagerLinkResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V5::Services::MutateCustomerManagerLinkResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              def mutate_customer_manager_link request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V5::Services::MutateCustomerManagerLinkRequest
              ...
              #   {::Google::Ads::GoogleAds::V5::Services::MoveManagerLinkRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V5::Services::MoveManagerLinkRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V5::Services::MoveManagerLinkResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V5::Services::MoveManagerLinkResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              def move_manager_link request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V5::Services::MoveManagerLinkRequest
              ...
              # {::Google::Ads::GoogleAds::V5::Services::CustomerManagerLinkService::Client::Configuration::Rpcs}
