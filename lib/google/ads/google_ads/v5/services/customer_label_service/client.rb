        ...
        module Services
          module CustomerLabelService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V5::Services::CustomerLabelService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V5::Services::CustomerLabelService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V5::Services::CustomerLabelService::Client.new
              #
              # To create a new CustomerLabelService client with a custom
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V5::Services::CustomerLabelService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/google_ads/v5/services/customer_label_service_services_pb"
                ...
                @customer_label_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V5::Services::CustomerLabelService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V5::Services::GetCustomerLabelRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V5::Services::GetCustomerLabelRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V5::Resources::CustomerLabel]
              ...
              def get_customer_label request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V5::Services::GetCustomerLabelRequest
              ...
              #   {::Google::Ads::GoogleAds::V5::Services::MutateCustomerLabelsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V5::Services::MutateCustomerLabelsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param operations [::Array<::Google::Ads::GoogleAds::V5::Services::CustomerLabelOperation, ::Hash>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V5::Services::MutateCustomerLabelsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V5::Services::MutateCustomerLabelsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              def mutate_customer_labels request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V5::Services::MutateCustomerLabelsRequest
              ...
              # {::Google::Ads::GoogleAds::V5::Services::CustomerLabelService::Client::Configuration::Rpcs}
