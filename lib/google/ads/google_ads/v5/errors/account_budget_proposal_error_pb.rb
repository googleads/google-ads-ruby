...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v5/errors/account_budget_proposal_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v5.errors.AccountBudgetProposalErrorEnum" do
    end
    add_enum "google.ads.googleads.v5.errors.AccountBudgetProposalErrorEnum.AccountBudgetProposalError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V5
        module Errors
          AccountBudgetProposalErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v5.errors.AccountBudgetProposalErrorEnum").msgclass
          AccountBudgetProposalErrorEnum::AccountBudgetProposalError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v5.errors.AccountBudgetProposalErrorEnum.AccountBudgetProposalError").enummodule
        end
      end
    end
  end
