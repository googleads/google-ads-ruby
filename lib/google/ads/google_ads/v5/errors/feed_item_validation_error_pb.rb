...
# source: google/ads/googleads/v5/errors/feed_item_validation_error.proto

require 'google/protobuf'

require 'google/api/annotations_pb'
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v5/errors/feed_item_validation_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v5.errors.FeedItemValidationErrorEnum" do
    end
    add_enum "google.ads.googleads.v5.errors.FeedItemValidationErrorEnum.FeedItemValidationError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V5
        module Errors
          FeedItemValidationErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v5.errors.FeedItemValidationErrorEnum").msgclass
          FeedItemValidationErrorEnum::FeedItemValidationError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v5.errors.FeedItemValidationErrorEnum.FeedItemValidationError").enummodule
        end
      end
    end
  end
