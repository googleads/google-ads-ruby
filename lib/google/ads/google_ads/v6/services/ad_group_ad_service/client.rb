        ...
        module Services
          module AdGroupAdService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V6::Services::AdGroupAdService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V6::Services::AdGroupAdService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V6::Services::AdGroupAdService::Client.new
              #
              # To create a new AdGroupAdService client with a custom
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V6::Services::AdGroupAdService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/google_ads/v6/services/ad_group_ad_service_services_pb"
                ...
                @ad_group_ad_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V6::Services::AdGroupAdService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V6::Services::GetAdGroupAdRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V6::Services::GetAdGroupAdRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V6::Resources::AdGroupAd]
              ...
              def get_ad_group_ad request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V6::Services::GetAdGroupAdRequest
              ...
              #   {::Google::Ads::GoogleAds::V6::Services::MutateAdGroupAdsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V6::Services::MutateAdGroupAdsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param operations [::Array<::Google::Ads::GoogleAds::V6::Services::AdGroupAdOperation, ::Hash>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V6::Services::MutateAdGroupAdsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V6::Services::MutateAdGroupAdsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              def mutate_ad_group_ads request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V6::Services::MutateAdGroupAdsRequest
              ...
              # {::Google::Ads::GoogleAds::V6::Services::AdGroupAdService::Client::Configuration::Rpcs}
