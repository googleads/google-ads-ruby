        ...
        module Services
          module AdParameterService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V6::Services::AdParameterService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V6::Services::AdParameterService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V6::Services::AdParameterService::Client.new
              #
              # To create a new AdParameterService client with a custom
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V6::Services::AdParameterService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/google_ads/v6/services/ad_parameter_service_services_pb"
                ...
                @ad_parameter_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V6::Services::AdParameterService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V6::Services::GetAdParameterRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V6::Services::GetAdParameterRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V6::Resources::AdParameter]
              ...
              def get_ad_parameter request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V6::Services::GetAdParameterRequest
              ...
              #   {::Google::Ads::GoogleAds::V6::Services::MutateAdParametersRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V6::Services::MutateAdParametersRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param operations [::Array<::Google::Ads::GoogleAds::V6::Services::AdParameterOperation, ::Hash>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V6::Services::MutateAdParametersResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V6::Services::MutateAdParametersResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              def mutate_ad_parameters request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V6::Services::MutateAdParametersRequest
              ...
              # {::Google::Ads::GoogleAds::V6::Services::AdParameterService::Client::Configuration::Rpcs}
