...
# Source: google/ads/googleads/v6/services/campaign_experiment_service.proto for package 'Google.Ads.GoogleAds.V6.Services'
        ...
        module Services
          module CampaignExperimentService
            ...
            class Service
              ...
              self.service_name = 'google.ads.googleads.v6.services.CampaignExperimentService'

              # Returns the requested campaign experiment in full detail.
              rpc :GetCampaignExperiment, ::Google::Ads::GoogleAds::V6::Services::GetCampaignExperimentRequest, ::Google::Ads::GoogleAds::V6::Resources::CampaignExperiment
              ...
              # campaign experiment.
              rpc :CreateCampaignExperiment, ::Google::Ads::GoogleAds::V6::Services::CreateCampaignExperimentRequest, ::Google::Longrunning::Operation
              # Updates campaign experiments. Operation statuses are returned.
              rpc :MutateCampaignExperiments, ::Google::Ads::GoogleAds::V6::Services::MutateCampaignExperimentsRequest, ::Google::Ads::GoogleAds::V6::Services::MutateCampaignExperimentsResponse
              ...
              rpc :GraduateCampaignExperiment, ::Google::Ads::GoogleAds::V6::Services::GraduateCampaignExperimentRequest, ::Google::Ads::GoogleAds::V6::Services::GraduateCampaignExperimentResponse
              ...
              rpc :PromoteCampaignExperiment, ::Google::Ads::GoogleAds::V6::Services::PromoteCampaignExperimentRequest, ::Google::Longrunning::Operation
              # Immediately ends a campaign experiment, changing the experiment's scheduled
              # end date and without waiting for end of day. End date is updated to be the
              # time of the request.
              rpc :EndCampaignExperiment, ::Google::Ads::GoogleAds::V6::Services::EndCampaignExperimentRequest, ::Google::Protobuf::Empty
              # Returns all errors that occurred during CampaignExperiment create or
              # promote (whichever occurred last).
              # Supports standard list paging.
              rpc :ListCampaignExperimentAsyncErrors, ::Google::Ads::GoogleAds::V6::Services::ListCampaignExperimentAsyncErrorsRequest, ::Google::Ads::GoogleAds::V6::Services::ListCampaignExperimentAsyncErrorsResponse
            end
