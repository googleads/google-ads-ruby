        ...
        module Services
          module RecommendationService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V6::Services::RecommendationService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V6::Services::RecommendationService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V6::Services::RecommendationService::Client.new
              #
              # To create a new RecommendationService client with a custom
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V6::Services::RecommendationService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/google_ads/v6/services/recommendation_service_services_pb"
                ...
                @recommendation_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V6::Services::RecommendationService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V6::Services::GetRecommendationRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V6::Services::GetRecommendationRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V6::Resources::Recommendation]
              ...
              #   {::Google::Ads::GoogleAds::V6::Services::ApplyRecommendationRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V6::Services::ApplyRecommendationRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param operations [::Array<::Google::Ads::GoogleAds::V6::Services::ApplyRecommendationOperation, ::Hash>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V6::Services::ApplyRecommendationResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              #   {::Google::Ads::GoogleAds::V6::Services::DismissRecommendationRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V6::Services::DismissRecommendationRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param customer_id [::String]
              #     Required. The ID of the customer with the recommendation.
              #   @param operations [::Array<::Google::Ads::GoogleAds::V6::Services::DismissRecommendationRequest::DismissRecommendationOperation, ::Hash>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V6::Services::DismissRecommendationResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              # {::Google::Ads::GoogleAds::V6::Services::RecommendationService::Client::Configuration::Rpcs}
