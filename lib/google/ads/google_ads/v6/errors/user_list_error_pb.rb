...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v6/errors/user_list_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v6.errors.UserListErrorEnum" do
    end
    add_enum "google.ads.googleads.v6.errors.UserListErrorEnum.UserListError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V6
        module Errors
          UserListErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v6.errors.UserListErrorEnum").msgclass
          UserListErrorEnum::UserListError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v6.errors.UserListErrorEnum.UserListError").enummodule
        end
      end
    end
  end
