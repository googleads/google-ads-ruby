...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v6/enums/lead_form_field_user_input_type.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v6.enums.LeadFormFieldUserInputTypeEnum" do
    end
    add_enum "google.ads.googleads.v6.enums.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
      value :FULL_NAME, 2
      value :GIVEN_NAME, 6
...
module Google
  module Ads
    module GoogleAds
      module V6
        module Enums
          LeadFormFieldUserInputTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v6.enums.LeadFormFieldUserInputTypeEnum").msgclass
          LeadFormFieldUserInputTypeEnum::LeadFormFieldUserInputType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v6.enums.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType").enummodule
        end
      end
    end
  end
