...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v6/resources/change_status.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v6.resources.ChangeStatus" do
      optional :resource_name, :string, 1
      proto3_optional :last_change_date_time, :string, 24
      optional :resource_type, :enum, 4, "google.ads.googleads.v6.enums.ChangeStatusResourceTypeEnum.ChangeStatusResourceType"
      proto3_optional :campaign, :string, 17
      proto3_optional :ad_group, :string, 18
      optional :resource_status, :enum, 8, "google.ads.googleads.v6.enums.ChangeStatusOperationEnum.ChangeStatusOperation"
...
module Google
  module Ads
    module GoogleAds
      module V6
        module Resources
          ChangeStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v6.resources.ChangeStatus").msgclass
        end
      end
    end
  end
