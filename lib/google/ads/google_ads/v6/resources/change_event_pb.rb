...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v6/resources/change_event.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v6.resources.ChangeEvent" do
      optional :resource_name, :string, 1
      optional :change_date_time, :string, 2
      optional :change_resource_type, :enum, 3, "google.ads.googleads.v6.enums.ChangeEventResourceTypeEnum.ChangeEventResourceType"
      optional :change_resource_name, :string, 4
      optional :client_type, :enum, 5, "google.ads.googleads.v6.enums.ChangeClientTypeEnum.ChangeClientType"
      optional :user_email, :string, 6
      optional :old_resource, :message, 7, "google.ads.googleads.v6.resources.ChangeEvent.ChangedResource"
      optional :new_resource, :message, 8, "google.ads.googleads.v6.resources.ChangeEvent.ChangedResource"
      optional :resource_change_operation, :enum, 9, "google.ads.googleads.v6.enums.ResourceChangeOperationEnum.ResourceChangeOperation"
    ...
    add_message "google.ads.googleads.v6.resources.ChangeEvent.ChangedResource" do
      ...
      optional :ad_group_criterion, :message, 3, "google.ads.googleads.v6.resources.AdGroupCriterion"
      optional :campaign, :message, 4, "google.ads.googleads.v6.resources.Campaign"
...
module Google
  module Ads
    module GoogleAds
      module V6
        module Resources
          ChangeEvent = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v6.resources.ChangeEvent").msgclass
          ChangeEvent::ChangedResource = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v6.resources.ChangeEvent.ChangedResource").msgclass
        end
      end
    end
  end
