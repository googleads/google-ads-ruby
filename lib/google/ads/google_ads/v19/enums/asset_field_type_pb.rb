...
module Google
  module Ads
    module GoogleAds
      module V19
        module Enums
          AssetFieldTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.enums.AssetFieldTypeEnum").msgclass
          AssetFieldTypeEnum::AssetFieldType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.enums.AssetFieldTypeEnum.AssetFieldType").enummodule
        end
      end
    end
  end
