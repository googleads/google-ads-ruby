...
module Google
  module Ads
    module GoogleAds
      module V19
        module Enums
          DistanceBucketEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.enums.DistanceBucketEnum").msgclass
          DistanceBucketEnum::DistanceBucket = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.enums.DistanceBucketEnum.DistanceBucket").enummodule
        end
      end
    end
  end
