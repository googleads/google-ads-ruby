...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          SmartCampaignSearchTermView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.SmartCampaignSearchTermView").msgclass
        end
      end
    end
  end
