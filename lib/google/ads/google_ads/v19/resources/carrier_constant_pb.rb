...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          CarrierConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.CarrierConstant").msgclass
        end
      end
    end
  end
