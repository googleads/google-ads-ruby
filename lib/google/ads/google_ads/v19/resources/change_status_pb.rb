...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          ChangeStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.ChangeStatus").msgclass
        end
      end
    end
  end
