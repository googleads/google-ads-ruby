...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          CampaignBudget = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.CampaignBudget").msgclass
        end
      end
    end
  end
