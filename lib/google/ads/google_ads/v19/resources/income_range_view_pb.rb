...
# source: google/ads/googleads/v19/resources/income_range_view.proto
...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          IncomeRangeView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.IncomeRangeView").msgclass
        end
      end
    end
  end
