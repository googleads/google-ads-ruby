...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          ContentCriterionView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.ContentCriterionView").msgclass
        end
      end
    end
  end
