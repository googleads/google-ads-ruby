...
# source: google/ads/googleads/v19/resources/travel_activity_performance_view.proto
...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          TravelActivityPerformanceView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.TravelActivityPerformanceView").msgclass
        end
      end
    end
  end
