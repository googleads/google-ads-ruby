...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          AdParameter = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.AdParameter").msgclass
        end
      end
    end
  end
