...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          CombinedAudience = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.CombinedAudience").msgclass
        end
      end
    end
  end
