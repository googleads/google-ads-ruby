...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          AdScheduleView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.AdScheduleView").msgclass
        end
      end
    end
  end
