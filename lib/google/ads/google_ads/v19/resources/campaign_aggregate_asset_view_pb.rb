...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          CampaignAggregateAssetView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.CampaignAggregateAssetView").msgclass
        end
      end
    end
  end
