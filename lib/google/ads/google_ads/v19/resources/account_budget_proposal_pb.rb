...
require 'google/ads/google_ads/v19/enums/account_budget_proposal_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          AccountBudgetProposal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.AccountBudgetProposal").msgclass
        end
      end
    end
  end
