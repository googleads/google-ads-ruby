...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          AdGroupLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.AdGroupLabel").msgclass
        end
      end
    end
  end
