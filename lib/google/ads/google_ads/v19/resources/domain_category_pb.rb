...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          DomainCategory = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.DomainCategory").msgclass
        end
      end
    end
  end
