...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          GroupPlacementView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.GroupPlacementView").msgclass
        end
      end
    end
  end
