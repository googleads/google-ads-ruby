...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          AdGroupCriterionLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.AdGroupCriterionLabel").msgclass
        end
      end
    end
  end
