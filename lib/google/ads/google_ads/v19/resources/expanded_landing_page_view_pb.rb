...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          ExpandedLandingPageView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.ExpandedLandingPageView").msgclass
        end
      end
    end
  end
