...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          CustomerUserAccess = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.CustomerUserAccess").msgclass
        end
      end
    end
  end
