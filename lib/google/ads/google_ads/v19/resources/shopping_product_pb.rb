...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          ShoppingProduct = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.ShoppingProduct").msgclass
          ShoppingProduct::ProductIssue = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.ShoppingProduct.ProductIssue").msgclass
        end
      end
    end
  end
