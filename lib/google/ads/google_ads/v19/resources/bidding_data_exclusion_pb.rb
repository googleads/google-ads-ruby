...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          BiddingDataExclusion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.BiddingDataExclusion").msgclass
        end
      end
    end
  end
