...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          UserInterest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.UserInterest").msgclass
        end
      end
    end
  end
