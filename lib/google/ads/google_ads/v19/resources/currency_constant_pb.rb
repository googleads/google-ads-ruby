...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          CurrencyConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.CurrencyConstant").msgclass
        end
      end
    end
  end
