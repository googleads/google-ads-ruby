...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          CampaignLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.CampaignLabel").msgclass
        end
      end
    end
  end
