...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          CustomerLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.CustomerLabel").msgclass
        end
      end
    end
  end
