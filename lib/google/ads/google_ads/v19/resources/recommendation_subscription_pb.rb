...
module Google
  module Ads
    module GoogleAds
      module V19
        module Resources
          RecommendationSubscription = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.resources.RecommendationSubscription").msgclass
        end
      end
    end
  end
