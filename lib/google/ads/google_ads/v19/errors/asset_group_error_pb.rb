...
module Google
  module Ads
    module GoogleAds
      module V19
        module Errors
          AssetGroupErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.errors.AssetGroupErrorEnum").msgclass
          AssetGroupErrorEnum::AssetGroupError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.errors.AssetGroupErrorEnum.AssetGroupError").enummodule
        end
      end
    end
  end
