...
module Google
  module Ads
    module GoogleAds
      module V19
        module Errors
          ImageErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.errors.ImageErrorEnum").msgclass
          ImageErrorEnum::ImageError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.errors.ImageErrorEnum.ImageError").enummodule
        end
      end
    end
  end
