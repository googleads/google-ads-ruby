...
module Google
  module Ads
    module GoogleAds
      module V19
        module Errors
          MediaUploadErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.errors.MediaUploadErrorEnum").msgclass
          MediaUploadErrorEnum::MediaUploadError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.errors.MediaUploadErrorEnum.MediaUploadError").enummodule
        end
      end
    end
  end
