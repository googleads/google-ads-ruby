    ...
    module GoogleAds
      module V19
        module Services
          ...
          SurveySatisfied = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.services.SurveySatisfied").msgclass
          SurveyDissatisfied = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.services.SurveyDissatisfied").msgclass
          ProvideLeadFeedbackRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.services.ProvideLeadFeedbackRequest").msgclass
          ProvideLeadFeedbackResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.services.ProvideLeadFeedbackResponse").msgclass
        end
      end
    end
  end
