        ...
        module Services
          module ReachPlanService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V19::Services::ReachPlanService::Client::Configuration}
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/google_ads/v19/services/reach_plan_service_services_pb"
                ...
                @reach_plan_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V19::Services::ReachPlanService::Stub,
              ...
              def generate_conversion_rates request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V19::Services::GenerateConversionRatesRequest
              ...
              #   {::Google::Ads::GoogleAds::V19::Services::ListPlannableLocationsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V19::Services::ListPlannableLocationsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V19::Services::ListPlannableLocationsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V19::Services::ListPlannableLocationsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::GoogleAds::V19::Services::ListPlannableLocationsRequest.new
              #
              #   # Call the list_plannable_locations method.
              #   result = client.list_plannable_locations request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V19::Services::ListPlannableLocationsResponse.
              #   p result
              #
              def list_plannable_locations request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V19::Services::ListPlannableLocationsRequest
              ...
              #   {::Google::Ads::GoogleAds::V19::Services::ListPlannableProductsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V19::Services::ListPlannableProductsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #     {::Google::Ads::GoogleAds::V19::Services::ReachPlanService::Client#list_plannable_locations ReachPlanService.ListPlannableLocations}.
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V19::Services::ListPlannableProductsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V19::Services::ListPlannableProductsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::GoogleAds::V19::Services::ListPlannableProductsRequest.new
              #
              #   # Call the list_plannable_products method.
              #   result = client.list_plannable_products request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V19::Services::ListPlannableProductsResponse.
              #   p result
              #
              def list_plannable_products request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V19::Services::ListPlannableProductsRequest
              ...
              #   {::Google::Ads::GoogleAds::V19::Services::GenerateReachForecastRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V19::Services::GenerateReachForecastRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param campaign_duration [::Google::Ads::GoogleAds::V19::Services::CampaignDuration, ::Hash]
              ...
              #   @param cookie_frequency_cap_setting [::Google::Ads::GoogleAds::V19::Services::FrequencyCap, ::Hash]
              #     Chosen cookie frequency cap to be applied to each planned product.
              #     This is equivalent to the frequency cap exposed in Google Ads when creating
              #     a campaign, it represents the maximum number of times an ad can be shown to
              ...
              #   @param effective_frequency_limit [::Google::Ads::GoogleAds::V19::Services::EffectiveFrequencyLimit, ::Hash]
              ...
              #   @param targeting [::Google::Ads::GoogleAds::V19::Services::Targeting, ::Hash]
              ...
              #   @param planned_products [::Array<::Google::Ads::GoogleAds::V19::Services::PlannedProduct, ::Hash>]
              #     Required. The products to be forecast.
              #     The max number of allowed planned products is 15.
              #   @param forecast_metric_options [::Google::Ads::GoogleAds::V19::Services::ForecastMetricOptions, ::Hash]
              #     Controls the forecast metrics returned in the response.
              #   @param customer_reach_group [::String]
              #     The name of the customer being planned for. This is a user-defined value.
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V19::Services::GenerateReachForecastResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V19::Services::GenerateReachForecastResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::GoogleAds::V19::Services::GenerateReachForecastRequest.new
              #
              #   # Call the generate_reach_forecast method.
              #   result = client.generate_reach_forecast request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V19::Services::GenerateReachForecastResponse.
              #   p result
              #
              def generate_reach_forecast request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V19::Services::GenerateReachForecastRequest
              ...
              # {::Google::Ads::GoogleAds::V19::Services::ReachPlanService::Client::Configuration::Rpcs}
