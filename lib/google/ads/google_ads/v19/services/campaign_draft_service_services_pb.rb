        ...
        module Services
          module CampaignDraftService
            ...
            class Service
              ...
              self.service_name = 'google.ads.googleads.v19.services.CampaignDraftService'
              ...
              #   [QuotaError]()
              #   [RequestError]()
              rpc :MutateCampaignDrafts, ::Google::Ads::GoogleAds::V19::Services::MutateCampaignDraftsRequest, ::Google::Ads::GoogleAds::V19::Services::MutateCampaignDraftsResponse
              ...
              #   [QuotaError]()
              #   [RequestError]()
              rpc :PromoteCampaignDraft, ::Google::Ads::GoogleAds::V19::Services::PromoteCampaignDraftRequest, ::Google::Longrunning::Operation
              ...
              #   [QuotaError]()
              #   [RequestError]()
              rpc :ListCampaignDraftAsyncErrors, ::Google::Ads::GoogleAds::V19::Services::ListCampaignDraftAsyncErrorsRequest, ::Google::Ads::GoogleAds::V19::Services::ListCampaignDraftAsyncErrorsResponse
            end
