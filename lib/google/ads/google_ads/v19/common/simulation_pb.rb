...
module Google
  module Ads
    module GoogleAds
      module V19
        module Common
          CpcBidSimulationPointList = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.common.CpcBidSimulationPointList").msgclass
          CpvBidSimulationPointList = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.common.CpvBidSimulationPointList").msgclass
          TargetCpaSimulationPointList = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.common.TargetCpaSimulationPointList").msgclass
          TargetRoasSimulationPointList = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.common.TargetRoasSimulationPointList").msgclass
          PercentCpcBidSimulationPointList = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.common.PercentCpcBidSimulationPointList").msgclass
          BudgetSimulationPointList = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.common.BudgetSimulationPointList").msgclass
          TargetImpressionShareSimulationPointList = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.common.TargetImpressionShareSimulationPointList").msgclass
          CpcBidSimulationPoint = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.common.CpcBidSimulationPoint").msgclass
          CpvBidSimulationPoint = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.common.CpvBidSimulationPoint").msgclass
          TargetCpaSimulationPoint = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.common.TargetCpaSimulationPoint").msgclass
          TargetRoasSimulationPoint = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.common.TargetRoasSimulationPoint").msgclass
          PercentCpcBidSimulationPoint = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.common.PercentCpcBidSimulationPoint").msgclass
          BudgetSimulationPoint = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.common.BudgetSimulationPoint").msgclass
          TargetImpressionShareSimulationPoint = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v19.common.TargetImpressionShareSimulationPoint").msgclass
        end
      end
    end
  end
