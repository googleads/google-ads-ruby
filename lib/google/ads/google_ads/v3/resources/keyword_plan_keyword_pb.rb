...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v3/resources/keyword_plan_keyword.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v3.resources.KeywordPlanKeyword" do
...
module Google
  module Ads
    module GoogleAds
      module V3
        module Resources
          KeywordPlanKeyword = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v3.resources.KeywordPlanKeyword").msgclass
        end
      end
    end
  end
