...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v3/resources/ad_group_extension_setting.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v3.resources.AdGroupExtensionSetting" do
...
module Google
  module Ads
    module GoogleAds
      module V3
        module Resources
          AdGroupExtensionSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v3.resources.AdGroupExtensionSetting").msgclass
        end
      end
    end
  end
