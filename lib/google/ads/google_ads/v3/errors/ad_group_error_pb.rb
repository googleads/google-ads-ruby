...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v3/errors/ad_group_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v3.errors.AdGroupErrorEnum" do
    end
    add_enum "google.ads.googleads.v3.errors.AdGroupErrorEnum.AdGroupError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V3
        module Errors
          AdGroupErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v3.errors.AdGroupErrorEnum").msgclass
          AdGroupErrorEnum::AdGroupError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v3.errors.AdGroupErrorEnum.AdGroupError").enummodule
        end
      end
    end
  end
