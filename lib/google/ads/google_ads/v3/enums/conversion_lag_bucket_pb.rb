...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v3/enums/conversion_lag_bucket.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v3.enums.ConversionLagBucketEnum" do
    end
    add_enum "google.ads.googleads.v3.enums.ConversionLagBucketEnum.ConversionLagBucket" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V3
        module Enums
          ConversionLagBucketEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v3.enums.ConversionLagBucketEnum").msgclass
          ConversionLagBucketEnum::ConversionLagBucket = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v3.enums.ConversionLagBucketEnum.ConversionLagBucket").enummodule
        end
      end
    end
  end
