...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/media_file_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::MediaFileService::Stub]
          class MediaFileServiceClient
            ...
            def initialize \
              ...
              @media_file_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::MediaFileService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V3::Resources::MediaFile]
            ...
            #
            #   media_file_client = Google::Ads::GoogleAds::MediaFile.new(version: :v3)
            #   formatted_resource_name = Google::Ads::GoogleAds::V3::Services::MediaFileServiceClient.media_file_path("[CUSTOMER]", "[MEDIA_FILE]")
            ...
            def get_media_file \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GetMediaFileRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V3::Services::MediaFileOperation | Hash>]
            #   Required. The list of operations to perform on individual media file.
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::MediaFileOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::MutateMediaFilesResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_media_files \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::MutateMediaFilesRequest)
