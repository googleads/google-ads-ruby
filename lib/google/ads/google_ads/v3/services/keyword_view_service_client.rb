...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/keyword_view_service.proto,
...
require "google/ads/google_ads/v3/services/keyword_view_service_pb"
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::KeywordViewService::Stub]
          class KeywordViewServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v3/services/keyword_view_service_services_pb"
              ...
              @keyword_view_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::KeywordViewService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V3::Resources::KeywordView]
            ...
            #
            #   keyword_view_client = Google::Ads::GoogleAds::KeywordView.new(version: :v3)
            #   formatted_resource_name = Google::Ads::GoogleAds::V3::Services::KeywordViewServiceClient.keyword_view_path("[CUSTOMER]", "[KEYWORD_VIEW]")
            ...
            def get_keyword_view \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GetKeywordViewRequest)
