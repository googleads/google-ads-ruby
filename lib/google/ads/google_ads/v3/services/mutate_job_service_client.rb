...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/mutate_job_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::MutateJobService::Stub]
          class MutateJobServiceClient
            ...
            def initialize \
              ...
              @mutate_job_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::MutateJobService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::CreateMutateJobResponse]
            ...
            #
            #   mutate_job_client = Google::Ads::GoogleAds::MutateJob.new(version: :v3)
            #
            ...
            def create_mutate_job \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::CreateMutateJobRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Resources::MutateJob]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            #
            #   mutate_job_client = Google::Ads::GoogleAds::MutateJob.new(version: :v3)
            #   formatted_resource_name = Google::Ads::GoogleAds::V3::Services::MutateJobServiceClient.mutate_job_path("[CUSTOMER]", "[MUTATE_JOB]")
            ...
            def get_mutate_job \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GetMutateJobRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Gax::PagedEnumerable<Google::Ads::GoogleAds::V3::Services::MutateJobResult>]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Gax::PagedEnumerable<Google::Ads::GoogleAds::V3::Services::MutateJobResult>]
            #   An enumerable of Google::Ads::GoogleAds::V3::Services::MutateJobResult instances.
            ...
            def list_mutate_job_results \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::ListMutateJobResultsRequest)
            ...
            def run_mutate_job \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::RunMutateJobRequest)
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::MutateOperation`
            #   can also be provided.
            # @param options [Google::Gax::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout,
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::AddMutateJobOperationsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def add_mutate_job_operations \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::AddMutateJobOperationsRequest)
