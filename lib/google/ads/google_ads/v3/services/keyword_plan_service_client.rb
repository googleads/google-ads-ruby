...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/keyword_plan_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::KeywordPlanService::Stub]
          class KeywordPlanServiceClient
            ...
            def initialize \
              ...
              @keyword_plan_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::KeywordPlanService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V3::Resources::KeywordPlan]
            ...
            #
            #   keyword_plan_client = Google::Ads::GoogleAds::KeywordPlan.new(version: :v3)
            #   formatted_resource_name = Google::Ads::GoogleAds::V3::Services::KeywordPlanServiceClient.keyword_plan_path("[CUSTOMER]", "[KEYWORD_PLAN]")
            ...
            def get_keyword_plan \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GetKeywordPlanRequest)
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::KeywordPlanOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::MutateKeywordPlansResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_keyword_plans \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::MutateKeywordPlansRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::GenerateForecastMetricsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            #
            #   keyword_plan_client = Google::Ads::GoogleAds::KeywordPlan.new(version: :v3)
            #   formatted_keyword_plan = Google::Ads::GoogleAds::V3::Services::KeywordPlanServiceClient.keyword_plan_path("[CUSTOMER]", "[KEYWORD_PLAN]")
            ...
            def generate_forecast_metrics \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GenerateForecastMetricsRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::GenerateHistoricalMetricsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def generate_historical_metrics \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GenerateHistoricalMetricsRequest)
