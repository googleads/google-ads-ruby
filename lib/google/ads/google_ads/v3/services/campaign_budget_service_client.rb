...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/campaign_budget_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::CampaignBudgetService::Stub]
          class CampaignBudgetServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v3/services/campaign_budget_service_services_pb"
              ...
              @campaign_budget_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::CampaignBudgetService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V3::Resources::CampaignBudget]
            ...
            #
            #   campaign_budget_client = Google::Ads::GoogleAds::CampaignBudget.new(version: :v3)
            #   formatted_resource_name = Google::Ads::GoogleAds::V3::Services::CampaignBudgetServiceClient.campaign_budget_path("[CUSTOMER]", "[CAMPAIGN_BUDGET]")
            ...
            def get_campaign_budget \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GetCampaignBudgetRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V3::Services::CampaignBudgetOperation | Hash>]
            #   Required. The list of operations to perform on individual campaign budgets.
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::CampaignBudgetOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::MutateCampaignBudgetsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_campaign_budgets \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::MutateCampaignBudgetsRequest)
