...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/shared_set_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::SharedSetService::Stub]
          class SharedSetServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v3/services/shared_set_service_services_pb"
              ...
              @shared_set_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::SharedSetService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V3::Resources::SharedSet]
            ...
            #
            #   shared_set_client = Google::Ads::GoogleAds::SharedSet.new(version: :v3)
            #   formatted_resource_name = Google::Ads::GoogleAds::V3::Services::SharedSetServiceClient.shared_set_path("[CUSTOMER]", "[SHARED_SET]")
            ...
            def get_shared_set \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GetSharedSetRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V3::Services::SharedSetOperation | Hash>]
            #   Required. The list of operations to perform on individual shared sets.
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::SharedSetOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::MutateSharedSetsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V3::Services::MutateSharedSetsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_shared_sets \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::MutateSharedSetsRequest)
