...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/ad_group_ad_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::AdGroupAdService::Stub]
          class AdGroupAdServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v3/services/ad_group_ad_service_services_pb"
              ...
              @ad_group_ad_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::AdGroupAdService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V3::Resources::AdGroupAd]
            ...
            #
            #   ad_group_ad_client = Google::Ads::GoogleAds::AdGroupAd.new(version: :v3)
            #   formatted_resource_name = Google::Ads::GoogleAds::V3::Services::AdGroupAdServiceClient.ad_group_ad_path("[CUSTOMER]", "[AD_GROUP_AD]")
            ...
            def get_ad_group_ad \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GetAdGroupAdRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V3::Services::AdGroupAdOperation | Hash>]
            #   Required. The list of operations to perform on individual ads.
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::AdGroupAdOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::MutateAdGroupAdsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_ad_group_ads \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::MutateAdGroupAdsRequest)
