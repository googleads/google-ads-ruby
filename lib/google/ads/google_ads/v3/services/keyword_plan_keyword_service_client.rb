...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/keyword_plan_keyword_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::KeywordPlanKeywordService::Stub]
          class KeywordPlanKeywordServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v3/services/keyword_plan_keyword_service_services_pb"
              ...
              @keyword_plan_keyword_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::KeywordPlanKeywordService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V3::Resources::KeywordPlanKeyword]
            ...
            #
            #   keyword_plan_keyword_client = Google::Ads::GoogleAds::KeywordPlanKeyword.new(version: :v3)
            #   formatted_resource_name = Google::Ads::GoogleAds::V3::Services::KeywordPlanKeywordServiceClient.keyword_plan_keyword_path("[CUSTOMER]", "[KEYWORD_PLAN_KEYWORD]")
            ...
            def get_keyword_plan_keyword \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GetKeywordPlanKeywordRequest)
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::KeywordPlanKeywordOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::MutateKeywordPlanKeywordsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_keyword_plan_keywords \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::MutateKeywordPlanKeywordsRequest)
