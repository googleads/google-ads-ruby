...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/keyword_plan_idea_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::KeywordPlanIdeaService::Stub]
          class KeywordPlanIdeaServiceClient
            ...
            def initialize \
              ...
              @keyword_plan_idea_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::KeywordPlanIdeaService::Stub.method(:new)
              )
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::KeywordAndUrlSeed`
            #   can also be provided.
            # @param keyword_seed [Google::Ads::GoogleAds::V3::Services::KeywordSeed | Hash]
            #   A Keyword or phrase to generate ideas from, e.g. cars.
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::KeywordSeed`
            #   can also be provided.
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::UrlSeed`
            #   can also be provided.
            # @param options [Google::Gax::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout,
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::GenerateKeywordIdeaResponse]
            ...
            #
            #   keyword_plan_idea_client = Google::Ads::GoogleAds::KeywordPlanIdea.new(version: :v3)
            #
            ...
            def generate_keyword_ideas \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GenerateKeywordIdeasRequest)
