...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/user_list_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::UserListService::Stub]
          class UserListServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v3/services/user_list_service_services_pb"
              ...
              @user_list_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::UserListService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V3::Resources::UserList]
            ...
            #
            #   user_list_client = Google::Ads::GoogleAds::UserList.new(version: :v3)
            #   formatted_resource_name = Google::Ads::GoogleAds::V3::Services::UserListServiceClient.user_list_path("[CUSTOMER]", "[USER_LIST]")
            ...
            def get_user_list \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GetUserListRequest)
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::UserListOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::MutateUserListsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_user_lists \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::MutateUserListsRequest)
