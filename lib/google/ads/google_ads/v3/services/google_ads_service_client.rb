...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/google_ads_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::GoogleAdsService::Stub]
          class GoogleAdsServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v3/services/google_ads_service_services_pb"
              ...
              @google_ads_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::GoogleAdsService::Stub.method(:new)
              )
              ...
              @search_stream = Google::Gax.create_api_call(
                @google_ads_service_stub.method(:search_stream),
                defaults["search_stream"],
                exception_transformer: exception_transformer,
                params_extractor: proc do |request|
                  {'customer_id' => request.customer_id}
                end
            ...
            # @param return_total_results_count [true, false]
            ...
            # @yieldparam result [Google::Gax::PagedEnumerable<Google::Ads::GoogleAds::V3::Services::GoogleAdsRow>]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Gax::PagedEnumerable<Google::Ads::GoogleAds::V3::Services::GoogleAdsRow>]
            #   An enumerable of Google::Ads::GoogleAds::V3::Services::GoogleAdsRow instances.
            ...
            #
            #   google_ads_client = Google::Ads::GoogleAds::GoogleAds.new(version: :v3)
            #
            ...
            def search \
                ...
                page_size: nil,
                validate_only: nil,
                return_total_results_count: nil,
                summary_row_setting: nil,
                options: nil,
                &block
              req = {
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::SearchGoogleAdsRequest)
            ...
            #   An enumerable of Google::Ads::GoogleAds::V3::Services::SearchGoogleAdsStreamResponse instances.
            #
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            ...
            #   # TODO: Initialize `query`:
            #   query = ''
            #   google_ads_client.search_stream(customer_id, query).each do |element|
            #     # Process element.
            #   end
            ...
            def search_stream \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::SearchGoogleAdsStreamRequest)
              @search_stream.call(req, options)
            end
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::MutateGoogleAdsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::MutateGoogleAdsRequest)
