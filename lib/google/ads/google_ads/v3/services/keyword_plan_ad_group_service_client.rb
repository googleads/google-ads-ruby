...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/keyword_plan_ad_group_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::KeywordPlanAdGroupService::Stub]
          class KeywordPlanAdGroupServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v3/services/keyword_plan_ad_group_service_services_pb"
              ...
              @keyword_plan_ad_group_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::KeywordPlanAdGroupService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V3::Resources::KeywordPlanAdGroup]
            ...
            #
            #   keyword_plan_ad_group_client = Google::Ads::GoogleAds::KeywordPlanAdGroup.new(version: :v3)
            #   formatted_resource_name = Google::Ads::GoogleAds::V3::Services::KeywordPlanAdGroupServiceClient.keyword_plan_ad_group_path("[CUSTOMER]", "[KEYWORD_PLAN_AD_GROUP]")
            ...
            def get_keyword_plan_ad_group \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GetKeywordPlanAdGroupRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V3::Services::KeywordPlanAdGroupOperation | Hash>]
            #   Required. The list of operations to perform on individual Keyword Plan ad groups.
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::KeywordPlanAdGroupOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::MutateKeywordPlanAdGroupsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_keyword_plan_ad_groups \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::MutateKeywordPlanAdGroupsRequest)
