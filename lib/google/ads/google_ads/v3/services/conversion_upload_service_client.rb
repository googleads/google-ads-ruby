...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/conversion_upload_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::ConversionUploadService::Stub]
          class ConversionUploadServiceClient
            ...
            def initialize \
              ...
              @conversion_upload_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::ConversionUploadService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::UploadClickConversionsResponse]
            ...
            #
            #   conversion_upload_client = Google::Ads::GoogleAds::ConversionUpload.new(version: :v3)
            #
            ...
            def upload_click_conversions \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::UploadClickConversionsRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::UploadCallConversionsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def upload_call_conversions \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::UploadCallConversionsRequest)
