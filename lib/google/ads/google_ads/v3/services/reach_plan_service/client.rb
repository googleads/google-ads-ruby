        ...
        module Services
          module ReachPlanService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V3::Services::ReachPlanService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V3::Services::ReachPlanService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V3::Services::ReachPlanService::Client.new
              #
              ...
              def initialize
                ...
                @reach_plan_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V3::Services::ReachPlanService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V3::Services::ListPlannableLocationsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V3::Services::ListPlannableLocationsRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V3::Services::ListPlannableLocationsResponse]
              ...
              def list_plannable_locations request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V3::Services::ListPlannableLocationsRequest
              ...
              #   {::Google::Ads::GoogleAds::V3::Services::ListPlannableProductsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V3::Services::ListPlannableProductsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V3::Services::ListPlannableProductsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def list_plannable_products request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V3::Services::ListPlannableProductsRequest
              ...
              #   {::Google::Ads::GoogleAds::V3::Services::GenerateProductMixIdeasRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V3::Services::GenerateProductMixIdeasRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V3::Services::GenerateProductMixIdeasResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def generate_product_mix_ideas request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V3::Services::GenerateProductMixIdeasRequest
              ...
              #   {::Google::Ads::GoogleAds::V3::Services::GenerateReachForecastRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V3::Services::GenerateReachForecastRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @overload generate_reach_forecast(customer_id: nil, currency_code: nil, campaign_duration: nil, cookie_frequency_cap: nil, min_effective_frequency: nil, targeting: nil, planned_products: nil)
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V3::Services::GenerateReachForecastResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def generate_reach_forecast request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V3::Services::GenerateReachForecastRequest
              ...
              # {::Google::Ads::GoogleAds::V3::Services::ReachPlanService::Client::Configuration::Rpcs}
