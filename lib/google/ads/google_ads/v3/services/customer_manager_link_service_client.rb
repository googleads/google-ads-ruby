...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/customer_manager_link_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::CustomerManagerLinkService::Stub]
          class CustomerManagerLinkServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v3/services/customer_manager_link_service_services_pb"
              ...
              @customer_manager_link_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::CustomerManagerLinkService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V3::Resources::CustomerManagerLink]
            ...
            #
            #   customer_manager_link_client = Google::Ads::GoogleAds::CustomerManagerLink.new(version: :v3)
            #   formatted_resource_name = Google::Ads::GoogleAds::V3::Services::CustomerManagerLinkServiceClient.customer_manager_link_path("[CUSTOMER]", "[CUSTOMER_MANAGER_LINK]")
            ...
            def get_customer_manager_link \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GetCustomerManagerLinkRequest)
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::CustomerManagerLinkOperation`
            #   can also be provided.
            # @param options [Google::Gax::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout,
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::MutateCustomerManagerLinkResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_customer_manager_link \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::MutateCustomerManagerLinkRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::MoveManagerLinkResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def move_manager_link \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::MoveManagerLinkRequest)
