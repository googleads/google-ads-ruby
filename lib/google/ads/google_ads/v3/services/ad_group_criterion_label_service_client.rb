...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/ad_group_criterion_label_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::AdGroupCriterionLabelService::Stub]
          class AdGroupCriterionLabelServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v3/services/ad_group_criterion_label_service_services_pb"
              ...
              @ad_group_criterion_label_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::AdGroupCriterionLabelService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V3::Resources::AdGroupCriterionLabel]
            ...
            #
            #   ad_group_criterion_label_client = Google::Ads::GoogleAds::AdGroupCriterionLabel.new(version: :v3)
            #   formatted_resource_name = Google::Ads::GoogleAds::V3::Services::AdGroupCriterionLabelServiceClient.ad_group_criterion_label_path("[CUSTOMER]", "[AD_GROUP_CRITERION_LABEL]")
            ...
            def get_ad_group_criterion_label \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GetAdGroupCriterionLabelRequest)
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::AdGroupCriterionLabelOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::MutateAdGroupCriterionLabelsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_ad_group_criterion_labels \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::MutateAdGroupCriterionLabelsRequest)
