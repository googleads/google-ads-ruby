...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/conversion_action_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::ConversionActionService::Stub]
          class ConversionActionServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v3/services/conversion_action_service_services_pb"
              ...
              @conversion_action_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::ConversionActionService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V3::Resources::ConversionAction]
            ...
            #
            #   conversion_action_client = Google::Ads::GoogleAds::ConversionAction.new(version: :v3)
            #   formatted_resource_name = Google::Ads::GoogleAds::V3::Services::ConversionActionServiceClient.conversion_action_path("[CUSTOMER]", "[CONVERSION_ACTION]")
            ...
            def get_conversion_action \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GetConversionActionRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V3::Services::ConversionActionOperation | Hash>]
            #   Required. The list of operations to perform on individual conversion actions.
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::ConversionActionOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::MutateConversionActionsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_conversion_actions \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::MutateConversionActionsRequest)
