        ...
        module Services
          module AdGroupAdService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V3::Services::AdGroupAdService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V3::Services::AdGroupAdService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V3::Services::AdGroupAdService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                @ad_group_ad_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V3::Services::AdGroupAdService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V3::Services::GetAdGroupAdRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V3::Services::GetAdGroupAdRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V3::Resources::AdGroupAd]
              ...
              def get_ad_group_ad request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V3::Services::GetAdGroupAdRequest
              ...
              #   {::Google::Ads::GoogleAds::V3::Services::MutateAdGroupAdsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V3::Services::MutateAdGroupAdsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V3::Services::MutateAdGroupAdsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_ad_group_ads request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V3::Services::MutateAdGroupAdsRequest
              ...
              # {::Google::Ads::GoogleAds::V3::Services::AdGroupAdService::Client::Configuration::Rpcs}
