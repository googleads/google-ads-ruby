...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/ad_group_feed_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::AdGroupFeedService::Stub]
          class AdGroupFeedServiceClient
            ...
            def initialize \
              ...
              @ad_group_feed_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::AdGroupFeedService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V3::Resources::AdGroupFeed]
            ...
            #
            #   ad_group_feed_client = Google::Ads::GoogleAds::AdGroupFeed.new(version: :v3)
            #   formatted_resource_name = Google::Ads::GoogleAds::V3::Services::AdGroupFeedServiceClient.ad_group_feed_path("[CUSTOMER]", "[AD_GROUP_FEED]")
            ...
            def get_ad_group_feed \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GetAdGroupFeedRequest)
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::AdGroupFeedOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::MutateAdGroupFeedsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_ad_group_feeds \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::MutateAdGroupFeedsRequest)
