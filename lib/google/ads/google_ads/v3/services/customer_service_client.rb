...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/customer_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::CustomerService::Stub]
          class CustomerServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v3/services/customer_service_services_pb"
              ...
              @customer_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::CustomerService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V3::Resources::Customer]
            ...
            #
            #   customer_client = Google::Ads::GoogleAds::Customer.new(version: :v3)
            #   formatted_resource_name = Google::Ads::GoogleAds::V3::Services::CustomerServiceClient.customer_path("[CUSTOMER]")
            ...
            def get_customer \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GetCustomerRequest)
            ...
            # @param operation [Google::Ads::GoogleAds::V3::Services::CustomerOperation | Hash]
            #   Required. The operation to perform on the customer
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::CustomerOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::MutateCustomerResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_customer \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::MutateCustomerRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::ListAccessibleCustomersResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def list_accessible_customers options: nil, &block
              req = Google::Ads::GoogleAds::V3::Services::ListAccessibleCustomersRequest.new
            ...
            # @param customer_client [Google::Ads::GoogleAds::V3::Resources::Customer | Hash]
            #   Required. The new client customer to create. The resource name on this customer
            #   will be ignored.
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Resources::Customer`
            #   can also be provided.
            ...
            #   can also be provided.
            # @param access_role [Google::Ads::GoogleAds::V3::Enums::AccessRoleEnum::AccessRole]
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::CreateCustomerClientResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def create_customer_client \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::CreateCustomerClientRequest)
