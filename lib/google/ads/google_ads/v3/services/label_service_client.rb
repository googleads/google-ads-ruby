...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/label_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::LabelService::Stub]
          class LabelServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v3/services/label_service_services_pb"
              ...
              @label_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::LabelService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V3::Resources::Label]
            ...
            #
            #   label_client = Google::Ads::GoogleAds::Label.new(version: :v3)
            #   formatted_resource_name = Google::Ads::GoogleAds::V3::Services::LabelServiceClient.label_path("[CUSTOMER]", "[LABEL]")
            ...
            def get_label \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GetLabelRequest)
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::LabelOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::MutateLabelsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_labels \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::MutateLabelsRequest)
