...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/campaign_experiment_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::CampaignExperimentService::Stub]
          class CampaignExperimentServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v3/services/campaign_experiment_service_services_pb"
              ...
              @campaign_experiment_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::CampaignExperimentService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V3::Resources::CampaignExperiment]
            ...
            #
            #   campaign_experiment_client = Google::Ads::GoogleAds::CampaignExperiment.new(version: :v3)
            #   formatted_resource_name = Google::Ads::GoogleAds::V3::Services::CampaignExperimentServiceClient.campaign_experiment_path("[CUSTOMER]", "[CAMPAIGN_EXPERIMENT]")
            ...
            def get_campaign_experiment \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GetCampaignExperimentRequest)
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Resources::CampaignExperiment`
            ...
            def create_campaign_experiment \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::CreateCampaignExperimentRequest)
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::CampaignExperimentOperation`
            #   can also be provided.
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::MutateCampaignExperimentsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_campaign_experiments \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::MutateCampaignExperimentsRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::GraduateCampaignExperimentResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            #
            #   campaign_experiment_client = Google::Ads::GoogleAds::CampaignExperiment.new(version: :v3)
            #   formatted_campaign_experiment = Google::Ads::GoogleAds::V3::Services::CampaignExperimentServiceClient.campaign_experiment_path("[CUSTOMER]", "[CAMPAIGN_EXPERIMENT]")
            #
            ...
            def graduate_campaign_experiment \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GraduateCampaignExperimentRequest)
            ...
            def promote_campaign_experiment \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::PromoteCampaignExperimentRequest)
              operation = Google::Gax::Operation.new(
            ...
            def end_campaign_experiment \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::EndCampaignExperimentRequest)
            ...
            def list_campaign_experiment_async_errors \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::ListCampaignExperimentAsyncErrorsRequest)
