...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/bidding_strategy_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::BiddingStrategyService::Stub]
          class BiddingStrategyServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v3/services/bidding_strategy_service_services_pb"
              ...
              @bidding_strategy_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::BiddingStrategyService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V3::Resources::BiddingStrategy]
            ...
            #
            #   bidding_strategy_client = Google::Ads::GoogleAds::BiddingStrategy.new(version: :v3)
            #   formatted_resource_name = Google::Ads::GoogleAds::V3::Services::BiddingStrategyServiceClient.bidding_strategy_path("[CUSTOMER]", "[BIDDING_STRATEGY]")
            ...
            def get_bidding_strategy \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GetBiddingStrategyRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V3::Services::BiddingStrategyOperation | Hash>]
            #   Required. The list of operations to perform on individual bidding strategies.
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::BiddingStrategyOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::MutateBiddingStrategiesResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_bidding_strategies \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::MutateBiddingStrategiesRequest)
