...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/campaign_draft_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::CampaignDraftService::Stub]
          class CampaignDraftServiceClient
            ...
            def initialize \
              ...
              @campaign_draft_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::CampaignDraftService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V3::Resources::CampaignDraft]
            ...
            #
            #   campaign_draft_client = Google::Ads::GoogleAds::CampaignDraft.new(version: :v3)
            #   formatted_resource_name = Google::Ads::GoogleAds::V3::Services::CampaignDraftServiceClient.campaign_draft_path("[CUSTOMER]", "[CAMPAIGN_DRAFT]")
            ...
            def get_campaign_draft \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GetCampaignDraftRequest)
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::CampaignDraftOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::MutateCampaignDraftsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_campaign_drafts \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::MutateCampaignDraftsRequest)
            ...
            # {Google::Ads::GoogleAds::V3::Services::CampaignDraftService::ListCampaignDraftAsyncErrors CampaignDraftService::ListCampaignDraftAsyncErrors} to view the list of
            # error reasons.
            #
            # @param campaign_draft [String]
            ...
            #
            #   campaign_draft_client = Google::Ads::GoogleAds::CampaignDraft.new(version: :v3)
            #   formatted_campaign_draft = Google::Ads::GoogleAds::V3::Services::CampaignDraftServiceClient.campaign_draft_path("[CUSTOMER]", "[CAMPAIGN_DRAFT]")
            #
            ...
            def promote_campaign_draft \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::PromoteCampaignDraftRequest)
            ...
            def list_campaign_draft_async_errors \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::ListCampaignDraftAsyncErrorsRequest)
