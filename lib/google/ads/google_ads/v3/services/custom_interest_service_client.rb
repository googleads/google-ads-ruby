...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/custom_interest_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::CustomInterestService::Stub]
          class CustomInterestServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v3/services/custom_interest_service_services_pb"
              ...
              @custom_interest_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::CustomInterestService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V3::Resources::CustomInterest]
            ...
            #
            #   custom_interest_client = Google::Ads::GoogleAds::CustomInterest.new(version: :v3)
            #   formatted_resource_name = Google::Ads::GoogleAds::V3::Services::CustomInterestServiceClient.custom_interest_path("[CUSTOMER]", "[CUSTOM_INTEREST]")
            ...
            def get_custom_interest \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GetCustomInterestRequest)
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::CustomInterestOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::MutateCustomInterestsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_custom_interests \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::MutateCustomInterestsRequest)
