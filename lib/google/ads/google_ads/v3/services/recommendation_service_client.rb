...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/recommendation_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::RecommendationService::Stub]
          class RecommendationServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v3/services/recommendation_service_services_pb"
              ...
              @recommendation_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::RecommendationService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V3::Resources::Recommendation]
            ...
            #
            #   recommendation_client = Google::Ads::GoogleAds::Recommendation.new(version: :v3)
            #   formatted_resource_name = Google::Ads::GoogleAds::V3::Services::RecommendationServiceClient.recommendation_path("[CUSTOMER]", "[RECOMMENDATION]")
            ...
            def get_recommendation \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GetRecommendationRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V3::Services::ApplyRecommendationOperation | Hash>]
            #   Required. The list of operations to apply recommendations.
            #   If partial_failure=false all recommendations should be of the same type
            #   There is a limit of 100 operations per request.
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::ApplyRecommendationOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::ApplyRecommendationResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def apply_recommendation \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::ApplyRecommendationRequest)
            ...
            # @param customer_id [String]
            #   Required. The ID of the customer with the recommendation.
            # @param operations [Array<Google::Ads::GoogleAds::V3::Services::DismissRecommendationRequest::DismissRecommendationOperation | Hash>]
            #   Required. The list of operations to dismiss recommendations.
            #   If partial_failure=false all recommendations should be of the same type
            #   There is a limit of 100 operations per request.
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::DismissRecommendationRequest::DismissRecommendationOperation`
            #   can also be provided.
            # @param partial_failure [true, false]
            #   If true, successful operations will be carried out and invalid
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::DismissRecommendationResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def dismiss_recommendation \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::DismissRecommendationRequest)
