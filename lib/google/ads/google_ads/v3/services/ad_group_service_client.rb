...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/ad_group_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::AdGroupService::Stub]
          class AdGroupServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v3/services/ad_group_service_services_pb"
              ...
              @ad_group_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::AdGroupService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V3::Resources::AdGroup]
            ...
            #
            #   ad_group_client = Google::Ads::GoogleAds::AdGroup.new(version: :v3)
            #   formatted_resource_name = Google::Ads::GoogleAds::V3::Services::AdGroupServiceClient.ad_group_path("[CUSTOMER]", "[AD_GROUP]")
            #   response = ad_group_client.get_ad_group(formatted_resource_name)
            ...
            def get_ad_group \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GetAdGroupRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V3::Services::AdGroupOperation | Hash>]
            #   Required. The list of operations to perform on individual ad groups.
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::AdGroupOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::MutateAdGroupsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V3::Services::MutateAdGroupsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            #   operations = []
            #   response = ad_group_client.mutate_ad_groups(customer_id, operations)
            ...
            def mutate_ad_groups \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::MutateAdGroupsRequest)
