...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v3/services/reach_plan_service.proto,
    ...
    module GoogleAds
      module V3
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V3::Services::ReachPlanService::Stub]
          class ReachPlanServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v3/services/reach_plan_service_services_pb"
              ...
              @reach_plan_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V3::Services::ReachPlanService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::ListPlannableLocationsResponse]
            ...
            #
            #   reach_plan_client = Google::Ads::GoogleAds::ReachPlan.new(version: :v3)
            #   response = reach_plan_client.list_plannable_locations

            def list_plannable_locations options: nil, &block
              req = Google::Ads::GoogleAds::V3::Services::ListPlannableLocationsRequest.new
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::ListPlannableProductsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def list_plannable_products \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::ListPlannableProductsRequest)
            ...
            #   can also be provided.
            # @param preferences [Google::Ads::GoogleAds::V3::Services::Preferences | Hash]
            #   The preferences of the suggested product mix.
            #   An unset preference is interpreted as all possible values are allowed,
            #   unless explicitly specified.
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::Preferences`
            #   can also be provided.
            # @param options [Google::Gax::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout,
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::GenerateProductMixIdeasResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def generate_product_mix_ideas \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GenerateProductMixIdeasRequest)
            ...
            #   A hash of the same form as `Google::Protobuf::StringValue`
            #   can also be provided.
            # @param campaign_duration [Google::Ads::GoogleAds::V3::Services::CampaignDuration | Hash]
            #   Required. Campaign duration.
            #   A hash of the same form as `Google::Ads::GoogleAds::V3::Services::CampaignDuration`
            #   can also be provided.
            ...
            #   A hash of the same form as `Google::Protobuf::Int32Value`
            #   can also be provided.
            # @param targeting [Google::Ads::GoogleAds::V3::Services::Targeting | Hash]
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V3::Services::GenerateReachForecastResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def generate_reach_forecast \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V3::Services::GenerateReachForecastRequest)
