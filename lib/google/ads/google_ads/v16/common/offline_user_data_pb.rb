...
begin
  ...
  imports = [
    ["google.ads.googleads.v16.common.Consent", "google/ads/googleads/v16/common/consent.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Common
          OfflineUserAddressInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.common.OfflineUserAddressInfo").msgclass
          UserIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.common.UserIdentifier").msgclass
          TransactionAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.common.TransactionAttribute").msgclass
          StoreAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.common.StoreAttribute").msgclass
          ItemAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.common.ItemAttribute").msgclass
          UserData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.common.UserData").msgclass
          UserAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.common.UserAttribute").msgclass
          EventAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.common.EventAttribute").msgclass
          EventItemAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.common.EventItemAttribute").msgclass
          ShoppingLoyalty = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.common.ShoppingLoyalty").msgclass
          CustomerMatchUserListMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.common.CustomerMatchUserListMetadata").msgclass
          StoreSalesMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.common.StoreSalesMetadata").msgclass
          StoreSalesThirdPartyMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.common.StoreSalesThirdPartyMetadata").msgclass
        end
      end
    end
  end
