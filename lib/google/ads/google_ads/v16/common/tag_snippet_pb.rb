...
module Google
  module Ads
    module GoogleAds
      module V16
        module Common
          TagSnippet = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.common.TagSnippet").msgclass
        end
      end
    end
  end
