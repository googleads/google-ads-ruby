...
module Google
  module Ads
    module GoogleAds
      module V16
        module Common
          DynamicLocationSetFilter = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.common.DynamicLocationSetFilter").msgclass
          BusinessNameFilter = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.common.BusinessNameFilter").msgclass
          DynamicAffiliateLocationSetFilter = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.common.DynamicAffiliateLocationSetFilter").msgclass
        end
      end
    end
  end
