...
module Google
  module Ads
    module GoogleAds
      module V16
        module Common
          CustomizerValue = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.common.CustomizerValue").msgclass
        end
      end
    end
  end
