...
module Google
  module Ads
    module GoogleAds
      module V16
        module Common
          UrlCollection = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.common.UrlCollection").msgclass
        end
      end
    end
  end
