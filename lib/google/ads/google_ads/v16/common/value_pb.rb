...
module Google
  module Ads
    module GoogleAds
      module V16
        module Common
          Value = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.common.Value").msgclass
        end
      end
    end
  end
