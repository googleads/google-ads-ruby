...
module Google
  module Ads
    module GoogleAds
      module V16
        module Common
          CriterionCategoryAvailability = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.common.CriterionCategoryAvailability").msgclass
          CriterionCategoryChannelAvailability = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.common.CriterionCategoryChannelAvailability").msgclass
          CriterionCategoryLocaleAvailability = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.common.CriterionCategoryLocaleAvailability").msgclass
        end
      end
    end
  end
