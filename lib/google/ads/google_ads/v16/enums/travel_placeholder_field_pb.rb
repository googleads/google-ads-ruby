...
module Google
  module Ads
    module GoogleAds
      module V16
        module Enums
          TravelPlaceholderFieldEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.enums.TravelPlaceholderFieldEnum").msgclass
          TravelPlaceholderFieldEnum::TravelPlaceholderField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.enums.TravelPlaceholderFieldEnum.TravelPlaceholderField").enummodule
        end
      end
    end
  end
