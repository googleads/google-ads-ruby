...
module Google
  module Ads
    module GoogleAds
      module V16
        module Enums
          ListingGroupFilterCustomAttributeIndexEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.enums.ListingGroupFilterCustomAttributeIndexEnum").msgclass
          ListingGroupFilterCustomAttributeIndexEnum::ListingGroupFilterCustomAttributeIndex = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.enums.ListingGroupFilterCustomAttributeIndexEnum.ListingGroupFilterCustomAttributeIndex").enummodule
        end
      end
    end
  end
