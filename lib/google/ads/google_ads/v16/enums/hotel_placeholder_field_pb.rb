...
module Google
  module Ads
    module GoogleAds
      module V16
        module Enums
          HotelPlaceholderFieldEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.enums.HotelPlaceholderFieldEnum").msgclass
          HotelPlaceholderFieldEnum::HotelPlaceholderField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.enums.HotelPlaceholderFieldEnum.HotelPlaceholderField").enummodule
        end
      end
    end
  end
