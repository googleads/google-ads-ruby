...
module Google
  module Ads
    module GoogleAds
      module V16
        module Enums
          UserListSizeRangeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.enums.UserListSizeRangeEnum").msgclass
          UserListSizeRangeEnum::UserListSizeRange = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.enums.UserListSizeRangeEnum.UserListSizeRange").enummodule
        end
      end
    end
  end
