...
module Google
  module Ads
    module GoogleAds
      module V16
        module Enums
          AccessInvitationStatusEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.enums.AccessInvitationStatusEnum").msgclass
          AccessInvitationStatusEnum::AccessInvitationStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.enums.AccessInvitationStatusEnum.AccessInvitationStatus").enummodule
        end
      end
    end
  end
