...
module Google
  module Ads
    module GoogleAds
      module V16
        module Enums
          ListingGroupFilterProductCategoryLevelEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.enums.ListingGroupFilterProductCategoryLevelEnum").msgclass
          ListingGroupFilterProductCategoryLevelEnum::ListingGroupFilterProductCategoryLevel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.enums.ListingGroupFilterProductCategoryLevelEnum.ListingGroupFilterProductCategoryLevel").enummodule
        end
      end
    end
  end
