...
module Google
  module Ads
    module GoogleAds
      module V16
        module Enums
          AssetTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.enums.AssetTypeEnum").msgclass
          AssetTypeEnum::AssetType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.enums.AssetTypeEnum.AssetType").enummodule
        end
      end
    end
  end
