...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateFeedsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateFeedsRequest").msgclass
          FeedOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.FeedOperation").msgclass
          MutateFeedsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateFeedsResponse").msgclass
          MutateFeedResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateFeedResult").msgclass
        end
      end
    end
  end
