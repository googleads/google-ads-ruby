...
begin
  ...
  imports = [
    ["google.ads.googleads.v16.resources.GoogleAdsField", "google/ads/googleads/v16/resources/google_ads_field.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          GetGoogleAdsFieldRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.GetGoogleAdsFieldRequest").msgclass
          SearchGoogleAdsFieldsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.SearchGoogleAdsFieldsRequest").msgclass
          SearchGoogleAdsFieldsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.SearchGoogleAdsFieldsResponse").msgclass
        end
      end
    end
  end
