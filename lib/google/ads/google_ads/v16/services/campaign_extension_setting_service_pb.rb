...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.resources.CampaignExtensionSetting", "google/ads/googleads/v16/resources/campaign_extension_setting.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateCampaignExtensionSettingsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCampaignExtensionSettingsRequest").msgclass
          CampaignExtensionSettingOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.CampaignExtensionSettingOperation").msgclass
          MutateCampaignExtensionSettingsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCampaignExtensionSettingsResponse").msgclass
          MutateCampaignExtensionSettingResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCampaignExtensionSettingResult").msgclass
        end
      end
    end
  end
