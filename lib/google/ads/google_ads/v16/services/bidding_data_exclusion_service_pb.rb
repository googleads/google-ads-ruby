...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.resources.BiddingDataExclusion", "google/ads/googleads/v16/resources/bidding_data_exclusion.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateBiddingDataExclusionsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateBiddingDataExclusionsRequest").msgclass
          BiddingDataExclusionOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.BiddingDataExclusionOperation").msgclass
          MutateBiddingDataExclusionsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateBiddingDataExclusionsResponse").msgclass
          MutateBiddingDataExclusionsResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateBiddingDataExclusionsResult").msgclass
        end
      end
    end
  end
