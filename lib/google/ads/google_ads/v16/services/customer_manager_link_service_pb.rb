...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.resources.CustomerManagerLink", "google/ads/googleads/v16/resources/customer_manager_link.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateCustomerManagerLinkRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomerManagerLinkRequest").msgclass
          MoveManagerLinkRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MoveManagerLinkRequest").msgclass
          CustomerManagerLinkOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.CustomerManagerLinkOperation").msgclass
          MutateCustomerManagerLinkResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomerManagerLinkResponse").msgclass
          MoveManagerLinkResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MoveManagerLinkResponse").msgclass
          MutateCustomerManagerLinkResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomerManagerLinkResult").msgclass
        end
      end
    end
  end
