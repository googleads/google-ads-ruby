...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.resources.AssetGroupAsset", "google/ads/googleads/v16/resources/asset_group_asset.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateAssetGroupAssetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateAssetGroupAssetsRequest").msgclass
          AssetGroupAssetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.AssetGroupAssetOperation").msgclass
          MutateAssetGroupAssetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateAssetGroupAssetsResponse").msgclass
          MutateAssetGroupAssetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateAssetGroupAssetResult").msgclass
        end
      end
    end
  end
