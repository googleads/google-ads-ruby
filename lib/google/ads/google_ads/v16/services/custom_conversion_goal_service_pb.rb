...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.resources.CustomConversionGoal", "google/ads/googleads/v16/resources/custom_conversion_goal.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateCustomConversionGoalsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomConversionGoalsRequest").msgclass
          CustomConversionGoalOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.CustomConversionGoalOperation").msgclass
          MutateCustomConversionGoalsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomConversionGoalsResponse").msgclass
          MutateCustomConversionGoalResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomConversionGoalResult").msgclass
        end
      end
    end
  end
