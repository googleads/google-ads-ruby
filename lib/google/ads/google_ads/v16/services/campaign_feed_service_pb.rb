...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateCampaignFeedsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCampaignFeedsRequest").msgclass
          CampaignFeedOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.CampaignFeedOperation").msgclass
          MutateCampaignFeedsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCampaignFeedsResponse").msgclass
          MutateCampaignFeedResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCampaignFeedResult").msgclass
        end
      end
    end
  end
