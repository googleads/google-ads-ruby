...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.resources.Experiment", "google/ads/googleads/v16/resources/experiment.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateExperimentsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateExperimentsRequest").msgclass
          ExperimentOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.ExperimentOperation").msgclass
          MutateExperimentsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateExperimentsResponse").msgclass
          MutateExperimentResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateExperimentResult").msgclass
          EndExperimentRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.EndExperimentRequest").msgclass
          ListExperimentAsyncErrorsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.ListExperimentAsyncErrorsRequest").msgclass
          ListExperimentAsyncErrorsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.ListExperimentAsyncErrorsResponse").msgclass
          GraduateExperimentRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.GraduateExperimentRequest").msgclass
          CampaignBudgetMapping = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.CampaignBudgetMapping").msgclass
          ScheduleExperimentRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.ScheduleExperimentRequest").msgclass
          ScheduleExperimentMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.ScheduleExperimentMetadata").msgclass
          PromoteExperimentRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.PromoteExperimentRequest").msgclass
          PromoteExperimentMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.PromoteExperimentMetadata").msgclass
        end
      end
    end
  end
