...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.common.SmartCampaignAdInfo", "google/ads/googleads/v16/common/ad_type_infos.proto"],
    ["google.ads.googleads.v16.resources.KeywordThemeConstant", "google/ads/googleads/v16/resources/keyword_theme_constant.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          SuggestSmartCampaignBudgetOptionsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.SuggestSmartCampaignBudgetOptionsRequest").msgclass
          SmartCampaignSuggestionInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.SmartCampaignSuggestionInfo").msgclass
          SmartCampaignSuggestionInfo::LocationList = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.SmartCampaignSuggestionInfo.LocationList").msgclass
          SmartCampaignSuggestionInfo::BusinessContext = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.SmartCampaignSuggestionInfo.BusinessContext").msgclass
          SuggestSmartCampaignBudgetOptionsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.SuggestSmartCampaignBudgetOptionsResponse").msgclass
          SuggestSmartCampaignBudgetOptionsResponse::Metrics = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.SuggestSmartCampaignBudgetOptionsResponse.Metrics").msgclass
          SuggestSmartCampaignBudgetOptionsResponse::BudgetOption = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.SuggestSmartCampaignBudgetOptionsResponse.BudgetOption").msgclass
          SuggestSmartCampaignAdRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.SuggestSmartCampaignAdRequest").msgclass
          SuggestSmartCampaignAdResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.SuggestSmartCampaignAdResponse").msgclass
          SuggestKeywordThemesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.SuggestKeywordThemesRequest").msgclass
          SuggestKeywordThemesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.SuggestKeywordThemesResponse").msgclass
          SuggestKeywordThemesResponse::KeywordTheme = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.SuggestKeywordThemesResponse.KeywordTheme").msgclass
        end
      end
    end
  end
