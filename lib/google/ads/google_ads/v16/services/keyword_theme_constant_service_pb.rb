...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          SuggestKeywordThemeConstantsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.SuggestKeywordThemeConstantsRequest").msgclass
          SuggestKeywordThemeConstantsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.SuggestKeywordThemeConstantsResponse").msgclass
        end
      end
    end
  end
