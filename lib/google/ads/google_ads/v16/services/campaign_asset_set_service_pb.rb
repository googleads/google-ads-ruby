...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateCampaignAssetSetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCampaignAssetSetsRequest").msgclass
          CampaignAssetSetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.CampaignAssetSetOperation").msgclass
          MutateCampaignAssetSetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCampaignAssetSetsResponse").msgclass
          MutateCampaignAssetSetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCampaignAssetSetResult").msgclass
        end
      end
    end
  end
