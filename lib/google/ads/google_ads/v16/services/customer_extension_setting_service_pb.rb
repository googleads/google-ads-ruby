...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.resources.CustomerExtensionSetting", "google/ads/googleads/v16/resources/customer_extension_setting.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateCustomerExtensionSettingsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomerExtensionSettingsRequest").msgclass
          CustomerExtensionSettingOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.CustomerExtensionSettingOperation").msgclass
          MutateCustomerExtensionSettingsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomerExtensionSettingsResponse").msgclass
          MutateCustomerExtensionSettingResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomerExtensionSettingResult").msgclass
        end
      end
    end
  end
