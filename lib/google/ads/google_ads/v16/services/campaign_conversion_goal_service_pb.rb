...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.resources.CampaignConversionGoal", "google/ads/googleads/v16/resources/campaign_conversion_goal.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateCampaignConversionGoalsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCampaignConversionGoalsRequest").msgclass
          CampaignConversionGoalOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.CampaignConversionGoalOperation").msgclass
          MutateCampaignConversionGoalsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCampaignConversionGoalsResponse").msgclass
          MutateCampaignConversionGoalResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCampaignConversionGoalResult").msgclass
        end
      end
    end
  end
