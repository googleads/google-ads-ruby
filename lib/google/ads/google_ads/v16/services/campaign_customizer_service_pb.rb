...
begin
  ...
  imports = [
    ["google.ads.googleads.v16.resources.CampaignCustomizer", "google/ads/googleads/v16/resources/campaign_customizer.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateCampaignCustomizersRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCampaignCustomizersRequest").msgclass
          CampaignCustomizerOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.CampaignCustomizerOperation").msgclass
          MutateCampaignCustomizersResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCampaignCustomizersResponse").msgclass
          MutateCampaignCustomizerResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCampaignCustomizerResult").msgclass
        end
      end
    end
  end
