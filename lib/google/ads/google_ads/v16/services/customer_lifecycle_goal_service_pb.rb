...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.resources.CustomerLifecycleGoal", "google/ads/googleads/v16/resources/customer_lifecycle_goal.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          ConfigureCustomerLifecycleGoalsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.ConfigureCustomerLifecycleGoalsRequest").msgclass
          CustomerLifecycleGoalOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.CustomerLifecycleGoalOperation").msgclass
          ConfigureCustomerLifecycleGoalsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.ConfigureCustomerLifecycleGoalsResponse").msgclass
          ConfigureCustomerLifecycleGoalsResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.ConfigureCustomerLifecycleGoalsResult").msgclass
        end
      end
    end
  end
