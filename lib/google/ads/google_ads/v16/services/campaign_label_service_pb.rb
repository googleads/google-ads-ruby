...
begin
  ...
  imports = [
    ["google.ads.googleads.v16.resources.CampaignLabel", "google/ads/googleads/v16/resources/campaign_label.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateCampaignLabelsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCampaignLabelsRequest").msgclass
          CampaignLabelOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.CampaignLabelOperation").msgclass
          ...
          MutateCampaignLabelResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCampaignLabelResult").msgclass
        end
      end
    end
  end
