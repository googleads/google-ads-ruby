...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.resources.CustomizerAttribute", "google/ads/googleads/v16/resources/customizer_attribute.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateCustomizerAttributesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomizerAttributesRequest").msgclass
          CustomizerAttributeOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.CustomizerAttributeOperation").msgclass
          MutateCustomizerAttributesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomizerAttributesResponse").msgclass
          MutateCustomizerAttributeResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomizerAttributeResult").msgclass
        end
      end
    end
  end
