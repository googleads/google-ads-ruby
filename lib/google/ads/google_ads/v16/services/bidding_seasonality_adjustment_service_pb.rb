...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.resources.BiddingSeasonalityAdjustment", "google/ads/googleads/v16/resources/bidding_seasonality_adjustment.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateBiddingSeasonalityAdjustmentsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateBiddingSeasonalityAdjustmentsRequest").msgclass
          BiddingSeasonalityAdjustmentOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.BiddingSeasonalityAdjustmentOperation").msgclass
          MutateBiddingSeasonalityAdjustmentsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateBiddingSeasonalityAdjustmentsResponse").msgclass
          MutateBiddingSeasonalityAdjustmentsResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateBiddingSeasonalityAdjustmentsResult").msgclass
        end
      end
    end
  end
