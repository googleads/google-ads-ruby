...
begin
  ...
  imports = [
    ["google.ads.googleads.v16.resources.AdGroupLabel", "google/ads/googleads/v16/resources/ad_group_label.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateAdGroupLabelsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateAdGroupLabelsRequest").msgclass
          AdGroupLabelOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.AdGroupLabelOperation").msgclass
          MutateAdGroupLabelsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateAdGroupLabelsResponse").msgclass
          MutateAdGroupLabelResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateAdGroupLabelResult").msgclass
        end
      end
    end
  end
