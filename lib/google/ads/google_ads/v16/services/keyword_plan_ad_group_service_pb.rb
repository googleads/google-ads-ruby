...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.resources.KeywordPlanAdGroup", "google/ads/googleads/v16/resources/keyword_plan_ad_group.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateKeywordPlanAdGroupsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateKeywordPlanAdGroupsRequest").msgclass
          KeywordPlanAdGroupOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.KeywordPlanAdGroupOperation").msgclass
          MutateKeywordPlanAdGroupsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateKeywordPlanAdGroupsResponse").msgclass
          MutateKeywordPlanAdGroupResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateKeywordPlanAdGroupResult").msgclass
        end
      end
    end
  end
