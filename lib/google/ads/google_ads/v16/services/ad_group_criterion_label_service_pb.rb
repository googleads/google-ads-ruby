...
begin
  ...
  imports = [
    ["google.ads.googleads.v16.resources.AdGroupCriterionLabel", "google/ads/googleads/v16/resources/ad_group_criterion_label.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateAdGroupCriterionLabelsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateAdGroupCriterionLabelsRequest").msgclass
          AdGroupCriterionLabelOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.AdGroupCriterionLabelOperation").msgclass
          MutateAdGroupCriterionLabelsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateAdGroupCriterionLabelsResponse").msgclass
          MutateAdGroupCriterionLabelResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateAdGroupCriterionLabelResult").msgclass
        end
      end
    end
  end
