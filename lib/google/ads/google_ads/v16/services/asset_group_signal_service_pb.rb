...
begin
  ...
  imports = [
    ["google.ads.googleads.v16.common.PolicyViolationKey", "google/ads/googleads/v16/common/policy.proto"],
    ["google.ads.googleads.v16.resources.AssetGroupSignal", "google/ads/googleads/v16/resources/asset_group_signal.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateAssetGroupSignalsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateAssetGroupSignalsRequest").msgclass
          AssetGroupSignalOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.AssetGroupSignalOperation").msgclass
          MutateAssetGroupSignalsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateAssetGroupSignalsResponse").msgclass
          MutateAssetGroupSignalResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateAssetGroupSignalResult").msgclass
        end
      end
    end
  end
