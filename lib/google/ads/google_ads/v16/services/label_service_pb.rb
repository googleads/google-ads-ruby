...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.resources.Label", "google/ads/googleads/v16/resources/label.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateLabelsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateLabelsRequest").msgclass
          LabelOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.LabelOperation").msgclass
          MutateLabelsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateLabelsResponse").msgclass
          MutateLabelResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateLabelResult").msgclass
        end
      end
    end
  end
