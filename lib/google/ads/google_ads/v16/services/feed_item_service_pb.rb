...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateFeedItemsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateFeedItemsRequest").msgclass
          FeedItemOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.FeedItemOperation").msgclass
          MutateFeedItemsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateFeedItemsResponse").msgclass
          MutateFeedItemResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateFeedItemResult").msgclass
        end
      end
    end
  end
