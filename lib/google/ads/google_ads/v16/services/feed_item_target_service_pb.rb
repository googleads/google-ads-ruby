...
begin
  ...
  imports = [
    ["google.ads.googleads.v16.resources.FeedItemTarget", "google/ads/googleads/v16/resources/feed_item_target.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateFeedItemTargetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateFeedItemTargetsRequest").msgclass
          FeedItemTargetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.FeedItemTargetOperation").msgclass
          MutateFeedItemTargetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateFeedItemTargetsResponse").msgclass
          MutateFeedItemTargetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateFeedItemTargetResult").msgclass
        end
      end
    end
  end
