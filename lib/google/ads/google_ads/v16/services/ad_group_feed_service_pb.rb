...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateAdGroupFeedsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateAdGroupFeedsRequest").msgclass
          AdGroupFeedOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.AdGroupFeedOperation").msgclass
          MutateAdGroupFeedsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateAdGroupFeedsResponse").msgclass
          MutateAdGroupFeedResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateAdGroupFeedResult").msgclass
        end
      end
    end
  end
