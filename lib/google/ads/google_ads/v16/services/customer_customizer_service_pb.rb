...
begin
  ...
  imports = [
    ["google.ads.googleads.v16.resources.CustomerCustomizer", "google/ads/googleads/v16/resources/customer_customizer.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateCustomerCustomizersRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomerCustomizersRequest").msgclass
          CustomerCustomizerOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.CustomerCustomizerOperation").msgclass
          MutateCustomerCustomizersResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomerCustomizersResponse").msgclass
          MutateCustomerCustomizerResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomerCustomizerResult").msgclass
        end
      end
    end
  end
