...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.resources.FeedItemSet", "google/ads/googleads/v16/resources/feed_item_set.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateFeedItemSetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateFeedItemSetsRequest").msgclass
          FeedItemSetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.FeedItemSetOperation").msgclass
          MutateFeedItemSetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateFeedItemSetsResponse").msgclass
          MutateFeedItemSetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateFeedItemSetResult").msgclass
        end
      end
    end
  end
