...
require 'google/ads/google_ads/v16/enums/conversion_adjustment_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          UploadConversionAdjustmentsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.UploadConversionAdjustmentsRequest").msgclass
          UploadConversionAdjustmentsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.UploadConversionAdjustmentsResponse").msgclass
          ConversionAdjustment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.ConversionAdjustment").msgclass
          RestatementValue = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.RestatementValue").msgclass
          GclidDateTimePair = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.GclidDateTimePair").msgclass
          ConversionAdjustmentResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.ConversionAdjustmentResult").msgclass
        end
      end
    end
  end
