...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.resources.CampaignDraft", "google/ads/googleads/v16/resources/campaign_draft.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateCampaignDraftsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCampaignDraftsRequest").msgclass
          PromoteCampaignDraftRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.PromoteCampaignDraftRequest").msgclass
          CampaignDraftOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.CampaignDraftOperation").msgclass
          MutateCampaignDraftsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCampaignDraftsResponse").msgclass
          MutateCampaignDraftResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCampaignDraftResult").msgclass
          ListCampaignDraftAsyncErrorsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.ListCampaignDraftAsyncErrorsRequest").msgclass
          ListCampaignDraftAsyncErrorsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.ListCampaignDraftAsyncErrorsResponse").msgclass
        end
      end
    end
  end
