...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.resources.RemarketingAction", "google/ads/googleads/v16/resources/remarketing_action.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateRemarketingActionsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateRemarketingActionsRequest").msgclass
          RemarketingActionOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.RemarketingActionOperation").msgclass
          MutateRemarketingActionsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateRemarketingActionsResponse").msgclass
          MutateRemarketingActionResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateRemarketingActionResult").msgclass
        end
      end
    end
  end
