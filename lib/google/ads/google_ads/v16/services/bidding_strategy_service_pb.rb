...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.resources.BiddingStrategy", "google/ads/googleads/v16/resources/bidding_strategy.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateBiddingStrategiesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateBiddingStrategiesRequest").msgclass
          BiddingStrategyOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.BiddingStrategyOperation").msgclass
          MutateBiddingStrategiesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateBiddingStrategiesResponse").msgclass
          MutateBiddingStrategyResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateBiddingStrategyResult").msgclass
        end
      end
    end
  end
