...
begin
  ...
  imports = [
    ["google.ads.googleads.v16.resources.CustomerSkAdNetworkConversionValueSchema", "google/ads/googleads/v16/resources/customer_sk_ad_network_conversion_value_schema.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          CustomerSkAdNetworkConversionValueSchemaOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.CustomerSkAdNetworkConversionValueSchemaOperation").msgclass
          MutateCustomerSkAdNetworkConversionValueSchemaRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomerSkAdNetworkConversionValueSchemaRequest").msgclass
          MutateCustomerSkAdNetworkConversionValueSchemaResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomerSkAdNetworkConversionValueSchemaResult").msgclass
          MutateCustomerSkAdNetworkConversionValueSchemaResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomerSkAdNetworkConversionValueSchemaResponse").msgclass
        end
      end
    end
  end
