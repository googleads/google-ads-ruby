...
begin
  ...
  imports = [
    ["google.ads.googleads.v16.resources.FeedItemSetLink", "google/ads/googleads/v16/resources/feed_item_set_link.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateFeedItemSetLinksRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateFeedItemSetLinksRequest").msgclass
          FeedItemSetLinkOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.FeedItemSetLinkOperation").msgclass
          MutateFeedItemSetLinksResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateFeedItemSetLinksResponse").msgclass
          MutateFeedItemSetLinkResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateFeedItemSetLinkResult").msgclass
        end
      end
    end
  end
