...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateAssetSetAssetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateAssetSetAssetsRequest").msgclass
          AssetSetAssetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.AssetSetAssetOperation").msgclass
          MutateAssetSetAssetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateAssetSetAssetsResponse").msgclass
          MutateAssetSetAssetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateAssetSetAssetResult").msgclass
        end
      end
    end
  end
