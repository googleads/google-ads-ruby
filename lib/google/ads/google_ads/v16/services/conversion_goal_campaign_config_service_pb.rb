...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.resources.ConversionGoalCampaignConfig", "google/ads/googleads/v16/resources/conversion_goal_campaign_config.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateConversionGoalCampaignConfigsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateConversionGoalCampaignConfigsRequest").msgclass
          ConversionGoalCampaignConfigOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.ConversionGoalCampaignConfigOperation").msgclass
          MutateConversionGoalCampaignConfigsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateConversionGoalCampaignConfigsResponse").msgclass
          MutateConversionGoalCampaignConfigResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateConversionGoalCampaignConfigResult").msgclass
        end
      end
    end
  end
