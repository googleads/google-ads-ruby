...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.resources.ExperimentArm", "google/ads/googleads/v16/resources/experiment_arm.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateExperimentArmsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateExperimentArmsRequest").msgclass
          ExperimentArmOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.ExperimentArmOperation").msgclass
          MutateExperimentArmsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateExperimentArmsResponse").msgclass
          MutateExperimentArmResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateExperimentArmResult").msgclass
        end
      end
    end
  end
