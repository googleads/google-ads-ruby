...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.resources.ConversionAction", "google/ads/googleads/v16/resources/conversion_action.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateConversionActionsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateConversionActionsRequest").msgclass
          ConversionActionOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.ConversionActionOperation").msgclass
          MutateConversionActionsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateConversionActionsResponse").msgclass
          MutateConversionActionResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateConversionActionResult").msgclass
        end
      end
    end
  end
