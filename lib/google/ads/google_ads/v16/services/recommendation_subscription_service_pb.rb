...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.resources.RecommendationSubscription", "google/ads/googleads/v16/resources/recommendation_subscription.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateRecommendationSubscriptionRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateRecommendationSubscriptionRequest").msgclass
          RecommendationSubscriptionOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.RecommendationSubscriptionOperation").msgclass
          MutateRecommendationSubscriptionResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateRecommendationSubscriptionResponse").msgclass
          MutateRecommendationSubscriptionResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateRecommendationSubscriptionResult").msgclass
        end
      end
    end
  end
