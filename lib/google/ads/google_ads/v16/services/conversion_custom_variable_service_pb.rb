...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.resources.ConversionCustomVariable", "google/ads/googleads/v16/resources/conversion_custom_variable.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateConversionCustomVariablesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateConversionCustomVariablesRequest").msgclass
          ConversionCustomVariableOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.ConversionCustomVariableOperation").msgclass
          MutateConversionCustomVariablesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateConversionCustomVariablesResponse").msgclass
          MutateConversionCustomVariableResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateConversionCustomVariableResult").msgclass
        end
      end
    end
  end
