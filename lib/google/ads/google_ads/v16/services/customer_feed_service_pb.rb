...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.resources.CustomerFeed", "google/ads/googleads/v16/resources/customer_feed.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateCustomerFeedsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomerFeedsRequest").msgclass
          CustomerFeedOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.CustomerFeedOperation").msgclass
          MutateCustomerFeedsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomerFeedsResponse").msgclass
          MutateCustomerFeedResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomerFeedResult").msgclass
        end
      end
    end
  end
