...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateCustomerAssetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomerAssetsRequest").msgclass
          CustomerAssetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.CustomerAssetOperation").msgclass
          MutateCustomerAssetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomerAssetsResponse").msgclass
          MutateCustomerAssetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomerAssetResult").msgclass
        end
      end
    end
  end
