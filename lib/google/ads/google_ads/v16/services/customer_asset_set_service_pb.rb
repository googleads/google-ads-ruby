...
begin
  ...
  imports = [
    ["google.ads.googleads.v16.resources.CustomerAssetSet", "google/ads/googleads/v16/resources/customer_asset_set.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateCustomerAssetSetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomerAssetSetsRequest").msgclass
          CustomerAssetSetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.CustomerAssetSetOperation").msgclass
          MutateCustomerAssetSetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomerAssetSetsResponse").msgclass
          MutateCustomerAssetSetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateCustomerAssetSetResult").msgclass
        end
      end
    end
  end
