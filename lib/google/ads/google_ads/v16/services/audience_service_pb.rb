...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.resources.Audience", "google/ads/googleads/v16/resources/audience.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          MutateAudiencesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateAudiencesRequest").msgclass
          MutateAudiencesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateAudiencesResponse").msgclass
          AudienceOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.AudienceOperation").msgclass
          MutateAudienceResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.MutateAudienceResult").msgclass
        end
      end
    end
  end
