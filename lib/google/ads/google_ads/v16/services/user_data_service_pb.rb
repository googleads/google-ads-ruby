...
begin
  ...
  imports = [
    ["google.ads.googleads.v16.common.CustomerMatchUserListMetadata", "google/ads/googleads/v16/common/offline_user_data.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Services
          UploadUserDataRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.UploadUserDataRequest").msgclass
          UserDataOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.UserDataOperation").msgclass
          UploadUserDataResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.services.UploadUserDataResponse").msgclass
        end
      end
    end
  end
