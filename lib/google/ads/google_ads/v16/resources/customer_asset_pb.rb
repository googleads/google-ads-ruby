...
# source: google/ads/googleads/v16/resources/customer_asset.proto
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          CustomerAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.CustomerAsset").msgclass
        end
      end
    end
  end
