...
# source: google/ads/googleads/v16/resources/parental_status_view.proto
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          ParentalStatusView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.ParentalStatusView").msgclass
        end
      end
    end
  end
