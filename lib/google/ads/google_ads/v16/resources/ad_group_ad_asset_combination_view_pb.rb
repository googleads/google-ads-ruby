...
begin
  ...
  imports = [
    ["google.ads.googleads.v16.common.AssetUsage", "google/ads/googleads/v16/common/asset_usage.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          AdGroupAdAssetCombinationView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AdGroupAdAssetCombinationView").msgclass
        end
      end
    end
  end
