...
require 'google/ads/google_ads/v16/enums/account_budget_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          AccountBudget = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AccountBudget").msgclass
          AccountBudget::PendingAccountBudgetProposal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AccountBudget.PendingAccountBudgetProposal").msgclass
        end
      end
    end
  end
