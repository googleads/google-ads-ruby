...
require 'google/ads/google_ads/v16/enums/operating_system_version_operator_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          OperatingSystemVersionConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.OperatingSystemVersionConstant").msgclass
        end
      end
    end
  end
