...
begin
  ...
  imports = [
    ["google.ads.googleads.v16.common.InteractionTypeInfo", "google/ads/googleads/v16/common/criteria.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          CampaignBidModifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.CampaignBidModifier").msgclass
        end
      end
    end
  end
