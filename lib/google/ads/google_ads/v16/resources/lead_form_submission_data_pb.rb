...
require 'google/ads/google_ads/v16/enums/lead_form_field_user_input_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          LeadFormSubmissionData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.LeadFormSubmissionData").msgclass
          LeadFormSubmissionField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.LeadFormSubmissionField").msgclass
          CustomLeadFormSubmissionField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.CustomLeadFormSubmissionField").msgclass
        end
      end
    end
  end
