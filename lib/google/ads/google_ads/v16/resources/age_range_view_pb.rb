...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          AgeRangeView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AgeRangeView").msgclass
        end
      end
    end
  end
