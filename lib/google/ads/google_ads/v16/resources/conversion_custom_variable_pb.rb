...
require 'google/ads/google_ads/v16/enums/conversion_custom_variable_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          ConversionCustomVariable = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.ConversionCustomVariable").msgclass
        end
      end
    end
  end
