...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          AdGroupAdLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AdGroupAdLabel").msgclass
        end
      end
    end
  end
