...
require 'google/ads/google_ads/v16/enums/android_privacy_network_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          AndroidPrivacySharedKeyGoogleNetworkType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AndroidPrivacySharedKeyGoogleNetworkType").msgclass
        end
      end
    end
  end
