...
# source: google/ads/googleads/v16/resources/user_location_view.proto
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          UserLocationView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.UserLocationView").msgclass
        end
      end
    end
  end
