...
require 'google/ads/google_ads/v16/enums/feed_item_quality_approval_status_pb'
require 'google/ads/google_ads/v16/enums/feed_item_quality_disapproval_reason_pb'
require 'google/ads/google_ads/v16/enums/feed_item_status_pb'
require 'google/ads/google_ads/v16/enums/feed_item_validation_status_pb'
require 'google/ads/google_ads/v16/enums/geo_targeting_restriction_pb'
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          FeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.FeedItem").msgclass
          FeedItemAttributeValue = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.FeedItemAttributeValue").msgclass
          FeedItemPlaceholderPolicyInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.FeedItemPlaceholderPolicyInfo").msgclass
          FeedItemValidationError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.FeedItemValidationError").msgclass
        end
      end
    end
  end
