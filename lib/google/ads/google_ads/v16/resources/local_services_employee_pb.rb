...
require 'google/ads/google_ads/v16/enums/local_services_employee_status_pb'
require 'google/ads/google_ads/v16/enums/local_services_employee_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          LocalServicesEmployee = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.LocalServicesEmployee").msgclass
          UniversityDegree = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.UniversityDegree").msgclass
          Residency = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.Residency").msgclass
          Fellowship = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.Fellowship").msgclass
        end
      end
    end
  end
