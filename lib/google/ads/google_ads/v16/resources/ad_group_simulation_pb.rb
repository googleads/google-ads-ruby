...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          AdGroupSimulation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AdGroupSimulation").msgclass
        end
      end
    end
  end
