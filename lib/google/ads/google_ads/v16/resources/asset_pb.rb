...
require 'google/ads/google_ads/v16/enums/asset_type_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.common.YoutubeVideoAsset", "google/ads/googleads/v16/common/asset_types.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          Asset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.Asset").msgclass
          AssetFieldTypePolicySummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AssetFieldTypePolicySummary").msgclass
          AssetPolicySummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AssetPolicySummary").msgclass
        end
      end
    end
  end
