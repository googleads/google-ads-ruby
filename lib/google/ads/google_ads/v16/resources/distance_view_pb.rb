...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          DistanceView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.DistanceView").msgclass
        end
      end
    end
  end
