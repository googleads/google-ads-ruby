...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          Video = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.Video").msgclass
        end
      end
    end
  end
