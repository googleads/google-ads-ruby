...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          AdGroupAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AdGroupAsset").msgclass
        end
      end
    end
  end
