...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          AssetGroupTopCombinationView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AssetGroupTopCombinationView").msgclass
          AssetGroupAssetCombinationData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AssetGroupAssetCombinationData").msgclass
        end
      end
    end
  end
