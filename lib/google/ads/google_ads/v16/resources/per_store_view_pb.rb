...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          PerStoreView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.PerStoreView").msgclass
        end
      end
    end
  end
