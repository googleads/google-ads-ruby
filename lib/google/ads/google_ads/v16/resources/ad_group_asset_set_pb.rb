...
# source: google/ads/googleads/v16/resources/ad_group_asset_set.proto
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          AdGroupAssetSet = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AdGroupAssetSet").msgclass
        end
      end
    end
  end
