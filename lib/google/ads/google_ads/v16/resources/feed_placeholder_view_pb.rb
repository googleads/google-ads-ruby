...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          FeedPlaceholderView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.FeedPlaceholderView").msgclass
        end
      end
    end
  end
