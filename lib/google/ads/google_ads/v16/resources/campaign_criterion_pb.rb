...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          CampaignCriterion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.CampaignCriterion").msgclass
        end
      end
    end
  end
