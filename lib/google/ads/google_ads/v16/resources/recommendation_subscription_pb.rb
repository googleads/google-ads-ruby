...
require 'google/ads/google_ads/v16/enums/recommendation_subscription_status_pb'
require 'google/ads/google_ads/v16/enums/recommendation_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          RecommendationSubscription = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.RecommendationSubscription").msgclass
        end
      end
    end
  end
