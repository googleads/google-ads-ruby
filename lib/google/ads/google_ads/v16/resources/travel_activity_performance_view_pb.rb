...
# source: google/ads/googleads/v16/resources/travel_activity_performance_view.proto
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          TravelActivityPerformanceView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.TravelActivityPerformanceView").msgclass
        end
      end
    end
  end
