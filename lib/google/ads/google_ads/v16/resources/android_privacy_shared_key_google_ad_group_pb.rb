...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          AndroidPrivacySharedKeyGoogleAdGroup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AndroidPrivacySharedKeyGoogleAdGroup").msgclass
        end
      end
    end
  end
