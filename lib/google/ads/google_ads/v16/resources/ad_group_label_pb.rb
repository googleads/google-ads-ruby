...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          AdGroupLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AdGroupLabel").msgclass
        end
      end
    end
  end
