...
# source: google/ads/googleads/v16/resources/ad_group_criterion_simulation.proto
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          AdGroupCriterionSimulation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AdGroupCriterionSimulation").msgclass
        end
      end
    end
  end
