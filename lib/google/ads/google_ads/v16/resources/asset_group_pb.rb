...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          AssetGroup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AssetGroup").msgclass
        end
      end
    end
  end
