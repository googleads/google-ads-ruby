...
require 'google/ads/google_ads/v16/enums/placement_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          DetailPlacementView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.DetailPlacementView").msgclass
        end
      end
    end
  end
