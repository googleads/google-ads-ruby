...
# source: google/ads/googleads/v16/resources/campaign_asset_set.proto

require 'google/protobuf'

require 'google/ads/google_ads/v16/enums/asset_set_link_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          CampaignAssetSet = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.CampaignAssetSet").msgclass
        end
      end
    end
  end
