...
require 'google/ads/google_ads/v16/enums/keyword_match_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          KeywordPlanCampaignKeyword = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.KeywordPlanCampaignKeyword").msgclass
        end
      end
    end
  end
