...
require 'google/ads/google_ads/v16/enums/keyword_plan_network_pb'
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          KeywordPlanCampaign = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.KeywordPlanCampaign").msgclass
          KeywordPlanGeoTarget = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.KeywordPlanGeoTarget").msgclass
        end
      end
    end
  end
