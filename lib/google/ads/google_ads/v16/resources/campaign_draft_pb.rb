...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          CampaignDraft = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.CampaignDraft").msgclass
        end
      end
    end
  end
