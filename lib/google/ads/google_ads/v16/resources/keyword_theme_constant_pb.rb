...
# source: google/ads/googleads/v16/resources/keyword_theme_constant.proto
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          KeywordThemeConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.KeywordThemeConstant").msgclass
        end
      end
    end
  end
