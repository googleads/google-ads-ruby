...
require 'google/ads/google_ads/v16/enums/bid_modifier_source_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v16.common.HotelDateSelectionTypeInfo", "google/ads/googleads/v16/common/criteria.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          AdGroupBidModifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AdGroupBidModifier").msgclass
        end
      end
    end
  end
