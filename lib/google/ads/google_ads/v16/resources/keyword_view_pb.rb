...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          KeywordView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.KeywordView").msgclass
        end
      end
    end
  end
