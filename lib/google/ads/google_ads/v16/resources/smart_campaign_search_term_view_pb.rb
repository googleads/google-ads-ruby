...
# source: google/ads/googleads/v16/resources/smart_campaign_search_term_view.proto
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          SmartCampaignSearchTermView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.SmartCampaignSearchTermView").msgclass
        end
      end
    end
  end
