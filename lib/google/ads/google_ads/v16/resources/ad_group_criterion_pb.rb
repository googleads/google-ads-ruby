...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          AdGroupCriterion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AdGroupCriterion").msgclass
          AdGroupCriterion::QualityInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AdGroupCriterion.QualityInfo").msgclass
          AdGroupCriterion::PositionEstimates = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AdGroupCriterion.PositionEstimates").msgclass
        end
      end
    end
  end
