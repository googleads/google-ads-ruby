...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          AssetGroupProductGroupView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AssetGroupProductGroupView").msgclass
        end
      end
    end
  end
