...
require 'google/ads/google_ads/v16/enums/asset_set_asset_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          AssetSetAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AssetSetAsset").msgclass
        end
      end
    end
  end
