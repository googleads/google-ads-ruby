...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          ThirdPartyAppAnalyticsLink = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.ThirdPartyAppAnalyticsLink").msgclass
        end
      end
    end
  end
