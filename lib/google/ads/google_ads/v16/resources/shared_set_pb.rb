...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          SharedSet = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.SharedSet").msgclass
        end
      end
    end
  end
