...
require 'google/ads/google_ads/v16/enums/mobile_device_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          MobileDeviceConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.MobileDeviceConstant").msgclass
        end
      end
    end
  end
