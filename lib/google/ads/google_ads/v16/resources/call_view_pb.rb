...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          CallView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.CallView").msgclass
        end
      end
    end
  end
