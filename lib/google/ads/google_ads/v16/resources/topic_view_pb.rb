...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          TopicView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.TopicView").msgclass
        end
      end
    end
  end
