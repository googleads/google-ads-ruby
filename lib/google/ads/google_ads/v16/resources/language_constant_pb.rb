...
# source: google/ads/googleads/v16/resources/language_constant.proto
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          LanguageConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.LanguageConstant").msgclass
        end
      end
    end
  end
