...
require 'google/ads/google_ads/v16/enums/access_invitation_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          CustomerUserAccessInvitation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.CustomerUserAccessInvitation").msgclass
        end
      end
    end
  end
