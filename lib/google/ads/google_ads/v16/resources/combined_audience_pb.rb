...
require 'google/ads/google_ads/v16/enums/combined_audience_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          CombinedAudience = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.CombinedAudience").msgclass
        end
      end
    end
  end
