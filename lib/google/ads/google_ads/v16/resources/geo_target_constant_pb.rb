...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          GeoTargetConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.GeoTargetConstant").msgclass
        end
      end
    end
  end
