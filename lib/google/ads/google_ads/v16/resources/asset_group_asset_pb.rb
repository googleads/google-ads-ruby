...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v16.common.PolicySummary", "google/ads/googleads/v16/common/policy_summary.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          AssetGroupAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AssetGroupAsset").msgclass
        end
      end
    end
  end
