...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          HotelGroupView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.HotelGroupView").msgclass
        end
      end
    end
  end
