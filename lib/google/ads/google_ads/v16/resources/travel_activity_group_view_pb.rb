...
# source: google/ads/googleads/v16/resources/travel_activity_group_view.proto
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          TravelActivityGroupView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.TravelActivityGroupView").msgclass
        end
      end
    end
  end
