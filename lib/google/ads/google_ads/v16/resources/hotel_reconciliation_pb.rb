...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          HotelReconciliation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.HotelReconciliation").msgclass
        end
      end
    end
  end
