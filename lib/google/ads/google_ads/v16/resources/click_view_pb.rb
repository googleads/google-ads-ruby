...
begin
  ...
  imports = [
    ["google.ads.googleads.v16.common.ClickLocation", "google/ads/googleads/v16/common/click_location.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          ClickView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.ClickView").msgclass
        end
      end
    end
  end
