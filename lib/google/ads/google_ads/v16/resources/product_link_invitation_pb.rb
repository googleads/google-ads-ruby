...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          ProductLinkInvitation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.ProductLinkInvitation").msgclass
          HotelCenterLinkInvitationIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.HotelCenterLinkInvitationIdentifier").msgclass
          MerchantCenterLinkInvitationIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.MerchantCenterLinkInvitationIdentifier").msgclass
          AdvertisingPartnerLinkInvitationIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AdvertisingPartnerLinkInvitationIdentifier").msgclass
        end
      end
    end
  end
