...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          SearchTermView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.SearchTermView").msgclass
        end
      end
    end
  end
