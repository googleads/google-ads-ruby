...
begin
  ...
  imports = [
    ["google.ads.googleads.v16.common.TargetCpaSimulationPointList", "google/ads/googleads/v16/common/simulation.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          BiddingStrategySimulation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.BiddingStrategySimulation").msgclass
        end
      end
    end
  end
