...
begin
  ...
  imports = [
    ["google.ads.googleads.v16.common.TextLabel", "google/ads/googleads/v16/common/text_label.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          Label = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.Label").msgclass
        end
      end
    end
  end
