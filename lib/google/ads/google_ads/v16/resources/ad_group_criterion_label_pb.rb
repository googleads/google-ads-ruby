...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          AdGroupCriterionLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.AdGroupCriterionLabel").msgclass
        end
      end
    end
  end
