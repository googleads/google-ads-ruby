...
require 'google/ads/google_ads/v16/enums/goal_config_level_pb'
...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          ConversionGoalCampaignConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.ConversionGoalCampaignConfig").msgclass
        end
      end
    end
  end
