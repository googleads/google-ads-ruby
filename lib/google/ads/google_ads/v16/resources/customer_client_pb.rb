...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          CustomerClient = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.CustomerClient").msgclass
        end
      end
    end
  end
