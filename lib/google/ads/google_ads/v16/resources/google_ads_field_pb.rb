...
module Google
  module Ads
    module GoogleAds
      module V16
        module Resources
          GoogleAdsField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.resources.GoogleAdsField").msgclass
        end
      end
    end
  end
