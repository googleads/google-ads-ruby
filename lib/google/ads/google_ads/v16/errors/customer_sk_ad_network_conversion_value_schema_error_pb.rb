...
module Google
  module Ads
    module GoogleAds
      module V16
        module Errors
          CustomerSkAdNetworkConversionValueSchemaErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.CustomerSkAdNetworkConversionValueSchemaErrorEnum").msgclass
          CustomerSkAdNetworkConversionValueSchemaErrorEnum::CustomerSkAdNetworkConversionValueSchemaError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.CustomerSkAdNetworkConversionValueSchemaErrorEnum.CustomerSkAdNetworkConversionValueSchemaError").enummodule
        end
      end
    end
  end
