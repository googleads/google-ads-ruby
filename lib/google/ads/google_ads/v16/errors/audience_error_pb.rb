...
module Google
  module Ads
    module GoogleAds
      module V16
        module Errors
          AudienceErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.AudienceErrorEnum").msgclass
          AudienceErrorEnum::AudienceError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.AudienceErrorEnum.AudienceError").enummodule
        end
      end
    end
  end
