...
module Google
  module Ads
    module GoogleAds
      module V16
        module Errors
          CampaignSharedSetErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.CampaignSharedSetErrorEnum").msgclass
          CampaignSharedSetErrorEnum::CampaignSharedSetError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.CampaignSharedSetErrorEnum.CampaignSharedSetError").enummodule
        end
      end
    end
  end
