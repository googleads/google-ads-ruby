...
module Google
  module Ads
    module GoogleAds
      module V16
        module Errors
          ProductLinkInvitationErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.ProductLinkInvitationErrorEnum").msgclass
          ProductLinkInvitationErrorEnum::ProductLinkInvitationError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.ProductLinkInvitationErrorEnum.ProductLinkInvitationError").enummodule
        end
      end
    end
  end
