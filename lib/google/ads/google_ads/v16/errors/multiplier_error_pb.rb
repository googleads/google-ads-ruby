...
module Google
  module Ads
    module GoogleAds
      module V16
        module Errors
          MultiplierErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.MultiplierErrorEnum").msgclass
          MultiplierErrorEnum::MultiplierError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.MultiplierErrorEnum.MultiplierError").enummodule
        end
      end
    end
  end
