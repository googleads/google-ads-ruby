...
module Google
  module Ads
    module GoogleAds
      module V16
        module Errors
          RecommendationSubscriptionErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.RecommendationSubscriptionErrorEnum").msgclass
          RecommendationSubscriptionErrorEnum::RecommendationSubscriptionError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.RecommendationSubscriptionErrorEnum.RecommendationSubscriptionError").enummodule
        end
      end
    end
  end
