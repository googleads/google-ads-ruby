...
module Google
  module Ads
    module GoogleAds
      module V16
        module Errors
          FeedItemErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.FeedItemErrorEnum").msgclass
          FeedItemErrorEnum::FeedItemError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.FeedItemErrorEnum.FeedItemError").enummodule
        end
      end
    end
  end
