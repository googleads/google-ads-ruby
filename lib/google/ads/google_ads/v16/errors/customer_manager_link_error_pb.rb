...
module Google
  module Ads
    module GoogleAds
      module V16
        module Errors
          CustomerManagerLinkErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.CustomerManagerLinkErrorEnum").msgclass
          CustomerManagerLinkErrorEnum::CustomerManagerLinkError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.CustomerManagerLinkErrorEnum.CustomerManagerLinkError").enummodule
        end
      end
    end
  end
