...
module Google
  module Ads
    module GoogleAds
      module V16
        module Errors
          AuthorizationErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.AuthorizationErrorEnum").msgclass
          AuthorizationErrorEnum::AuthorizationError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.AuthorizationErrorEnum.AuthorizationError").enummodule
        end
      end
    end
  end
