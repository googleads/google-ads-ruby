...
module Google
  module Ads
    module GoogleAds
      module V16
        module Errors
          RecommendationErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.RecommendationErrorEnum").msgclass
          RecommendationErrorEnum::RecommendationError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.RecommendationErrorEnum.RecommendationError").enummodule
        end
      end
    end
  end
