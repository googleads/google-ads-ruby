...
module Google
  module Ads
    module GoogleAds
      module V16
        module Errors
          CampaignCriterionErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.CampaignCriterionErrorEnum").msgclass
          CampaignCriterionErrorEnum::CampaignCriterionError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.CampaignCriterionErrorEnum.CampaignCriterionError").enummodule
        end
      end
    end
  end
