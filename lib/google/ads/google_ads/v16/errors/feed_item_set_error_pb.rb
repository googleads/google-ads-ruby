...
module Google
  module Ads
    module GoogleAds
      module V16
        module Errors
          FeedItemSetErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.FeedItemSetErrorEnum").msgclass
          FeedItemSetErrorEnum::FeedItemSetError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.FeedItemSetErrorEnum.FeedItemSetError").enummodule
        end
      end
    end
  end
