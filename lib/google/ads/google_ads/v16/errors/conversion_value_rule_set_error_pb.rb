...
module Google
  module Ads
    module GoogleAds
      module V16
        module Errors
          ConversionValueRuleSetErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.ConversionValueRuleSetErrorEnum").msgclass
          ConversionValueRuleSetErrorEnum::ConversionValueRuleSetError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.ConversionValueRuleSetErrorEnum.ConversionValueRuleSetError").enummodule
        end
      end
    end
  end
