...
module Google
  module Ads
    module GoogleAds
      module V16
        module Errors
          FeedItemTargetErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.FeedItemTargetErrorEnum").msgclass
          FeedItemTargetErrorEnum::FeedItemTargetError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.FeedItemTargetErrorEnum.FeedItemTargetError").enummodule
        end
      end
    end
  end
