...
module Google
  module Ads
    module GoogleAds
      module V16
        module Errors
          AssetGroupListingGroupFilterErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.AssetGroupListingGroupFilterErrorEnum").msgclass
          AssetGroupListingGroupFilterErrorEnum::AssetGroupListingGroupFilterError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.AssetGroupListingGroupFilterErrorEnum.AssetGroupListingGroupFilterError").enummodule
        end
      end
    end
  end
