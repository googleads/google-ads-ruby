...
module Google
  module Ads
    module GoogleAds
      module V16
        module Errors
          AuthenticationErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.AuthenticationErrorEnum").msgclass
          AuthenticationErrorEnum::AuthenticationError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.AuthenticationErrorEnum.AuthenticationError").enummodule
        end
      end
    end
  end
