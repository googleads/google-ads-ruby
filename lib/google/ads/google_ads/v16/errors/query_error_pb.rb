...
module Google
  module Ads
    module GoogleAds
      module V16
        module Errors
          QueryErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.QueryErrorEnum").msgclass
          QueryErrorEnum::QueryError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.QueryErrorEnum.QueryError").enummodule
        end
      end
    end
  end
