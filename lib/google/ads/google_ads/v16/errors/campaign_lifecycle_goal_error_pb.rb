...
module Google
  module Ads
    module GoogleAds
      module V16
        module Errors
          CampaignLifecycleGoalErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.CampaignLifecycleGoalErrorEnum").msgclass
          CampaignLifecycleGoalErrorEnum::CampaignLifecycleGoalError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.CampaignLifecycleGoalErrorEnum.CampaignLifecycleGoalError").enummodule
        end
      end
    end
  end
