...
module Google
  module Ads
    module GoogleAds
      module V16
        module Errors
          DateErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.DateErrorEnum").msgclass
          DateErrorEnum::DateError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.DateErrorEnum.DateError").enummodule
        end
      end
    end
  end
