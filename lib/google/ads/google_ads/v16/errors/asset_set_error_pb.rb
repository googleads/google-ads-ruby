...
module Google
  module Ads
    module GoogleAds
      module V16
        module Errors
          AssetSetErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.AssetSetErrorEnum").msgclass
          AssetSetErrorEnum::AssetSetError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v16.errors.AssetSetErrorEnum.AssetSetError").enummodule
        end
      end
    end
  end
