...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v4/services/custom_interest_service.proto,
    ...
    module GoogleAds
      module V4
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V4::Services::CustomInterestService::Stub]
          class CustomInterestServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v4/services/custom_interest_service_services_pb"
              ...
              @custom_interest_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V4::Services::CustomInterestService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V4::Resources::CustomInterest]
            ...
            #
            #   custom_interest_client = Google::Ads::GoogleAds::CustomInterest.new(version: :v4)
            #   formatted_resource_name = Google::Ads::GoogleAds::V4::Services::CustomInterestServiceClient.custom_interest_path("[CUSTOMER]", "[CUSTOM_INTEREST]")
            ...
            def get_custom_interest \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::GetCustomInterestRequest)
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V4::Services::CustomInterestOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::MutateCustomInterestsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_custom_interests \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::MutateCustomInterestsRequest)
