...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v4/services/keyword_plan_ad_group_service.proto,
    ...
    module GoogleAds
      module V4
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V4::Services::KeywordPlanAdGroupService::Stub]
          class KeywordPlanAdGroupServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v4/services/keyword_plan_ad_group_service_services_pb"
              ...
              @keyword_plan_ad_group_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V4::Services::KeywordPlanAdGroupService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V4::Resources::KeywordPlanAdGroup]
            ...
            #
            #   keyword_plan_ad_group_client = Google::Ads::GoogleAds::KeywordPlanAdGroup.new(version: :v4)
            #   formatted_resource_name = Google::Ads::GoogleAds::V4::Services::KeywordPlanAdGroupServiceClient.keyword_plan_ad_group_path("[CUSTOMER]", "[KEYWORD_PLAN_AD_GROUP]")
            ...
            def get_keyword_plan_ad_group \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::GetKeywordPlanAdGroupRequest)
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V4::Services::KeywordPlanAdGroupOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::MutateKeywordPlanAdGroupsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_keyword_plan_ad_groups \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::MutateKeywordPlanAdGroupsRequest)
