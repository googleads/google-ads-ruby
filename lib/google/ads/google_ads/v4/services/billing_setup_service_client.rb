...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v4/services/billing_setup_service.proto,
    ...
    module GoogleAds
      module V4
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V4::Services::BillingSetupService::Stub]
          class BillingSetupServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v4/services/billing_setup_service_services_pb"
              ...
              @billing_setup_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V4::Services::BillingSetupService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V4::Resources::BillingSetup]
            ...
            #
            #   billing_setup_client = Google::Ads::GoogleAds::BillingSetup.new(version: :v4)
            #   formatted_resource_name = Google::Ads::GoogleAds::V4::Services::BillingSetupServiceClient.billing_setup_path("[CUSTOMER]", "[BILLING_SETUP]")
            ...
            def get_billing_setup \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::GetBillingSetupRequest)
            ...
            # @param operation [Google::Ads::GoogleAds::V4::Services::BillingSetupOperation | Hash]
            #   Required. The operation to perform.
            #   A hash of the same form as `Google::Ads::GoogleAds::V4::Services::BillingSetupOperation`
            #   can also be provided.
            # @param options [Google::Gax::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout,
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::MutateBillingSetupResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V4::Services::MutateBillingSetupResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_billing_setup \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::MutateBillingSetupRequest)
