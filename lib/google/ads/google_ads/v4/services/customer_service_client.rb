...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v4/services/customer_service.proto,
    ...
    module GoogleAds
      module V4
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V4::Services::CustomerService::Stub]
          class CustomerServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v4/services/customer_service_services_pb"
              ...
              @customer_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V4::Services::CustomerService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V4::Resources::Customer]
            ...
            #
            #   customer_client = Google::Ads::GoogleAds::Customer.new(version: :v4)
            #   formatted_resource_name = Google::Ads::GoogleAds::V4::Services::CustomerServiceClient.customer_path("[CUSTOMER]")
            ...
            def get_customer \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::GetCustomerRequest)
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V4::Services::CustomerOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::MutateCustomerResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_customer \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::MutateCustomerRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::ListAccessibleCustomersResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def list_accessible_customers options: nil, &block
              req = Google::Ads::GoogleAds::V4::Services::ListAccessibleCustomersRequest.new
            ...
            #   will be ignored.
            #   A hash of the same form as `Google::Ads::GoogleAds::V4::Resources::Customer`
            #   can also be provided.
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::CreateCustomerClientResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def create_customer_client \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::CreateCustomerClientRequest)
