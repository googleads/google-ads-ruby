...
# Source: google/ads/google_ads/v4/services/campaign_experiment_service.proto for package 'Google::Ads::GoogleAds::V4::Services'
...
module Google::Ads::GoogleAds::V4::Services
  module CampaignExperimentService
    ...
    class Service
      ...
      rpc :GetCampaignExperiment, GetCampaignExperimentRequest, Google::Ads::GoogleAds::V4::Resources::CampaignExperiment
      ...
      # campaign experiment.
      rpc :CreateCampaignExperiment, CreateCampaignExperimentRequest, Google::Longrunning::Operation
      # Updates campaign experiments. Operation statuses are returned.
      rpc :MutateCampaignExperiments, MutateCampaignExperimentsRequest, MutateCampaignExperimentsResponse
      ...
      rpc :GraduateCampaignExperiment, GraduateCampaignExperimentRequest, GraduateCampaignExperimentResponse
      ...
      rpc :PromoteCampaignExperiment, PromoteCampaignExperimentRequest, Google::Longrunning::Operation
      # Immediately ends a campaign experiment, changing the experiment's scheduled
      # end date and without waiting for end of day. End date is updated to be the
      # time of the request.
      rpc :EndCampaignExperiment, EndCampaignExperimentRequest, Google::Protobuf::Empty
      # Returns all errors that occurred during CampaignExperiment create or
      # promote (whichever occurred last).
      # Supports standard list paging.
      rpc :ListCampaignExperimentAsyncErrors, ListCampaignExperimentAsyncErrorsRequest, ListCampaignExperimentAsyncErrorsResponse
    end
