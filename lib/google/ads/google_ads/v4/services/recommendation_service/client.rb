        ...
        module Services
          module RecommendationService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V4::Services::RecommendationService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V4::Services::RecommendationService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V4::Services::RecommendationService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                @recommendation_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V4::Services::RecommendationService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::GetRecommendationRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::GetRecommendationRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Resources::Recommendation]
              ...
              def get_recommendation request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V4::Services::GetRecommendationRequest
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::ApplyRecommendationRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::ApplyRecommendationRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Services::ApplyRecommendationResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def apply_recommendation request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V4::Services::ApplyRecommendationRequest
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::DismissRecommendationRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::DismissRecommendationRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Services::DismissRecommendationResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def dismiss_recommendation request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V4::Services::DismissRecommendationRequest
              ...
              # {::Google::Ads::GoogleAds::V4::Services::RecommendationService::Client::Configuration::Rpcs}
