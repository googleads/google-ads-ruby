        ...
        module Services
          module UserListService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V4::Services::UserListService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V4::Services::UserListService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V4::Services::UserListService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                @user_list_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V4::Services::UserListService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::GetUserListRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::GetUserListRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Resources::UserList]
              ...
              def get_user_list request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V4::Services::GetUserListRequest
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::MutateUserListsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::MutateUserListsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Services::MutateUserListsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_user_lists request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V4::Services::MutateUserListsRequest
              ...
              # {::Google::Ads::GoogleAds::V4::Services::UserListService::Client::Configuration::Rpcs}
