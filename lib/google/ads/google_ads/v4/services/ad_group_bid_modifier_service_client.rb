...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v4/services/ad_group_bid_modifier_service.proto,
    ...
    module GoogleAds
      module V4
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V4::Services::AdGroupBidModifierService::Stub]
          class AdGroupBidModifierServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v4/services/ad_group_bid_modifier_service_services_pb"
              ...
              @ad_group_bid_modifier_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V4::Services::AdGroupBidModifierService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V4::Resources::AdGroupBidModifier]
            ...
            #
            #   ad_group_bid_modifier_client = Google::Ads::GoogleAds::AdGroupBidModifier.new(version: :v4)
            #   formatted_resource_name = Google::Ads::GoogleAds::V4::Services::AdGroupBidModifierServiceClient.ad_group_bid_modifier_path("[CUSTOMER]", "[AD_GROUP_BID_MODIFIER]")
            ...
            def get_ad_group_bid_modifier \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::GetAdGroupBidModifierRequest)
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V4::Services::AdGroupBidModifierOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::MutateAdGroupBidModifiersResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_ad_group_bid_modifiers \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::MutateAdGroupBidModifiersRequest)
