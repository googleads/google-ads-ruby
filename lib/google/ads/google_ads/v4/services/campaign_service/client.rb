        ...
        module Services
          module CampaignService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V4::Services::CampaignService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V4::Services::CampaignService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V4::Services::CampaignService::Client.new
              #
              # To create a new CampaignService client with a custom
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V4::Services::CampaignService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                @campaign_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V4::Services::CampaignService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::GetCampaignRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::GetCampaignRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Resources::Campaign]
              ...
              def get_campaign request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V4::Services::GetCampaignRequest
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::MutateCampaignsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::MutateCampaignsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Services::MutateCampaignsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_campaigns request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V4::Services::MutateCampaignsRequest
              ...
              # {::Google::Ads::GoogleAds::V4::Services::CampaignService::Client::Configuration::Rpcs}
