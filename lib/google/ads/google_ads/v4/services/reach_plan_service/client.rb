        ...
        module Services
          module ReachPlanService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V4::Services::ReachPlanService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V4::Services::ReachPlanService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V4::Services::ReachPlanService::Client.new
              #
              # To create a new ReachPlanService client with a custom
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V4::Services::ReachPlanService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                @reach_plan_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V4::Services::ReachPlanService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::ListPlannableLocationsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::ListPlannableLocationsRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Services::ListPlannableLocationsResponse]
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::ListPlannableProductsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::ListPlannableProductsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Services::ListPlannableProductsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::GenerateProductMixIdeasRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::GenerateProductMixIdeasRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Services::GenerateProductMixIdeasResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::GenerateReachForecastRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::GenerateReachForecastRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Services::GenerateReachForecastResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              # {::Google::Ads::GoogleAds::V4::Services::ReachPlanService::Client::Configuration::Rpcs}
