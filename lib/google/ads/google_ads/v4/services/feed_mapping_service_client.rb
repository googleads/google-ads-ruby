...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v4/services/feed_mapping_service.proto,
    ...
    module GoogleAds
      module V4
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V4::Services::FeedMappingService::Stub]
          class FeedMappingServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v4/services/feed_mapping_service_services_pb"
              ...
              @feed_mapping_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V4::Services::FeedMappingService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V4::Resources::FeedMapping]
            ...
            #
            #   feed_mapping_client = Google::Ads::GoogleAds::FeedMapping.new(version: :v4)
            #   formatted_resource_name = Google::Ads::GoogleAds::V4::Services::FeedMappingServiceClient.feed_mapping_path("[CUSTOMER]", "[FEED_MAPPING]")
            ...
            def get_feed_mapping \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::GetFeedMappingRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V4::Services::FeedMappingOperation | Hash>]
            #   Required. The list of operations to perform on individual feed mappings.
            #   A hash of the same form as `Google::Ads::GoogleAds::V4::Services::FeedMappingOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::MutateFeedMappingsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_feed_mappings \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::MutateFeedMappingsRequest)
