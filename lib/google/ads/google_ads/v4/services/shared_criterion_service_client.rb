...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v4/services/shared_criterion_service.proto,
    ...
    module GoogleAds
      module V4
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V4::Services::SharedCriterionService::Stub]
          class SharedCriterionServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v4/services/shared_criterion_service_services_pb"
              ...
              @shared_criterion_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V4::Services::SharedCriterionService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V4::Resources::SharedCriterion]
            ...
            #
            #   shared_criterion_client = Google::Ads::GoogleAds::SharedCriterion.new(version: :v4)
            #   formatted_resource_name = Google::Ads::GoogleAds::V4::Services::SharedCriterionServiceClient.shared_criteria_path("[CUSTOMER]", "[SHARED_CRITERIA]")
            ...
            def get_shared_criterion \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::GetSharedCriterionRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V4::Services::SharedCriterionOperation | Hash>]
            #   Required. The list of operations to perform on individual shared criteria.
            #   A hash of the same form as `Google::Ads::GoogleAds::V4::Services::SharedCriterionOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::MutateSharedCriteriaResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_shared_criteria \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::MutateSharedCriteriaRequest)
