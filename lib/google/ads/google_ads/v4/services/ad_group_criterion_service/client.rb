        ...
        module Services
          module AdGroupCriterionService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V4::Services::AdGroupCriterionService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V4::Services::AdGroupCriterionService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V4::Services::AdGroupCriterionService::Client.new
              #
              # To create a new AdGroupCriterionService client with a custom
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V4::Services::AdGroupCriterionService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                @ad_group_criterion_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V4::Services::AdGroupCriterionService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::GetAdGroupCriterionRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::GetAdGroupCriterionRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Resources::AdGroupCriterion]
              ...
              def get_ad_group_criterion request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V4::Services::GetAdGroupCriterionRequest
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::MutateAdGroupCriteriaRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::MutateAdGroupCriteriaRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Services::MutateAdGroupCriteriaResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_ad_group_criteria request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V4::Services::MutateAdGroupCriteriaRequest
              ...
              # {::Google::Ads::GoogleAds::V4::Services::AdGroupCriterionService::Client::Configuration::Rpcs}
