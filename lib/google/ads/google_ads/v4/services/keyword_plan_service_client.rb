...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v4/services/keyword_plan_service.proto,
    ...
    module GoogleAds
      module V4
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V4::Services::KeywordPlanService::Stub]
          class KeywordPlanServiceClient
            ...
            def initialize \
              ...
              @keyword_plan_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V4::Services::KeywordPlanService::Stub.method(:new)
              )
              ...
              @generate_forecast_curve = Google::Gax.create_api_call(
                @keyword_plan_service_stub.method(:generate_forecast_curve),
                defaults["generate_forecast_curve"],
                exception_transformer: exception_transformer,
                params_extractor: proc do |request|
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V4::Resources::KeywordPlan]
            ...
            #
            #   keyword_plan_client = Google::Ads::GoogleAds::KeywordPlan.new(version: :v4)
            #   formatted_resource_name = Google::Ads::GoogleAds::V4::Services::KeywordPlanServiceClient.keyword_plan_path("[CUSTOMER]", "[KEYWORD_PLAN]")
            ...
            def get_keyword_plan \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::GetKeywordPlanRequest)
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V4::Services::KeywordPlanOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::MutateKeywordPlansResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_keyword_plans \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::MutateKeywordPlansRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::GenerateForecastCurveResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            #
            #   keyword_plan_client = Google::Ads::GoogleAds::KeywordPlan.new(version: :v4)
            #   formatted_keyword_plan = Google::Ads::GoogleAds::V4::Services::KeywordPlanServiceClient.keyword_plan_path("[CUSTOMER]", "[KEYWORD_PLAN]")
            #   response = keyword_plan_client.generate_forecast_curve(formatted_keyword_plan)
            ...
            def generate_forecast_curve \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::GenerateForecastCurveRequest)
              @generate_forecast_curve.call(req, options, &block)
            end
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::GenerateForecastMetricsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def generate_forecast_metrics \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::GenerateForecastMetricsRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::GenerateHistoricalMetricsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def generate_historical_metrics \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::GenerateHistoricalMetricsRequest)
