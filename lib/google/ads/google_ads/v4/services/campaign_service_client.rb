...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v4/services/campaign_service.proto,
    ...
    module GoogleAds
      module V4
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V4::Services::CampaignService::Stub]
          class CampaignServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v4/services/campaign_service_services_pb"
              ...
              @campaign_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V4::Services::CampaignService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V4::Resources::Campaign]
            ...
            #
            #   campaign_client = Google::Ads::GoogleAds::Campaign.new(version: :v4)
            #   formatted_resource_name = Google::Ads::GoogleAds::V4::Services::CampaignServiceClient.campaign_path("[CUSTOMER]", "[CAMPAIGN]")
            ...
            def get_campaign \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::GetCampaignRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V4::Services::CampaignOperation | Hash>]
            #   Required. The list of operations to perform on individual campaigns.
            #   A hash of the same form as `Google::Ads::GoogleAds::V4::Services::CampaignOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::MutateCampaignsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V4::Services::MutateCampaignsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_campaigns \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::MutateCampaignsRequest)
