...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v4/services/user_list_service.proto,
    ...
    module GoogleAds
      module V4
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V4::Services::UserListService::Stub]
          class UserListServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v4/services/user_list_service_services_pb"
              ...
              @user_list_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V4::Services::UserListService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V4::Resources::UserList]
            ...
            #
            #   user_list_client = Google::Ads::GoogleAds::UserList.new(version: :v4)
            #   formatted_resource_name = Google::Ads::GoogleAds::V4::Services::UserListServiceClient.user_list_path("[CUSTOMER]", "[USER_LIST]")
            ...
            def get_user_list \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::GetUserListRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V4::Services::UserListOperation | Hash>]
            #   Required. The list of operations to perform on individual user lists.
            #   A hash of the same form as `Google::Ads::GoogleAds::V4::Services::UserListOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::MutateUserListsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_user_lists \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::MutateUserListsRequest)
