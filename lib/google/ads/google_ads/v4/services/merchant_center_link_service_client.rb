...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v4/services/merchant_center_link_service.proto,
    ...
    module GoogleAds
      module V4
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V4::Services::MerchantCenterLinkService::Stub]
          class MerchantCenterLinkServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v4/services/merchant_center_link_service_services_pb"
              ...
              @merchant_center_link_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V4::Services::MerchantCenterLinkService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::ListMerchantCenterLinksResponse]
            ...
            #
            #   merchant_center_link_client = Google::Ads::GoogleAds::MerchantCenterLink.new(version: :v4)
            #
            ...
            def list_merchant_center_links \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::ListMerchantCenterLinksRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Resources::MerchantCenterLink]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            #
            #   merchant_center_link_client = Google::Ads::GoogleAds::MerchantCenterLink.new(version: :v4)
            #   formatted_resource_name = Google::Ads::GoogleAds::V4::Services::MerchantCenterLinkServiceClient.merchant_center_link_path("[CUSTOMER]", "[MERCHANT_CENTER_LINK]")
            ...
            def get_merchant_center_link \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::GetMerchantCenterLinkRequest)
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V4::Services::MerchantCenterLinkOperation`
            #   can also be provided.
            # @param options [Google::Gax::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout,
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::MutateMerchantCenterLinkResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_merchant_center_link \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::MutateMerchantCenterLinkRequest)
