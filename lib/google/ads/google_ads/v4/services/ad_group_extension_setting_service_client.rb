...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v4/services/ad_group_extension_setting_service.proto,
    ...
    module GoogleAds
      module V4
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V4::Services::AdGroupExtensionSettingService::Stub]
          class AdGroupExtensionSettingServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v4/services/ad_group_extension_setting_service_services_pb"
              ...
              @ad_group_extension_setting_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V4::Services::AdGroupExtensionSettingService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V4::Resources::AdGroupExtensionSetting]
            ...
            #
            #   ad_group_extension_setting_client = Google::Ads::GoogleAds::AdGroupExtensionSetting.new(version: :v4)
            #   formatted_resource_name = Google::Ads::GoogleAds::V4::Services::AdGroupExtensionSettingServiceClient.ad_group_extension_setting_path("[CUSTOMER]", "[AD_GROUP_EXTENSION_SETTING]")
            ...
            def get_ad_group_extension_setting \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::GetAdGroupExtensionSettingRequest)
            ...
            #   modified.
            # @param operations [Array<Google::Ads::GoogleAds::V4::Services::AdGroupExtensionSettingOperation | Hash>]
            #   Required. The list of operations to perform on individual ad group extension
            #   settings.
            #   A hash of the same form as `Google::Ads::GoogleAds::V4::Services::AdGroupExtensionSettingOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::MutateAdGroupExtensionSettingsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V4::Services::MutateAdGroupExtensionSettingsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_ad_group_extension_settings \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::MutateAdGroupExtensionSettingsRequest)
