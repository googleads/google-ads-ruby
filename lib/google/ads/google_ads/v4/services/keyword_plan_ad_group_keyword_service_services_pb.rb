...
# Source: google/ads/google_ads/v4/services/keyword_plan_ad_group_keyword_service.proto for package 'Google::Ads::GoogleAds::V4::Services'
...
module Google::Ads::GoogleAds::V4::Services
  module KeywordPlanAdGroupKeywordService
    ...
    class Service
      ...
      rpc :GetKeywordPlanAdGroupKeyword, GetKeywordPlanAdGroupKeywordRequest, Google::Ads::GoogleAds::V4::Resources::KeywordPlanAdGroupKeyword
      # Creates, updates, or removes Keyword Plan ad group keywords. Operation
      # statuses are returned.
      rpc :MutateKeywordPlanAdGroupKeywords, MutateKeywordPlanAdGroupKeywordsRequest, MutateKeywordPlanAdGroupKeywordsResponse
    end
