...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v4/services/age_range_view_service.proto,
...
require "google/ads/google_ads/v4/services/age_range_view_service_pb"
    ...
    module GoogleAds
      module V4
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V4::Services::AgeRangeViewService::Stub]
          class AgeRangeViewServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v4/services/age_range_view_service_services_pb"
              ...
              @age_range_view_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V4::Services::AgeRangeViewService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V4::Resources::AgeRangeView]
            ...
            #
            #   age_range_view_client = Google::Ads::GoogleAds::AgeRangeView.new(version: :v4)
            #   formatted_resource_name = Google::Ads::GoogleAds::V4::Services::AgeRangeViewServiceClient.age_range_view_path("[CUSTOMER]", "[AGE_RANGE_VIEW]")
            ...
            def get_age_range_view \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::GetAgeRangeViewRequest)
