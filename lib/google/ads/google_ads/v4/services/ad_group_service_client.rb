...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v4/services/ad_group_service.proto,
    ...
    module GoogleAds
      module V4
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V4::Services::AdGroupService::Stub]
          class AdGroupServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v4/services/ad_group_service_services_pb"
              ...
              @ad_group_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V4::Services::AdGroupService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V4::Resources::AdGroup]
            ...
            #
            #   ad_group_client = Google::Ads::GoogleAds::AdGroup.new(version: :v4)
            #   formatted_resource_name = Google::Ads::GoogleAds::V4::Services::AdGroupServiceClient.ad_group_path("[CUSTOMER]", "[AD_GROUP]")
            ...
            def get_ad_group \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::GetAdGroupRequest)
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V4::Services::AdGroupOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::MutateAdGroupsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_ad_groups \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::MutateAdGroupsRequest)
