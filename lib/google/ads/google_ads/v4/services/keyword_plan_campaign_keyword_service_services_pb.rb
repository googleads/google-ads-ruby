...
# Source: google/ads/google_ads/v4/services/keyword_plan_campaign_keyword_service.proto for package 'Google::Ads::GoogleAds::V4::Services'
...
module Google::Ads::GoogleAds::V4::Services
  module KeywordPlanCampaignKeywordService
    ...
    class Service
      ...
      rpc :GetKeywordPlanCampaignKeyword, GetKeywordPlanCampaignKeywordRequest, Google::Ads::GoogleAds::V4::Resources::KeywordPlanCampaignKeyword
      # Creates, updates, or removes Keyword Plan campaign keywords. Operation
      # statuses are returned.
      rpc :MutateKeywordPlanCampaignKeywords, MutateKeywordPlanCampaignKeywordsRequest, MutateKeywordPlanCampaignKeywordsResponse
    end
