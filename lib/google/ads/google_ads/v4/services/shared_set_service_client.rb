...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v4/services/shared_set_service.proto,
    ...
    module GoogleAds
      module V4
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V4::Services::SharedSetService::Stub]
          class SharedSetServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v4/services/shared_set_service_services_pb"
              ...
              @shared_set_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V4::Services::SharedSetService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V4::Resources::SharedSet]
            ...
            #
            #   shared_set_client = Google::Ads::GoogleAds::SharedSet.new(version: :v4)
            #   formatted_resource_name = Google::Ads::GoogleAds::V4::Services::SharedSetServiceClient.shared_set_path("[CUSTOMER]", "[SHARED_SET]")
            ...
            def get_shared_set \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::GetSharedSetRequest)
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V4::Services::SharedSetOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::MutateSharedSetsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_shared_sets \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::MutateSharedSetsRequest)
