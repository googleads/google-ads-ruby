...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v4/services/ad_group_criterion_label_service.proto,
    ...
    module GoogleAds
      module V4
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V4::Services::AdGroupCriterionLabelService::Stub]
          class AdGroupCriterionLabelServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v4/services/ad_group_criterion_label_service_services_pb"
              ...
              @ad_group_criterion_label_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V4::Services::AdGroupCriterionLabelService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V4::Resources::AdGroupCriterionLabel]
            ...
            #
            #   ad_group_criterion_label_client = Google::Ads::GoogleAds::AdGroupCriterionLabel.new(version: :v4)
            #   formatted_resource_name = Google::Ads::GoogleAds::V4::Services::AdGroupCriterionLabelServiceClient.ad_group_criterion_label_path("[CUSTOMER]", "[AD_GROUP_CRITERION_LABEL]")
            ...
            def get_ad_group_criterion_label \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::GetAdGroupCriterionLabelRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V4::Services::AdGroupCriterionLabelOperation | Hash>]
            #   Required. The list of operations to perform on ad group criterion labels.
            #   A hash of the same form as `Google::Ads::GoogleAds::V4::Services::AdGroupCriterionLabelOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::MutateAdGroupCriterionLabelsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V4::Services::MutateAdGroupCriterionLabelsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_ad_group_criterion_labels \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::MutateAdGroupCriterionLabelsRequest)
