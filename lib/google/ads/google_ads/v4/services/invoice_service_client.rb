...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v4/services/invoice_service.proto,
...
require "google/ads/google_ads/v4/services/invoice_service_pb"
    ...
    module GoogleAds
      module V4
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V4::Services::InvoiceService::Stub]
          class InvoiceServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v4/services/invoice_service_services_pb"
              ...
              @invoice_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V4::Services::InvoiceService::Stub.method(:new)
              )
            ...
            # @param issue_month [Google::Ads::GoogleAds::V4::Enums::MonthOfYearEnum::MonthOfYear]
            #   Required. The issue month to retrieve invoices.
            # @param options [Google::Gax::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout,
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::ListInvoicesResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V4::Services::ListInvoicesResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            #   invoice_client = Google::Ads::GoogleAds::Invoice.new(version: :v4)
            #
            ...
            def list_invoices \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::ListInvoicesRequest)
