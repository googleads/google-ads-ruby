        ...
        module Services
          module CustomerFeedService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V4::Services::CustomerFeedService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V4::Services::CustomerFeedService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V4::Services::CustomerFeedService::Client.new
              #
              # To create a new CustomerFeedService client with a custom
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V4::Services::CustomerFeedService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                @customer_feed_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V4::Services::CustomerFeedService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::GetCustomerFeedRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::GetCustomerFeedRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Resources::CustomerFeed]
              ...
              def get_customer_feed request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V4::Services::GetCustomerFeedRequest
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::MutateCustomerFeedsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::MutateCustomerFeedsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Services::MutateCustomerFeedsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_customer_feeds request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V4::Services::MutateCustomerFeedsRequest
              ...
              # {::Google::Ads::GoogleAds::V4::Services::CustomerFeedService::Client::Configuration::Rpcs}
