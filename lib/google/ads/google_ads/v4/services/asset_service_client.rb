...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v4/services/asset_service.proto,
    ...
    module GoogleAds
      module V4
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V4::Services::AssetService::Stub]
          class AssetServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v4/services/asset_service_services_pb"
              ...
              @asset_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V4::Services::AssetService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V4::Resources::Asset]
            ...
            #
            #   asset_client = Google::Ads::GoogleAds::Asset.new(version: :v4)
            #   formatted_resource_name = Google::Ads::GoogleAds::V4::Services::AssetServiceClient.asset_path("[CUSTOMER]", "[ASSET]")
            ...
            def get_asset \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::GetAssetRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V4::Services::AssetOperation | Hash>]
            #   Required. The list of operations to perform on individual assets.
            #   A hash of the same form as `Google::Ads::GoogleAds::V4::Services::AssetOperation`
            #   can also be provided.
            # @param options [Google::Gax::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout,
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::MutateAssetsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V4::Services::MutateAssetsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_assets \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::MutateAssetsRequest)
