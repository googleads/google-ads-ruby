...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v4/services/offline_user_data_job_service.proto,
    ...
    module GoogleAds
      module V4
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V4::Services::OfflineUserDataJobService::Stub]
          class OfflineUserDataJobServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v4/services/offline_user_data_job_service_services_pb"
              ...
              @offline_user_data_job_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V4::Services::OfflineUserDataJobService::Stub.method(:new)
              )
            ...
            # @param job [Google::Ads::GoogleAds::V4::Resources::OfflineUserDataJob | Hash]
            #   Required. The offline user data job to be created.
            #   A hash of the same form as `Google::Ads::GoogleAds::V4::Resources::OfflineUserDataJob`
            #   can also be provided.
            # @param options [Google::Gax::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout,
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::CreateOfflineUserDataJobResponse]
            ...
            #
            #   offline_user_data_job_client = Google::Ads::GoogleAds::OfflineUserDataJob.new(version: :v4)
            #
            ...
            def create_offline_user_data_job \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::CreateOfflineUserDataJobRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Resources::OfflineUserDataJob]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            #
            #   offline_user_data_job_client = Google::Ads::GoogleAds::OfflineUserDataJob.new(version: :v4)
            #   formatted_resource_name = Google::Ads::GoogleAds::V4::Services::OfflineUserDataJobServiceClient.offline_user_data_job_path("[CUSTOMER]", "[OFFLINE_USER_DATA_JOB]")
            ...
            def get_offline_user_data_job \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::GetOfflineUserDataJobRequest)
            ...
            #   can also be provided.
            # @param operations [Array<Google::Ads::GoogleAds::V4::Services::OfflineUserDataJobOperation | Hash>]
            #   Required. The list of operations to be done.
            #   A hash of the same form as `Google::Ads::GoogleAds::V4::Services::OfflineUserDataJobOperation`
            #   can also be provided.
            # @param options [Google::Gax::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout,
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::AddOfflineUserDataJobOperationsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def add_offline_user_data_job_operations \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::AddOfflineUserDataJobOperationsRequest)
            ...
            def run_offline_user_data_job \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::RunOfflineUserDataJobRequest)
