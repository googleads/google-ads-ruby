        ...
        module Services
          module AssetService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V4::Services::AssetService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V4::Services::AssetService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V4::Services::AssetService::Client.new
              #
              # To create a new AssetService client with a custom
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V4::Services::AssetService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                @asset_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V4::Services::AssetService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::GetAssetRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::GetAssetRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Resources::Asset]
              ...
              def get_asset request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V4::Services::GetAssetRequest
              ...
              #   {::Google::Ads::GoogleAds::V4::Services::MutateAssetsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V4::Services::MutateAssetsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V4::Services::MutateAssetsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_assets request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V4::Services::MutateAssetsRequest
              ...
              # {::Google::Ads::GoogleAds::V4::Services::AssetService::Client::Configuration::Rpcs}
