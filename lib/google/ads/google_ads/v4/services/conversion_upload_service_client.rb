...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v4/services/conversion_upload_service.proto,
...
require "google/ads/google_ads/v4/services/conversion_upload_service_pb"
    ...
    module GoogleAds
      module V4
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V4::Services::ConversionUploadService::Stub]
          class ConversionUploadServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v4/services/conversion_upload_service_services_pb"
              ...
              @conversion_upload_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V4::Services::ConversionUploadService::Stub.method(:new)
              )
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V4::Services::ClickConversion`
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::UploadClickConversionsResponse]
            ...
            #
            #   conversion_upload_client = Google::Ads::GoogleAds::ConversionUpload.new(version: :v4)
            #
            ...
            def upload_click_conversions \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::UploadClickConversionsRequest)
            ...
            #   Required. The conversions that are being uploaded.
            #   A hash of the same form as `Google::Ads::GoogleAds::V4::Services::CallConversion`
            #   can also be provided.
            # @param partial_failure [true, false]
            #   Required. If true, successful operations will be carried out and invalid
            #   operations will return errors. If false, all operations will be carried
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V4::Services::UploadCallConversionsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def upload_call_conversions \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V4::Services::UploadCallConversionsRequest)
