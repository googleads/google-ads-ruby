...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v4/resources/ad_group_criterion_simulation.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v4.resources.AdGroupCriterionSimulation" do
...
module Google
  module Ads
    module GoogleAds
      module V4
        module Resources
          AdGroupCriterionSimulation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v4.resources.AdGroupCriterionSimulation").msgclass
        end
      end
    end
  end
