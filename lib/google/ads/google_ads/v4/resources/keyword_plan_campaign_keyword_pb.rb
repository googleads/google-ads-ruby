...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v4/resources/keyword_plan_campaign_keyword.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v4.resources.KeywordPlanCampaignKeyword" do
...
module Google
  module Ads
    module GoogleAds
      module V4
        module Resources
          KeywordPlanCampaignKeyword = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v4.resources.KeywordPlanCampaignKeyword").msgclass
        end
      end
    end
  end
