...
require 'google/ads/google_ads/v4/common/explorer_auto_optimizer_setting_pb'
...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v4/resources/ad_group.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v4.resources.AdGroup" do
      optional :resource_name, :string, 1
      optional :id, :message, 3, "google.protobuf.Int64Value"
      optional :name, :message, 4, "google.protobuf.StringValue"
      optional :status, :enum, 5, "google.ads.googleads.v4.enums.AdGroupStatusEnum.AdGroupStatus"
      optional :type, :enum, 12, "google.ads.googleads.v4.enums.AdGroupTypeEnum.AdGroupType"
      optional :ad_rotation_mode, :enum, 22, "google.ads.googleads.v4.enums.AdGroupAdRotationModeEnum.AdGroupAdRotationMode"
      ...
      repeated :url_custom_parameters, :message, 6, "google.ads.googleads.v4.common.CustomParameter"
      ...
      optional :explorer_auto_optimizer_setting, :message, 21, "google.ads.googleads.v4.common.ExplorerAutoOptimizerSetting"
      optional :display_custom_bid_dimension, :enum, 23, "google.ads.googleads.v4.enums.TargetingDimensionEnum.TargetingDimension"
      optional :final_url_suffix, :message, 24, "google.protobuf.StringValue"
      optional :targeting_setting, :message, 25, "google.ads.googleads.v4.common.TargetingSetting"
      optional :effective_target_cpa_micros, :message, 28, "google.protobuf.Int64Value"
      optional :effective_target_cpa_source, :enum, 29, "google.ads.googleads.v4.enums.BiddingSourceEnum.BiddingSource"
      optional :effective_target_roas, :message, 31, "google.protobuf.DoubleValue"
      optional :effective_target_roas_source, :enum, 32, "google.ads.googleads.v4.enums.BiddingSourceEnum.BiddingSource"
...
module Google
  module Ads
    module GoogleAds
      module V4
        module Resources
          AdGroup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v4.resources.AdGroup").msgclass
        end
      end
    end
  end
