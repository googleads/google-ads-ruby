...
require 'google/ads/google_ads/v23/resources/experiment_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v23.resources.Experiment", "google/ads/googleads/v23/resources/experiment.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateExperimentsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateExperimentsRequest").msgclass
          ExperimentOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ExperimentOperation").msgclass
          MutateExperimentsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateExperimentsResponse").msgclass
          MutateExperimentResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateExperimentResult").msgclass
          EndExperimentRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.EndExperimentRequest").msgclass
          ListExperimentAsyncErrorsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ListExperimentAsyncErrorsRequest").msgclass
          ListExperimentAsyncErrorsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ListExperimentAsyncErrorsResponse").msgclass
          GraduateExperimentRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.GraduateExperimentRequest").msgclass
          CampaignBudgetMapping = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.CampaignBudgetMapping").msgclass
          ScheduleExperimentRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ScheduleExperimentRequest").msgclass
          ScheduleExperimentMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ScheduleExperimentMetadata").msgclass
          PromoteExperimentRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.PromoteExperimentRequest").msgclass
          PromoteExperimentMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.PromoteExperimentMetadata").msgclass
        end
      end
    end
  end
