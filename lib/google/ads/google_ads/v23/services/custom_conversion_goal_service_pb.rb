...
require 'google/ads/google_ads/v23/resources/custom_conversion_goal_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v23.resources.CustomConversionGoal", "google/ads/googleads/v23/resources/custom_conversion_goal.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateCustomConversionGoalsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCustomConversionGoalsRequest").msgclass
          CustomConversionGoalOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.CustomConversionGoalOperation").msgclass
          MutateCustomConversionGoalsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCustomConversionGoalsResponse").msgclass
          MutateCustomConversionGoalResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCustomConversionGoalResult").msgclass
        end
      end
    end
  end
