...
require 'google/ads/google_ads/v23/enums/brand_state_pb'
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          SuggestBrandsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.SuggestBrandsRequest").msgclass
          SuggestBrandsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.SuggestBrandsResponse").msgclass
          BrandSuggestion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.BrandSuggestion").msgclass
        end
      end
    end
  end
