...
require 'google/ads/google_ads/v23/resources/remarketing_action_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v23.resources.RemarketingAction", "google/ads/googleads/v23/resources/remarketing_action.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateRemarketingActionsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateRemarketingActionsRequest").msgclass
          RemarketingActionOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.RemarketingActionOperation").msgclass
          MutateRemarketingActionsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateRemarketingActionsResponse").msgclass
          MutateRemarketingActionResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateRemarketingActionResult").msgclass
        end
      end
    end
  end
