...
require 'google/ads/google_ads/v23/resources/campaign_customizer_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.resources.CampaignCustomizer", "google/ads/googleads/v23/resources/campaign_customizer.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateCampaignCustomizersRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCampaignCustomizersRequest").msgclass
          CampaignCustomizerOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.CampaignCustomizerOperation").msgclass
          MutateCampaignCustomizersResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCampaignCustomizersResponse").msgclass
          MutateCampaignCustomizerResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCampaignCustomizerResult").msgclass
        end
      end
    end
  end
