...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateCampaignsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCampaignsRequest").msgclass
          CampaignOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.CampaignOperation").msgclass
          MutateCampaignsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCampaignsResponse").msgclass
          MutateCampaignResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCampaignResult").msgclass
          EnablePMaxBrandGuidelinesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.EnablePMaxBrandGuidelinesRequest").msgclass
          EnableOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.EnableOperation").msgclass
          BrandCampaignAssets = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.BrandCampaignAssets").msgclass
          EnablePMaxBrandGuidelinesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.EnablePMaxBrandGuidelinesResponse").msgclass
          EnablementResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.EnablementResult").msgclass
        end
      end
    end
  end
