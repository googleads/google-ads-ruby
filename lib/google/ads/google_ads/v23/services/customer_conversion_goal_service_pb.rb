...
require 'google/ads/google_ads/v23/resources/customer_conversion_goal_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v23.resources.CustomerConversionGoal", "google/ads/googleads/v23/resources/customer_conversion_goal.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateCustomerConversionGoalsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCustomerConversionGoalsRequest").msgclass
          CustomerConversionGoalOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.CustomerConversionGoalOperation").msgclass
          MutateCustomerConversionGoalsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCustomerConversionGoalsResponse").msgclass
          MutateCustomerConversionGoalResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCustomerConversionGoalResult").msgclass
        end
      end
    end
  end
