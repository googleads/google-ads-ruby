...
require 'google/ads/google_ads/v23/resources/customer_customizer_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.resources.CustomerCustomizer", "google/ads/googleads/v23/resources/customer_customizer.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateCustomerCustomizersRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCustomerCustomizersRequest").msgclass
          CustomerCustomizerOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.CustomerCustomizerOperation").msgclass
          MutateCustomerCustomizersResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCustomerCustomizersResponse").msgclass
          MutateCustomerCustomizerResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCustomerCustomizerResult").msgclass
        end
      end
    end
  end
