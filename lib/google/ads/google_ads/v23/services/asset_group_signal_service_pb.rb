...
require 'google/ads/google_ads/v23/resources/asset_group_signal_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v23.resources.AssetGroupSignal", "google/ads/googleads/v23/resources/asset_group_signal.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateAssetGroupSignalsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateAssetGroupSignalsRequest").msgclass
          AssetGroupSignalOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.AssetGroupSignalOperation").msgclass
          MutateAssetGroupSignalsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateAssetGroupSignalsResponse").msgclass
          MutateAssetGroupSignalResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateAssetGroupSignalResult").msgclass
        end
      end
    end
  end
