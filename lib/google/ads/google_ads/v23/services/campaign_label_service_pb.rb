...
require 'google/ads/google_ads/v23/resources/campaign_label_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.resources.CampaignLabel", "google/ads/googleads/v23/resources/campaign_label.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateCampaignLabelsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCampaignLabelsRequest").msgclass
          CampaignLabelOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.CampaignLabelOperation").msgclass
          MutateCampaignLabelsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCampaignLabelsResponse").msgclass
          MutateCampaignLabelResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCampaignLabelResult").msgclass
        end
      end
    end
  end
