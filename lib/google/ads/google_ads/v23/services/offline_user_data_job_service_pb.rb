...
require 'google/ads/google_ads/v23/resources/offline_user_data_job_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.resources.OfflineUserDataJob", "google/ads/googleads/v23/resources/offline_user_data_job.proto"],
    ["google.ads.googleads.v23.common.UserData", "google/ads/googleads/v23/common/offline_user_data.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          CreateOfflineUserDataJobRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.CreateOfflineUserDataJobRequest").msgclass
          CreateOfflineUserDataJobResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.CreateOfflineUserDataJobResponse").msgclass
          RunOfflineUserDataJobRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.RunOfflineUserDataJobRequest").msgclass
          AddOfflineUserDataJobOperationsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.AddOfflineUserDataJobOperationsRequest").msgclass
          OfflineUserDataJobOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.OfflineUserDataJobOperation").msgclass
          AddOfflineUserDataJobOperationsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.AddOfflineUserDataJobOperationsResponse").msgclass
        end
      end
    end
  end
