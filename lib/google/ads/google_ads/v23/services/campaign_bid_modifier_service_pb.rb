...
require 'google/ads/google_ads/v23/resources/campaign_bid_modifier_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v23.resources.CampaignBidModifier", "google/ads/googleads/v23/resources/campaign_bid_modifier.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateCampaignBidModifiersRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCampaignBidModifiersRequest").msgclass
          CampaignBidModifierOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.CampaignBidModifierOperation").msgclass
          MutateCampaignBidModifiersResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCampaignBidModifiersResponse").msgclass
          MutateCampaignBidModifierResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCampaignBidModifierResult").msgclass
        end
      end
    end
  end
