...
require 'google/ads/google_ads/v23/resources/asset_group_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v23.resources.AssetGroup", "google/ads/googleads/v23/resources/asset_group.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateAssetGroupsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateAssetGroupsRequest").msgclass
          AssetGroupOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.AssetGroupOperation").msgclass
          MutateAssetGroupsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateAssetGroupsResponse").msgclass
          MutateAssetGroupResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateAssetGroupResult").msgclass
        end
      end
    end
  end
