...
require 'google/ads/google_ads/v23/resources/google_ads_field_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.resources.GoogleAdsField", "google/ads/googleads/v23/resources/google_ads_field.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          GetGoogleAdsFieldRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.GetGoogleAdsFieldRequest").msgclass
          SearchGoogleAdsFieldsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.SearchGoogleAdsFieldsRequest").msgclass
          SearchGoogleAdsFieldsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.SearchGoogleAdsFieldsResponse").msgclass
        end
      end
    end
  end
