...
require 'google/ads/google_ads/v23/resources/custom_audience_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v23.resources.CustomAudience", "google/ads/googleads/v23/resources/custom_audience.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateCustomAudiencesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCustomAudiencesRequest").msgclass
          CustomAudienceOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.CustomAudienceOperation").msgclass
          MutateCustomAudiencesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCustomAudiencesResponse").msgclass
          MutateCustomAudienceResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCustomAudienceResult").msgclass
        end
      end
    end
  end
