...
require 'google/ads/google_ads/v23/resources/ad_group_criterion_customizer_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.resources.AdGroupCriterionCustomizer", "google/ads/googleads/v23/resources/ad_group_criterion_customizer.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateAdGroupCriterionCustomizersRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateAdGroupCriterionCustomizersRequest").msgclass
          AdGroupCriterionCustomizerOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.AdGroupCriterionCustomizerOperation").msgclass
          MutateAdGroupCriterionCustomizersResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateAdGroupCriterionCustomizersResponse").msgclass
          MutateAdGroupCriterionCustomizerResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateAdGroupCriterionCustomizerResult").msgclass
        end
      end
    end
  end
