...
require 'google/ads/google_ads/v23/common/ad_type_infos_pb'
require 'google/ads/google_ads/v23/common/criteria_pb'
require 'google/ads/google_ads/v23/resources/keyword_theme_constant_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.common.AdScheduleInfo", "google/ads/googleads/v23/common/criteria.proto"],
    ["google.ads.googleads.v23.common.SmartCampaignAdInfo", "google/ads/googleads/v23/common/ad_type_infos.proto"],
    ["google.ads.googleads.v23.resources.KeywordThemeConstant", "google/ads/googleads/v23/resources/keyword_theme_constant.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          SuggestSmartCampaignBudgetOptionsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.SuggestSmartCampaignBudgetOptionsRequest").msgclass
          SmartCampaignSuggestionInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.SmartCampaignSuggestionInfo").msgclass
          SmartCampaignSuggestionInfo::LocationList = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.SmartCampaignSuggestionInfo.LocationList").msgclass
          SmartCampaignSuggestionInfo::BusinessContext = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.SmartCampaignSuggestionInfo.BusinessContext").msgclass
          SuggestSmartCampaignBudgetOptionsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.SuggestSmartCampaignBudgetOptionsResponse").msgclass
          SuggestSmartCampaignBudgetOptionsResponse::Metrics = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.SuggestSmartCampaignBudgetOptionsResponse.Metrics").msgclass
          SuggestSmartCampaignBudgetOptionsResponse::BudgetOption = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.SuggestSmartCampaignBudgetOptionsResponse.BudgetOption").msgclass
          SuggestSmartCampaignAdRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.SuggestSmartCampaignAdRequest").msgclass
          SuggestSmartCampaignAdResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.SuggestSmartCampaignAdResponse").msgclass
          SuggestKeywordThemesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.SuggestKeywordThemesRequest").msgclass
          SuggestKeywordThemesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.SuggestKeywordThemesResponse").msgclass
          SuggestKeywordThemesResponse::KeywordTheme = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.SuggestKeywordThemesResponse.KeywordTheme").msgclass
        end
      end
    end
  end
