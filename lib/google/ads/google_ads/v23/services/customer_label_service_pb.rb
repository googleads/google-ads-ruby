...
require 'google/ads/google_ads/v23/resources/customer_label_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.resources.CustomerLabel", "google/ads/googleads/v23/resources/customer_label.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateCustomerLabelsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCustomerLabelsRequest").msgclass
          CustomerLabelOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.CustomerLabelOperation").msgclass
          MutateCustomerLabelsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCustomerLabelsResponse").msgclass
          MutateCustomerLabelResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCustomerLabelResult").msgclass
        end
      end
    end
  end
