...
require 'google/ads/google_ads/v23/resources/campaign_conversion_goal_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v23.resources.CampaignConversionGoal", "google/ads/googleads/v23/resources/campaign_conversion_goal.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateCampaignConversionGoalsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCampaignConversionGoalsRequest").msgclass
          CampaignConversionGoalOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.CampaignConversionGoalOperation").msgclass
          MutateCampaignConversionGoalsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCampaignConversionGoalsResponse").msgclass
          MutateCampaignConversionGoalResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCampaignConversionGoalResult").msgclass
        end
      end
    end
  end
