...
require 'google/ads/google_ads/v23/resources/billing_setup_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.resources.BillingSetup", "google/ads/googleads/v23/resources/billing_setup.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateBillingSetupRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateBillingSetupRequest").msgclass
          BillingSetupOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.BillingSetupOperation").msgclass
          MutateBillingSetupResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateBillingSetupResponse").msgclass
          MutateBillingSetupResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateBillingSetupResult").msgclass
        end
      end
    end
  end
