...
require 'google/ads/google_ads/v23/resources/goal_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v23.resources.Goal", "google/ads/googleads/v23/resources/goal.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateGoalsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateGoalsRequest").msgclass
          GoalOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.GoalOperation").msgclass
          MutateGoalsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateGoalsResponse").msgclass
          MutateGoalResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateGoalResult").msgclass
        end
      end
    end
  end
