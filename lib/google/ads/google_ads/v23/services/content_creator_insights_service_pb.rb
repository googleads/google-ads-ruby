...
require 'google/ads/google_ads/v23/common/audience_insights_attribute_pb'
require 'google/ads/google_ads/v23/common/criteria_pb'
require 'google/ads/google_ads/v23/enums/insights_trend_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v23.common.AudienceInsightsAttribute", "google/ads/googleads/v23/common/audience_insights_attribute.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          GenerateCreatorInsightsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.GenerateCreatorInsightsRequest").msgclass
          GenerateCreatorInsightsRequest::SearchAttributes = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.GenerateCreatorInsightsRequest.SearchAttributes").msgclass
          GenerateCreatorInsightsRequest::SearchBrand = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.GenerateCreatorInsightsRequest.SearchBrand").msgclass
          GenerateCreatorInsightsRequest::YouTubeChannels = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.GenerateCreatorInsightsRequest.YouTubeChannels").msgclass
          GenerateCreatorInsightsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.GenerateCreatorInsightsResponse").msgclass
          GenerateTrendingInsightsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.GenerateTrendingInsightsRequest").msgclass
          GenerateTrendingInsightsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.GenerateTrendingInsightsResponse").msgclass
          YouTubeCreatorInsights = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.YouTubeCreatorInsights").msgclass
          YouTubeMetrics = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.YouTubeMetrics").msgclass
          YouTubeChannelInsights = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.YouTubeChannelInsights").msgclass
          SearchAudience = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.SearchAudience").msgclass
          SearchTopics = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.SearchTopics").msgclass
          TrendInsight = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.TrendInsight").msgclass
          TrendInsightMetrics = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.TrendInsightMetrics").msgclass
          TrendInsightDataPoint = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.TrendInsightDataPoint").msgclass
          LanguageDistribution = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.LanguageDistribution").msgclass
        end
      end
    end
  end
