...
require 'google/ads/google_ads/v23/resources/campaign_group_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v23.resources.CampaignGroup", "google/ads/googleads/v23/resources/campaign_group.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateCampaignGroupsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCampaignGroupsRequest").msgclass
          CampaignGroupOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.CampaignGroupOperation").msgclass
          MutateCampaignGroupsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCampaignGroupsResponse").msgclass
          MutateCampaignGroupResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCampaignGroupResult").msgclass
        end
      end
    end
  end
