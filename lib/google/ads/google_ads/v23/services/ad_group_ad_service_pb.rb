...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateAdGroupAdsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateAdGroupAdsRequest").msgclass
          AdGroupAdOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.AdGroupAdOperation").msgclass
          MutateAdGroupAdsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateAdGroupAdsResponse").msgclass
          MutateAdGroupAdResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateAdGroupAdResult").msgclass
          RemoveAutomaticallyCreatedAssetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.RemoveAutomaticallyCreatedAssetsRequest").msgclass
          AssetsWithFieldType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.AssetsWithFieldType").msgclass
        end
      end
    end
  end
