...
require 'google/ads/google_ads/v23/resources/conversion_value_rule_set_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v23.resources.ConversionValueRuleSet", "google/ads/googleads/v23/resources/conversion_value_rule_set.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateConversionValueRuleSetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateConversionValueRuleSetsRequest").msgclass
          ConversionValueRuleSetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ConversionValueRuleSetOperation").msgclass
          MutateConversionValueRuleSetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateConversionValueRuleSetsResponse").msgclass
          MutateConversionValueRuleSetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateConversionValueRuleSetResult").msgclass
        end
      end
    end
  end
