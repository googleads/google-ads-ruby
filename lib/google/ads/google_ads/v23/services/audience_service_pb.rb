...
require 'google/ads/google_ads/v23/resources/audience_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v23.resources.Audience", "google/ads/googleads/v23/resources/audience.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateAudiencesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateAudiencesRequest").msgclass
          MutateAudiencesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateAudiencesResponse").msgclass
          AudienceOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.AudienceOperation").msgclass
          MutateAudienceResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateAudienceResult").msgclass
        end
      end
    end
  end
