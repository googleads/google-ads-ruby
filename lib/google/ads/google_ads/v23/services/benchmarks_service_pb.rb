...
require 'google/ads/google_ads/v23/common/additional_application_info_pb'
require 'google/ads/google_ads/v23/common/criteria_pb'
require 'google/ads/google_ads/v23/common/dates_pb'
require 'google/ads/google_ads/v23/enums/benchmarks_marketing_objective_pb'
require 'google/ads/google_ads/v23/enums/benchmarks_source_type_pb'
require 'google/ads/google_ads/v23/enums/benchmarks_time_granularity_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.common.AdditionalApplicationInfo", "google/ads/googleads/v23/common/additional_application_info.proto"],
    ["google.ads.googleads.v23.common.DateRange", "google/ads/googleads/v23/common/dates.proto"],
    ["google.ads.googleads.v23.common.LocationInfo", "google/ads/googleads/v23/common/criteria.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          ListBenchmarksAvailableDatesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ListBenchmarksAvailableDatesRequest").msgclass
          ListBenchmarksAvailableDatesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ListBenchmarksAvailableDatesResponse").msgclass
          ListBenchmarksLocationsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ListBenchmarksLocationsRequest").msgclass
          ListBenchmarksLocationsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ListBenchmarksLocationsResponse").msgclass
          BenchmarksLocation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.BenchmarksLocation").msgclass
          ListBenchmarksProductsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ListBenchmarksProductsRequest").msgclass
          ListBenchmarksProductsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ListBenchmarksProductsResponse").msgclass
          BenchmarksProductMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.BenchmarksProductMetadata").msgclass
          ListBenchmarksSourcesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ListBenchmarksSourcesRequest").msgclass
          ListBenchmarksSourcesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ListBenchmarksSourcesResponse").msgclass
          BenchmarksSourceMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.BenchmarksSourceMetadata").msgclass
          IndustryVerticalInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.IndustryVerticalInfo").msgclass
          GenerateBenchmarksMetricsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.GenerateBenchmarksMetricsRequest").msgclass
          BenchmarksSource = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.BenchmarksSource").msgclass
          ProductFilter = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ProductFilter").msgclass
          ProductFilter::ProductList = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ProductFilter.ProductList").msgclass
          ProductFilter::MarketingObjectiveList = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ProductFilter.MarketingObjectiveList").msgclass
          BreakdownDefinition = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.BreakdownDefinition").msgclass
          GenerateBenchmarksMetricsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.GenerateBenchmarksMetricsResponse").msgclass
          BreakdownMetrics = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.BreakdownMetrics").msgclass
          BreakdownKey = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.BreakdownKey").msgclass
          Metrics = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.Metrics").msgclass
          RateMetrics = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.RateMetrics").msgclass
        end
      end
    end
  end
