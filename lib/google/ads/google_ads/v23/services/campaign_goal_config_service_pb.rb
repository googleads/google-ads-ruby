...
require 'google/ads/google_ads/v23/resources/campaign_goal_config_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v23.resources.CampaignGoalConfig", "google/ads/googleads/v23/resources/campaign_goal_config.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateCampaignGoalConfigsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCampaignGoalConfigsRequest").msgclass
          CampaignGoalConfigOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.CampaignGoalConfigOperation").msgclass
          MutateCampaignGoalConfigsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCampaignGoalConfigsResponse").msgclass
          MutateCampaignGoalConfigResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCampaignGoalConfigResult").msgclass
        end
      end
    end
  end
