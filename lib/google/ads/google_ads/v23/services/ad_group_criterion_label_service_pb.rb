...
require 'google/ads/google_ads/v23/resources/ad_group_criterion_label_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.resources.AdGroupCriterionLabel", "google/ads/googleads/v23/resources/ad_group_criterion_label.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateAdGroupCriterionLabelsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateAdGroupCriterionLabelsRequest").msgclass
          AdGroupCriterionLabelOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.AdGroupCriterionLabelOperation").msgclass
          MutateAdGroupCriterionLabelsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateAdGroupCriterionLabelsResponse").msgclass
          MutateAdGroupCriterionLabelResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateAdGroupCriterionLabelResult").msgclass
        end
      end
    end
  end
