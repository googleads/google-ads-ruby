...
require 'google/ads/google_ads/v23/resources/keyword_plan_ad_group_keyword_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v23.resources.KeywordPlanAdGroupKeyword", "google/ads/googleads/v23/resources/keyword_plan_ad_group_keyword.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateKeywordPlanAdGroupKeywordsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateKeywordPlanAdGroupKeywordsRequest").msgclass
          KeywordPlanAdGroupKeywordOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.KeywordPlanAdGroupKeywordOperation").msgclass
          MutateKeywordPlanAdGroupKeywordsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateKeywordPlanAdGroupKeywordsResponse").msgclass
          MutateKeywordPlanAdGroupKeywordResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateKeywordPlanAdGroupKeywordResult").msgclass
        end
      end
    end
  end
