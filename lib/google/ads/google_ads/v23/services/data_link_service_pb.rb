...
require 'google/ads/google_ads/v23/enums/data_link_status_pb'
require 'google/ads/google_ads/v23/resources/data_link_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.resources.DataLink", "google/ads/googleads/v23/resources/data_link.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          CreateDataLinkRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.CreateDataLinkRequest").msgclass
          CreateDataLinkResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.CreateDataLinkResponse").msgclass
          RemoveDataLinkRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.RemoveDataLinkRequest").msgclass
          RemoveDataLinkResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.RemoveDataLinkResponse").msgclass
          UpdateDataLinkRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.UpdateDataLinkRequest").msgclass
          UpdateDataLinkResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.UpdateDataLinkResponse").msgclass
        end
      end
    end
  end
