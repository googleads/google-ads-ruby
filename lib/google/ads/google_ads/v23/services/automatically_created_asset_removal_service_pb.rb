...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          RemoveCampaignAutomaticallyCreatedAssetRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.RemoveCampaignAutomaticallyCreatedAssetRequest").msgclass
          RemoveCampaignAutomaticallyCreatedAssetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.RemoveCampaignAutomaticallyCreatedAssetOperation").msgclass
          RemoveCampaignAutomaticallyCreatedAssetResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.RemoveCampaignAutomaticallyCreatedAssetResponse").msgclass
        end
      end
    end
  end
