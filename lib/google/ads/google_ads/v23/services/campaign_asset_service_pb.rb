...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateCampaignAssetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCampaignAssetsRequest").msgclass
          CampaignAssetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.CampaignAssetOperation").msgclass
          MutateCampaignAssetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCampaignAssetsResponse").msgclass
          MutateCampaignAssetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCampaignAssetResult").msgclass
        end
      end
    end
  end
