...
require 'google/ads/google_ads/v23/resources/customer_lifecycle_goal_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v23.resources.CustomerLifecycleGoal", "google/ads/googleads/v23/resources/customer_lifecycle_goal.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          ConfigureCustomerLifecycleGoalsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ConfigureCustomerLifecycleGoalsRequest").msgclass
          CustomerLifecycleGoalOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.CustomerLifecycleGoalOperation").msgclass
          ConfigureCustomerLifecycleGoalsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ConfigureCustomerLifecycleGoalsResponse").msgclass
          ConfigureCustomerLifecycleGoalsResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ConfigureCustomerLifecycleGoalsResult").msgclass
        end
      end
    end
  end
