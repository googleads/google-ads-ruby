...
require 'google/ads/google_ads/v23/resources/recommendation_subscription_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v23.resources.RecommendationSubscription", "google/ads/googleads/v23/resources/recommendation_subscription.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateRecommendationSubscriptionRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateRecommendationSubscriptionRequest").msgclass
          RecommendationSubscriptionOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.RecommendationSubscriptionOperation").msgclass
          MutateRecommendationSubscriptionResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateRecommendationSubscriptionResponse").msgclass
          MutateRecommendationSubscriptionResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateRecommendationSubscriptionResult").msgclass
        end
      end
    end
  end
