...
require 'google/ads/google_ads/v23/resources/customer_negative_criterion_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.resources.CustomerNegativeCriterion", "google/ads/googleads/v23/resources/customer_negative_criterion.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateCustomerNegativeCriteriaRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCustomerNegativeCriteriaRequest").msgclass
          CustomerNegativeCriterionOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.CustomerNegativeCriterionOperation").msgclass
          MutateCustomerNegativeCriteriaResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCustomerNegativeCriteriaResponse").msgclass
          MutateCustomerNegativeCriteriaResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCustomerNegativeCriteriaResult").msgclass
        end
      end
    end
  end
