...
require 'google/ads/google_ads/v23/resources/bidding_data_exclusion_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v23.resources.BiddingDataExclusion", "google/ads/googleads/v23/resources/bidding_data_exclusion.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateBiddingDataExclusionsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateBiddingDataExclusionsRequest").msgclass
          BiddingDataExclusionOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.BiddingDataExclusionOperation").msgclass
          MutateBiddingDataExclusionsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateBiddingDataExclusionsResponse").msgclass
          MutateBiddingDataExclusionsResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateBiddingDataExclusionsResult").msgclass
        end
      end
    end
  end
