...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.common.CustomerMatchUserListMetadata", "google/ads/googleads/v23/common/offline_user_data.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          UploadUserDataRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.UploadUserDataRequest").msgclass
          UserDataOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.UserDataOperation").msgclass
          UploadUserDataResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.UploadUserDataResponse").msgclass
        end
      end
    end
  end
