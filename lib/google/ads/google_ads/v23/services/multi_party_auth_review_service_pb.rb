...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          ResolveMultiPartyAuthReviewRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ResolveMultiPartyAuthReviewRequest").msgclass
          ResolveMultiPartyAuthReviewResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ResolveMultiPartyAuthReviewResponse").msgclass
          ResolveMultiPartyAuthReviewOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ResolveMultiPartyAuthReviewOperation").msgclass
          ResolveMultiPartyAuthReviewResultOrError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ResolveMultiPartyAuthReviewResultOrError").msgclass
          ResolveMultiPartyAuthReviewResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ResolveMultiPartyAuthReviewResult").msgclass
        end
      end
    end
  end
