...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.resources.Invoice", "google/ads/googleads/v23/resources/invoice.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          ListInvoicesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ListInvoicesRequest").msgclass
          ListInvoicesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.ListInvoicesResponse").msgclass
        end
      end
    end
  end
