...
require 'google/ads/google_ads/v23/resources/bidding_seasonality_adjustment_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v23.resources.BiddingSeasonalityAdjustment", "google/ads/googleads/v23/resources/bidding_seasonality_adjustment.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateBiddingSeasonalityAdjustmentsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateBiddingSeasonalityAdjustmentsRequest").msgclass
          BiddingSeasonalityAdjustmentOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.BiddingSeasonalityAdjustmentOperation").msgclass
          MutateBiddingSeasonalityAdjustmentsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateBiddingSeasonalityAdjustmentsResponse").msgclass
          MutateBiddingSeasonalityAdjustmentsResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateBiddingSeasonalityAdjustmentsResult").msgclass
        end
      end
    end
  end
