...
require 'google/ads/google_ads/v23/resources/customer_manager_link_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v23.resources.CustomerManagerLink", "google/ads/googleads/v23/resources/customer_manager_link.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateCustomerManagerLinkRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCustomerManagerLinkRequest").msgclass
          MoveManagerLinkRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MoveManagerLinkRequest").msgclass
          CustomerManagerLinkOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.CustomerManagerLinkOperation").msgclass
          MutateCustomerManagerLinkResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCustomerManagerLinkResponse").msgclass
          MoveManagerLinkResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MoveManagerLinkResponse").msgclass
          MutateCustomerManagerLinkResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateCustomerManagerLinkResult").msgclass
        end
      end
    end
  end
