...
require 'google/ads/google_ads/v23/resources/shared_set_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v23.resources.SharedSet", "google/ads/googleads/v23/resources/shared_set.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Services
          MutateSharedSetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateSharedSetsRequest").msgclass
          SharedSetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.SharedSetOperation").msgclass
          MutateSharedSetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateSharedSetsResponse").msgclass
          MutateSharedSetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.services.MutateSharedSetResult").msgclass
        end
      end
    end
  end
