...
module Google
  module Ads
    module GoogleAds
      module V23
        module Common
          CustomizerValue = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.CustomizerValue").msgclass
        end
      end
    end
  end
