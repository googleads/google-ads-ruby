...
require 'google/ads/google_ads/v23/enums/audience_insights_dimension_pb'
require 'google/ads/google_ads/v23/enums/insights_knowledge_graph_entity_capabilities_pb'
require 'google/ads/google_ads/v23/enums/user_list_type_pb'
require 'google/ads/google_ads/v23/enums/youtube_video_property_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.common.AgeRangeInfo", "google/ads/googleads/v23/common/criteria.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Common
          AudienceInsightsAttributeMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.AudienceInsightsAttributeMetadata").msgclass
          AudienceInsightsAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.AudienceInsightsAttribute").msgclass
          AudienceInsightsEntity = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.AudienceInsightsEntity").msgclass
          AudienceInsightsCategory = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.AudienceInsightsCategory").msgclass
          AudienceInsightsLineup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.AudienceInsightsLineup").msgclass
          YouTubeChannelAttributeMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.YouTubeChannelAttributeMetadata").msgclass
          YouTubeVideoAttributeMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.YouTubeVideoAttributeMetadata").msgclass
          LineupAttributeMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.LineupAttributeMetadata").msgclass
          LineupAttributeMetadata::SampleChannel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.LineupAttributeMetadata.SampleChannel").msgclass
          LocationAttributeMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.LocationAttributeMetadata").msgclass
          UserInterestAttributeMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.UserInterestAttributeMetadata").msgclass
          KnowledgeGraphAttributeMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.KnowledgeGraphAttributeMetadata").msgclass
          UserListAttributeMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.UserListAttributeMetadata").msgclass
          AudienceInsightsAttributeMetadataGroup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.AudienceInsightsAttributeMetadataGroup").msgclass
        end
      end
    end
  end
