...
module Google
  module Ads
    module GoogleAds
      module V23
        module Common
          CustomerThirdPartyIntegrationPartners = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.CustomerThirdPartyIntegrationPartners").msgclass
          CustomerThirdPartyViewabilityIntegrationPartner = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.CustomerThirdPartyViewabilityIntegrationPartner").msgclass
          CustomerThirdPartyBrandSafetyIntegrationPartner = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.CustomerThirdPartyBrandSafetyIntegrationPartner").msgclass
          CustomerThirdPartyBrandLiftIntegrationPartner = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.CustomerThirdPartyBrandLiftIntegrationPartner").msgclass
          CustomerThirdPartyReachIntegrationPartner = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.CustomerThirdPartyReachIntegrationPartner").msgclass
          CampaignThirdPartyIntegrationPartners = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.CampaignThirdPartyIntegrationPartners").msgclass
          CampaignThirdPartyViewabilityIntegrationPartner = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.CampaignThirdPartyViewabilityIntegrationPartner").msgclass
          CampaignThirdPartyBrandSafetyIntegrationPartner = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.CampaignThirdPartyBrandSafetyIntegrationPartner").msgclass
          CampaignThirdPartyBrandLiftIntegrationPartner = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.CampaignThirdPartyBrandLiftIntegrationPartner").msgclass
          CampaignThirdPartyReachIntegrationPartner = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.CampaignThirdPartyReachIntegrationPartner").msgclass
          ThirdPartyIntegrationPartnerData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.common.ThirdPartyIntegrationPartnerData").msgclass
        end
      end
    end
  end
