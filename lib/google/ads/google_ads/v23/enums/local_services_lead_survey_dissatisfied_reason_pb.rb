...
module Google
  module Ads
    module GoogleAds
      module V23
        module Enums
          LocalServicesLeadSurveyDissatisfiedReasonEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.enums.LocalServicesLeadSurveyDissatisfiedReasonEnum").msgclass
          LocalServicesLeadSurveyDissatisfiedReasonEnum::SurveyDissatisfiedReason = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.enums.LocalServicesLeadSurveyDissatisfiedReasonEnum.SurveyDissatisfiedReason").enummodule
        end
      end
    end
  end
