...
module Google
  module Ads
    module GoogleAds
      module V23
        module Enums
          CriterionCategoryChannelAvailabilityModeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.enums.CriterionCategoryChannelAvailabilityModeEnum").msgclass
          CriterionCategoryChannelAvailabilityModeEnum::CriterionCategoryChannelAvailabilityMode = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.enums.CriterionCategoryChannelAvailabilityModeEnum.CriterionCategoryChannelAvailabilityMode").enummodule
        end
      end
    end
  end
