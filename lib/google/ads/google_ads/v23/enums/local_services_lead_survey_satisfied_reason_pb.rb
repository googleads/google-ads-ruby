...
module Google
  module Ads
    module GoogleAds
      module V23
        module Enums
          LocalServicesLeadSurveySatisfiedReasonEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.enums.LocalServicesLeadSurveySatisfiedReasonEnum").msgclass
          LocalServicesLeadSurveySatisfiedReasonEnum::SurveySatisfiedReason = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.enums.LocalServicesLeadSurveySatisfiedReasonEnum.SurveySatisfiedReason").enummodule
        end
      end
    end
  end
