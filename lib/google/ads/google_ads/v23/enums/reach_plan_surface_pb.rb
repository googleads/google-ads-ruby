...
module Google
  module Ads
    module GoogleAds
      module V23
        module Enums
          ReachPlanSurfaceEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.enums.ReachPlanSurfaceEnum").msgclass
          ReachPlanSurfaceEnum::ReachPlanSurface = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.enums.ReachPlanSurfaceEnum.ReachPlanSurface").enummodule
        end
      end
    end
  end
