...
module Google
  module Ads
    module GoogleAds
      module V23
        module Enums
          AdFormatTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.enums.AdFormatTypeEnum").msgclass
          AdFormatTypeEnum::AdFormatType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.enums.AdFormatTypeEnum.AdFormatType").enummodule
        end
      end
    end
  end
