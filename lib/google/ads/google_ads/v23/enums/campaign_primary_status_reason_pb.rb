...
module Google
  module Ads
    module GoogleAds
      module V23
        module Enums
          CampaignPrimaryStatusReasonEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.enums.CampaignPrimaryStatusReasonEnum").msgclass
          CampaignPrimaryStatusReasonEnum::CampaignPrimaryStatusReason = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.enums.CampaignPrimaryStatusReasonEnum.CampaignPrimaryStatusReason").enummodule
        end
      end
    end
  end
