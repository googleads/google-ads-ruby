...
module Google
  module Ads
    module GoogleAds
      module V23
        module Enums
          LocalServicesVerificationArtifactTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.enums.LocalServicesVerificationArtifactTypeEnum").msgclass
          LocalServicesVerificationArtifactTypeEnum::LocalServicesVerificationArtifactType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.enums.LocalServicesVerificationArtifactTypeEnum.LocalServicesVerificationArtifactType").enummodule
        end
      end
    end
  end
