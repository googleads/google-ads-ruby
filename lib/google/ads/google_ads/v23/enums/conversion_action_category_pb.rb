...
module Google
  module Ads
    module GoogleAds
      module V23
        module Enums
          ConversionActionCategoryEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.enums.ConversionActionCategoryEnum").msgclass
          ConversionActionCategoryEnum::ConversionActionCategory = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.enums.ConversionActionCategoryEnum.ConversionActionCategory").enummodule
        end
      end
    end
  end
