...
module Google
  module Ads
    module GoogleAds
      module V23
        module Enums
          ServedAssetFieldTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.enums.ServedAssetFieldTypeEnum").msgclass
          ServedAssetFieldTypeEnum::ServedAssetFieldType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.enums.ServedAssetFieldTypeEnum.ServedAssetFieldType").enummodule
        end
      end
    end
  end
