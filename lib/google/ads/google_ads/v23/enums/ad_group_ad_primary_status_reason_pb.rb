...
module Google
  module Ads
    module GoogleAds
      module V23
        module Enums
          AdGroupAdPrimaryStatusReasonEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.enums.AdGroupAdPrimaryStatusReasonEnum").msgclass
          AdGroupAdPrimaryStatusReasonEnum::AdGroupAdPrimaryStatusReason = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.enums.AdGroupAdPrimaryStatusReasonEnum.AdGroupAdPrimaryStatusReason").enummodule
        end
      end
    end
  end
