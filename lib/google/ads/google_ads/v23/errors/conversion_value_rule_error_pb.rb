...
module Google
  module Ads
    module GoogleAds
      module V23
        module Errors
          ConversionValueRuleErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.ConversionValueRuleErrorEnum").msgclass
          ConversionValueRuleErrorEnum::ConversionValueRuleError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.ConversionValueRuleErrorEnum.ConversionValueRuleError").enummodule
        end
      end
    end
  end
