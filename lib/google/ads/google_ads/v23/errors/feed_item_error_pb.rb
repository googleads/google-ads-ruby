...
module Google
  module Ads
    module GoogleAds
      module V23
        module Errors
          FeedItemErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.FeedItemErrorEnum").msgclass
          FeedItemErrorEnum::FeedItemError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.FeedItemErrorEnum.FeedItemError").enummodule
        end
      end
    end
  end
