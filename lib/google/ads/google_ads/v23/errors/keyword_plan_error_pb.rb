...
module Google
  module Ads
    module GoogleAds
      module V23
        module Errors
          KeywordPlanErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.KeywordPlanErrorEnum").msgclass
          KeywordPlanErrorEnum::KeywordPlanError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.KeywordPlanErrorEnum.KeywordPlanError").enummodule
        end
      end
    end
  end
