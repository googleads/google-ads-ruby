...
module Google
  module Ads
    module GoogleAds
      module V23
        module Errors
          DateErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.DateErrorEnum").msgclass
          DateErrorEnum::DateError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.DateErrorEnum.DateError").enummodule
        end
      end
    end
  end
