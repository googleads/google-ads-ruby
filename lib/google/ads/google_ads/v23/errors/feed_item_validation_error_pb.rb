...
module Google
  module Ads
    module GoogleAds
      module V23
        module Errors
          FeedItemValidationErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.FeedItemValidationErrorEnum").msgclass
          FeedItemValidationErrorEnum::FeedItemValidationError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.FeedItemValidationErrorEnum.FeedItemValidationError").enummodule
        end
      end
    end
  end
