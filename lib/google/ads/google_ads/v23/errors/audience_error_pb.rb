...
module Google
  module Ads
    module GoogleAds
      module V23
        module Errors
          AudienceErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.AudienceErrorEnum").msgclass
          AudienceErrorEnum::AudienceError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.AudienceErrorEnum.AudienceError").enummodule
        end
      end
    end
  end
