...
module Google
  module Ads
    module GoogleAds
      module V23
        module Errors
          CampaignDraftErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.CampaignDraftErrorEnum").msgclass
          CampaignDraftErrorEnum::CampaignDraftError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.CampaignDraftErrorEnum.CampaignDraftError").enummodule
        end
      end
    end
  end
