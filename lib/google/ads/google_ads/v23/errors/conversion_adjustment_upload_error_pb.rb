...
module Google
  module Ads
    module GoogleAds
      module V23
        module Errors
          ConversionAdjustmentUploadErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.ConversionAdjustmentUploadErrorEnum").msgclass
          ConversionAdjustmentUploadErrorEnum::ConversionAdjustmentUploadError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.ConversionAdjustmentUploadErrorEnum.ConversionAdjustmentUploadError").enummodule
        end
      end
    end
  end
