...
module Google
  module Ads
    module GoogleAds
      module V23
        module Errors
          ManagerLinkErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.ManagerLinkErrorEnum").msgclass
          ManagerLinkErrorEnum::ManagerLinkError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.ManagerLinkErrorEnum.ManagerLinkError").enummodule
        end
      end
    end
  end
