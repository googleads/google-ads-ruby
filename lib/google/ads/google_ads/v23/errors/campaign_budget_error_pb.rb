...
module Google
  module Ads
    module GoogleAds
      module V23
        module Errors
          CampaignBudgetErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.CampaignBudgetErrorEnum").msgclass
          CampaignBudgetErrorEnum::CampaignBudgetError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.CampaignBudgetErrorEnum.CampaignBudgetError").enummodule
        end
      end
    end
  end
