...
module Google
  module Ads
    module GoogleAds
      module V23
        module Errors
          ExperimentErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.ExperimentErrorEnum").msgclass
          ExperimentErrorEnum::ExperimentError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.ExperimentErrorEnum.ExperimentError").enummodule
        end
      end
    end
  end
