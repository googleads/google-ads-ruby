...
module Google
  module Ads
    module GoogleAds
      module V23
        module Errors
          RequestErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.RequestErrorEnum").msgclass
          RequestErrorEnum::RequestError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.RequestErrorEnum.RequestError").enummodule
        end
      end
    end
  end
