...
module Google
  module Ads
    module GoogleAds
      module V23
        module Errors
          FeedMappingErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.FeedMappingErrorEnum").msgclass
          FeedMappingErrorEnum::FeedMappingError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.FeedMappingErrorEnum.FeedMappingError").enummodule
        end
      end
    end
  end
