...
module Google
  module Ads
    module GoogleAds
      module V23
        module Errors
          FinalUrlExpansionAssetViewErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.FinalUrlExpansionAssetViewErrorEnum").msgclass
          FinalUrlExpansionAssetViewErrorEnum::FinalUrlExpansionAssetViewError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.errors.FinalUrlExpansionAssetViewErrorEnum.FinalUrlExpansionAssetViewError").enummodule
        end
      end
    end
  end
