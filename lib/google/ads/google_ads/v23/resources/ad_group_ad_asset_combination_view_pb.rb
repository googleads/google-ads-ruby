...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          AdGroupAdAssetCombinationView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.AdGroupAdAssetCombinationView").msgclass
        end
      end
    end
  end
