...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          AndroidPrivacySharedKeyGoogleAdGroup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.AndroidPrivacySharedKeyGoogleAdGroup").msgclass
        end
      end
    end
  end
