...
require 'google/ads/google_ads/v23/common/tag_snippet_pb'
require 'google/ads/google_ads/v23/enums/attribution_model_pb'
require 'google/ads/google_ads/v23/enums/conversion_action_category_pb'
require 'google/ads/google_ads/v23/enums/conversion_action_counting_type_pb'
require 'google/ads/google_ads/v23/enums/conversion_action_status_pb'
require 'google/ads/google_ads/v23/enums/conversion_action_type_pb'
require 'google/ads/google_ads/v23/enums/conversion_origin_pb'
require 'google/ads/google_ads/v23/enums/data_driven_model_status_pb'
require 'google/ads/google_ads/v23/enums/mobile_app_vendor_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.common.TagSnippet", "google/ads/googleads/v23/common/tag_snippet.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          ConversionAction = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.ConversionAction").msgclass
          ConversionAction::AttributionModelSettings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.ConversionAction.AttributionModelSettings").msgclass
          ConversionAction::ValueSettings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.ConversionAction.ValueSettings").msgclass
          ConversionAction::ThirdPartyAppAnalyticsSettings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.ConversionAction.ThirdPartyAppAnalyticsSettings").msgclass
          ConversionAction::FirebaseSettings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.ConversionAction.FirebaseSettings").msgclass
          ConversionAction::GoogleAnalytics4Settings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.ConversionAction.GoogleAnalytics4Settings").msgclass
        end
      end
    end
  end
