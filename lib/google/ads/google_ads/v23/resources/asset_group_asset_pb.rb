...
require 'google/ads/google_ads/v23/common/policy_summary_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.common.AssetLinkPrimaryStatusDetails", "google/ads/googleads/v23/common/asset_policy.proto"],
    ["google.ads.googleads.v23.common.PolicySummary", "google/ads/googleads/v23/common/policy_summary.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          AssetGroupAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.AssetGroupAsset").msgclass
        end
      end
    end
  end
