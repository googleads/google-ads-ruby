...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          ChangeStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.ChangeStatus").msgclass
        end
      end
    end
  end
