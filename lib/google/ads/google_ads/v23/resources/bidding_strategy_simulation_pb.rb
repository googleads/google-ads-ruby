...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.common.TargetCpaSimulationPointList", "google/ads/googleads/v23/common/simulation.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          BiddingStrategySimulation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.BiddingStrategySimulation").msgclass
        end
      end
    end
  end
