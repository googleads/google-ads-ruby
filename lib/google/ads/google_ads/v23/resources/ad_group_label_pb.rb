...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          AdGroupLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.AdGroupLabel").msgclass
        end
      end
    end
  end
