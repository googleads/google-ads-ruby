...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          BatchJob = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.BatchJob").msgclass
          BatchJob::BatchJobMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.BatchJob.BatchJobMetadata").msgclass
        end
      end
    end
  end
