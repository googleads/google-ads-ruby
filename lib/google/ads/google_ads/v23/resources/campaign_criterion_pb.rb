...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          CampaignCriterion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.CampaignCriterion").msgclass
        end
      end
    end
  end
