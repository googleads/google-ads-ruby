...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          QualifyingQuestion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.QualifyingQuestion").msgclass
        end
      end
    end
  end
