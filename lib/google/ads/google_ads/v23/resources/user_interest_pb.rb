...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.common.CriterionCategoryAvailability", "google/ads/googleads/v23/common/criterion_category_availability.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          UserInterest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.UserInterest").msgclass
        end
      end
    end
  end
