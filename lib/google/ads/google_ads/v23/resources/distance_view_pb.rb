...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          DistanceView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.DistanceView").msgclass
        end
      end
    end
  end
