...
require 'google/ads/google_ads/v23/common/asset_types_pb'
...
require 'google/ads/google_ads/v23/enums/asset_orientation_pb'
require 'google/ads/google_ads/v23/enums/asset_source_pb'
require 'google/ads/google_ads/v23/enums/asset_type_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v23.common.YoutubeVideoAsset", "google/ads/googleads/v23/common/asset_types.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          Asset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.Asset").msgclass
          AssetFieldTypePolicySummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.AssetFieldTypePolicySummary").msgclass
          AssetPolicySummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.AssetPolicySummary").msgclass
        end
      end
    end
  end
