...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          LocationView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.LocationView").msgclass
        end
      end
    end
  end
