...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          TopicView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.TopicView").msgclass
        end
      end
    end
  end
