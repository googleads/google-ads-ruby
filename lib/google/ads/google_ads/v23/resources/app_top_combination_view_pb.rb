...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          AppTopCombinationView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.AppTopCombinationView").msgclass
          AdGroupCreativeAssetCombinationData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.AdGroupCreativeAssetCombinationData").msgclass
        end
      end
    end
  end
