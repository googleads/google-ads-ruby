...
require 'google/ads/google_ads/v23/enums/incentive_state_pb'
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          AppliedIncentive = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.AppliedIncentive").msgclass
        end
      end
    end
  end
