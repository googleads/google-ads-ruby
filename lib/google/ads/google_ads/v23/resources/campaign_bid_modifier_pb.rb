...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.common.InteractionTypeInfo", "google/ads/googleads/v23/common/criteria.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          CampaignBidModifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.CampaignBidModifier").msgclass
        end
      end
    end
  end
