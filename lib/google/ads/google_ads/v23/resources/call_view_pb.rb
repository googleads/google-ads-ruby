...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          CallView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.CallView").msgclass
        end
      end
    end
  end
