...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          Ad = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.Ad").msgclass
        end
      end
    end
  end
