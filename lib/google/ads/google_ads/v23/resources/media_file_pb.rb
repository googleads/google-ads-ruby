...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          MediaFile = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.MediaFile").msgclass
          MediaImage = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.MediaImage").msgclass
          MediaBundle = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.MediaBundle").msgclass
          MediaAudio = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.MediaAudio").msgclass
          MediaVideo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.MediaVideo").msgclass
        end
      end
    end
  end
