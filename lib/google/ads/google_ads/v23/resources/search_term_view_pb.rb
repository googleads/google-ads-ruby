...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          SearchTermView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.SearchTermView").msgclass
        end
      end
    end
  end
