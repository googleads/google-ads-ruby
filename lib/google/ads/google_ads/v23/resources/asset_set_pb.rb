...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.common.LocationSet", "google/ads/googleads/v23/common/asset_set_types.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          AssetSet = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.AssetSet").msgclass
          AssetSet::MerchantCenterFeed = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.AssetSet.MerchantCenterFeed").msgclass
          AssetSet::HotelPropertyData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.AssetSet.HotelPropertyData").msgclass
        end
      end
    end
  end
