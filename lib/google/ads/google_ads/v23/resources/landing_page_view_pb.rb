...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          LandingPageView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.LandingPageView").msgclass
        end
      end
    end
  end
