...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          UserLocationView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.UserLocationView").msgclass
        end
      end
    end
  end
