...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          Video = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.Video").msgclass
        end
      end
    end
  end
