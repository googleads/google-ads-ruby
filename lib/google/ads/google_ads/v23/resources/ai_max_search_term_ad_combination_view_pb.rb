...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          AiMaxSearchTermAdCombinationView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.AiMaxSearchTermAdCombinationView").msgclass
        end
      end
    end
  end
