...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          HotelGroupView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.HotelGroupView").msgclass
        end
      end
    end
  end
