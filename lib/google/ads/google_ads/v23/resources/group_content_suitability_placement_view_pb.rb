...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          GroupContentSuitabilityPlacementView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.GroupContentSuitabilityPlacementView").msgclass
        end
      end
    end
  end
