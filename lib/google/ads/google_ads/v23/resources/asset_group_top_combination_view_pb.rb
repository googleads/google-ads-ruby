...
require 'google/ads/google_ads/v23/common/asset_usage_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.common.AssetUsage", "google/ads/googleads/v23/common/asset_usage.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          AssetGroupTopCombinationView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.AssetGroupTopCombinationView").msgclass
          AssetGroupAssetCombinationData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.AssetGroupAssetCombinationData").msgclass
        end
      end
    end
  end
