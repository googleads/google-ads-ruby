...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          SharedSet = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.SharedSet").msgclass
        end
      end
    end
  end
