...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          FinalUrlExpansionAssetView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.FinalUrlExpansionAssetView").msgclass
        end
      end
    end
  end
