...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          SmartCampaignSearchTermView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.SmartCampaignSearchTermView").msgclass
        end
      end
    end
  end
