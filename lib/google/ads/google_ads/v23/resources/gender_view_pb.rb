...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          GenderView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.GenderView").msgclass
        end
      end
    end
  end
