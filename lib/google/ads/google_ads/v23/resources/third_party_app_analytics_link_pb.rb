...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          ThirdPartyAppAnalyticsLink = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.ThirdPartyAppAnalyticsLink").msgclass
        end
      end
    end
  end
