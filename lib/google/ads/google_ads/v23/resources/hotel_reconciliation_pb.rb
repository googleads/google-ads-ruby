...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          HotelReconciliation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.HotelReconciliation").msgclass
        end
      end
    end
  end
