...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          GoogleAdsField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.GoogleAdsField").msgclass
        end
      end
    end
  end
