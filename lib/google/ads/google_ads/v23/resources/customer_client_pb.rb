...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          CustomerClient = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.CustomerClient").msgclass
        end
      end
    end
  end
