...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          DataLink = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.DataLink").msgclass
          YoutubeVideoIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.YoutubeVideoIdentifier").msgclass
        end
      end
    end
  end
