...
require 'google/ads/google_ads/v23/enums/goal_config_level_pb'
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          ConversionGoalCampaignConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.ConversionGoalCampaignConfig").msgclass
        end
      end
    end
  end
