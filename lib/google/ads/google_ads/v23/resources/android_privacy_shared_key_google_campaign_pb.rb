...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          AndroidPrivacySharedKeyGoogleCampaign = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.AndroidPrivacySharedKeyGoogleCampaign").msgclass
        end
      end
    end
  end
