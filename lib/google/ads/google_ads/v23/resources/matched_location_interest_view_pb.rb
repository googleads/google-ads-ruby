...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          MatchedLocationInterestView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.MatchedLocationInterestView").msgclass
        end
      end
    end
  end
