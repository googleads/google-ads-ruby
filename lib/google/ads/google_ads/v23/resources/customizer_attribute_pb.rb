...
require 'google/ads/google_ads/v23/enums/customizer_attribute_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          CustomizerAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.CustomizerAttribute").msgclass
        end
      end
    end
  end
