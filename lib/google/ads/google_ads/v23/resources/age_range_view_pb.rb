...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          AgeRangeView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.AgeRangeView").msgclass
        end
      end
    end
  end
