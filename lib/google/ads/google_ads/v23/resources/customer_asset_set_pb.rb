...
require 'google/ads/google_ads/v23/enums/asset_set_link_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          CustomerAssetSet = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.CustomerAssetSet").msgclass
        end
      end
    end
  end
