...
require 'google/ads/google_ads/v23/enums/keyword_plan_network_pb'
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          KeywordPlanCampaign = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.KeywordPlanCampaign").msgclass
          KeywordPlanGeoTarget = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.KeywordPlanGeoTarget").msgclass
        end
      end
    end
  end
