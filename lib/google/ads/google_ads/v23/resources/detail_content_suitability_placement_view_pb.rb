...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          DetailContentSuitabilityPlacementView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.DetailContentSuitabilityPlacementView").msgclass
        end
      end
    end
  end
