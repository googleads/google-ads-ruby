...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          ShoppingProduct = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.ShoppingProduct").msgclass
          ShoppingProduct::ProductIssue = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.ShoppingProduct.ProductIssue").msgclass
        end
      end
    end
  end
