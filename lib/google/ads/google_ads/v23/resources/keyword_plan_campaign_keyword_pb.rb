...
require 'google/ads/google_ads/v23/enums/keyword_match_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          KeywordPlanCampaignKeyword = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.KeywordPlanCampaignKeyword").msgclass
        end
      end
    end
  end
