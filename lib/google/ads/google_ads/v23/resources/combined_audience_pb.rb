...
require 'google/ads/google_ads/v23/enums/combined_audience_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          CombinedAudience = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.CombinedAudience").msgclass
        end
      end
    end
  end
