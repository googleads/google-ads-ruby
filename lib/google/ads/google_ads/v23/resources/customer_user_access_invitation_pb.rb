...
require 'google/ads/google_ads/v23/enums/access_invitation_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          CustomerUserAccessInvitation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.CustomerUserAccessInvitation").msgclass
        end
      end
    end
  end
