...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          AssetGroup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.AssetGroup").msgclass
          AssetCoverage = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.AssetCoverage").msgclass
          AdStrengthActionItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.AdStrengthActionItem").msgclass
          AdStrengthActionItem::AddAssetDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.AdStrengthActionItem.AddAssetDetails").msgclass
        end
      end
    end
  end
