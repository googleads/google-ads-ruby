...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.common.CustomerThirdPartyIntegrationPartners", "google/ads/googleads/v23/common/third_party_integration_partners.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          Customer = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.Customer").msgclass
          CallReportingSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.CallReportingSetting").msgclass
          ConversionTrackingSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.ConversionTrackingSetting").msgclass
          RemarketingSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.RemarketingSetting").msgclass
          CustomerAgreementSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.CustomerAgreementSetting").msgclass
          LocalServicesSettings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.LocalServicesSettings").msgclass
          GranularLicenseStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.GranularLicenseStatus").msgclass
          GranularInsuranceStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.GranularInsuranceStatus").msgclass
          VideoCustomer = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.VideoCustomer").msgclass
        end
      end
    end
  end
