...
require 'google/ads/google_ads/v23/enums/local_services_employee_status_pb'
require 'google/ads/google_ads/v23/enums/local_services_employee_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          LocalServicesEmployee = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.LocalServicesEmployee").msgclass
          UniversityDegree = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.UniversityDegree").msgclass
          Residency = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.Residency").msgclass
          Fellowship = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.Fellowship").msgclass
        end
      end
    end
  end
