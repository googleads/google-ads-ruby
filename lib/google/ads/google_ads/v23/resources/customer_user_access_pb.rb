...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          CustomerUserAccess = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.CustomerUserAccess").msgclass
        end
      end
    end
  end
