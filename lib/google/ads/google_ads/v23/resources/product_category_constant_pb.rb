...
require 'google/ads/google_ads/v23/enums/product_category_level_pb'
require 'google/ads/google_ads/v23/enums/product_category_state_pb'
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          ProductCategoryConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.ProductCategoryConstant").msgclass
          ProductCategoryConstant::ProductCategoryLocalization = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.ProductCategoryConstant.ProductCategoryLocalization").msgclass
        end
      end
    end
  end
