...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          AssetGroupProductGroupView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.AssetGroupProductGroupView").msgclass
        end
      end
    end
  end
