...
begin
  ...
  imports = [
    ["google.ads.googleads.v23.common.ClickLocation", "google/ads/googleads/v23/common/click_location.proto"],
    ["google.ads.googleads.v23.common.KeywordInfo", "google/ads/googleads/v23/common/criteria.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V23
        module Resources
          ClickView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v23.resources.ClickView").msgclass
        end
      end
    end
  end
