...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v13/enums/recommendation_type.proto", :syntax => :proto3) do
    ...
    add_enum "google.ads.googleads.v13.enums.RecommendationTypeEnum.RecommendationType" do
      ...
      value :CALL_ASSET, 30
      value :SHOPPING_ADD_AGE_GROUP, 31
      value :SHOPPING_ADD_COLOR, 32
      value :SHOPPING_ADD_GENDER, 33
      value :SHOPPING_ADD_GTIN, 34
      value :SHOPPING_ADD_MORE_IDENTIFIERS, 35
      value :SHOPPING_ADD_SIZE, 36
      value :SHOPPING_ADD_PRODUCTS_TO_CAMPAIGN, 37
      value :SHOPPING_FIX_DISAPPROVED_PRODUCTS, 38
      value :SHOPPING_TARGET_ALL_OFFERS, 39
      value :SHOPPING_FIX_SUSPENDED_MERCHANT_CENTER_ACCOUNT, 40
      value :SHOPPING_FIX_MERCHANT_CENTER_ACCOUNT_SUSPENSION_WARNING, 41
      value :SHOPPING_MIGRATE_REGULAR_SHOPPING_CAMPAIGN_OFFERS_TO_PERFORMANCE_MAX, 42
    end
  end
end
