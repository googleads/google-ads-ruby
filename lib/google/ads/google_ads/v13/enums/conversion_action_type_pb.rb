...
# source: google/ads/googleads/v13/enums/conversion_action_type.proto

require 'google/protobuf'

Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v13/enums/conversion_action_type.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v13.enums.ConversionActionTypeEnum" do
    end
    add_enum "google.ads.googleads.v13.enums.ConversionActionTypeEnum.ConversionActionType" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
      value :AD_CALL, 2
...
module Google
  module Ads
    module GoogleAds
      module V13
        module Enums
          ConversionActionTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v13.enums.ConversionActionTypeEnum").msgclass
          ConversionActionTypeEnum::ConversionActionType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v13.enums.ConversionActionTypeEnum.ConversionActionType").enummodule
        end
      end
    end
  end
