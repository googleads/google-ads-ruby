        ...
        module Services
          module KeywordPlanIdeaService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V13::Services::KeywordPlanIdeaService::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all KeywordPlanIdeaService clients
              #   ::Google::Ads::GoogleAds::V13::Services::KeywordPlanIdeaService::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              #   client = ::Google::Ads::GoogleAds::V13::Services::KeywordPlanIdeaService::Client.new
              #
              #   # Create a client using a custom configuration
              #   client = ::Google::Ads::GoogleAds::V13::Services::KeywordPlanIdeaService::Client.new do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/google_ads/v13/services/keyword_plan_idea_service_services_pb"
                ...
                @keyword_plan_idea_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V13::Services::KeywordPlanIdeaService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V13::Services::GenerateKeywordIdeasRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V13::Services::GenerateKeywordIdeasRequest, ::Hash]
              ...
              #   @param keyword_plan_network [::Google::Ads::GoogleAds::V13::Enums::KeywordPlanNetworkEnum::KeywordPlanNetwork]
              #     Targeting network.
              #     If not set, Google Search And Partners Network will be used.
              #   @param keyword_annotation [::Array<::Google::Ads::GoogleAds::V13::Enums::KeywordPlanKeywordAnnotationEnum::KeywordPlanKeywordAnnotation>]
              #     The keyword annotations to include in response.
              #   @param aggregate_metrics [::Google::Ads::GoogleAds::V13::Common::KeywordPlanAggregateMetrics, ::Hash]
              #     The aggregate fields to include in response.
              #   @param historical_metrics_options [::Google::Ads::GoogleAds::V13::Common::HistoricalMetricsOptions, ::Hash]
              #     The options for historical metrics data.
              #   @param keyword_and_url_seed [::Google::Ads::GoogleAds::V13::Services::KeywordAndUrlSeed, ::Hash]
              #     A Keyword and a specific Url to generate ideas from
              #     for example, cars, www.example.com/cars.
              #   @param keyword_seed [::Google::Ads::GoogleAds::V13::Services::KeywordSeed, ::Hash]
              #     A Keyword or phrase to generate ideas from, for example, cars.
              #   @param url_seed [::Google::Ads::GoogleAds::V13::Services::UrlSeed, ::Hash]
              #     A specific url to generate ideas from, for example, www.example.com/cars.
              #   @param site_seed [::Google::Ads::GoogleAds::V13::Services::SiteSeed, ::Hash]
              #     The site to generate ideas from, for example, www.example.com.
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Gapic::PagedEnumerable<::Google::Ads::GoogleAds::V13::Services::GenerateKeywordIdeaResult>]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Gapic::PagedEnumerable<::Google::Ads::GoogleAds::V13::Services::GenerateKeywordIdeaResult>]
              #
              ...
              #   request = Google::Ads::GoogleAds::V13::Services::GenerateKeywordIdeasRequest.new
              #
              ...
              #   result.each do |item|
              #     # Each element is of type ::Google::Ads::GoogleAds::V13::Services::GenerateKeywordIdeaResult.
              #     p item
              #   end
              #
              def generate_keyword_ideas request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V13::Services::GenerateKeywordIdeasRequest
              ...
              #   {::Google::Ads::GoogleAds::V13::Services::GenerateKeywordHistoricalMetricsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V13::Services::GenerateKeywordHistoricalMetricsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V13::Services::GenerateKeywordHistoricalMetricsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V13::Services::GenerateKeywordHistoricalMetricsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::GoogleAds::V13::Services::GenerateKeywordHistoricalMetricsRequest.new
              #
              #   # Call the generate_keyword_historical_metrics method.
              #   result = client.generate_keyword_historical_metrics request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V13::Services::GenerateKeywordHistoricalMetricsResponse.
              #   p result
              #
              def generate_keyword_historical_metrics request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V13::Services::GenerateKeywordHistoricalMetricsRequest
              ...
              #   {::Google::Ads::GoogleAds::V13::Services::GenerateAdGroupThemesRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V13::Services::GenerateAdGroupThemesRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V13::Services::GenerateAdGroupThemesResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V13::Services::GenerateAdGroupThemesResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::GoogleAds::V13::Services::GenerateAdGroupThemesRequest.new
              #
              #   # Call the generate_ad_group_themes method.
              #   result = client.generate_ad_group_themes request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V13::Services::GenerateAdGroupThemesResponse.
              #   p result
              #
              def generate_ad_group_themes request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V13::Services::GenerateAdGroupThemesRequest
              ...
              # {::Google::Ads::GoogleAds::V13::Services::KeywordPlanIdeaService::Client::Configuration::Rpcs}
