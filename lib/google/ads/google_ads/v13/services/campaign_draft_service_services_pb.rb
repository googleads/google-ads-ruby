        ...
        module Services
          module CampaignDraftService
            ...
            class Service
              ...
              self.service_name = 'google.ads.googleads.v13.services.CampaignDraftService'
              ...
              #   [QuotaError]()
              #   [RequestError]()
              rpc :MutateCampaignDrafts, ::Google::Ads::GoogleAds::V13::Services::MutateCampaignDraftsRequest, ::Google::Ads::GoogleAds::V13::Services::MutateCampaignDraftsResponse
              ...
              #   [QuotaError]()
              #   [RequestError]()
              rpc :PromoteCampaignDraft, ::Google::Ads::GoogleAds::V13::Services::PromoteCampaignDraftRequest, ::Google::Longrunning::Operation
              ...
              #   [QuotaError]()
              #   [RequestError]()
              rpc :ListCampaignDraftAsyncErrors, ::Google::Ads::GoogleAds::V13::Services::ListCampaignDraftAsyncErrorsRequest, ::Google::Ads::GoogleAds::V13::Services::ListCampaignDraftAsyncErrorsResponse
            end
