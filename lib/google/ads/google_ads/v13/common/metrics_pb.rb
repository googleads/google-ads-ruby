...
require 'google/ads/google_ads/v13/enums/interaction_event_type_pb'
require 'google/ads/google_ads/v13/enums/quality_score_bucket_pb'

Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v13/common/metrics.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v13.common.Metrics" do
      ...
      proto3_optional :auction_insight_search_absolute_top_impression_percentage, :double, 258
      proto3_optional :auction_insight_search_impression_share, :double, 259
      proto3_optional :auction_insight_search_outranking_share, :double, 260
      proto3_optional :auction_insight_search_overlap_rate, :double, 261
      proto3_optional :auction_insight_search_position_above_rate, :double, 262
      proto3_optional :auction_insight_search_top_impression_percentage, :double, 263
      ...
      proto3_optional :biddable_app_install_conversions, :double, 254
      proto3_optional :biddable_app_post_install_conversions, :double, 255
      ...
      proto3_optional :hotel_commission_rate_micros, :int64, 256
      proto3_optional :hotel_expected_commission_cost, :double, 257
      proto3_optional :hotel_price_difference_percentage, :double, 214
      proto3_optional :hotel_eligible_impressions, :int64, 215
      optional :historical_creative_quality_score, :enum, 80, "google.ads.googleads.v13.enums.QualityScoreBucketEnum.QualityScoreBucket"
      optional :historical_landing_page_quality_score, :enum, 81, "google.ads.googleads.v13.enums.QualityScoreBucketEnum.QualityScoreBucket"
      proto3_optional :historical_quality_score, :int64, 216
      optional :historical_search_predicted_ctr, :enum, 83, "google.ads.googleads.v13.enums.QualityScoreBucketEnum.QualityScoreBucket"
      ...
      repeated :interaction_event_types, :enum, 100, "google.ads.googleads.v13.enums.InteractionEventTypeEnum.InteractionEventType"
      ...
      optional :publisher_purchased_clicks, :int64, 264
      optional :publisher_organic_clicks, :int64, 265
      optional :publisher_unknown_clicks, :int64, 266
      proto3_optional :all_conversions_from_location_asset_click_to_call, :double, 267
      proto3_optional :all_conversions_from_location_asset_directions, :double, 268
      proto3_optional :all_conversions_from_location_asset_menu, :double, 269
      proto3_optional :all_conversions_from_location_asset_order, :double, 270
      proto3_optional :all_conversions_from_location_asset_other_engagement, :double, 271
      proto3_optional :all_conversions_from_location_asset_store_visits, :double, 272
      proto3_optional :all_conversions_from_location_asset_website, :double, 273
      proto3_optional :eligible_impressions_from_location_asset_store_reach, :int64, 274
      proto3_optional :view_through_conversions_from_location_asset_click_to_call, :double, 275
      proto3_optional :view_through_conversions_from_location_asset_directions, :double, 276
      proto3_optional :view_through_conversions_from_location_asset_menu, :double, 277
      proto3_optional :view_through_conversions_from_location_asset_order, :double, 278
      proto3_optional :view_through_conversions_from_location_asset_other_engagement, :double, 279
      proto3_optional :view_through_conversions_from_location_asset_store_visits, :double, 280
      proto3_optional :view_through_conversions_from_location_asset_website, :double, 281
    end
  end
end
...
module Google
  module Ads
    module GoogleAds
      module V13
        module Common
          Metrics = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v13.common.Metrics").msgclass
        end
      end
    end
  end
