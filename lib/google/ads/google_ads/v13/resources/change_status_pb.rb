...
require 'google/ads/google_ads/v13/enums/change_status_operation_pb'
require 'google/ads/google_ads/v13/enums/change_status_resource_type_pb'
require 'google/api/field_behavior_pb'
require 'google/api/resource_pb'

Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v13/resources/change_status.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v13.resources.ChangeStatus" do
      optional :resource_name, :string, 1
      proto3_optional :last_change_date_time, :string, 24
      optional :resource_type, :enum, 4, "google.ads.googleads.v13.enums.ChangeStatusResourceTypeEnum.ChangeStatusResourceType"
      proto3_optional :campaign, :string, 17
      proto3_optional :ad_group, :string, 18
      optional :resource_status, :enum, 8, "google.ads.googleads.v13.enums.ChangeStatusOperationEnum.ChangeStatusOperation"
      ...
      optional :combined_audience, :string, 40
    end
  end
end
...
module Google
  module Ads
    module GoogleAds
      module V13
        module Resources
          ChangeStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v13.resources.ChangeStatus").msgclass
        end
      end
    end
  end
