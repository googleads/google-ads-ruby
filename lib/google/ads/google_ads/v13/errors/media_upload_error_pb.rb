...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v13/errors/media_upload_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v13.errors.MediaUploadErrorEnum" do
    end
    add_enum "google.ads.googleads.v13.errors.MediaUploadErrorEnum.MediaUploadError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V13
        module Errors
          MediaUploadErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v13.errors.MediaUploadErrorEnum").msgclass
          MediaUploadErrorEnum::MediaUploadError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v13.errors.MediaUploadErrorEnum.MediaUploadError").enummodule
        end
      end
    end
  end
