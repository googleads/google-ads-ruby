...
# source: google/ads/googleads/v13/errors/experiment_arm_error.proto

require 'google/protobuf'

Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v13/errors/experiment_arm_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v13.errors.ExperimentArmErrorEnum" do
    end
    add_enum "google.ads.googleads.v13.errors.ExperimentArmErrorEnum.ExperimentArmError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V13
        module Errors
          ExperimentArmErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v13.errors.ExperimentArmErrorEnum").msgclass
          ExperimentArmErrorEnum::ExperimentArmError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v13.errors.ExperimentArmErrorEnum.ExperimentArmError").enummodule
        end
      end
    end
  end
