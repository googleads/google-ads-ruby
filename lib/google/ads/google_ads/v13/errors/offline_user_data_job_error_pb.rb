...
# source: google/ads/googleads/v13/errors/offline_user_data_job_error.proto

require 'google/protobuf'

Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v13/errors/offline_user_data_job_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v13.errors.OfflineUserDataJobErrorEnum" do
    end
    add_enum "google.ads.googleads.v13.errors.OfflineUserDataJobErrorEnum.OfflineUserDataJobError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V13
        module Errors
          OfflineUserDataJobErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v13.errors.OfflineUserDataJobErrorEnum").msgclass
          OfflineUserDataJobErrorEnum::OfflineUserDataJobError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v13.errors.OfflineUserDataJobErrorEnum.OfflineUserDataJobError").enummodule
        end
      end
    end
  end
