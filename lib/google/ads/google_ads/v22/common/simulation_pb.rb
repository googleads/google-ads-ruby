...
module Google
  module Ads
    module GoogleAds
      module V22
        module Common
          CpcBidSimulationPointList = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.CpcBidSimulationPointList").msgclass
          CpvBidSimulationPointList = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.CpvBidSimulationPointList").msgclass
          TargetCpaSimulationPointList = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.TargetCpaSimulationPointList").msgclass
          TargetRoasSimulationPointList = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.TargetRoasSimulationPointList").msgclass
          PercentCpcBidSimulationPointList = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.PercentCpcBidSimulationPointList").msgclass
          BudgetSimulationPointList = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.BudgetSimulationPointList").msgclass
          TargetImpressionShareSimulationPointList = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.TargetImpressionShareSimulationPointList").msgclass
          CpcBidSimulationPoint = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.CpcBidSimulationPoint").msgclass
          CpvBidSimulationPoint = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.CpvBidSimulationPoint").msgclass
          TargetCpaSimulationPoint = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.TargetCpaSimulationPoint").msgclass
          TargetRoasSimulationPoint = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.TargetRoasSimulationPoint").msgclass
          PercentCpcBidSimulationPoint = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.PercentCpcBidSimulationPoint").msgclass
          BudgetSimulationPoint = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.BudgetSimulationPoint").msgclass
          TargetImpressionShareSimulationPoint = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.TargetImpressionShareSimulationPoint").msgclass
        end
      end
    end
  end
