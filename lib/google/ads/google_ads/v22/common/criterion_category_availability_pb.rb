...
module Google
  module Ads
    module GoogleAds
      module V22
        module Common
          CriterionCategoryAvailability = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.CriterionCategoryAvailability").msgclass
          CriterionCategoryChannelAvailability = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.CriterionCategoryChannelAvailability").msgclass
          CriterionCategoryLocaleAvailability = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.CriterionCategoryLocaleAvailability").msgclass
        end
      end
    end
  end
