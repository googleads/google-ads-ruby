...
module Google
  module Ads
    module GoogleAds
      module V22
        module Common
          OfflineUserAddressInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.OfflineUserAddressInfo").msgclass
          UserIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.UserIdentifier").msgclass
          TransactionAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.TransactionAttribute").msgclass
          StoreAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.StoreAttribute").msgclass
          ItemAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.ItemAttribute").msgclass
          UserData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.UserData").msgclass
          UserAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.UserAttribute").msgclass
          EventAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.EventAttribute").msgclass
          EventItemAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.EventItemAttribute").msgclass
          ShoppingLoyalty = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.ShoppingLoyalty").msgclass
          CustomerMatchUserListMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.CustomerMatchUserListMetadata").msgclass
          StoreSalesMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.StoreSalesMetadata").msgclass
          StoreSalesThirdPartyMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.StoreSalesThirdPartyMetadata").msgclass
        end
      end
    end
  end
