...
begin
  ...
  imports = [
    ["google.ads.googleads.v22.common.AgeRangeInfo", "google/ads/googleads/v22/common/criteria.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Common
          AudienceInsightsAttributeMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.AudienceInsightsAttributeMetadata").msgclass
          AudienceInsightsAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.AudienceInsightsAttribute").msgclass
          AudienceInsightsEntity = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.AudienceInsightsEntity").msgclass
          AudienceInsightsCategory = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.AudienceInsightsCategory").msgclass
          AudienceInsightsLineup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.AudienceInsightsLineup").msgclass
          YouTubeChannelAttributeMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.YouTubeChannelAttributeMetadata").msgclass
          YouTubeVideoAttributeMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.YouTubeVideoAttributeMetadata").msgclass
          LineupAttributeMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.LineupAttributeMetadata").msgclass
          LineupAttributeMetadata::SampleChannel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.LineupAttributeMetadata.SampleChannel").msgclass
          LocationAttributeMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.LocationAttributeMetadata").msgclass
          UserInterestAttributeMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.UserInterestAttributeMetadata").msgclass
          KnowledgeGraphAttributeMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.KnowledgeGraphAttributeMetadata").msgclass
          UserListAttributeMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.UserListAttributeMetadata").msgclass
          AudienceInsightsAttributeMetadataGroup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.AudienceInsightsAttributeMetadataGroup").msgclass
        end
      end
    end
  end
