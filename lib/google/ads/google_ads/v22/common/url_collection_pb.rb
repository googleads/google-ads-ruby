...
module Google
  module Ads
    module GoogleAds
      module V22
        module Common
          UrlCollection = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.common.UrlCollection").msgclass
        end
      end
    end
  end
