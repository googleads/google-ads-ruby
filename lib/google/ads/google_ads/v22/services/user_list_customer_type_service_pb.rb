...
require 'google/ads/google_ads/v22/resources/user_list_customer_type_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v22.resources.UserListCustomerType", "google/ads/googleads/v22/resources/user_list_customer_type.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Services
          MutateUserListCustomerTypesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateUserListCustomerTypesRequest").msgclass
          UserListCustomerTypeOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.UserListCustomerTypeOperation").msgclass
          MutateUserListCustomerTypesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateUserListCustomerTypesResponse").msgclass
          MutateUserListCustomerTypeResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateUserListCustomerTypeResult").msgclass
        end
      end
    end
  end
