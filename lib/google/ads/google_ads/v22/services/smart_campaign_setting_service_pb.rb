...
require 'google/ads/google_ads/v22/enums/smart_campaign_not_eligible_reason_pb'
require 'google/ads/google_ads/v22/enums/smart_campaign_status_pb'
require 'google/ads/google_ads/v22/resources/smart_campaign_setting_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v22.resources.SmartCampaignSetting", "google/ads/googleads/v22/resources/smart_campaign_setting.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Services
          GetSmartCampaignStatusRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.GetSmartCampaignStatusRequest").msgclass
          SmartCampaignNotEligibleDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.SmartCampaignNotEligibleDetails").msgclass
          SmartCampaignEligibleDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.SmartCampaignEligibleDetails").msgclass
          SmartCampaignPausedDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.SmartCampaignPausedDetails").msgclass
          SmartCampaignRemovedDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.SmartCampaignRemovedDetails").msgclass
          SmartCampaignEndedDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.SmartCampaignEndedDetails").msgclass
          GetSmartCampaignStatusResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.GetSmartCampaignStatusResponse").msgclass
          MutateSmartCampaignSettingsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateSmartCampaignSettingsRequest").msgclass
          SmartCampaignSettingOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.SmartCampaignSettingOperation").msgclass
          MutateSmartCampaignSettingsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateSmartCampaignSettingsResponse").msgclass
          MutateSmartCampaignSettingResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateSmartCampaignSettingResult").msgclass
        end
      end
    end
  end
