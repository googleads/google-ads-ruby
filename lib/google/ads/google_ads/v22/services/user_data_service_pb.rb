...
begin
  ...
  imports = [
    ["google.ads.googleads.v22.common.CustomerMatchUserListMetadata", "google/ads/googleads/v22/common/offline_user_data.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Services
          UploadUserDataRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.UploadUserDataRequest").msgclass
          UserDataOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.UserDataOperation").msgclass
          UploadUserDataResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.UploadUserDataResponse").msgclass
        end
      end
    end
  end
