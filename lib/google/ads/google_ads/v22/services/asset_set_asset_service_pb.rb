...
module Google
  module Ads
    module GoogleAds
      module V22
        module Services
          MutateAssetSetAssetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateAssetSetAssetsRequest").msgclass
          AssetSetAssetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.AssetSetAssetOperation").msgclass
          MutateAssetSetAssetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateAssetSetAssetsResponse").msgclass
          MutateAssetSetAssetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateAssetSetAssetResult").msgclass
        end
      end
    end
  end
