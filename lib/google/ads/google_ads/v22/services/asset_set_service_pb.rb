...
module Google
  module Ads
    module GoogleAds
      module V22
        module Services
          MutateAssetSetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateAssetSetsRequest").msgclass
          AssetSetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.AssetSetOperation").msgclass
          MutateAssetSetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateAssetSetsResponse").msgclass
          MutateAssetSetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateAssetSetResult").msgclass
        end
      end
    end
  end
