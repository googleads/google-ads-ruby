...
require 'google/ads/google_ads/v22/common/consent_pb'
require 'google/ads/google_ads/v22/common/offline_user_data_pb'
require 'google/ads/google_ads/v22/enums/conversion_customer_type_pb'
require 'google/ads/google_ads/v22/enums/conversion_environment_enum_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v22.common.UserIdentifier", "google/ads/googleads/v22/common/offline_user_data.proto"],
    ["google.ads.googleads.v22.common.Consent", "google/ads/googleads/v22/common/consent.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Services
          UploadClickConversionsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.UploadClickConversionsRequest").msgclass
          UploadClickConversionsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.UploadClickConversionsResponse").msgclass
          UploadCallConversionsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.UploadCallConversionsRequest").msgclass
          UploadCallConversionsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.UploadCallConversionsResponse").msgclass
          ClickConversion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.ClickConversion").msgclass
          CallConversion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.CallConversion").msgclass
          ExternalAttributionData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.ExternalAttributionData").msgclass
          ClickConversionResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.ClickConversionResult").msgclass
          CallConversionResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.CallConversionResult").msgclass
          CustomVariable = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.CustomVariable").msgclass
          CartData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.CartData").msgclass
          CartData::Item = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.CartData.Item").msgclass
          SessionAttributeKeyValuePair = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.SessionAttributeKeyValuePair").msgclass
          SessionAttributesKeyValuePairs = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.SessionAttributesKeyValuePairs").msgclass
        end
      end
    end
  end
