...
require 'google/ads/google_ads/v22/resources/ad_group_criterion_customizer_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v22.resources.AdGroupCriterionCustomizer", "google/ads/googleads/v22/resources/ad_group_criterion_customizer.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Services
          MutateAdGroupCriterionCustomizersRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateAdGroupCriterionCustomizersRequest").msgclass
          AdGroupCriterionCustomizerOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.AdGroupCriterionCustomizerOperation").msgclass
          MutateAdGroupCriterionCustomizersResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateAdGroupCriterionCustomizersResponse").msgclass
          MutateAdGroupCriterionCustomizerResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateAdGroupCriterionCustomizerResult").msgclass
        end
      end
    end
  end
