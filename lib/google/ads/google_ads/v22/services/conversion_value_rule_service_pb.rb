...
require 'google/ads/google_ads/v22/resources/conversion_value_rule_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v22.resources.ConversionValueRule", "google/ads/googleads/v22/resources/conversion_value_rule.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Services
          MutateConversionValueRulesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateConversionValueRulesRequest").msgclass
          ConversionValueRuleOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.ConversionValueRuleOperation").msgclass
          MutateConversionValueRulesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateConversionValueRulesResponse").msgclass
          MutateConversionValueRuleResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateConversionValueRuleResult").msgclass
        end
      end
    end
  end
