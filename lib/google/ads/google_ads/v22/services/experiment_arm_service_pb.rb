...
require 'google/ads/google_ads/v22/resources/experiment_arm_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v22.resources.ExperimentArm", "google/ads/googleads/v22/resources/experiment_arm.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Services
          MutateExperimentArmsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateExperimentArmsRequest").msgclass
          ExperimentArmOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.ExperimentArmOperation").msgclass
          MutateExperimentArmsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateExperimentArmsResponse").msgclass
          MutateExperimentArmResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateExperimentArmResult").msgclass
        end
      end
    end
  end
