...
require "google/ads/google_ads/v22/services/keyword_plan_idea_service_pb"
        ...
        module Services
          module KeywordPlanIdeaService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V22::Services::KeywordPlanIdeaService::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all KeywordPlanIdeaService clients
              #   ::Google::Ads::GoogleAds::V22::Services::KeywordPlanIdeaService::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              #   client = ::Google::Ads::GoogleAds::V22::Services::KeywordPlanIdeaService::Client.new
              #
              #   # Create a client using a custom configuration
              #   client = ::Google::Ads::GoogleAds::V22::Services::KeywordPlanIdeaService::Client.new do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/google_ads/v22/services/keyword_plan_idea_service_services_pb"
                ...
                @keyword_plan_idea_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V22::Services::KeywordPlanIdeaService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V22::Services::GenerateKeywordIdeasRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V22::Services::GenerateKeywordIdeasRequest, ::Hash]
              ...
              #   @param keyword_plan_network [::Google::Ads::GoogleAds::V22::Enums::KeywordPlanNetworkEnum::KeywordPlanNetwork]
              #     Targeting network.
              #     If not set, Google Search And Partners Network will be used.
              #   @param keyword_annotation [::Array<::Google::Ads::GoogleAds::V22::Enums::KeywordPlanKeywordAnnotationEnum::KeywordPlanKeywordAnnotation>]
              #     The keyword annotations to include in response.
              #   @param aggregate_metrics [::Google::Ads::GoogleAds::V22::Common::KeywordPlanAggregateMetrics, ::Hash]
              #     The aggregate fields to include in response.
              #   @param historical_metrics_options [::Google::Ads::GoogleAds::V22::Common::HistoricalMetricsOptions, ::Hash]
              #     The options for historical metrics data.
              #   @param keyword_and_url_seed [::Google::Ads::GoogleAds::V22::Services::KeywordAndUrlSeed, ::Hash]
              ...
              #   @param keyword_seed [::Google::Ads::GoogleAds::V22::Services::KeywordSeed, ::Hash]
              ...
              #   @param url_seed [::Google::Ads::GoogleAds::V22::Services::UrlSeed, ::Hash]
              ...
              #   @param site_seed [::Google::Ads::GoogleAds::V22::Services::SiteSeed, ::Hash]
              ...
              # @yieldparam response [::Gapic::PagedEnumerable<::Google::Ads::GoogleAds::V22::Services::GenerateKeywordIdeaResult>]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Gapic::PagedEnumerable<::Google::Ads::GoogleAds::V22::Services::GenerateKeywordIdeaResult>]
              #
              ...
              #   request = Google::Ads::GoogleAds::V22::Services::GenerateKeywordIdeasRequest.new
              #
              ...
              #   result.each do |item|
              #     # Each element is of type ::Google::Ads::GoogleAds::V22::Services::GenerateKeywordIdeaResult.
              #     p item
              #   end
              #
              def generate_keyword_ideas request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V22::Services::GenerateKeywordIdeasRequest
              ...
              #   {::Google::Ads::GoogleAds::V22::Services::GenerateKeywordHistoricalMetricsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V22::Services::GenerateKeywordHistoricalMetricsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V22::Services::GenerateKeywordHistoricalMetricsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V22::Services::GenerateKeywordHistoricalMetricsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::GoogleAds::V22::Services::GenerateKeywordHistoricalMetricsRequest.new
              #
              #   # Call the generate_keyword_historical_metrics method.
              #   result = client.generate_keyword_historical_metrics request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V22::Services::GenerateKeywordHistoricalMetricsResponse.
              #   p result
              #
              def generate_keyword_historical_metrics request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V22::Services::GenerateKeywordHistoricalMetricsRequest
              ...
              #   {::Google::Ads::GoogleAds::V22::Services::GenerateAdGroupThemesRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V22::Services::GenerateAdGroupThemesRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V22::Services::GenerateAdGroupThemesResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V22::Services::GenerateAdGroupThemesResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::GoogleAds::V22::Services::GenerateAdGroupThemesRequest.new
              #
              #   # Call the generate_ad_group_themes method.
              #   result = client.generate_ad_group_themes request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V22::Services::GenerateAdGroupThemesResponse.
              #   p result
              #
              def generate_ad_group_themes request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V22::Services::GenerateAdGroupThemesRequest
              ...
              #   {::Google::Ads::GoogleAds::V22::Services::GenerateKeywordForecastMetricsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V22::Services::GenerateKeywordForecastMetricsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param forecast_period [::Google::Ads::GoogleAds::V22::Common::DateRange, ::Hash]
              ...
              #   @param campaign [::Google::Ads::GoogleAds::V22::Services::CampaignToForecast, ::Hash]
              #     Required. The campaign used in the forecast.
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V22::Services::GenerateKeywordForecastMetricsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V22::Services::GenerateKeywordForecastMetricsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::GoogleAds::V22::Services::GenerateKeywordForecastMetricsRequest.new
              #
              #   # Call the generate_keyword_forecast_metrics method.
              #   result = client.generate_keyword_forecast_metrics request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V22::Services::GenerateKeywordForecastMetricsResponse.
              #   p result
              #
              def generate_keyword_forecast_metrics request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V22::Services::GenerateKeywordForecastMetricsRequest
              ...
              # {::Google::Ads::GoogleAds::V22::Services::KeywordPlanIdeaService::Client::Configuration::Rpcs}
