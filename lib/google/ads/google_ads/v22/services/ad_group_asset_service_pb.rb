...
module Google
  module Ads
    module GoogleAds
      module V22
        module Services
          MutateAdGroupAssetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateAdGroupAssetsRequest").msgclass
          AdGroupAssetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.AdGroupAssetOperation").msgclass
          MutateAdGroupAssetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateAdGroupAssetsResponse").msgclass
          MutateAdGroupAssetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateAdGroupAssetResult").msgclass
        end
      end
    end
  end
