...
# source: google/ads/googleads/v22/services/third_party_app_analytics_link_service.proto
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Services
          RegenerateShareableLinkIdRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.RegenerateShareableLinkIdRequest").msgclass
          RegenerateShareableLinkIdResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.RegenerateShareableLinkIdResponse").msgclass
        end
      end
    end
  end
