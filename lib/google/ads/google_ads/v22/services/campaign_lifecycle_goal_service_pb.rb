...
require 'google/ads/google_ads/v22/resources/campaign_lifecycle_goal_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v22.resources.CampaignLifecycleGoal", "google/ads/googleads/v22/resources/campaign_lifecycle_goal.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Services
          ConfigureCampaignLifecycleGoalsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.ConfigureCampaignLifecycleGoalsRequest").msgclass
          CampaignLifecycleGoalOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.CampaignLifecycleGoalOperation").msgclass
          ConfigureCampaignLifecycleGoalsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.ConfigureCampaignLifecycleGoalsResponse").msgclass
          ConfigureCampaignLifecycleGoalsResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.ConfigureCampaignLifecycleGoalsResult").msgclass
        end
      end
    end
  end
