...
require 'google/ads/google_ads/v22/enums/identity_verification_program_pb'
require 'google/ads/google_ads/v22/enums/identity_verification_program_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Services
          StartIdentityVerificationRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.StartIdentityVerificationRequest").msgclass
          GetIdentityVerificationRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.GetIdentityVerificationRequest").msgclass
          GetIdentityVerificationResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.GetIdentityVerificationResponse").msgclass
          IdentityVerification = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.IdentityVerification").msgclass
          IdentityVerificationProgress = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.IdentityVerificationProgress").msgclass
          IdentityVerificationRequirement = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.IdentityVerificationRequirement").msgclass
        end
      end
    end
  end
