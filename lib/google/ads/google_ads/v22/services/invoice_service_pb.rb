...
begin
  ...
  imports = [
    ["google.ads.googleads.v22.resources.Invoice", "google/ads/googleads/v22/resources/invoice.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Services
          ListInvoicesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.ListInvoicesRequest").msgclass
          ListInvoicesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.ListInvoicesResponse").msgclass
        end
      end
    end
  end
