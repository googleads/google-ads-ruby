...
require 'google/ads/google_ads/v22/resources/conversion_value_rule_set_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v22.resources.ConversionValueRuleSet", "google/ads/googleads/v22/resources/conversion_value_rule_set.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Services
          MutateConversionValueRuleSetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateConversionValueRuleSetsRequest").msgclass
          ConversionValueRuleSetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.ConversionValueRuleSetOperation").msgclass
          MutateConversionValueRuleSetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateConversionValueRuleSetsResponse").msgclass
          MutateConversionValueRuleSetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateConversionValueRuleSetResult").msgclass
        end
      end
    end
  end
