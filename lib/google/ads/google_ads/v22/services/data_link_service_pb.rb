...
require 'google/ads/google_ads/v22/resources/data_link_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v22.resources.DataLink", "google/ads/googleads/v22/resources/data_link.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Services
          CreateDataLinkRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.CreateDataLinkRequest").msgclass
          CreateDataLinkResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.CreateDataLinkResponse").msgclass
          RemoveDataLinkRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.RemoveDataLinkRequest").msgclass
          RemoveDataLinkResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.RemoveDataLinkResponse").msgclass
          UpdateDataLinkRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.UpdateDataLinkRequest").msgclass
          UpdateDataLinkResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.UpdateDataLinkResponse").msgclass
        end
      end
    end
  end
