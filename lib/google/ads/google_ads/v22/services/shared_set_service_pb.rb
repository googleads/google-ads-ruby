...
require 'google/ads/google_ads/v22/resources/shared_set_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v22.resources.SharedSet", "google/ads/googleads/v22/resources/shared_set.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Services
          MutateSharedSetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateSharedSetsRequest").msgclass
          SharedSetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.SharedSetOperation").msgclass
          MutateSharedSetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateSharedSetsResponse").msgclass
          MutateSharedSetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateSharedSetResult").msgclass
        end
      end
    end
  end
