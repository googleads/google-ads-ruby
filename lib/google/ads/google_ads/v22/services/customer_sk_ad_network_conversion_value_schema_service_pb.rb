...
require 'google/ads/google_ads/v22/resources/customer_sk_ad_network_conversion_value_schema_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v22.resources.CustomerSkAdNetworkConversionValueSchema", "google/ads/googleads/v22/resources/customer_sk_ad_network_conversion_value_schema.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Services
          CustomerSkAdNetworkConversionValueSchemaOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.CustomerSkAdNetworkConversionValueSchemaOperation").msgclass
          MutateCustomerSkAdNetworkConversionValueSchemaRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateCustomerSkAdNetworkConversionValueSchemaRequest").msgclass
          MutateCustomerSkAdNetworkConversionValueSchemaResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateCustomerSkAdNetworkConversionValueSchemaResult").msgclass
          MutateCustomerSkAdNetworkConversionValueSchemaResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateCustomerSkAdNetworkConversionValueSchemaResponse").msgclass
        end
      end
    end
  end
