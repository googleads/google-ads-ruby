...
# source: google/ads/googleads/v22/services/multi_party_auth_review_service.proto
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Services
          ResolveMultiPartyAuthReviewRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.ResolveMultiPartyAuthReviewRequest").msgclass
          ResolveMultiPartyAuthReviewResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.ResolveMultiPartyAuthReviewResponse").msgclass
          ResolveMultiPartyAuthReviewOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.ResolveMultiPartyAuthReviewOperation").msgclass
          ResolveMultiPartyAuthReviewResultOrError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.ResolveMultiPartyAuthReviewResultOrError").msgclass
          ResolveMultiPartyAuthReviewResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.ResolveMultiPartyAuthReviewResult").msgclass
        end
      end
    end
  end
