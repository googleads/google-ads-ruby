...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v22.resources.CustomerUserAccess", "google/ads/googleads/v22/resources/customer_user_access.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Services
          MutateCustomerUserAccessRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateCustomerUserAccessRequest").msgclass
          CustomerUserAccessOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.CustomerUserAccessOperation").msgclass
          MutateCustomerUserAccessResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateCustomerUserAccessResponse").msgclass
          MutateCustomerUserAccessResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.services.MutateCustomerUserAccessResult").msgclass
        end
      end
    end
  end
