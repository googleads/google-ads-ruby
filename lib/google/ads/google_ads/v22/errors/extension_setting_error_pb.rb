...
module Google
  module Ads
    module GoogleAds
      module V22
        module Errors
          ExtensionSettingErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.errors.ExtensionSettingErrorEnum").msgclass
          ExtensionSettingErrorEnum::ExtensionSettingError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.errors.ExtensionSettingErrorEnum.ExtensionSettingError").enummodule
        end
      end
    end
  end
