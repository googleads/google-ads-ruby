...
module Google
  module Ads
    module GoogleAds
      module V22
        module Errors
          BatchJobErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.errors.BatchJobErrorEnum").msgclass
          BatchJobErrorEnum::BatchJobError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.errors.BatchJobErrorEnum.BatchJobError").enummodule
        end
      end
    end
  end
