...
module Google
  module Ads
    module GoogleAds
      module V22
        module Errors
          FeedItemSetErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.errors.FeedItemSetErrorEnum").msgclass
          FeedItemSetErrorEnum::FeedItemSetError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.errors.FeedItemSetErrorEnum.FeedItemSetError").enummodule
        end
      end
    end
  end
