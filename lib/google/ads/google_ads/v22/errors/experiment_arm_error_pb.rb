...
module Google
  module Ads
    module GoogleAds
      module V22
        module Errors
          ExperimentArmErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.errors.ExperimentArmErrorEnum").msgclass
          ExperimentArmErrorEnum::ExperimentArmError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.errors.ExperimentArmErrorEnum.ExperimentArmError").enummodule
        end
      end
    end
  end
