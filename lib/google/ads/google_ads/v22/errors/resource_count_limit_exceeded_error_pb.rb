...
module Google
  module Ads
    module GoogleAds
      module V22
        module Errors
          ResourceCountLimitExceededErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.errors.ResourceCountLimitExceededErrorEnum").msgclass
          ResourceCountLimitExceededErrorEnum::ResourceCountLimitExceededError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.errors.ResourceCountLimitExceededErrorEnum.ResourceCountLimitExceededError").enummodule
        end
      end
    end
  end
