...
module Google
  module Ads
    module GoogleAds
      module V22
        module Errors
          AssetErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.errors.AssetErrorEnum").msgclass
          AssetErrorEnum::AssetError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.errors.AssetErrorEnum.AssetError").enummodule
        end
      end
    end
  end
