...
module Google
  module Ads
    module GoogleAds
      module V22
        module Errors
          ConversionUploadErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.errors.ConversionUploadErrorEnum").msgclass
          ConversionUploadErrorEnum::ConversionUploadError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.errors.ConversionUploadErrorEnum.ConversionUploadError").enummodule
        end
      end
    end
  end
