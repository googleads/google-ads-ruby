...
# source: google/ads/googleads/v22/resources/experiment_arm.proto
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          ExperimentArm = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.ExperimentArm").msgclass
        end
      end
    end
  end
