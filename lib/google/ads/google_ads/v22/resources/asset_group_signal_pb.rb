...
require 'google/ads/google_ads/v22/enums/asset_group_signal_approval_status_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v22.common.AudienceInfo", "google/ads/googleads/v22/common/criteria.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          AssetGroupSignal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AssetGroupSignal").msgclass
        end
      end
    end
  end
