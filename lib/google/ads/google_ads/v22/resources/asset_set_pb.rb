...
begin
  ...
  imports = [
    ["google.ads.googleads.v22.common.LocationSet", "google/ads/googleads/v22/common/asset_set_types.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          AssetSet = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AssetSet").msgclass
          AssetSet::MerchantCenterFeed = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AssetSet.MerchantCenterFeed").msgclass
          AssetSet::HotelPropertyData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AssetSet.HotelPropertyData").msgclass
        end
      end
    end
  end
