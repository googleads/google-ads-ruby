...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          ProductLink = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.ProductLink").msgclass
          DataPartnerIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.DataPartnerIdentifier").msgclass
          GoogleAdsIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.GoogleAdsIdentifier").msgclass
          MerchantCenterIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.MerchantCenterIdentifier").msgclass
          AdvertisingPartnerIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AdvertisingPartnerIdentifier").msgclass
        end
      end
    end
  end
