...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          LandingPageView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.LandingPageView").msgclass
        end
      end
    end
  end
