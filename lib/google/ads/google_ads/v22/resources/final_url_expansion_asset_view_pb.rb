...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          FinalUrlExpansionAssetView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.FinalUrlExpansionAssetView").msgclass
        end
      end
    end
  end
