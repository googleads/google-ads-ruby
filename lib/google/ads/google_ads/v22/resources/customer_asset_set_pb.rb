...
require 'google/ads/google_ads/v22/enums/asset_set_link_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          CustomerAssetSet = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.CustomerAssetSet").msgclass
        end
      end
    end
  end
