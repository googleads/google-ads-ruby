...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v22.common.TargetingSetting", "google/ads/googleads/v22/common/targeting_setting.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          AdGroup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AdGroup").msgclass
          AdGroup::AudienceSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AdGroup.AudienceSetting").msgclass
          AdGroup::DemandGenAdGroupSettings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AdGroup.DemandGenAdGroupSettings").msgclass
          AdGroup::DemandGenAdGroupSettings::DemandGenChannelControls = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AdGroup.DemandGenAdGroupSettings.DemandGenChannelControls").msgclass
          AdGroup::DemandGenAdGroupSettings::DemandGenChannelControls::DemandGenSelectedChannels = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AdGroup.DemandGenAdGroupSettings.DemandGenChannelControls.DemandGenSelectedChannels").msgclass
          AdGroup::VideoAdGroupSettings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AdGroup.VideoAdGroupSettings").msgclass
          AdGroup::VideoAdGroupSettings::VideoAdSequenceStepSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AdGroup.VideoAdGroupSettings.VideoAdSequenceStepSetting").msgclass
          AdGroup::AiMaxAdGroupSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AdGroup.AiMaxAdGroupSetting").msgclass
        end
      end
    end
  end
