...
require 'google/ads/google_ads/v22/enums/conversion_custom_variable_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          ConversionCustomVariable = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.ConversionCustomVariable").msgclass
        end
      end
    end
  end
