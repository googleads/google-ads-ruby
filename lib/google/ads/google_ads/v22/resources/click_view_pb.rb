...
begin
  ...
  imports = [
    ["google.ads.googleads.v22.common.ClickLocation", "google/ads/googleads/v22/common/click_location.proto"],
    ["google.ads.googleads.v22.common.KeywordInfo", "google/ads/googleads/v22/common/criteria.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          ClickView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.ClickView").msgclass
        end
      end
    end
  end
