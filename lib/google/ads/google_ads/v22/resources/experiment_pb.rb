...
begin
  ...
  imports = [
    ["google.ads.googleads.v22.common.MetricGoal", "google/ads/googleads/v22/common/metric_goal.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          Experiment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.Experiment").msgclass
        end
      end
    end
  end
