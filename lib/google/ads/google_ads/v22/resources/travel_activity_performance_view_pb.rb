...
# source: google/ads/googleads/v22/resources/travel_activity_performance_view.proto
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          TravelActivityPerformanceView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.TravelActivityPerformanceView").msgclass
        end
      end
    end
  end
