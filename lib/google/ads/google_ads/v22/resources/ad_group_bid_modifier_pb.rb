...
require 'google/ads/google_ads/v22/enums/bid_modifier_source_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v22.common.HotelDateSelectionTypeInfo", "google/ads/googleads/v22/common/criteria.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          AdGroupBidModifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AdGroupBidModifier").msgclass
        end
      end
    end
  end
