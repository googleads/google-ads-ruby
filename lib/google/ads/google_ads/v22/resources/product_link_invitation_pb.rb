...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          ProductLinkInvitation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.ProductLinkInvitation").msgclass
          HotelCenterLinkInvitationIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.HotelCenterLinkInvitationIdentifier").msgclass
          MerchantCenterLinkInvitationIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.MerchantCenterLinkInvitationIdentifier").msgclass
          AdvertisingPartnerLinkInvitationIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AdvertisingPartnerLinkInvitationIdentifier").msgclass
        end
      end
    end
  end
