...
# source: google/ads/googleads/v22/resources/managed_placement_view.proto
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          ManagedPlacementView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.ManagedPlacementView").msgclass
        end
      end
    end
  end
