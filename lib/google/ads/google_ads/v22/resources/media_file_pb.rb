...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          MediaFile = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.MediaFile").msgclass
          MediaImage = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.MediaImage").msgclass
          MediaBundle = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.MediaBundle").msgclass
          MediaAudio = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.MediaAudio").msgclass
          MediaVideo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.MediaVideo").msgclass
        end
      end
    end
  end
