...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          HotelReconciliation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.HotelReconciliation").msgclass
        end
      end
    end
  end
