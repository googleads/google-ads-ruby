...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          GoogleAdsField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.GoogleAdsField").msgclass
        end
      end
    end
  end
