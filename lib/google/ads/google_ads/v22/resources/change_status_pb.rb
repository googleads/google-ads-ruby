...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          ChangeStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.ChangeStatus").msgclass
        end
      end
    end
  end
