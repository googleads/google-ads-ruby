...
require 'google/ads/google_ads/v22/enums/operating_system_version_operator_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          OperatingSystemVersionConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.OperatingSystemVersionConstant").msgclass
        end
      end
    end
  end
