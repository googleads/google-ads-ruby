...
require 'google/ads/google_ads/v22/errors/collection_size_error_pb'
require 'google/ads/google_ads/v22/errors/conversion_adjustment_upload_error_pb'
require 'google/ads/google_ads/v22/errors/conversion_upload_error_pb'
require 'google/ads/google_ads/v22/errors/date_error_pb'
require 'google/ads/google_ads/v22/errors/distinct_error_pb'
require 'google/ads/google_ads/v22/errors/field_error_pb'
require 'google/ads/google_ads/v22/errors/mutate_error_pb'
require 'google/ads/google_ads/v22/errors/not_allowlisted_error_pb'
require 'google/ads/google_ads/v22/errors/string_format_error_pb'
require 'google/ads/google_ads/v22/errors/string_length_error_pb'
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          OfflineConversionUploadClientSummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.OfflineConversionUploadClientSummary").msgclass
          OfflineConversionSummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.OfflineConversionSummary").msgclass
          OfflineConversionAlert = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.OfflineConversionAlert").msgclass
          OfflineConversionError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.OfflineConversionError").msgclass
        end
      end
    end
  end
