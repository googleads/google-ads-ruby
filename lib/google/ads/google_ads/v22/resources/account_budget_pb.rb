...
require 'google/ads/google_ads/v22/enums/account_budget_proposal_type_pb'
require 'google/ads/google_ads/v22/enums/account_budget_status_pb'
require 'google/ads/google_ads/v22/enums/spending_limit_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          AccountBudget = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AccountBudget").msgclass
          AccountBudget::PendingAccountBudgetProposal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AccountBudget.PendingAccountBudgetProposal").msgclass
        end
      end
    end
  end
