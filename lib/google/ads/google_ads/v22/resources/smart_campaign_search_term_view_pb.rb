...
# source: google/ads/googleads/v22/resources/smart_campaign_search_term_view.proto
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          SmartCampaignSearchTermView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.SmartCampaignSearchTermView").msgclass
        end
      end
    end
  end
