...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          CustomerUserAccess = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.CustomerUserAccess").msgclass
        end
      end
    end
  end
