...
require 'google/ads/google_ads/v22/enums/account_link_status_pb'
require 'google/ads/google_ads/v22/enums/linked_account_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          AccountLink = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AccountLink").msgclass
          ThirdPartyAppAnalyticsLinkIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.ThirdPartyAppAnalyticsLinkIdentifier").msgclass
        end
      end
    end
  end
