...
require 'google/ads/google_ads/v22/enums/offline_user_data_job_failure_reason_pb'
require 'google/ads/google_ads/v22/enums/offline_user_data_job_match_rate_range_pb'
require 'google/ads/google_ads/v22/enums/offline_user_data_job_status_pb'
require 'google/ads/google_ads/v22/enums/offline_user_data_job_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          OfflineUserDataJob = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.OfflineUserDataJob").msgclass
          OfflineUserDataJobMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.OfflineUserDataJobMetadata").msgclass
        end
      end
    end
  end
