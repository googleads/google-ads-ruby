...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          CustomerClient = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.CustomerClient").msgclass
        end
      end
    end
  end
