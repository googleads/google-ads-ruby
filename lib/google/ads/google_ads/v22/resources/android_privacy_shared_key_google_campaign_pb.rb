...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          AndroidPrivacySharedKeyGoogleCampaign = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AndroidPrivacySharedKeyGoogleCampaign").msgclass
        end
      end
    end
  end
