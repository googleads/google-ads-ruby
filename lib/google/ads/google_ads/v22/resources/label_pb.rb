...
begin
  ...
  imports = [
    ["google.ads.googleads.v22.common.TextLabel", "google/ads/googleads/v22/common/text_label.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          Label = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.Label").msgclass
        end
      end
    end
  end
