...
require 'google/ads/google_ads/v22/enums/user_list_customer_type_category_pb'
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          UserListCustomerType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.UserListCustomerType").msgclass
        end
      end
    end
  end
