...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          PerformanceMaxPlacementView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.PerformanceMaxPlacementView").msgclass
        end
      end
    end
  end
