...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          DetailContentSuitabilityPlacementView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.DetailContentSuitabilityPlacementView").msgclass
        end
      end
    end
  end
