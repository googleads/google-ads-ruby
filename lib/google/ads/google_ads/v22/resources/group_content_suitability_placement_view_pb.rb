...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          GroupContentSuitabilityPlacementView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.GroupContentSuitabilityPlacementView").msgclass
        end
      end
    end
  end
