...
require 'google/ads/google_ads/v22/enums/account_budget_proposal_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          AccountBudgetProposal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AccountBudgetProposal").msgclass
        end
      end
    end
  end
