...
require 'google/ads/google_ads/v22/enums/combined_audience_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          CombinedAudience = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.CombinedAudience").msgclass
        end
      end
    end
  end
