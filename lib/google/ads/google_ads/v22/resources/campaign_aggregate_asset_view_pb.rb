...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          CampaignAggregateAssetView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.CampaignAggregateAssetView").msgclass
        end
      end
    end
  end
