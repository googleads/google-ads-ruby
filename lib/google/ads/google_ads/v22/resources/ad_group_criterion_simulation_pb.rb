...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          AdGroupCriterionSimulation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AdGroupCriterionSimulation").msgclass
        end
      end
    end
  end
