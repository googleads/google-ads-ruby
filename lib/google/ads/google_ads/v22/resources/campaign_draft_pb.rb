...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          CampaignDraft = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.CampaignDraft").msgclass
        end
      end
    end
  end
