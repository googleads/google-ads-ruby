...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          TopicConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.TopicConstant").msgclass
        end
      end
    end
  end
