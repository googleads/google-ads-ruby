...
require 'google/ads/google_ads/v22/common/asset_types_pb'
...
require 'google/ads/google_ads/v22/enums/asset_type_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v22.common.YoutubeVideoAsset", "google/ads/googleads/v22/common/asset_types.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          Asset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.Asset").msgclass
          AssetFieldTypePolicySummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AssetFieldTypePolicySummary").msgclass
          AssetPolicySummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AssetPolicySummary").msgclass
        end
      end
    end
  end
