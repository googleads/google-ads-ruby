...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          CampaignBudget = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.CampaignBudget").msgclass
        end
      end
    end
  end
