...
begin
  ...
  imports = [
    ["google.ads.googleads.v22.common.CriterionCategoryAvailability", "google/ads/googleads/v22/common/criterion_category_availability.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          UserInterest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.UserInterest").msgclass
        end
      end
    end
  end
