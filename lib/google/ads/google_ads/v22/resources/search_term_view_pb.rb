...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          SearchTermView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.SearchTermView").msgclass
        end
      end
    end
  end
