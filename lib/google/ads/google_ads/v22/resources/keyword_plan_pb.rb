...
begin
  ...
  imports = [
    ["google.ads.googleads.v22.common.DateRange", "google/ads/googleads/v22/common/dates.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          KeywordPlan = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.KeywordPlan").msgclass
          KeywordPlanForecastPeriod = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.KeywordPlanForecastPeriod").msgclass
        end
      end
    end
  end
