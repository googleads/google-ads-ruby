...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          AiMaxSearchTermAdCombinationView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AiMaxSearchTermAdCombinationView").msgclass
        end
      end
    end
  end
