...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          AdGroupLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AdGroupLabel").msgclass
        end
      end
    end
  end
