...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          AdGroupAdLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AdGroupAdLabel").msgclass
        end
      end
    end
  end
