...
require 'google/ads/google_ads/v22/enums/customizer_attribute_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          CustomizerAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.CustomizerAttribute").msgclass
        end
      end
    end
  end
