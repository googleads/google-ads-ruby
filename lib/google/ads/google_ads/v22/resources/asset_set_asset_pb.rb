...
require 'google/ads/google_ads/v22/enums/asset_set_asset_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          AssetSetAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AssetSetAsset").msgclass
        end
      end
    end
  end
