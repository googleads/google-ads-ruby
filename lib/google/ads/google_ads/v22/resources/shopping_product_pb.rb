...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          ShoppingProduct = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.ShoppingProduct").msgclass
          ShoppingProduct::ProductIssue = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.ShoppingProduct.ProductIssue").msgclass
        end
      end
    end
  end
