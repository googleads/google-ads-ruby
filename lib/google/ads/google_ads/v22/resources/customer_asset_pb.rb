...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          CustomerAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.CustomerAsset").msgclass
        end
      end
    end
  end
