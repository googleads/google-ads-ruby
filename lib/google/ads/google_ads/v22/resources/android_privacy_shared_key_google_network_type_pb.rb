...
require 'google/ads/google_ads/v22/enums/android_privacy_interaction_type_pb'
require 'google/ads/google_ads/v22/enums/android_privacy_network_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          AndroidPrivacySharedKeyGoogleNetworkType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AndroidPrivacySharedKeyGoogleNetworkType").msgclass
        end
      end
    end
  end
