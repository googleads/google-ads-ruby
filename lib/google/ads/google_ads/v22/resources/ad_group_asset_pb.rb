...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          AdGroupAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.AdGroupAsset").msgclass
        end
      end
    end
  end
