...
begin
  ...
  imports = [
    ["google.ads.googleads.v22.common.InteractionTypeInfo", "google/ads/googleads/v22/common/criteria.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          CampaignBidModifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.CampaignBidModifier").msgclass
        end
      end
    end
  end
