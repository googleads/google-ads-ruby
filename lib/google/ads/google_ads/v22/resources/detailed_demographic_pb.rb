...
# source: google/ads/googleads/v22/resources/detailed_demographic.proto
...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          DetailedDemographic = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.DetailedDemographic").msgclass
        end
      end
    end
  end
