...
module Google
  module Ads
    module GoogleAds
      module V22
        module Resources
          SharedSet = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.resources.SharedSet").msgclass
        end
      end
    end
  end
