...
module Google
  module Ads
    module GoogleAds
      module V22
        module Enums
          CustomerPayPerConversionEligibilityFailureReasonEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.enums.CustomerPayPerConversionEligibilityFailureReasonEnum").msgclass
          CustomerPayPerConversionEligibilityFailureReasonEnum::CustomerPayPerConversionEligibilityFailureReason = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.enums.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason").enummodule
        end
      end
    end
  end
