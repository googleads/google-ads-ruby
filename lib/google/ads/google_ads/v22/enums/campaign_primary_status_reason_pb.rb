...
module Google
  module Ads
    module GoogleAds
      module V22
        module Enums
          CampaignPrimaryStatusReasonEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.enums.CampaignPrimaryStatusReasonEnum").msgclass
          CampaignPrimaryStatusReasonEnum::CampaignPrimaryStatusReason = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.enums.CampaignPrimaryStatusReasonEnum.CampaignPrimaryStatusReason").enummodule
        end
      end
    end
  end
