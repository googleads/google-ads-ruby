...
module Google
  module Ads
    module GoogleAds
      module V22
        module Enums
          AdGroupCriterionPrimaryStatusReasonEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.enums.AdGroupCriterionPrimaryStatusReasonEnum").msgclass
          AdGroupCriterionPrimaryStatusReasonEnum::AdGroupCriterionPrimaryStatusReason = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.enums.AdGroupCriterionPrimaryStatusReasonEnum.AdGroupCriterionPrimaryStatusReason").enummodule
        end
      end
    end
  end
