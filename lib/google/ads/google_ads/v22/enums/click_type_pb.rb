...
module Google
  module Ads
    module GoogleAds
      module V22
        module Enums
          ClickTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.enums.ClickTypeEnum").msgclass
          ClickTypeEnum::ClickType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.enums.ClickTypeEnum.ClickType").enummodule
        end
      end
    end
  end
