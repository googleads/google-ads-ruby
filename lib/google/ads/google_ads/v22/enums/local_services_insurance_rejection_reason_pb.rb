...
module Google
  module Ads
    module GoogleAds
      module V22
        module Enums
          LocalServicesInsuranceRejectionReasonEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.enums.LocalServicesInsuranceRejectionReasonEnum").msgclass
          LocalServicesInsuranceRejectionReasonEnum::LocalServicesInsuranceRejectionReason = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.enums.LocalServicesInsuranceRejectionReasonEnum.LocalServicesInsuranceRejectionReason").enummodule
        end
      end
    end
  end
