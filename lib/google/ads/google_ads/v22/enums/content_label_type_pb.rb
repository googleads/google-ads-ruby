...
module Google
  module Ads
    module GoogleAds
      module V22
        module Enums
          ContentLabelTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.enums.ContentLabelTypeEnum").msgclass
          ContentLabelTypeEnum::ContentLabelType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.enums.ContentLabelTypeEnum.ContentLabelType").enummodule
        end
      end
    end
  end
