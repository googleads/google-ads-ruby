...
module Google
  module Ads
    module GoogleAds
      module V22
        module Enums
          PromotionExtensionOccasionEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.enums.PromotionExtensionOccasionEnum").msgclass
          PromotionExtensionOccasionEnum::PromotionExtensionOccasion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v22.enums.PromotionExtensionOccasionEnum.PromotionExtensionOccasion").enummodule
        end
      end
    end
  end
