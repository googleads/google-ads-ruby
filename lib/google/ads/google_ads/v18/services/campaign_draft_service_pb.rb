...
require 'google/ads/google_ads/v18/resources/campaign_draft_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.resources.CampaignDraft", "google/ads/googleads/v18/resources/campaign_draft.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateCampaignDraftsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCampaignDraftsRequest").msgclass
          PromoteCampaignDraftRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.PromoteCampaignDraftRequest").msgclass
          CampaignDraftOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.CampaignDraftOperation").msgclass
          MutateCampaignDraftsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCampaignDraftsResponse").msgclass
          MutateCampaignDraftResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCampaignDraftResult").msgclass
          ListCampaignDraftAsyncErrorsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.ListCampaignDraftAsyncErrorsRequest").msgclass
          ListCampaignDraftAsyncErrorsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.ListCampaignDraftAsyncErrorsResponse").msgclass
        end
      end
    end
  end
