...
require 'google/ads/google_ads/v18/resources/user_list_customer_type_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v18.resources.UserListCustomerType", "google/ads/googleads/v18/resources/user_list_customer_type.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateUserListCustomerTypesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateUserListCustomerTypesRequest").msgclass
          UserListCustomerTypeOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.UserListCustomerTypeOperation").msgclass
          MutateUserListCustomerTypesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateUserListCustomerTypesResponse").msgclass
          MutateUserListCustomerTypeResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateUserListCustomerTypeResult").msgclass
        end
      end
    end
  end
