...
require 'google/ads/google_ads/v18/resources/ad_group_ad_label_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v18.resources.AdGroupAdLabel", "google/ads/googleads/v18/resources/ad_group_ad_label.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateAdGroupAdLabelsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAdGroupAdLabelsRequest").msgclass
          AdGroupAdLabelOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.AdGroupAdLabelOperation").msgclass
          MutateAdGroupAdLabelsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAdGroupAdLabelsResponse").msgclass
          MutateAdGroupAdLabelResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAdGroupAdLabelResult").msgclass
        end
      end
    end
  end
