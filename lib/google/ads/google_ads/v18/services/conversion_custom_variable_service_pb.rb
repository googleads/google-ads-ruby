...
require 'google/ads/google_ads/v18/resources/conversion_custom_variable_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.resources.ConversionCustomVariable", "google/ads/googleads/v18/resources/conversion_custom_variable.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateConversionCustomVariablesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateConversionCustomVariablesRequest").msgclass
          ConversionCustomVariableOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.ConversionCustomVariableOperation").msgclass
          MutateConversionCustomVariablesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateConversionCustomVariablesResponse").msgclass
          MutateConversionCustomVariableResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateConversionCustomVariableResult").msgclass
        end
      end
    end
  end
