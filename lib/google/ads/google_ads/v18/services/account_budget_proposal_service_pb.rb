...
require 'google/ads/google_ads/v18/resources/account_budget_proposal_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.resources.AccountBudgetProposal", "google/ads/googleads/v18/resources/account_budget_proposal.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateAccountBudgetProposalRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAccountBudgetProposalRequest").msgclass
          AccountBudgetProposalOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.AccountBudgetProposalOperation").msgclass
          MutateAccountBudgetProposalResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAccountBudgetProposalResponse").msgclass
          MutateAccountBudgetProposalResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAccountBudgetProposalResult").msgclass
        end
      end
    end
  end
