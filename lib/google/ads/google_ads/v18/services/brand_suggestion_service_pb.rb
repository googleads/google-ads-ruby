...
require 'google/ads/google_ads/v18/enums/brand_state_pb'
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          SuggestBrandsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.SuggestBrandsRequest").msgclass
          SuggestBrandsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.SuggestBrandsResponse").msgclass
          BrandSuggestion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.BrandSuggestion").msgclass
        end
      end
    end
  end
