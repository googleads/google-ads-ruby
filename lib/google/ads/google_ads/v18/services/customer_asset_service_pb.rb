...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateCustomerAssetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCustomerAssetsRequest").msgclass
          CustomerAssetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.CustomerAssetOperation").msgclass
          MutateCustomerAssetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCustomerAssetsResponse").msgclass
          MutateCustomerAssetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCustomerAssetResult").msgclass
        end
      end
    end
  end
