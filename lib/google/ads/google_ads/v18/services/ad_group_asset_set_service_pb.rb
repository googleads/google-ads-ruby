...
require 'google/ads/google_ads/v18/resources/ad_group_asset_set_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v18.resources.AdGroupAssetSet", "google/ads/googleads/v18/resources/ad_group_asset_set.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateAdGroupAssetSetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAdGroupAssetSetsRequest").msgclass
          AdGroupAssetSetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.AdGroupAssetSetOperation").msgclass
          MutateAdGroupAssetSetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAdGroupAssetSetsResponse").msgclass
          MutateAdGroupAssetSetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAdGroupAssetSetResult").msgclass
        end
      end
    end
  end
