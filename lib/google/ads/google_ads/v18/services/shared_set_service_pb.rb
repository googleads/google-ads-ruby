...
require 'google/ads/google_ads/v18/resources/shared_set_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.resources.SharedSet", "google/ads/googleads/v18/resources/shared_set.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateSharedSetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateSharedSetsRequest").msgclass
          SharedSetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.SharedSetOperation").msgclass
          MutateSharedSetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateSharedSetsResponse").msgclass
          MutateSharedSetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateSharedSetResult").msgclass
        end
      end
    end
  end
