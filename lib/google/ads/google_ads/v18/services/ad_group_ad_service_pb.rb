...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.common.PolicyValidationParameter", "google/ads/googleads/v18/common/policy.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateAdGroupAdsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAdGroupAdsRequest").msgclass
          AdGroupAdOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.AdGroupAdOperation").msgclass
          MutateAdGroupAdsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAdGroupAdsResponse").msgclass
          MutateAdGroupAdResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAdGroupAdResult").msgclass
          RemoveAutomaticallyCreatedAssetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.RemoveAutomaticallyCreatedAssetsRequest").msgclass
          AssetsWithFieldType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.AssetsWithFieldType").msgclass
        end
      end
    end
  end
