...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.common.PolicyViolationKey", "google/ads/googleads/v18/common/policy.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateAdGroupCriteriaRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAdGroupCriteriaRequest").msgclass
          AdGroupCriterionOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.AdGroupCriterionOperation").msgclass
          MutateAdGroupCriteriaResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAdGroupCriteriaResponse").msgclass
          MutateAdGroupCriterionResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAdGroupCriterionResult").msgclass
        end
      end
    end
  end
