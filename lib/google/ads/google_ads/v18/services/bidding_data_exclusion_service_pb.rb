...
require 'google/ads/google_ads/v18/resources/bidding_data_exclusion_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.resources.BiddingDataExclusion", "google/ads/googleads/v18/resources/bidding_data_exclusion.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateBiddingDataExclusionsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateBiddingDataExclusionsRequest").msgclass
          BiddingDataExclusionOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.BiddingDataExclusionOperation").msgclass
          MutateBiddingDataExclusionsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateBiddingDataExclusionsResponse").msgclass
          MutateBiddingDataExclusionsResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateBiddingDataExclusionsResult").msgclass
        end
      end
    end
  end
