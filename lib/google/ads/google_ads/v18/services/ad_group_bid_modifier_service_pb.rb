...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateAdGroupBidModifiersRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAdGroupBidModifiersRequest").msgclass
          AdGroupBidModifierOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.AdGroupBidModifierOperation").msgclass
          MutateAdGroupBidModifiersResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAdGroupBidModifiersResponse").msgclass
          MutateAdGroupBidModifierResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAdGroupBidModifierResult").msgclass
        end
      end
    end
  end
