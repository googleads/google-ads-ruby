...
require 'google/ads/google_ads/v18/enums/access_role_pb'
require 'google/ads/google_ads/v18/enums/response_content_type_pb'
require 'google/ads/google_ads/v18/resources/customer_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v18.resources.Customer", "google/ads/googleads/v18/resources/customer.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateCustomerRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCustomerRequest").msgclass
          CreateCustomerClientRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.CreateCustomerClientRequest").msgclass
          CustomerOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.CustomerOperation").msgclass
          CreateCustomerClientResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.CreateCustomerClientResponse").msgclass
          MutateCustomerResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCustomerResponse").msgclass
          MutateCustomerResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCustomerResult").msgclass
          ListAccessibleCustomersRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.ListAccessibleCustomersRequest").msgclass
          ListAccessibleCustomersResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.ListAccessibleCustomersResponse").msgclass
        end
      end
    end
  end
