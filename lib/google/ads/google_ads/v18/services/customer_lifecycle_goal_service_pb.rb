...
require 'google/ads/google_ads/v18/resources/customer_lifecycle_goal_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.resources.CustomerLifecycleGoal", "google/ads/googleads/v18/resources/customer_lifecycle_goal.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          ConfigureCustomerLifecycleGoalsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.ConfigureCustomerLifecycleGoalsRequest").msgclass
          CustomerLifecycleGoalOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.CustomerLifecycleGoalOperation").msgclass
          ConfigureCustomerLifecycleGoalsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.ConfigureCustomerLifecycleGoalsResponse").msgclass
          ConfigureCustomerLifecycleGoalsResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.ConfigureCustomerLifecycleGoalsResult").msgclass
        end
      end
    end
  end
