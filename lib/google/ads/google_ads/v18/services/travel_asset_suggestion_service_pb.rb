...
require 'google/ads/google_ads/v18/enums/call_to_action_type_pb'
require 'google/ads/google_ads/v18/enums/hotel_asset_suggestion_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          SuggestTravelAssetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.SuggestTravelAssetsRequest").msgclass
          SuggestTravelAssetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.SuggestTravelAssetsResponse").msgclass
          HotelAssetSuggestion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.HotelAssetSuggestion").msgclass
          HotelTextAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.HotelTextAsset").msgclass
          HotelImageAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.HotelImageAsset").msgclass
        end
      end
    end
  end
