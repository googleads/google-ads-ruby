        ...
        module Services
          module KeywordPlanIdeaService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V18::Services::KeywordPlanIdeaService::Client::Configuration}
              ...
              #   {::Google::Ads::GoogleAds::V18::Services::GenerateKeywordIdeasRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V18::Services::GenerateKeywordIdeasRequest, ::Hash]
              ...
              #   @param keyword_plan_network [::Google::Ads::GoogleAds::V18::Enums::KeywordPlanNetworkEnum::KeywordPlanNetwork]
              #     Targeting network.
              #     If not set, Google Search And Partners Network will be used.
              #   @param keyword_annotation [::Array<::Google::Ads::GoogleAds::V18::Enums::KeywordPlanKeywordAnnotationEnum::KeywordPlanKeywordAnnotation>]
              #     The keyword annotations to include in response.
              #   @param aggregate_metrics [::Google::Ads::GoogleAds::V18::Common::KeywordPlanAggregateMetrics, ::Hash]
              #     The aggregate fields to include in response.
              #   @param historical_metrics_options [::Google::Ads::GoogleAds::V18::Common::HistoricalMetricsOptions, ::Hash]
              ...
              #
              # @return [::Gapic::PagedEnumerable<::Google::Ads::GoogleAds::V18::Services::GenerateKeywordIdeaResult>]
              #
              ...
              #   {::Google::Ads::GoogleAds::V18::Services::GenerateKeywordHistoricalMetricsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V18::Services::GenerateKeywordHistoricalMetricsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V18::Services::GenerateKeywordHistoricalMetricsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V18::Services::GenerateKeywordHistoricalMetricsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #   {::Google::Ads::GoogleAds::V18::Services::GenerateAdGroupThemesRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V18::Services::GenerateAdGroupThemesRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V18::Services::GenerateAdGroupThemesResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V18::Services::GenerateAdGroupThemesResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #   {::Google::Ads::GoogleAds::V18::Services::GenerateKeywordForecastMetricsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V18::Services::GenerateKeywordForecastMetricsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param forecast_period [::Google::Ads::GoogleAds::V18::Common::DateRange, ::Hash]
              ...
              #   @param campaign [::Google::Ads::GoogleAds::V18::Services::CampaignToForecast, ::Hash]
              #     Required. The campaign used in the forecast.
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V18::Services::GenerateKeywordForecastMetricsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V18::Services::GenerateKeywordForecastMetricsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              # {::Google::Ads::GoogleAds::V18::Services::KeywordPlanIdeaService::Client::Configuration::Rpcs}
