...
require 'google/ads/google_ads/v18/enums/conversion_adjustment_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          UploadConversionAdjustmentsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.UploadConversionAdjustmentsRequest").msgclass
          UploadConversionAdjustmentsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.UploadConversionAdjustmentsResponse").msgclass
          ConversionAdjustment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.ConversionAdjustment").msgclass
          RestatementValue = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.RestatementValue").msgclass
          GclidDateTimePair = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.GclidDateTimePair").msgclass
          ConversionAdjustmentResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.ConversionAdjustmentResult").msgclass
        end
      end
    end
  end
