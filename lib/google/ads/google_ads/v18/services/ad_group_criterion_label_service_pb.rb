...
require 'google/ads/google_ads/v18/resources/ad_group_criterion_label_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v18.resources.AdGroupCriterionLabel", "google/ads/googleads/v18/resources/ad_group_criterion_label.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateAdGroupCriterionLabelsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAdGroupCriterionLabelsRequest").msgclass
          AdGroupCriterionLabelOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.AdGroupCriterionLabelOperation").msgclass
          MutateAdGroupCriterionLabelsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAdGroupCriterionLabelsResponse").msgclass
          MutateAdGroupCriterionLabelResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAdGroupCriterionLabelResult").msgclass
        end
      end
    end
  end
