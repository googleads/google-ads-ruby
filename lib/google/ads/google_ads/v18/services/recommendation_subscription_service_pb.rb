...
require 'google/ads/google_ads/v18/resources/recommendation_subscription_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.resources.RecommendationSubscription", "google/ads/googleads/v18/resources/recommendation_subscription.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateRecommendationSubscriptionRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateRecommendationSubscriptionRequest").msgclass
          RecommendationSubscriptionOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.RecommendationSubscriptionOperation").msgclass
          MutateRecommendationSubscriptionResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateRecommendationSubscriptionResponse").msgclass
          MutateRecommendationSubscriptionResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateRecommendationSubscriptionResult").msgclass
        end
      end
    end
  end
