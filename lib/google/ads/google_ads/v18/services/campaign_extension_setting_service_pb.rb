...
require 'google/ads/google_ads/v18/resources/campaign_extension_setting_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.resources.CampaignExtensionSetting", "google/ads/googleads/v18/resources/campaign_extension_setting.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateCampaignExtensionSettingsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCampaignExtensionSettingsRequest").msgclass
          CampaignExtensionSettingOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.CampaignExtensionSettingOperation").msgclass
          MutateCampaignExtensionSettingsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCampaignExtensionSettingsResponse").msgclass
          MutateCampaignExtensionSettingResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCampaignExtensionSettingResult").msgclass
        end
      end
    end
  end
