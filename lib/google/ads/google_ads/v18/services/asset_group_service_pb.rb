...
require 'google/ads/google_ads/v18/resources/asset_group_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.resources.AssetGroup", "google/ads/googleads/v18/resources/asset_group.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateAssetGroupsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAssetGroupsRequest").msgclass
          AssetGroupOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.AssetGroupOperation").msgclass
          MutateAssetGroupsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAssetGroupsResponse").msgclass
          MutateAssetGroupResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAssetGroupResult").msgclass
        end
      end
    end
  end
