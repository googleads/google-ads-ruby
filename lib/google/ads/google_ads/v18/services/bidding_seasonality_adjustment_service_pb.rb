...
require 'google/ads/google_ads/v18/resources/bidding_seasonality_adjustment_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.resources.BiddingSeasonalityAdjustment", "google/ads/googleads/v18/resources/bidding_seasonality_adjustment.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateBiddingSeasonalityAdjustmentsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateBiddingSeasonalityAdjustmentsRequest").msgclass
          BiddingSeasonalityAdjustmentOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.BiddingSeasonalityAdjustmentOperation").msgclass
          MutateBiddingSeasonalityAdjustmentsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateBiddingSeasonalityAdjustmentsResponse").msgclass
          MutateBiddingSeasonalityAdjustmentsResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateBiddingSeasonalityAdjustmentsResult").msgclass
        end
      end
    end
  end
