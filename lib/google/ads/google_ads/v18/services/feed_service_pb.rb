...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateFeedsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateFeedsRequest").msgclass
          FeedOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.FeedOperation").msgclass
          MutateFeedsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateFeedsResponse").msgclass
          MutateFeedResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateFeedResult").msgclass
        end
      end
    end
  end
