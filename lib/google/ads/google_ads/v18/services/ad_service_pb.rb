...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateAdsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAdsRequest").msgclass
          AdOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.AdOperation").msgclass
          MutateAdsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAdsResponse").msgclass
          MutateAdResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAdResult").msgclass
        end
      end
    end
  end
