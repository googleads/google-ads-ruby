...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateAdGroupAssetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAdGroupAssetsRequest").msgclass
          AdGroupAssetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.AdGroupAssetOperation").msgclass
          MutateAdGroupAssetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAdGroupAssetsResponse").msgclass
          MutateAdGroupAssetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAdGroupAssetResult").msgclass
        end
      end
    end
  end
