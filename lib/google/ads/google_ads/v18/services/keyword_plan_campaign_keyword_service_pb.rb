...
require 'google/ads/google_ads/v18/resources/keyword_plan_campaign_keyword_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.resources.KeywordPlanCampaignKeyword", "google/ads/googleads/v18/resources/keyword_plan_campaign_keyword.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateKeywordPlanCampaignKeywordsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateKeywordPlanCampaignKeywordsRequest").msgclass
          KeywordPlanCampaignKeywordOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.KeywordPlanCampaignKeywordOperation").msgclass
          MutateKeywordPlanCampaignKeywordsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateKeywordPlanCampaignKeywordsResponse").msgclass
          MutateKeywordPlanCampaignKeywordResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateKeywordPlanCampaignKeywordResult").msgclass
        end
      end
    end
  end
