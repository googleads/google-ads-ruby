...
require 'google/ads/google_ads/v18/enums/smart_campaign_not_eligible_reason_pb'
require 'google/ads/google_ads/v18/enums/smart_campaign_status_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v18.resources.SmartCampaignSetting", "google/ads/googleads/v18/resources/smart_campaign_setting.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          GetSmartCampaignStatusRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.GetSmartCampaignStatusRequest").msgclass
          SmartCampaignNotEligibleDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.SmartCampaignNotEligibleDetails").msgclass
          SmartCampaignEligibleDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.SmartCampaignEligibleDetails").msgclass
          SmartCampaignPausedDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.SmartCampaignPausedDetails").msgclass
          SmartCampaignRemovedDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.SmartCampaignRemovedDetails").msgclass
          SmartCampaignEndedDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.SmartCampaignEndedDetails").msgclass
          GetSmartCampaignStatusResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.GetSmartCampaignStatusResponse").msgclass
          MutateSmartCampaignSettingsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateSmartCampaignSettingsRequest").msgclass
          SmartCampaignSettingOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.SmartCampaignSettingOperation").msgclass
          MutateSmartCampaignSettingsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateSmartCampaignSettingsResponse").msgclass
          MutateSmartCampaignSettingResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateSmartCampaignSettingResult").msgclass
        end
      end
    end
  end
