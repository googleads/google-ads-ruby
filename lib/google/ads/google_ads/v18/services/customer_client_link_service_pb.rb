...
require 'google/ads/google_ads/v18/resources/customer_client_link_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.resources.CustomerClientLink", "google/ads/googleads/v18/resources/customer_client_link.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateCustomerClientLinkRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCustomerClientLinkRequest").msgclass
          CustomerClientLinkOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.CustomerClientLinkOperation").msgclass
          MutateCustomerClientLinkResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCustomerClientLinkResponse").msgclass
          MutateCustomerClientLinkResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCustomerClientLinkResult").msgclass
        end
      end
    end
  end
