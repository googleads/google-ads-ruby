...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          GenerateShareablePreviewsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.GenerateShareablePreviewsRequest").msgclass
          ShareablePreview = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.ShareablePreview").msgclass
          AssetGroupIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.AssetGroupIdentifier").msgclass
          GenerateShareablePreviewsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.GenerateShareablePreviewsResponse").msgclass
          ShareablePreviewOrError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.ShareablePreviewOrError").msgclass
          ShareablePreviewResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.ShareablePreviewResult").msgclass
        end
      end
    end
  end
