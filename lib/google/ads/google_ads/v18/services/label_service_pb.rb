...
require 'google/ads/google_ads/v18/resources/label_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.resources.Label", "google/ads/googleads/v18/resources/label.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateLabelsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateLabelsRequest").msgclass
          LabelOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.LabelOperation").msgclass
          MutateLabelsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateLabelsResponse").msgclass
          MutateLabelResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateLabelResult").msgclass
        end
      end
    end
  end
