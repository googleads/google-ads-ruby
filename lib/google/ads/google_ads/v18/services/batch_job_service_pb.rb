...
require 'google/ads/google_ads/v18/resources/batch_job_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v18.resources.BatchJob", "google/ads/googleads/v18/resources/batch_job.proto"],
    ["google.ads.googleads.v18.services.MutateOperation", "google/ads/googleads/v18/services/google_ads_service.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateBatchJobRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateBatchJobRequest").msgclass
          BatchJobOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.BatchJobOperation").msgclass
          MutateBatchJobResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateBatchJobResponse").msgclass
          MutateBatchJobResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateBatchJobResult").msgclass
          RunBatchJobRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.RunBatchJobRequest").msgclass
          AddBatchJobOperationsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.AddBatchJobOperationsRequest").msgclass
          AddBatchJobOperationsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.AddBatchJobOperationsResponse").msgclass
          ListBatchJobResultsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.ListBatchJobResultsRequest").msgclass
          ListBatchJobResultsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.ListBatchJobResultsResponse").msgclass
          BatchJobResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.BatchJobResult").msgclass
        end
      end
    end
  end
