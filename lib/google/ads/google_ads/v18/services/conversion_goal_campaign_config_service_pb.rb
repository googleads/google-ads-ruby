...
require 'google/ads/google_ads/v18/resources/conversion_goal_campaign_config_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.resources.ConversionGoalCampaignConfig", "google/ads/googleads/v18/resources/conversion_goal_campaign_config.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateConversionGoalCampaignConfigsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateConversionGoalCampaignConfigsRequest").msgclass
          ConversionGoalCampaignConfigOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.ConversionGoalCampaignConfigOperation").msgclass
          MutateConversionGoalCampaignConfigsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateConversionGoalCampaignConfigsResponse").msgclass
          MutateConversionGoalCampaignConfigResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateConversionGoalCampaignConfigResult").msgclass
        end
      end
    end
  end
