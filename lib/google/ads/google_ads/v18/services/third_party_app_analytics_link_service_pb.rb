...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          RegenerateShareableLinkIdRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.RegenerateShareableLinkIdRequest").msgclass
          RegenerateShareableLinkIdResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.RegenerateShareableLinkIdResponse").msgclass
        end
      end
    end
  end
