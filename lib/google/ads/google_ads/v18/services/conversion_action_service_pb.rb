...
require 'google/ads/google_ads/v18/resources/conversion_action_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.resources.ConversionAction", "google/ads/googleads/v18/resources/conversion_action.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateConversionActionsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateConversionActionsRequest").msgclass
          ConversionActionOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.ConversionActionOperation").msgclass
          MutateConversionActionsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateConversionActionsResponse").msgclass
          MutateConversionActionResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateConversionActionResult").msgclass
        end
      end
    end
  end
