...
require 'google/ads/google_ads/v18/resources/feed_item_set_link_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v18.resources.FeedItemSetLink", "google/ads/googleads/v18/resources/feed_item_set_link.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateFeedItemSetLinksRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateFeedItemSetLinksRequest").msgclass
          FeedItemSetLinkOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.FeedItemSetLinkOperation").msgclass
          MutateFeedItemSetLinksResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateFeedItemSetLinksResponse").msgclass
          MutateFeedItemSetLinkResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateFeedItemSetLinkResult").msgclass
        end
      end
    end
  end
