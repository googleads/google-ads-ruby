...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.resources.AssetGroupSignal", "google/ads/googleads/v18/resources/asset_group_signal.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateAssetGroupSignalsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAssetGroupSignalsRequest").msgclass
          AssetGroupSignalOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.AssetGroupSignalOperation").msgclass
          MutateAssetGroupSignalsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAssetGroupSignalsResponse").msgclass
          MutateAssetGroupSignalResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAssetGroupSignalResult").msgclass
        end
      end
    end
  end
