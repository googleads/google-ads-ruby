...
require 'google/ads/google_ads/v18/resources/customer_manager_link_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.resources.CustomerManagerLink", "google/ads/googleads/v18/resources/customer_manager_link.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateCustomerManagerLinkRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCustomerManagerLinkRequest").msgclass
          MoveManagerLinkRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MoveManagerLinkRequest").msgclass
          CustomerManagerLinkOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.CustomerManagerLinkOperation").msgclass
          MutateCustomerManagerLinkResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCustomerManagerLinkResponse").msgclass
          MoveManagerLinkResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MoveManagerLinkResponse").msgclass
          MutateCustomerManagerLinkResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCustomerManagerLinkResult").msgclass
        end
      end
    end
  end
