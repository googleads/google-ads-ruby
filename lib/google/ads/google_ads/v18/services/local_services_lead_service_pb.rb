...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          AppendLeadConversationRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.AppendLeadConversationRequest").msgclass
          AppendLeadConversationResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.AppendLeadConversationResponse").msgclass
          Conversation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.Conversation").msgclass
          ConversationOrError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.ConversationOrError").msgclass
        end
      end
    end
  end
