...
begin
  ...
  imports = [
    ["google.ads.googleads.v18.common.CustomerMatchUserListMetadata", "google/ads/googleads/v18/common/offline_user_data.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          UploadUserDataRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.UploadUserDataRequest").msgclass
          UserDataOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.UserDataOperation").msgclass
          UploadUserDataResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.UploadUserDataResponse").msgclass
        end
      end
    end
  end
