...
require 'google/ads/google_ads/v18/resources/experiment_arm_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.resources.ExperimentArm", "google/ads/googleads/v18/resources/experiment_arm.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateExperimentArmsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateExperimentArmsRequest").msgclass
          ExperimentArmOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.ExperimentArmOperation").msgclass
          MutateExperimentArmsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateExperimentArmsResponse").msgclass
          MutateExperimentArmResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateExperimentArmResult").msgclass
        end
      end
    end
  end
