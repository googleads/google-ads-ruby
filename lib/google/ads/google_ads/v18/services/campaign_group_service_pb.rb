...
require 'google/ads/google_ads/v18/resources/campaign_group_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.resources.CampaignGroup", "google/ads/googleads/v18/resources/campaign_group.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateCampaignGroupsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCampaignGroupsRequest").msgclass
          CampaignGroupOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.CampaignGroupOperation").msgclass
          MutateCampaignGroupsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCampaignGroupsResponse").msgclass
          MutateCampaignGroupResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCampaignGroupResult").msgclass
        end
      end
    end
  end
