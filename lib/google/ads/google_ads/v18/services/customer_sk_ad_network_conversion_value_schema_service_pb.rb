...
require 'google/ads/google_ads/v18/resources/customer_sk_ad_network_conversion_value_schema_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v18.resources.CustomerSkAdNetworkConversionValueSchema", "google/ads/googleads/v18/resources/customer_sk_ad_network_conversion_value_schema.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          CustomerSkAdNetworkConversionValueSchemaOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.CustomerSkAdNetworkConversionValueSchemaOperation").msgclass
          MutateCustomerSkAdNetworkConversionValueSchemaRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCustomerSkAdNetworkConversionValueSchemaRequest").msgclass
          MutateCustomerSkAdNetworkConversionValueSchemaResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCustomerSkAdNetworkConversionValueSchemaResult").msgclass
          MutateCustomerSkAdNetworkConversionValueSchemaResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCustomerSkAdNetworkConversionValueSchemaResponse").msgclass
        end
      end
    end
  end
