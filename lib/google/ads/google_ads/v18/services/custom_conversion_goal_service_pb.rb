...
require 'google/ads/google_ads/v18/resources/custom_conversion_goal_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.resources.CustomConversionGoal", "google/ads/googleads/v18/resources/custom_conversion_goal.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateCustomConversionGoalsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCustomConversionGoalsRequest").msgclass
          CustomConversionGoalOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.CustomConversionGoalOperation").msgclass
          MutateCustomConversionGoalsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCustomConversionGoalsResponse").msgclass
          MutateCustomConversionGoalResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCustomConversionGoalResult").msgclass
        end
      end
    end
  end
