...
require 'google/ads/google_ads/v18/resources/customer_asset_set_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v18.resources.CustomerAssetSet", "google/ads/googleads/v18/resources/customer_asset_set.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateCustomerAssetSetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCustomerAssetSetsRequest").msgclass
          CustomerAssetSetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.CustomerAssetSetOperation").msgclass
          MutateCustomerAssetSetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCustomerAssetSetsResponse").msgclass
          MutateCustomerAssetSetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateCustomerAssetSetResult").msgclass
        end
      end
    end
  end
