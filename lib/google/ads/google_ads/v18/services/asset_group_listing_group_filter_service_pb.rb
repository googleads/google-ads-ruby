...
require 'google/ads/google_ads/v18/resources/asset_group_listing_group_filter_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.resources.AssetGroupListingGroupFilter", "google/ads/googleads/v18/resources/asset_group_listing_group_filter.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateAssetGroupListingGroupFiltersRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAssetGroupListingGroupFiltersRequest").msgclass
          AssetGroupListingGroupFilterOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.AssetGroupListingGroupFilterOperation").msgclass
          MutateAssetGroupListingGroupFiltersResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAssetGroupListingGroupFiltersResponse").msgclass
          MutateAssetGroupListingGroupFilterResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateAssetGroupListingGroupFilterResult").msgclass
        end
      end
    end
  end
