...
require 'google/ads/google_ads/v18/resources/conversion_value_rule_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.resources.ConversionValueRule", "google/ads/googleads/v18/resources/conversion_value_rule.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Services
          MutateConversionValueRulesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateConversionValueRulesRequest").msgclass
          ConversionValueRuleOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.ConversionValueRuleOperation").msgclass
          MutateConversionValueRulesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateConversionValueRulesResponse").msgclass
          MutateConversionValueRuleResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.services.MutateConversionValueRuleResult").msgclass
        end
      end
    end
  end
