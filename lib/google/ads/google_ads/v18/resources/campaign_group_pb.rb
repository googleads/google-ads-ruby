...
require 'google/ads/google_ads/v18/enums/campaign_group_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          CampaignGroup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.CampaignGroup").msgclass
        end
      end
    end
  end
