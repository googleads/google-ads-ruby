...
require 'google/ads/google_ads/v18/enums/feed_item_quality_approval_status_pb'
require 'google/ads/google_ads/v18/enums/feed_item_quality_disapproval_reason_pb'
require 'google/ads/google_ads/v18/enums/feed_item_status_pb'
require 'google/ads/google_ads/v18/enums/feed_item_validation_status_pb'
require 'google/ads/google_ads/v18/enums/geo_targeting_restriction_pb'
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          FeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.FeedItem").msgclass
          FeedItemAttributeValue = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.FeedItemAttributeValue").msgclass
          FeedItemPlaceholderPolicyInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.FeedItemPlaceholderPolicyInfo").msgclass
          FeedItemValidationError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.FeedItemValidationError").msgclass
        end
      end
    end
  end
