...
require 'google/ads/google_ads/v18/common/click_location_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v18.common.ClickLocation", "google/ads/googleads/v18/common/click_location.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          ClickView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.ClickView").msgclass
        end
      end
    end
  end
