...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          CustomerExtensionSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.CustomerExtensionSetting").msgclass
        end
      end
    end
  end
