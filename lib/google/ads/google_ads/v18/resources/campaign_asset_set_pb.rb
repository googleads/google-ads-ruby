...
require 'google/ads/google_ads/v18/enums/asset_set_link_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          CampaignAssetSet = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.CampaignAssetSet").msgclass
        end
      end
    end
  end
