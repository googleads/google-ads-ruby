...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          GoogleAdsField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.GoogleAdsField").msgclass
        end
      end
    end
  end
