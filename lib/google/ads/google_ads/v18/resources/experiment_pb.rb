...
begin
  ...
  imports = [
    ["google.ads.googleads.v18.common.MetricGoal", "google/ads/googleads/v18/common/metric_goal.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          Experiment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.Experiment").msgclass
        end
      end
    end
  end
