...
# source: google/ads/googleads/v18/resources/android_privacy_shared_key_google_campaign.proto

require 'google/protobuf'

require 'google/ads/google_ads/v18/enums/android_privacy_interaction_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          AndroidPrivacySharedKeyGoogleCampaign = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.AndroidPrivacySharedKeyGoogleCampaign").msgclass
        end
      end
    end
  end
