...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          AdGroupCriterionLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.AdGroupCriterionLabel").msgclass
        end
      end
    end
  end
