...
require 'google/ads/google_ads/v18/enums/bid_modifier_source_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v18.common.HotelDateSelectionTypeInfo", "google/ads/googleads/v18/common/criteria.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          AdGroupBidModifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.AdGroupBidModifier").msgclass
        end
      end
    end
  end
