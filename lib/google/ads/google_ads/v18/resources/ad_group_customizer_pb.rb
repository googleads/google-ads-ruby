...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          AdGroupCustomizer = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.AdGroupCustomizer").msgclass
        end
      end
    end
  end
