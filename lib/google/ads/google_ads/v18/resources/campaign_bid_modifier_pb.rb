...
begin
  ...
  imports = [
    ["google.ads.googleads.v18.common.InteractionTypeInfo", "google/ads/googleads/v18/common/criteria.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          CampaignBidModifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.CampaignBidModifier").msgclass
        end
      end
    end
  end
