...
require 'google/ads/google_ads/v18/common/feed_item_set_filter_type_infos_pb'
require 'google/ads/google_ads/v18/enums/feed_item_set_status_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v18.common.DynamicLocationSetFilter", "google/ads/googleads/v18/common/feed_item_set_filter_type_infos.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          FeedItemSet = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.FeedItemSet").msgclass
        end
      end
    end
  end
