...
require 'google/ads/google_ads/v18/common/tag_snippet_pb'
require 'google/ads/google_ads/v18/enums/attribution_model_pb'
require 'google/ads/google_ads/v18/enums/conversion_action_category_pb'
require 'google/ads/google_ads/v18/enums/conversion_action_counting_type_pb'
require 'google/ads/google_ads/v18/enums/conversion_action_status_pb'
require 'google/ads/google_ads/v18/enums/conversion_action_type_pb'
require 'google/ads/google_ads/v18/enums/conversion_origin_pb'
require 'google/ads/google_ads/v18/enums/data_driven_model_status_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v18.common.TagSnippet", "google/ads/googleads/v18/common/tag_snippet.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          ConversionAction = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.ConversionAction").msgclass
          ConversionAction::AttributionModelSettings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.ConversionAction.AttributionModelSettings").msgclass
          ConversionAction::ValueSettings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.ConversionAction.ValueSettings").msgclass
          ConversionAction::ThirdPartyAppAnalyticsSettings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.ConversionAction.ThirdPartyAppAnalyticsSettings").msgclass
          ConversionAction::FirebaseSettings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.ConversionAction.FirebaseSettings").msgclass
          ConversionAction::GoogleAnalytics4Settings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.ConversionAction.GoogleAnalytics4Settings").msgclass
        end
      end
    end
  end
