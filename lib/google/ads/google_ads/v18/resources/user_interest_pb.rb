...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          UserInterest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.UserInterest").msgclass
        end
      end
    end
  end
