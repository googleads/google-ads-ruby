...
require 'google/ads/google_ads/v18/enums/keyword_plan_network_pb'
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          KeywordPlanCampaign = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.KeywordPlanCampaign").msgclass
          KeywordPlanGeoTarget = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.KeywordPlanGeoTarget").msgclass
        end
      end
    end
  end
