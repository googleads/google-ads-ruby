...
begin
  ...
  imports = [
    ["google.ads.googleads.v18.common.LocalServicesDocumentReadOnly", "google/ads/googleads/v18/common/local_services.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          LocalServicesVerificationArtifact = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.LocalServicesVerificationArtifact").msgclass
          BackgroundCheckVerificationArtifact = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.BackgroundCheckVerificationArtifact").msgclass
          InsuranceVerificationArtifact = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.InsuranceVerificationArtifact").msgclass
          LicenseVerificationArtifact = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.LicenseVerificationArtifact").msgclass
          BusinessRegistrationCheckVerificationArtifact = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.BusinessRegistrationCheckVerificationArtifact").msgclass
          BusinessRegistrationNumber = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.BusinessRegistrationNumber").msgclass
          BusinessRegistrationDocument = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.BusinessRegistrationDocument").msgclass
        end
      end
    end
  end
