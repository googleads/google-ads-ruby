...
require 'google/ads/google_ads/v18/common/asset_types_pb'
...
require 'google/ads/google_ads/v18/enums/asset_type_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v18.common.YoutubeVideoAsset", "google/ads/googleads/v18/common/asset_types.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          Asset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.Asset").msgclass
          AssetFieldTypePolicySummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.AssetFieldTypePolicySummary").msgclass
          AssetPolicySummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.AssetPolicySummary").msgclass
        end
      end
    end
  end
