...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          AdGroupAdLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.AdGroupAdLabel").msgclass
        end
      end
    end
  end
