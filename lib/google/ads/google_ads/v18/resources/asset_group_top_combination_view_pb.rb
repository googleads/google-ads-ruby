...
require 'google/ads/google_ads/v18/common/asset_usage_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v18.common.AssetUsage", "google/ads/googleads/v18/common/asset_usage.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          AssetGroupTopCombinationView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.AssetGroupTopCombinationView").msgclass
          AssetGroupAssetCombinationData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.AssetGroupAssetCombinationData").msgclass
        end
      end
    end
  end
