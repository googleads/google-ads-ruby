...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          PerformanceMaxPlacementView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.PerformanceMaxPlacementView").msgclass
        end
      end
    end
  end
