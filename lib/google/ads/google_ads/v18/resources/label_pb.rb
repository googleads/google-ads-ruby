...
begin
  ...
  imports = [
    ["google.ads.googleads.v18.common.TextLabel", "google/ads/googleads/v18/common/text_label.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          Label = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.Label").msgclass
        end
      end
    end
  end
