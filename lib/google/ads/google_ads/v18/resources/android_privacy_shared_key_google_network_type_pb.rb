...
require 'google/ads/google_ads/v18/enums/android_privacy_network_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          AndroidPrivacySharedKeyGoogleNetworkType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.AndroidPrivacySharedKeyGoogleNetworkType").msgclass
        end
      end
    end
  end
