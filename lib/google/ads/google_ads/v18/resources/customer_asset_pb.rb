...
# source: google/ads/googleads/v18/resources/customer_asset.proto
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          CustomerAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.CustomerAsset").msgclass
        end
      end
    end
  end
