...
begin
  ...
  imports = [
    ["google.ads.googleads.v18.common.ContentLabelInfo", "google/ads/googleads/v18/common/criteria.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          CustomerNegativeCriterion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.CustomerNegativeCriterion").msgclass
        end
      end
    end
  end
