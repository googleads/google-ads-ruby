...
begin
  ...
  imports = [
    ["google.ads.googleads.v18.common.DateRange", "google/ads/googleads/v18/common/dates.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          KeywordPlan = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.KeywordPlan").msgclass
          KeywordPlanForecastPeriod = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.KeywordPlanForecastPeriod").msgclass
        end
      end
    end
  end
