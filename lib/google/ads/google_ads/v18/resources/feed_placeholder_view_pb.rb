...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          FeedPlaceholderView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.FeedPlaceholderView").msgclass
        end
      end
    end
  end
