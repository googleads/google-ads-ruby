...
require 'google/ads/google_ads/v18/enums/manager_link_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          CustomerManagerLink = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.CustomerManagerLink").msgclass
        end
      end
    end
  end
