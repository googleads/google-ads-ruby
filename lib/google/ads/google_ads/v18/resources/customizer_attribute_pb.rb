...
require 'google/ads/google_ads/v18/enums/customizer_attribute_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          CustomizerAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.CustomizerAttribute").msgclass
        end
      end
    end
  end
