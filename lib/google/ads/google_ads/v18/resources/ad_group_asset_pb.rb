...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          AdGroupAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.AdGroupAsset").msgclass
        end
      end
    end
  end
