...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          AssetGroup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.AssetGroup").msgclass
        end
      end
    end
  end
