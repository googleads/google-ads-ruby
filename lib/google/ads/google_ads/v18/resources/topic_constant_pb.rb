...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          TopicConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.TopicConstant").msgclass
        end
      end
    end
  end
