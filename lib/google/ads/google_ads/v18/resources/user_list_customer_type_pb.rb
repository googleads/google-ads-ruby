...
require 'google/ads/google_ads/v18/enums/user_list_customer_type_category_pb'
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          UserListCustomerType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.UserListCustomerType").msgclass
        end
      end
    end
  end
