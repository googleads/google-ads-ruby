...
require 'google/ads/google_ads/v18/resources/offline_conversion_upload_client_summary_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v18.resources.OfflineConversionSummary", "google/ads/googleads/v18/resources/offline_conversion_upload_client_summary.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          OfflineConversionUploadConversionActionSummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.OfflineConversionUploadConversionActionSummary").msgclass
        end
      end
    end
  end
