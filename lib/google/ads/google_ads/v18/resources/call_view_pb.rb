...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          CallView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.CallView").msgclass
        end
      end
    end
  end
