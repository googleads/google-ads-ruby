...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          BillingSetup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.BillingSetup").msgclass
          BillingSetup::PaymentsAccountInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.BillingSetup.PaymentsAccountInfo").msgclass
        end
      end
    end
  end
