...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          AdGroupCriterionSimulation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.AdGroupCriterionSimulation").msgclass
        end
      end
    end
  end
