...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          SearchTermView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.SearchTermView").msgclass
        end
      end
    end
  end
