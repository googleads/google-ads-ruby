...
require 'google/ads/google_ads/v18/enums/shared_set_status_pb'
require 'google/ads/google_ads/v18/enums/shared_set_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          SharedSet = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.SharedSet").msgclass
        end
      end
    end
  end
