...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          AssetGroupProductGroupView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.AssetGroupProductGroupView").msgclass
        end
      end
    end
  end
