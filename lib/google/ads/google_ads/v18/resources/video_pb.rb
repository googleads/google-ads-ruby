...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          Video = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.Video").msgclass
        end
      end
    end
  end
