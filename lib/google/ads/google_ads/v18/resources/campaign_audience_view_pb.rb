...
# source: google/ads/googleads/v18/resources/campaign_audience_view.proto
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          CampaignAudienceView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.CampaignAudienceView").msgclass
        end
      end
    end
  end
