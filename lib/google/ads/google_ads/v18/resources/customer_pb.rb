...
require 'google/ads/google_ads/v18/enums/brand_safety_suitability_pb'
require 'google/ads/google_ads/v18/enums/conversion_tracking_status_enum_pb'
require 'google/ads/google_ads/v18/enums/customer_pay_per_conversion_eligibility_failure_reason_pb'
require 'google/ads/google_ads/v18/enums/customer_status_pb'
require 'google/ads/google_ads/v18/enums/local_services_verification_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          Customer = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.Customer").msgclass
          CallReportingSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.CallReportingSetting").msgclass
          ConversionTrackingSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.ConversionTrackingSetting").msgclass
          RemarketingSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.RemarketingSetting").msgclass
          CustomerAgreementSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.CustomerAgreementSetting").msgclass
          LocalServicesSettings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.LocalServicesSettings").msgclass
          GranularLicenseStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.GranularLicenseStatus").msgclass
          GranularInsuranceStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.GranularInsuranceStatus").msgclass
        end
      end
    end
  end
