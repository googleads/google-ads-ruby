...
require 'google/ads/google_ads/v18/enums/local_services_conversation_type_pb'
require 'google/ads/google_ads/v18/enums/local_services_participant_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          LocalServicesLeadConversation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.LocalServicesLeadConversation").msgclass
          PhoneCallDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.PhoneCallDetails").msgclass
          MessageDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.MessageDetails").msgclass
        end
      end
    end
  end
