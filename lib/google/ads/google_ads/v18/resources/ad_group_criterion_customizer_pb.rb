...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          AdGroupCriterionCustomizer = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.AdGroupCriterionCustomizer").msgclass
        end
      end
    end
  end
