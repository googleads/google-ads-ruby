...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          UserLocationView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.UserLocationView").msgclass
        end
      end
    end
  end
