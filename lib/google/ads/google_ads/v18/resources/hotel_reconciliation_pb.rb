...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          HotelReconciliation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.HotelReconciliation").msgclass
        end
      end
    end
  end
