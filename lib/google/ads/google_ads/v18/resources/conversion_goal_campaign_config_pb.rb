...
require 'google/ads/google_ads/v18/enums/goal_config_level_pb'
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          ConversionGoalCampaignConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.ConversionGoalCampaignConfig").msgclass
        end
      end
    end
  end
