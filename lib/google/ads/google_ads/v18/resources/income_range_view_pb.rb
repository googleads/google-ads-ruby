...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          IncomeRangeView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.IncomeRangeView").msgclass
        end
      end
    end
  end
