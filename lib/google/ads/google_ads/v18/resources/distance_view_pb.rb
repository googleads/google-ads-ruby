...
require 'google/ads/google_ads/v18/enums/distance_bucket_pb'
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          DistanceView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.DistanceView").msgclass
        end
      end
    end
  end
