...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          SharedCriterion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.SharedCriterion").msgclass
        end
      end
    end
  end
