...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          DataLink = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.DataLink").msgclass
          YoutubeVideoIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.YoutubeVideoIdentifier").msgclass
        end
      end
    end
  end
