...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          AdGroupAdAssetCombinationView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.AdGroupAdAssetCombinationView").msgclass
        end
      end
    end
  end
