...
require 'google/ads/google_ads/v18/common/asset_set_types_pb'
require 'google/ads/google_ads/v18/enums/asset_set_status_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v18.common.LocationSet", "google/ads/googleads/v18/common/asset_set_types.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          AssetSet = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.AssetSet").msgclass
          AssetSet::MerchantCenterFeed = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.AssetSet.MerchantCenterFeed").msgclass
          AssetSet::HotelPropertyData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.AssetSet.HotelPropertyData").msgclass
        end
      end
    end
  end
