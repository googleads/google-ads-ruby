...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          CampaignCriterion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.CampaignCriterion").msgclass
        end
      end
    end
  end
