...
require 'google/ads/google_ads/v18/enums/access_invitation_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          CustomerUserAccessInvitation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.CustomerUserAccessInvitation").msgclass
        end
      end
    end
  end
