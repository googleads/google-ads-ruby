...
# source: google/ads/googleads/v18/resources/smart_campaign_search_term_view.proto
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          SmartCampaignSearchTermView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.SmartCampaignSearchTermView").msgclass
        end
      end
    end
  end
