...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          SmartCampaignSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.SmartCampaignSetting").msgclass
          SmartCampaignSetting::PhoneNumber = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.SmartCampaignSetting.PhoneNumber").msgclass
          SmartCampaignSetting::AdOptimizedBusinessProfileSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.SmartCampaignSetting.AdOptimizedBusinessProfileSetting").msgclass
        end
      end
    end
  end
