...
module Google
  module Ads
    module GoogleAds
      module V18
        module Resources
          ChangeStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.resources.ChangeStatus").msgclass
        end
      end
    end
  end
