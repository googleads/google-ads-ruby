...
module Google
  module Ads
    module GoogleAds
      module V18
        module Errors
          AdGroupBidModifierErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.AdGroupBidModifierErrorEnum").msgclass
          AdGroupBidModifierErrorEnum::AdGroupBidModifierError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.AdGroupBidModifierErrorEnum.AdGroupBidModifierError").enummodule
        end
      end
    end
  end
