...
module Google
  module Ads
    module GoogleAds
      module V18
        module Errors
          AutomaticallyCreatedAssetRemovalErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.AutomaticallyCreatedAssetRemovalErrorEnum").msgclass
          AutomaticallyCreatedAssetRemovalErrorEnum::AutomaticallyCreatedAssetRemovalError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.AutomaticallyCreatedAssetRemovalErrorEnum.AutomaticallyCreatedAssetRemovalError").enummodule
        end
      end
    end
  end
