...
module Google
  module Ads
    module GoogleAds
      module V18
        module Errors
          AssetGroupErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.AssetGroupErrorEnum").msgclass
          AssetGroupErrorEnum::AssetGroupError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.AssetGroupErrorEnum.AssetGroupError").enummodule
        end
      end
    end
  end
