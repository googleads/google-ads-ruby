...
module Google
  module Ads
    module GoogleAds
      module V18
        module Errors
          AssetGroupListingGroupFilterErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.AssetGroupListingGroupFilterErrorEnum").msgclass
          AssetGroupListingGroupFilterErrorEnum::AssetGroupListingGroupFilterError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.AssetGroupListingGroupFilterErrorEnum.AssetGroupListingGroupFilterError").enummodule
        end
      end
    end
  end
