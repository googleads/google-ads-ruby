...
module Google
  module Ads
    module GoogleAds
      module V18
        module Errors
          CustomConversionGoalErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.CustomConversionGoalErrorEnum").msgclass
          CustomConversionGoalErrorEnum::CustomConversionGoalError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.CustomConversionGoalErrorEnum.CustomConversionGoalError").enummodule
        end
      end
    end
  end
