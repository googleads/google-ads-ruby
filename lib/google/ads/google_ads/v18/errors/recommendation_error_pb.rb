...
module Google
  module Ads
    module GoogleAds
      module V18
        module Errors
          RecommendationErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.RecommendationErrorEnum").msgclass
          RecommendationErrorEnum::RecommendationError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.RecommendationErrorEnum.RecommendationError").enummodule
        end
      end
    end
  end
