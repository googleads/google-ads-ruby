...
module Google
  module Ads
    module GoogleAds
      module V18
        module Errors
          FeedItemSetLinkErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.FeedItemSetLinkErrorEnum").msgclass
          FeedItemSetLinkErrorEnum::FeedItemSetLinkError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.FeedItemSetLinkErrorEnum.FeedItemSetLinkError").enummodule
        end
      end
    end
  end
