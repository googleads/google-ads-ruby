...
module Google
  module Ads
    module GoogleAds
      module V18
        module Errors
          AdGroupCriterionCustomizerErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.AdGroupCriterionCustomizerErrorEnum").msgclass
          AdGroupCriterionCustomizerErrorEnum::AdGroupCriterionCustomizerError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.AdGroupCriterionCustomizerErrorEnum.AdGroupCriterionCustomizerError").enummodule
        end
      end
    end
  end
