...
module Google
  module Ads
    module GoogleAds
      module V18
        module Errors
          DateErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.DateErrorEnum").msgclass
          DateErrorEnum::DateError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.DateErrorEnum.DateError").enummodule
        end
      end
    end
  end
