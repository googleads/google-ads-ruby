...
module Google
  module Ads
    module GoogleAds
      module V18
        module Errors
          AdGroupCustomizerErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.AdGroupCustomizerErrorEnum").msgclass
          AdGroupCustomizerErrorEnum::AdGroupCustomizerError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.AdGroupCustomizerErrorEnum.AdGroupCustomizerError").enummodule
        end
      end
    end
  end
