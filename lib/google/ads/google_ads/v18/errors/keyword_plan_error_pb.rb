...
module Google
  module Ads
    module GoogleAds
      module V18
        module Errors
          KeywordPlanErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.KeywordPlanErrorEnum").msgclass
          KeywordPlanErrorEnum::KeywordPlanError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.KeywordPlanErrorEnum.KeywordPlanError").enummodule
        end
      end
    end
  end
