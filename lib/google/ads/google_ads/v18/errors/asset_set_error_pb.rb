...
module Google
  module Ads
    module GoogleAds
      module V18
        module Errors
          AssetSetErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.AssetSetErrorEnum").msgclass
          AssetSetErrorEnum::AssetSetError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.AssetSetErrorEnum.AssetSetError").enummodule
        end
      end
    end
  end
