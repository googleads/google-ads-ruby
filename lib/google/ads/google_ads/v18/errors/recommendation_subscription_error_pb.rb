...
module Google
  module Ads
    module GoogleAds
      module V18
        module Errors
          RecommendationSubscriptionErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.RecommendationSubscriptionErrorEnum").msgclass
          RecommendationSubscriptionErrorEnum::RecommendationSubscriptionError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.RecommendationSubscriptionErrorEnum.RecommendationSubscriptionError").enummodule
        end
      end
    end
  end
