...
module Google
  module Ads
    module GoogleAds
      module V18
        module Errors
          CustomerClientLinkErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.CustomerClientLinkErrorEnum").msgclass
          CustomerClientLinkErrorEnum::CustomerClientLinkError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.errors.CustomerClientLinkErrorEnum.CustomerClientLinkError").enummodule
        end
      end
    end
  end
