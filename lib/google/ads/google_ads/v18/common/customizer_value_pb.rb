...
module Google
  module Ads
    module GoogleAds
      module V18
        module Common
          CustomizerValue = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.common.CustomizerValue").msgclass
        end
      end
    end
  end
