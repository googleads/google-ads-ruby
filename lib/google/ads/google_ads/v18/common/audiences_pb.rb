...
require 'google/ads/google_ads/v18/enums/gender_type_pb'
require 'google/ads/google_ads/v18/enums/income_range_type_pb'
require 'google/ads/google_ads/v18/enums/parental_status_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V18
        module Common
          AudienceDimension = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.common.AudienceDimension").msgclass
          AudienceExclusionDimension = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.common.AudienceExclusionDimension").msgclass
          ExclusionSegment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.common.ExclusionSegment").msgclass
          AgeDimension = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.common.AgeDimension").msgclass
          AgeSegment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.common.AgeSegment").msgclass
          GenderDimension = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.common.GenderDimension").msgclass
          HouseholdIncomeDimension = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.common.HouseholdIncomeDimension").msgclass
          ParentalStatusDimension = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.common.ParentalStatusDimension").msgclass
          AudienceSegmentDimension = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.common.AudienceSegmentDimension").msgclass
          AudienceSegment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.common.AudienceSegment").msgclass
          UserListSegment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.common.UserListSegment").msgclass
          UserInterestSegment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.common.UserInterestSegment").msgclass
          LifeEventSegment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.common.LifeEventSegment").msgclass
          DetailedDemographicSegment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.common.DetailedDemographicSegment").msgclass
          CustomAudienceSegment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.common.CustomAudienceSegment").msgclass
        end
      end
    end
  end
