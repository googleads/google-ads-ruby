...
module Google
  module Ads
    module GoogleAds
      module V18
        module Common
          TagSnippet = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.common.TagSnippet").msgclass
        end
      end
    end
  end
