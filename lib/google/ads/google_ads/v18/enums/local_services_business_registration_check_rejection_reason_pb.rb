...
module Google
  module Ads
    module GoogleAds
      module V18
        module Enums
          LocalServicesBusinessRegistrationCheckRejectionReasonEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.LocalServicesBusinessRegistrationCheckRejectionReasonEnum").msgclass
