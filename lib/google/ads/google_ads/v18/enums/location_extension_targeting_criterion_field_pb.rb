...
module Google
  module Ads
    module GoogleAds
      module V18
        module Enums
          LocationExtensionTargetingCriterionFieldEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.LocationExtensionTargetingCriterionFieldEnum").msgclass
          LocationExtensionTargetingCriterionFieldEnum::LocationExtensionTargetingCriterionField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.LocationExtensionTargetingCriterionFieldEnum.LocationExtensionTargetingCriterionField").enummodule
        end
      end
    end
  end
