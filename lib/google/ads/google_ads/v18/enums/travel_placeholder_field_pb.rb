...
module Google
  module Ads
    module GoogleAds
      module V18
        module Enums
          TravelPlaceholderFieldEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.TravelPlaceholderFieldEnum").msgclass
          TravelPlaceholderFieldEnum::TravelPlaceholderField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.TravelPlaceholderFieldEnum.TravelPlaceholderField").enummodule
        end
      end
    end
  end
