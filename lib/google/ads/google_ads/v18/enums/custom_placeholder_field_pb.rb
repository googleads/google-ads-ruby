...
module Google
  module Ads
    module GoogleAds
      module V18
        module Enums
          CustomPlaceholderFieldEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.CustomPlaceholderFieldEnum").msgclass
          CustomPlaceholderFieldEnum::CustomPlaceholderField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.CustomPlaceholderFieldEnum.CustomPlaceholderField").enummodule
        end
      end
    end
  end
