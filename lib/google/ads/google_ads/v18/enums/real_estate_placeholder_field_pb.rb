...
module Google
  module Ads
    module GoogleAds
      module V18
        module Enums
          RealEstatePlaceholderFieldEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.RealEstatePlaceholderFieldEnum").msgclass
          RealEstatePlaceholderFieldEnum::RealEstatePlaceholderField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.RealEstatePlaceholderFieldEnum.RealEstatePlaceholderField").enummodule
        end
      end
    end
  end
