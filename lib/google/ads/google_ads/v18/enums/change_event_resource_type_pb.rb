...
module Google
  module Ads
    module GoogleAds
      module V18
        module Enums
          ChangeEventResourceTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.ChangeEventResourceTypeEnum").msgclass
          ChangeEventResourceTypeEnum::ChangeEventResourceType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.ChangeEventResourceTypeEnum.ChangeEventResourceType").enummodule
        end
      end
    end
  end
