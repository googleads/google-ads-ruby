...
module Google
  module Ads
    module GoogleAds
      module V18
        module Enums
          ShoppingAddProductsToCampaignRecommendationEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.ShoppingAddProductsToCampaignRecommendationEnum").msgclass
          ShoppingAddProductsToCampaignRecommendationEnum::Reason = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.ShoppingAddProductsToCampaignRecommendationEnum.Reason").enummodule
        end
      end
    end
  end
