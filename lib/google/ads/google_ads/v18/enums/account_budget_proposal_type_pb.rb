...
module Google
  module Ads
    module GoogleAds
      module V18
        module Enums
          AccountBudgetProposalTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.AccountBudgetProposalTypeEnum").msgclass
          AccountBudgetProposalTypeEnum::AccountBudgetProposalType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.AccountBudgetProposalTypeEnum.AccountBudgetProposalType").enummodule
        end
      end
    end
  end
