...
module Google
  module Ads
    module GoogleAds
      module V18
        module Enums
          PromotionPlaceholderFieldEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.PromotionPlaceholderFieldEnum").msgclass
          PromotionPlaceholderFieldEnum::PromotionPlaceholderField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.PromotionPlaceholderFieldEnum.PromotionPlaceholderField").enummodule
        end
      end
    end
  end
