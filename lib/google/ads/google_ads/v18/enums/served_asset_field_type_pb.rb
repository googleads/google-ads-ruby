...
module Google
  module Ads
    module GoogleAds
      module V18
        module Enums
          ServedAssetFieldTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.ServedAssetFieldTypeEnum").msgclass
          ServedAssetFieldTypeEnum::ServedAssetFieldType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.ServedAssetFieldTypeEnum.ServedAssetFieldType").enummodule
        end
      end
    end
  end
