...
module Google
  module Ads
    module GoogleAds
      module V18
        module Enums
          BiddingStrategyTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.BiddingStrategyTypeEnum").msgclass
          BiddingStrategyTypeEnum::BiddingStrategyType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.BiddingStrategyTypeEnum.BiddingStrategyType").enummodule
        end
      end
    end
  end
