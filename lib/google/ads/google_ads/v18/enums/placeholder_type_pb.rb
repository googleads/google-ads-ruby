...
module Google
  module Ads
    module GoogleAds
      module V18
        module Enums
          PlaceholderTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.PlaceholderTypeEnum").msgclass
          PlaceholderTypeEnum::PlaceholderType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.PlaceholderTypeEnum.PlaceholderType").enummodule
        end
      end
    end
  end
