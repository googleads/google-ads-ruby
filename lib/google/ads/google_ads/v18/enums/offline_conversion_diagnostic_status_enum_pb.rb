...
module Google
  module Ads
    module GoogleAds
      module V18
        module Enums
          OfflineConversionDiagnosticStatusEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.OfflineConversionDiagnosticStatusEnum").msgclass
          OfflineConversionDiagnosticStatusEnum::OfflineConversionDiagnosticStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v18.enums.OfflineConversionDiagnosticStatusEnum.OfflineConversionDiagnosticStatus").enummodule
        end
      end
    end
  end
