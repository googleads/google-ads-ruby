...
# source: google/ads/googleads/v12/errors/account_budget_proposal_error.proto

require 'google/protobuf'

Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v12/errors/account_budget_proposal_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v12.errors.AccountBudgetProposalErrorEnum" do
    end
    add_enum "google.ads.googleads.v12.errors.AccountBudgetProposalErrorEnum.AccountBudgetProposalError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
      ...
      value :INVALID_MASTER_SERVICE_AGREEMENT, 26
    end
  end
end
...
module Google
  module Ads
    module GoogleAds
      module V12
        module Errors
          AccountBudgetProposalErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v12.errors.AccountBudgetProposalErrorEnum").msgclass
          AccountBudgetProposalErrorEnum::AccountBudgetProposalError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v12.errors.AccountBudgetProposalErrorEnum.AccountBudgetProposalError").enummodule
        end
      end
    end
  end
