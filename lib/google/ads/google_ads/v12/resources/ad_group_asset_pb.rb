...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v12/resources/ad_group_asset.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v12.resources.AdGroupAsset" do
      ...
      optional :source, :enum, 6, "google.ads.googleads.v12.enums.AssetSourceEnum.AssetSource"
...
module Google
  module Ads
    module GoogleAds
      module V12
        module Resources
          AdGroupAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v12.resources.AdGroupAsset").msgclass
        end
      end
    end
  end
