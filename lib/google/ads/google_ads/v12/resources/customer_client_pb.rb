...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v12/resources/customer_client.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v12.resources.CustomerClient" do
      ...
      optional :status, :enum, 22, "google.ads.googleads.v12.enums.CustomerStatusEnum.CustomerStatus"
    end
  end
end
...
module Google
  module Ads
    module GoogleAds
      module V12
        module Resources
          CustomerClient = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v12.resources.CustomerClient").msgclass
        end
      end
    end
  end
