...
# source: google/ads/googleads/v12/resources/campaign_budget.proto
...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v12/resources/campaign_budget.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v12.resources.CampaignBudget" do
      ...
      optional :status, :enum, 6, "google.ads.googleads.v12.enums.BudgetStatusEnum.BudgetStatus"
      optional :delivery_method, :enum, 7, "google.ads.googleads.v12.enums.BudgetDeliveryMethodEnum.BudgetDeliveryMethod"
      ...
      optional :period, :enum, 13, "google.ads.googleads.v12.enums.BudgetPeriodEnum.BudgetPeriod"
      ...
      optional :type, :enum, 18, "google.ads.googleads.v12.enums.BudgetTypeEnum.BudgetType"
...
module Google
  module Ads
    module GoogleAds
      module V12
        module Resources
          CampaignBudget = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v12.resources.CampaignBudget").msgclass
        end
      end
    end
  end
