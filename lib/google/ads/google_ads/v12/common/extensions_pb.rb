...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v12/common/extensions.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v12.common.AppFeedItem" do
      proto3_optional :link_text, :string, 9
      proto3_optional :app_id, :string, 10
      optional :app_store, :enum, 3, "google.ads.googleads.v12.enums.AppStoreEnum.AppStore"
      repeated :final_urls, :string, 11
      repeated :final_mobile_urls, :string, 12
      proto3_optional :tracking_url_template, :string, 13
      repeated :url_custom_parameters, :message, 7, "google.ads.googleads.v12.common.CustomParameter"
      proto3_optional :final_url_suffix, :string, 14
    end
    add_message "google.ads.googleads.v12.common.CallFeedItem" do
      ...
      optional :call_conversion_reporting_state, :enum, 6, "google.ads.googleads.v12.enums.CallConversionReportingStateEnum.CallConversionReportingState"
    end
    add_message "google.ads.googleads.v12.common.CalloutFeedItem" do
      proto3_optional :callout_text, :string, 2
    end
    add_message "google.ads.googleads.v12.common.LocationFeedItem" do
    ...
    add_message "google.ads.googleads.v12.common.AffiliateLocationFeedItem" do
    ...
    add_message "google.ads.googleads.v12.common.TextMessageFeedItem" do
    ...
    add_message "google.ads.googleads.v12.common.PriceFeedItem" do
      ...
      repeated :price_offerings, :message, 5, "google.ads.googleads.v12.common.PriceOffer"
      proto3_optional :final_url_suffix, :string, 9
    end
    add_message "google.ads.googleads.v12.common.PriceOffer" do
    ...
    add_message "google.ads.googleads.v12.common.PromotionFeedItem" do
      ...
      repeated :url_custom_parameters, :message, 13, "google.ads.googleads.v12.common.CustomParameter"
    ...
    add_message "google.ads.googleads.v12.common.StructuredSnippetFeedItem" do
      proto3_optional :header, :string, 3
      repeated :values, :string, 4
    end
    add_message "google.ads.googleads.v12.common.SitelinkFeedItem" do
      proto3_optional :link_text, :string, 9
    ...
    add_message "google.ads.googleads.v12.common.HotelCalloutFeedItem" do
      proto3_optional :text, :string, 3
      proto3_optional :language_code, :string, 4
    end
    add_message "google.ads.googleads.v12.common.ImageFeedItem" do
...
module Google
  module Ads
    module GoogleAds
      module V12
        module Common
          AppFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v12.common.AppFeedItem").msgclass
          CallFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v12.common.CallFeedItem").msgclass
          CalloutFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v12.common.CalloutFeedItem").msgclass
          LocationFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v12.common.LocationFeedItem").msgclass
          AffiliateLocationFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v12.common.AffiliateLocationFeedItem").msgclass
          TextMessageFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v12.common.TextMessageFeedItem").msgclass
          PriceFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v12.common.PriceFeedItem").msgclass
          PriceOffer = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v12.common.PriceOffer").msgclass
          PromotionFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v12.common.PromotionFeedItem").msgclass
          StructuredSnippetFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v12.common.StructuredSnippetFeedItem").msgclass
          SitelinkFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v12.common.SitelinkFeedItem").msgclass
          HotelCalloutFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v12.common.HotelCalloutFeedItem").msgclass
          ImageFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v12.common.ImageFeedItem").msgclass
        end
      end
    end
  end
