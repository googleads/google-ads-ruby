...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v12/common/asset_policy.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v12.common.AdAssetPolicySummary" do
...
module Google
  module Ads
    module GoogleAds
      module V12
        module Common
          AdAssetPolicySummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v12.common.AdAssetPolicySummary").msgclass
        end
      end
    end
  end
