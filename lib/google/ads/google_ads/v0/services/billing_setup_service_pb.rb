...
# source: google/ads/google_ads/v0/services/billing_setup_service.proto
...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_message "google.ads.googleads.v0.services.GetBillingSetupRequest" do
    optional :resource_name, :string, 1
  end
  add_message "google.ads.googleads.v0.services.MutateBillingSetupRequest" do
    optional :customer_id, :string, 1
    optional :operation, :message, 2, "google.ads.googleads.v0.services.BillingSetupOperation"
  end
  ...
  add_message "google.ads.googleads.v0.services.MutateBillingSetupResponse" do
    optional :result, :message, 1, "google.ads.googleads.v0.services.MutateBillingSetupResult"
  end
  add_message "google.ads.googleads.v0.services.MutateBillingSetupResult" do
    optional :resource_name, :string, 1
  end
end
