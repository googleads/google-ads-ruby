...
# source: google/ads/google_ads/v0/services/keyword_plan_service.proto
...
Google::Protobuf::DescriptorPool.generated_pool.build do
  ...
  add_message "google.ads.googleads.v0.services.KeywordPlanOperation" do
    ...
    oneof :operation do
      optional :create, :message, 1, "google.ads.googleads.v0.resources.KeywordPlan"
      optional :update, :message, 2, "google.ads.googleads.v0.resources.KeywordPlan"
  ...
  add_message "google.ads.googleads.v0.services.GenerateForecastMetricsRequest" do
    optional :keyword_plan, :string, 1
  end
  add_message "google.ads.googleads.v0.services.GenerateForecastMetricsResponse" do
    repeated :campaign_forecasts, :message, 1, "google.ads.googleads.v0.services.KeywordPlanCampaignForecast"
    repeated :ad_group_forecasts, :message, 2, "google.ads.googleads.v0.services.KeywordPlanAdGroupForecast"
    repeated :keyword_forecasts, :message, 3, "google.ads.googleads.v0.services.KeywordPlanKeywordForecast"
  end
  add_message "google.ads.googleads.v0.services.KeywordPlanCampaignForecast" do
    optional :keyword_plan_campaign, :message, 1, "google.protobuf.StringValue"
    optional :campaign_forecast, :message, 2, "google.ads.googleads.v0.services.ForecastMetrics"
  end
  add_message "google.ads.googleads.v0.services.KeywordPlanAdGroupForecast" do
    optional :keyword_plan_ad_group, :message, 1, "google.protobuf.StringValue"
    optional :ad_group_forecast, :message, 2, "google.ads.googleads.v0.services.ForecastMetrics"
  end
  add_message "google.ads.googleads.v0.services.KeywordPlanKeywordForecast" do
    optional :keyword_plan_ad_group_keyword, :message, 1, "google.protobuf.StringValue"
    optional :keyword_forecast, :message, 2, "google.ads.googleads.v0.services.ForecastMetrics"
  end
  add_message "google.ads.googleads.v0.services.ForecastMetrics" do
  ...
  add_message "google.ads.googleads.v0.services.GenerateHistoricalMetricsRequest" do
    optional :keyword_plan, :string, 1
  end
  add_message "google.ads.googleads.v0.services.GenerateHistoricalMetricsResponse" do
    repeated :metrics, :message, 1, "google.ads.googleads.v0.services.KeywordPlanKeywordHistoricalMetrics"
  end
  add_message "google.ads.googleads.v0.services.KeywordPlanKeywordHistoricalMetrics" do
    optional :search_query, :message, 1, "google.protobuf.StringValue"
    optional :keyword_metrics, :message, 2, "google.ads.googleads.v0.common.KeywordPlanHistoricalMetrics"
  end
end
