...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v0/services/keyword_plan_ad_group_service.proto,
...
require "google/ads/google_ads/v0/services/keyword_plan_ad_group_service_pb"
    ...
    module GoogleAds
      module V0
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V0::Services::KeywordPlanAdGroupService::Stub]
          class KeywordPlanAdGroupServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v0/services/keyword_plan_ad_group_service_services_pb"
              ...
              @keyword_plan_ad_group_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V0::Services::KeywordPlanAdGroupService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V0::Resources::KeywordPlanAdGroup]
            ...
            #
            #   keyword_plan_ad_group_service_client = Google::Ads::GoogleAds::KeywordPlanAdGroup.new(version: :v0)
            #   formatted_resource_name = Google::Ads::GoogleAds::V0::Services::KeywordPlanAdGroupServiceClient.keyword_plan_ad_group_path("[CUSTOMER]", "[KEYWORD_PLAN_AD_GROUP]")
            ...
            def get_keyword_plan_ad_group \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V0::Services::GetKeywordPlanAdGroupRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V0::Services::KeywordPlanAdGroupOperation | Hash>]
            #   The list of operations to perform on individual Keyword Plan ad groups.
            #   A hash of the same form as `Google::Ads::GoogleAds::V0::Services::KeywordPlanAdGroupOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V0::Services::MutateKeywordPlanAdGroupsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V0::Services::MutateKeywordPlanAdGroupsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_keyword_plan_ad_groups \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V0::Services::MutateKeywordPlanAdGroupsRequest)
