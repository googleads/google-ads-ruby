...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v0/services/age_range_view_service.proto,
...
require "google/ads/google_ads/v0/services/age_range_view_service_pb"
    ...
    module GoogleAds
      module V0
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V0::Services::AgeRangeViewService::Stub]
          class AgeRangeViewServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v0/services/age_range_view_service_services_pb"
              ...
              @age_range_view_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V0::Services::AgeRangeViewService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V0::Resources::AgeRangeView]
            ...
            #
            #   age_range_view_service_client = Google::Ads::GoogleAds::AgeRangeView.new(version: :v0)
            #   formatted_resource_name = Google::Ads::GoogleAds::V0::Services::AgeRangeViewServiceClient.age_range_view_path("[CUSTOMER]", "[AGE_RANGE_VIEW]")
            ...
            def get_age_range_view \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V0::Services::GetAgeRangeViewRequest)
