...
Google::Protobuf::DescriptorPool.generated_pool.build do
  ...
  add_message "google.ads.googleads.v0.services.CreateCustomerClientRequest" do
    optional :customer_id, :string, 1
    optional :customer_client, :message, 2, "google.ads.googleads.v0.resources.Customer"
  end
  add_message "google.ads.googleads.v0.services.CustomerOperation" do
    optional :update, :message, 1, "google.ads.googleads.v0.resources.Customer"
    optional :update_mask, :message, 2, "google.protobuf.FieldMask"
  end
  add_message "google.ads.googleads.v0.services.CreateCustomerClientResponse" do
    optional :resource_name, :string, 2
  end
  add_message "google.ads.googleads.v0.services.MutateCustomerResponse" do
    optional :result, :message, 2, "google.ads.googleads.v0.services.MutateCustomerResult"
  end
  add_message "google.ads.googleads.v0.services.MutateCustomerResult" do
    optional :resource_name, :string, 1
  end
