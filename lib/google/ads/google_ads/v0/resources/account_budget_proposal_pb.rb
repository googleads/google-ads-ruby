...
# source: google/ads/google_ads/v0/resources/account_budget_proposal.proto

require 'google/protobuf'

require 'google/ads/google_ads/v0/enums/account_budget_proposal_status_pb'
...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_message "google.ads.googleads.v0.resources.AccountBudgetProposal" do
    ...
    oneof :proposed_start_time do
      ...
      optional :proposed_start_time_type, :enum, 7, "google.ads.googleads.v0.enums.TimeTypeEnum.TimeType"
    end
...
module Google::Ads::GoogleAds::V0::Resources
  AccountBudgetProposal = Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v0.resources.AccountBudgetProposal").msgclass
end
