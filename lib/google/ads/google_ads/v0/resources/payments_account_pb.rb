...
# source: google/ads/google_ads/v0/resources/payments_account.proto

require 'google/protobuf'

require 'google/protobuf/wrappers_pb'
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_message "google.ads.googleads.v0.resources.PaymentsAccount" do
...
module Google
  module Ads
    module GoogleAds
      module V0
        module Resources
          PaymentsAccount = Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v0.resources.PaymentsAccount").msgclass
        end
      end
    end
  end
