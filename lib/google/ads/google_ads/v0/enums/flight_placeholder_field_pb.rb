...
# source: google/ads/google_ads/v0/enums/flight_placeholder_field.proto

require 'google/protobuf'

Google::Protobuf::DescriptorPool.generated_pool.build do
  add_message "google.ads.googleads.v0.enums.FlightPlaceholderFieldEnum" do
  end
  add_enum "google.ads.googleads.v0.enums.FlightPlaceholderFieldEnum.FlightPlaceholderField" do
    value :UNSPECIFIED, 0
    value :UNKNOWN, 1
