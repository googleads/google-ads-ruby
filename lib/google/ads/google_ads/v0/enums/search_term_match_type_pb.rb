...
# source: google/ads/google_ads/v0/enums/search_term_match_type.proto

require 'google/protobuf'

Google::Protobuf::DescriptorPool.generated_pool.build do
  add_message "google.ads.googleads.v0.enums.SearchTermMatchTypeEnum" do
  end
  add_enum "google.ads.googleads.v0.enums.SearchTermMatchTypeEnum.SearchTermMatchType" do
    value :UNSPECIFIED, 0
    value :UNKNOWN, 1
    value :BROAD, 2
    value :EXACT, 3
