...
# source: google/ads/google_ads/v0/enums/criterion_category_locale_availability_mode.proto

require 'google/protobuf'

Google::Protobuf::DescriptorPool.generated_pool.build do
  add_message "google.ads.googleads.v0.enums.CriterionCategoryLocaleAvailabilityModeEnum" do
  end
  add_enum "google.ads.googleads.v0.enums.CriterionCategoryLocaleAvailabilityModeEnum.CriterionCategoryLocaleAvailabilityMode" do
    value :UNSPECIFIED, 0
    value :UNKNOWN, 1
    value :ALL_LOCALES, 2
