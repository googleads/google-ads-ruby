...
# source: google/ads/google_ads/v0/enums/vanity_pharma_text.proto

require 'google/protobuf'

Google::Protobuf::DescriptorPool.generated_pool.build do
  add_message "google.ads.googleads.v0.enums.VanityPharmaTextEnum" do
  end
  add_enum "google.ads.googleads.v0.enums.VanityPharmaTextEnum.VanityPharmaText" do
    value :UNSPECIFIED, 0
    value :UNKNOWN, 1
...
module Google::Ads::GoogleAds::V0::Enums
  VanityPharmaTextEnum = Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v0.enums.VanityPharmaTextEnum").msgclass
  VanityPharmaTextEnum::VanityPharmaText = Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v0.enums.VanityPharmaTextEnum.VanityPharmaText").enummodule
end
