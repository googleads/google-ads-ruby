...
# source: google/ads/google_ads/v0/enums/feed_item_quality_disapproval_reason.proto

require 'google/protobuf'

Google::Protobuf::DescriptorPool.generated_pool.build do
  add_message "google.ads.googleads.v0.enums.FeedItemQualityDisapprovalReasonEnum" do
  end
  add_enum "google.ads.googleads.v0.enums.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason" do
    value :UNSPECIFIED, 0
    value :UNKNOWN, 1
...
module Google::Ads::GoogleAds::V0::Enums
  FeedItemQualityDisapprovalReasonEnum = Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v0.enums.FeedItemQualityDisapprovalReasonEnum").msgclass
  FeedItemQualityDisapprovalReasonEnum::FeedItemQualityDisapprovalReason = Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v0.enums.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason").enummodule
end
