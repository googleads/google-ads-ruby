...
# source: google/ads/google_ads/v0/enums/attribution_model.proto

require 'google/protobuf'

Google::Protobuf::DescriptorPool.generated_pool.build do
  add_message "google.ads.googleads.v0.enums.AttributionModelEnum" do
  end
  add_enum "google.ads.googleads.v0.enums.AttributionModelEnum.AttributionModel" do
    value :UNSPECIFIED, 0
    value :UNKNOWN, 1
    value :EXTERNAL, 100
