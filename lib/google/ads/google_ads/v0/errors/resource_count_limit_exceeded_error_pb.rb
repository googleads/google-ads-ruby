...
# source: google/ads/google_ads/v0/errors/resource_count_limit_exceeded_error.proto

require 'google/protobuf'

Google::Protobuf::DescriptorPool.generated_pool.build do
  add_message "google.ads.googleads.v0.errors.ResourceCountLimitExceededErrorEnum" do
  end
  add_enum "google.ads.googleads.v0.errors.ResourceCountLimitExceededErrorEnum.ResourceCountLimitExceededError" do
    value :UNSPECIFIED, 0
    value :UNKNOWN, 1
