...
# source: google/ads/google_ads/v0/errors/operation_access_denied_error.proto

require 'google/protobuf'

Google::Protobuf::DescriptorPool.generated_pool.build do
  add_message "google.ads.googleads.v0.errors.OperationAccessDeniedErrorEnum" do
  end
  add_enum "google.ads.googleads.v0.errors.OperationAccessDeniedErrorEnum.OperationAccessDeniedError" do
    value :UNSPECIFIED, 0
    value :UNKNOWN, 1
