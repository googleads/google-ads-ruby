...
# source: google/ads/google_ads/v0/errors/ad_group_error.proto

require 'google/protobuf'

Google::Protobuf::DescriptorPool.generated_pool.build do
  add_message "google.ads.googleads.v0.errors.AdGroupErrorEnum" do
  end
  add_enum "google.ads.googleads.v0.errors.AdGroupErrorEnum.AdGroupError" do
    value :UNSPECIFIED, 0
    value :UNKNOWN, 1
...
module Google::Ads::GoogleAds::V0::Errors
  AdGroupErrorEnum = Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v0.errors.AdGroupErrorEnum").msgclass
  AdGroupErrorEnum::AdGroupError = Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v0.errors.AdGroupErrorEnum.AdGroupError").enummodule
end
