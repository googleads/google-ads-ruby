...
# source: google/ads/google_ads/v0/errors/extension_setting_error.proto

require 'google/protobuf'

Google::Protobuf::DescriptorPool.generated_pool.build do
  add_message "google.ads.googleads.v0.errors.ExtensionSettingErrorEnum" do
  end
  add_enum "google.ads.googleads.v0.errors.ExtensionSettingErrorEnum.ExtensionSettingError" do
    value :UNSPECIFIED, 0
    value :UNKNOWN, 1
...
module Google::Ads::GoogleAds::V0::Errors
  ExtensionSettingErrorEnum = Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v0.errors.ExtensionSettingErrorEnum").msgclass
  ExtensionSettingErrorEnum::ExtensionSettingError = Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v0.errors.ExtensionSettingErrorEnum.ExtensionSettingError").enummodule
end
