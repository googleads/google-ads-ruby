...
# source: google/ads/google_ads/v0/errors/function_error.proto

require 'google/protobuf'

Google::Protobuf::DescriptorPool.generated_pool.build do
  add_message "google.ads.googleads.v0.errors.FunctionErrorEnum" do
  end
  add_enum "google.ads.googleads.v0.errors.FunctionErrorEnum.FunctionError" do
    value :UNSPECIFIED, 0
    value :UNKNOWN, 1
...
module Google::Ads::GoogleAds::V0::Errors
  FunctionErrorEnum = Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v0.errors.FunctionErrorEnum").msgclass
  FunctionErrorEnum::FunctionError = Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v0.errors.FunctionErrorEnum.FunctionError").enummodule
end
