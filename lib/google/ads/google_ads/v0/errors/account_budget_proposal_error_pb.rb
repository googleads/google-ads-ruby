...
# source: google/ads/google_ads/v0/errors/account_budget_proposal_error.proto

require 'google/protobuf'

Google::Protobuf::DescriptorPool.generated_pool.build do
  add_message "google.ads.googleads.v0.errors.AccountBudgetProposalErrorEnum" do
  end
  add_enum "google.ads.googleads.v0.errors.AccountBudgetProposalErrorEnum.AccountBudgetProposalError" do
    value :UNSPECIFIED, 0
    value :UNKNOWN, 1
