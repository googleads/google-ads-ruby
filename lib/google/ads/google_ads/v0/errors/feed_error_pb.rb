...
# source: google/ads/google_ads/v0/errors/feed_error.proto

require 'google/protobuf'

Google::Protobuf::DescriptorPool.generated_pool.build do
  add_message "google.ads.googleads.v0.errors.FeedErrorEnum" do
  end
  add_enum "google.ads.googleads.v0.errors.FeedErrorEnum.FeedError" do
    value :UNSPECIFIED, 0
    value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V0
        module Errors
          FeedErrorEnum = Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v0.errors.FeedErrorEnum").msgclass
          FeedErrorEnum::FeedError = Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v0.errors.FeedErrorEnum.FeedError").enummodule
        end
      end
    end
  end
