...
# source: google/ads/google_ads/v0/errors/ad_group_criterion_error.proto

require 'google/protobuf'

Google::Protobuf::DescriptorPool.generated_pool.build do
  add_message "google.ads.googleads.v0.errors.AdGroupCriterionErrorEnum" do
  end
  add_enum "google.ads.googleads.v0.errors.AdGroupCriterionErrorEnum.AdGroupCriterionError" do
    value :UNSPECIFIED, 0
    value :UNKNOWN, 1
...
module Google::Ads::GoogleAds::V0::Errors
  AdGroupCriterionErrorEnum = Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v0.errors.AdGroupCriterionErrorEnum").msgclass
  AdGroupCriterionErrorEnum::AdGroupCriterionError = Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v0.errors.AdGroupCriterionErrorEnum.AdGroupCriterionError").enummodule
end
