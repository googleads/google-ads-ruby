...
# source: google/ads/google_ads/v0/errors/media_bundle_error.proto

require 'google/protobuf'

Google::Protobuf::DescriptorPool.generated_pool.build do
  add_message "google.ads.googleads.v0.errors.MediaBundleErrorEnum" do
  end
  add_enum "google.ads.googleads.v0.errors.MediaBundleErrorEnum.MediaBundleError" do
    value :UNSPECIFIED, 0
    value :UNKNOWN, 1
    value :BAD_REQUEST, 3
...
module Google
  module Ads
    module GoogleAds
      module V0
        module Errors
          MediaBundleErrorEnum = Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v0.errors.MediaBundleErrorEnum").msgclass
          MediaBundleErrorEnum::MediaBundleError = Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v0.errors.MediaBundleErrorEnum.MediaBundleError").enummodule
        end
      end
    end
  end
