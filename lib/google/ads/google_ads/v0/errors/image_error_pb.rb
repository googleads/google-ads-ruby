...
# source: google/ads/google_ads/v0/errors/image_error.proto

require 'google/protobuf'

Google::Protobuf::DescriptorPool.generated_pool.build do
  add_message "google.ads.googleads.v0.errors.ImageErrorEnum" do
  end
  add_enum "google.ads.googleads.v0.errors.ImageErrorEnum.ImageError" do
    value :UNSPECIFIED, 0
    value :UNKNOWN, 1
