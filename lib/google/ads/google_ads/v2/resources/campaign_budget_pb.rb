...
require 'google/ads/google_ads/v2/enums/budget_delivery_method_pb'
require 'google/ads/google_ads/v2/enums/budget_period_pb'
require 'google/ads/google_ads/v2/enums/budget_status_pb'
require 'google/ads/google_ads/v2/enums/budget_type_pb'
require 'google/api/field_behavior_pb'
require 'google/api/resource_pb'
require 'google/protobuf/wrappers_pb'
require 'google/api/annotations_pb'
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v2/resources/campaign_budget.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v2.resources.CampaignBudget" do
      ...
      optional :status, :enum, 6, "google.ads.googleads.v2.enums.BudgetStatusEnum.BudgetStatus"
      optional :delivery_method, :enum, 7, "google.ads.googleads.v2.enums.BudgetDeliveryMethodEnum.BudgetDeliveryMethod"
      ...
      optional :period, :enum, 13, "google.ads.googleads.v2.enums.BudgetPeriodEnum.BudgetPeriod"
      ...
      optional :type, :enum, 18, "google.ads.googleads.v2.enums.BudgetTypeEnum.BudgetType"
    end
  end
end
...
module Google
  module Ads
    module GoogleAds
      module V2
        module Resources
          CampaignBudget = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v2.resources.CampaignBudget").msgclass
        end
      end
    end
  end
