...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v2/resources/campaign_feed.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v2.resources.CampaignFeed" do
...
module Google
  module Ads
    module GoogleAds
      module V2
        module Resources
          CampaignFeed = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v2.resources.CampaignFeed").msgclass
        end
      end
    end
  end
