...
require 'google/ads/google_ads/v2/enums/google_ads_field_category_pb'
require 'google/ads/google_ads/v2/enums/google_ads_field_data_type_pb'
require 'google/api/field_behavior_pb'
require 'google/api/resource_pb'
require 'google/protobuf/wrappers_pb'
require 'google/api/annotations_pb'
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v2/resources/google_ads_field.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v2.resources.GoogleAdsField" do
      optional :resource_name, :string, 1
      optional :name, :message, 2, "google.protobuf.StringValue"
      optional :category, :enum, 3, "google.ads.googleads.v2.enums.GoogleAdsFieldCategoryEnum.GoogleAdsFieldCategory"
      ...
      optional :data_type, :enum, 12, "google.ads.googleads.v2.enums.GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType"
...
module Google
  module Ads
    module GoogleAds
      module V2
        module Resources
          GoogleAdsField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v2.resources.GoogleAdsField").msgclass
        end
      end
    end
  end
