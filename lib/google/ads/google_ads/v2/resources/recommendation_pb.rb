...
require 'google/ads/google_ads/v2/enums/recommendation_type_pb'
require 'google/ads/google_ads/v2/enums/target_cpa_opt_in_recommendation_goal_pb'
...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v2/resources/recommendation.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v2.resources.Recommendation" do
      optional :resource_name, :string, 1
      optional :type, :enum, 2, "google.ads.googleads.v2.enums.RecommendationTypeEnum.RecommendationType"
      optional :impact, :message, 3, "google.ads.googleads.v2.resources.Recommendation.RecommendationImpact"
      ...
      oneof :recommendation do
        optional :campaign_budget_recommendation, :message, 4, "google.ads.googleads.v2.resources.Recommendation.CampaignBudgetRecommendation"
        optional :keyword_recommendation, :message, 8, "google.ads.googleads.v2.resources.Recommendation.KeywordRecommendation"
        optional :text_ad_recommendation, :message, 9, "google.ads.googleads.v2.resources.Recommendation.TextAdRecommendation"
        optional :target_cpa_opt_in_recommendation, :message, 10, "google.ads.googleads.v2.resources.Recommendation.TargetCpaOptInRecommendation"
        optional :maximize_conversions_opt_in_recommendation, :message, 11, "google.ads.googleads.v2.resources.Recommendation.MaximizeConversionsOptInRecommendation"
        optional :enhanced_cpc_opt_in_recommendation, :message, 12, "google.ads.googleads.v2.resources.Recommendation.EnhancedCpcOptInRecommendation"
        optional :search_partners_opt_in_recommendation, :message, 14, "google.ads.googleads.v2.resources.Recommendation.SearchPartnersOptInRecommendation"
        optional :maximize_clicks_opt_in_recommendation, :message, 15, "google.ads.googleads.v2.resources.Recommendation.MaximizeClicksOptInRecommendation"
        optional :optimize_ad_rotation_recommendation, :message, 16, "google.ads.googleads.v2.resources.Recommendation.OptimizeAdRotationRecommendation"
        optional :callout_extension_recommendation, :message, 17, "google.ads.googleads.v2.resources.Recommendation.CalloutExtensionRecommendation"
        optional :sitelink_extension_recommendation, :message, 18, "google.ads.googleads.v2.resources.Recommendation.SitelinkExtensionRecommendation"
        optional :call_extension_recommendation, :message, 19, "google.ads.googleads.v2.resources.Recommendation.CallExtensionRecommendation"
        optional :keyword_match_type_recommendation, :message, 20, "google.ads.googleads.v2.resources.Recommendation.KeywordMatchTypeRecommendation"
        optional :move_unused_budget_recommendation, :message, 21, "google.ads.googleads.v2.resources.Recommendation.MoveUnusedBudgetRecommendation"
      end
    end
    add_message "google.ads.googleads.v2.resources.Recommendation.RecommendationImpact" do
      optional :base_metrics, :message, 1, "google.ads.googleads.v2.resources.Recommendation.RecommendationMetrics"
      optional :potential_metrics, :message, 2, "google.ads.googleads.v2.resources.Recommendation.RecommendationMetrics"
    end
    add_message "google.ads.googleads.v2.resources.Recommendation.RecommendationMetrics" do
    ...
    add_message "google.ads.googleads.v2.resources.Recommendation.CampaignBudgetRecommendation" do
      ...
      repeated :budget_options, :message, 3, "google.ads.googleads.v2.resources.Recommendation.CampaignBudgetRecommendation.CampaignBudgetRecommendationOption"
    end
    add_message "google.ads.googleads.v2.resources.Recommendation.CampaignBudgetRecommendation.CampaignBudgetRecommendationOption" do
      optional :budget_amount_micros, :message, 1, "google.protobuf.Int64Value"
      optional :impact, :message, 2, "google.ads.googleads.v2.resources.Recommendation.RecommendationImpact"
    end
    add_message "google.ads.googleads.v2.resources.Recommendation.KeywordRecommendation" do
    ...
    add_message "google.ads.googleads.v2.resources.Recommendation.TargetCpaOptInRecommendation" do
      repeated :options, :message, 1, "google.ads.googleads.v2.resources.Recommendation.TargetCpaOptInRecommendation.TargetCpaOptInRecommendationOption"
      optional :recommended_target_cpa_micros, :message, 2, "google.protobuf.Int64Value"
    end
    add_message "google.ads.googleads.v2.resources.Recommendation.TargetCpaOptInRecommendation.TargetCpaOptInRecommendationOption" do
      optional :goal, :enum, 1, "google.ads.googleads.v2.enums.TargetCpaOptInRecommendationGoalEnum.TargetCpaOptInRecommendationGoal"
      ...
      optional :impact, :message, 4, "google.ads.googleads.v2.resources.Recommendation.RecommendationImpact"
    end
...
module Google
  module Ads
    module GoogleAds
      module V2
        module Resources
          Recommendation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v2.resources.Recommendation").msgclass
          Recommendation::RecommendationImpact = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v2.resources.Recommendation.RecommendationImpact").msgclass
          Recommendation::RecommendationMetrics = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v2.resources.Recommendation.RecommendationMetrics").msgclass
