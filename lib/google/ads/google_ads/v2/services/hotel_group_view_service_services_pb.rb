...
# Source: google/ads/google_ads/v2/services/hotel_group_view_service.proto for package 'Google::Ads::GoogleAds::V2::Services'
...
module Google::Ads::GoogleAds::V2::Services
  module HotelGroupViewService
    ...
    class Service
      ...
      rpc :GetHotelGroupView, GetHotelGroupViewRequest, Google::Ads::GoogleAds::V2::Resources::HotelGroupView
    end
