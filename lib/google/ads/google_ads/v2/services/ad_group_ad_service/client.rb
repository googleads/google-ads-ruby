...
require "google/ads/google_ads/v2/services/ad_group_ad_service/credentials"
require "google/ads/google_ads/v2/services/ad_group_ad_service/paths"
        ...
        module Services
          module AdGroupAdService
            ...
            class Client
              ...
              #
              # See {Google::Ads::GoogleAds::V2::Services::AdGroupAdService::Client::Configuration}
              ...
              #
              #     Google::Ads::GoogleAds::V2::Services::AdGroupAdService::Client.configure do |config|
              ...
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V2::Services::AdGroupAdService::Client.new
              #
              # To create a new AdGroupAdService client with a custom
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V2::Services::AdGroupAdService::Client.new do |config|
              #       config.timeout = 10_000
              #     end
              #
              ...
              def initialize
                ...
                @ad_group_ad_service_stub = Gapic::ServiceStub.new(
                  Google::Ads::GoogleAds::V2::Services::AdGroupAdService::Stub,
              ...
              #   @param request [Google::Ads::GoogleAds::V2::Services::GetAdGroupAdRequest | Hash]
              #     Returns the requested ad in full detail.
              ...
              # @yieldparam response [Google::Ads::GoogleAds::V2::Resources::AdGroupAd]
              ...
              def get_ad_group_ad request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V2::Services::GetAdGroupAdRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V2::Services::MutateAdGroupAdsRequest | Hash]
              #     Creates, updates, or removes ads. Operation statuses are returned.
              #   @param options [Gapic::CallOptions, Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [Google::Ads::GoogleAds::V2::Services::MutateAdGroupAdsResponse]
              # @yieldparam operation [GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_ad_group_ads request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V2::Services::MutateAdGroupAdsRequest
              ...
              # {Google::Ads::GoogleAds::V2::Services::AdGroupAdService::Client::Configuration::Rpcs}
              ...
              #     Google::Ads::GoogleAds::V2::Services::AdGroupAdService::Client.configure do |config|
              #       config.timeout = 10_000
              #       config.rpcs.get_ad_group_ad.timeout = 20_000
              #     end
              #
...
begin
  require "google/ads/google_ads/v2/services/ad_group_ad_service/helpers"
rescue LoadError
end
