...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v2/services/campaign_budget_service.proto,
    ...
    module GoogleAds
      module V2
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V2::Services::CampaignBudgetService::Stub]
          class CampaignBudgetServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v2/services/campaign_budget_service_services_pb"
              ...
              @campaign_budget_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V2::Services::CampaignBudgetService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V2::Resources::CampaignBudget]
            ...
            #
            #   campaign_budget_client = Google::Ads::GoogleAds::CampaignBudget.new(version: :v2)
            #   formatted_resource_name = Google::Ads::GoogleAds::V2::Services::CampaignBudgetServiceClient.campaign_budget_path("[CUSTOMER]", "[CAMPAIGN_BUDGET]")
            #   response = campaign_budget_client.get_campaign_budget(formatted_resource_name)
            ...
            def get_campaign_budget \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::GetCampaignBudgetRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V2::Services::CampaignBudgetOperation | Hash>]
            #   The list of operations to perform on individual campaign budgets.
            #   A hash of the same form as `Google::Ads::GoogleAds::V2::Services::CampaignBudgetOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V2::Services::MutateCampaignBudgetsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V2::Services::MutateCampaignBudgetsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            #   operations = []
            #   response = campaign_budget_client.mutate_campaign_budgets(customer_id, operations)
            ...
            def mutate_campaign_budgets \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::MutateCampaignBudgetsRequest)
