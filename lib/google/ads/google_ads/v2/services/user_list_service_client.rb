...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v2/services/user_list_service.proto,
    ...
    module GoogleAds
      module V2
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V2::Services::UserListService::Stub]
          class UserListServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v2/services/user_list_service_services_pb"
              ...
              @user_list_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V2::Services::UserListService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V2::Resources::UserList]
            ...
            #
            #   user_list_client = Google::Ads::GoogleAds::UserList.new(version: :v2)
            #   formatted_resource_name = Google::Ads::GoogleAds::V2::Services::UserListServiceClient.user_list_path("[CUSTOMER]", "[USER_LIST]")
            ...
            def get_user_list \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::GetUserListRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V2::Services::UserListOperation | Hash>]
            #   The list of operations to perform on individual user lists.
            #   A hash of the same form as `Google::Ads::GoogleAds::V2::Services::UserListOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V2::Services::MutateUserListsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V2::Services::MutateUserListsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_user_lists \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::MutateUserListsRequest)
