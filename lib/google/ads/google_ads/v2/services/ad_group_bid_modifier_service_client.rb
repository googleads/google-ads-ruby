...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v2/services/ad_group_bid_modifier_service.proto,
    ...
    module GoogleAds
      module V2
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V2::Services::AdGroupBidModifierService::Stub]
          class AdGroupBidModifierServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v2/services/ad_group_bid_modifier_service_services_pb"
              ...
              @ad_group_bid_modifier_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V2::Services::AdGroupBidModifierService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V2::Resources::AdGroupBidModifier]
            ...
            #
            #   ad_group_bid_modifier_client = Google::Ads::GoogleAds::AdGroupBidModifier.new(version: :v2)
            #   formatted_resource_name = Google::Ads::GoogleAds::V2::Services::AdGroupBidModifierServiceClient.ad_group_bid_modifier_path("[CUSTOMER]", "[AD_GROUP_BID_MODIFIER]")
            #   response = ad_group_bid_modifier_client.get_ad_group_bid_modifier(formatted_resource_name)
            ...
            def get_ad_group_bid_modifier \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::GetAdGroupBidModifierRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V2::Services::AdGroupBidModifierOperation | Hash>]
            #   The list of operations to perform on individual ad group bid modifiers.
            #   A hash of the same form as `Google::Ads::GoogleAds::V2::Services::AdGroupBidModifierOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V2::Services::MutateAdGroupBidModifiersResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V2::Services::MutateAdGroupBidModifiersResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            #   operations = []
            #   response = ad_group_bid_modifier_client.mutate_ad_group_bid_modifiers(customer_id, operations)
            ...
            def mutate_ad_group_bid_modifiers \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::MutateAdGroupBidModifiersRequest)
