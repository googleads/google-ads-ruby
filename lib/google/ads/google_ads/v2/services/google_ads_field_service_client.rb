...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v2/services/google_ads_field_service.proto,
    ...
    module GoogleAds
      module V2
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V2::Services::GoogleAdsFieldService::Stub]
          class GoogleAdsFieldServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v2/services/google_ads_field_service_services_pb"
              ...
              @google_ads_field_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V2::Services::GoogleAdsFieldService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V2::Resources::GoogleAdsField]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V2::Resources::GoogleAdsField]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            #   google_ads_field_client = Google::Ads::GoogleAds::GoogleAdsField.new(version: :v2)
            #   formatted_resource_name = Google::Ads::GoogleAds::V2::Services::GoogleAdsFieldServiceClient.google_ads_field_path("[GOOGLE_ADS_FIELD]")
            ...
            def get_google_ads_field \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::GetGoogleAdsFieldRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Gax::PagedEnumerable<Google::Ads::GoogleAds::V2::Resources::GoogleAdsField>]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Gax::PagedEnumerable<Google::Ads::GoogleAds::V2::Resources::GoogleAdsField>]
            #   An enumerable of Google::Ads::GoogleAds::V2::Resources::GoogleAdsField instances.
            ...
            def search_google_ads_fields \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::SearchGoogleAdsFieldsRequest)
