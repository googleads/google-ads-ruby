...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v2/services/conversion_upload_service.proto,
    ...
    module GoogleAds
      module V2
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V2::Services::ConversionUploadService::Stub]
          class ConversionUploadServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v2/services/conversion_upload_service_services_pb"
              ...
              @conversion_upload_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V2::Services::ConversionUploadService::Stub.method(:new)
              )
            ...
            # @param conversions [Array<Google::Ads::GoogleAds::V2::Services::ClickConversion | Hash>]
            #   The conversions that are being uploaded.
            #   A hash of the same form as `Google::Ads::GoogleAds::V2::Services::ClickConversion`
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V2::Services::UploadClickConversionsResponse]
            ...
            #
            #   conversion_upload_client = Google::Ads::GoogleAds::ConversionUpload.new(version: :v2)
            #
            ...
            def upload_click_conversions \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::UploadClickConversionsRequest)
            ...
            # @param customer_id [String]
            #   The ID of the customer performing the upload.
            # @param conversions [Array<Google::Ads::GoogleAds::V2::Services::CallConversion | Hash>]
            #   The conversions that are being uploaded.
            #   A hash of the same form as `Google::Ads::GoogleAds::V2::Services::CallConversion`
            #   can also be provided.
            # @param partial_failure [true, false]
            #   If true, successful operations will be carried out and invalid
            #   operations will return errors. If false, all operations will be carried
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V2::Services::UploadCallConversionsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def upload_call_conversions \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::UploadCallConversionsRequest)
