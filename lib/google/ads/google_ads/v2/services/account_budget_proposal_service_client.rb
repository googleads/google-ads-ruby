...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v2/services/account_budget_proposal_service.proto,
...
require "google/ads/google_ads/v2/services/account_budget_proposal_service_pb"
    ...
    module GoogleAds
      module V2
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V2::Services::AccountBudgetProposalService::Stub]
          class AccountBudgetProposalServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v2/services/account_budget_proposal_service_services_pb"
              ...
              @account_budget_proposal_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V2::Services::AccountBudgetProposalService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V2::Resources::AccountBudgetProposal]
            ...
            #
            #   account_budget_proposal_client = Google::Ads::GoogleAds::AccountBudgetProposal.new(version: :v2)
            #   formatted_resource_name = Google::Ads::GoogleAds::V2::Services::AccountBudgetProposalServiceClient.account_budget_proposal_path("[CUSTOMER]", "[ACCOUNT_BUDGET_PROPOSAL]")
            ...
            def get_account_budget_proposal \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::GetAccountBudgetProposalRequest)
            ...
            # @param operation [Google::Ads::GoogleAds::V2::Services::AccountBudgetProposalOperation | Hash]
            #   The operation to perform on an individual account-level budget proposal.
            #   A hash of the same form as `Google::Ads::GoogleAds::V2::Services::AccountBudgetProposalOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V2::Services::MutateAccountBudgetProposalResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V2::Services::MutateAccountBudgetProposalResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_account_budget_proposal \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::MutateAccountBudgetProposalRequest)
