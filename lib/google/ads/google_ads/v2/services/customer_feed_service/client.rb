...
require "google/ads/google_ads/v2/services/customer_feed_service/credentials"
require "google/ads/google_ads/v2/services/customer_feed_service/paths"
        ...
        module Services
          module CustomerFeedService
            ...
            class Client
              ...
              #
              # See {Google::Ads::GoogleAds::V2::Services::CustomerFeedService::Client::Configuration}
              ...
              #
              #     Google::Ads::GoogleAds::V2::Services::CustomerFeedService::Client.configure do |config|
              ...
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V2::Services::CustomerFeedService::Client.new
              #
              # To create a new CustomerFeedService client with a custom
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V2::Services::CustomerFeedService::Client.new do |config|
              #       config.timeout = 10_000
              #     end
              #
              ...
              def initialize
                ...
                @customer_feed_service_stub = Gapic::ServiceStub.new(
                  Google::Ads::GoogleAds::V2::Services::CustomerFeedService::Stub,
              ...
              #   @param request [Google::Ads::GoogleAds::V2::Services::GetCustomerFeedRequest | Hash]
              #     Returns the requested customer feed in full detail.
              ...
              # @yieldparam response [Google::Ads::GoogleAds::V2::Resources::CustomerFeed]
              ...
              def get_customer_feed request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V2::Services::GetCustomerFeedRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V2::Services::MutateCustomerFeedsRequest | Hash]
              #     Creates, updates, or removes customer feeds. Operation statuses are
              #     returned.
              #   @param options [Gapic::CallOptions, Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @overload mutate_customer_feeds(customer_id: nil, operations: nil, partial_failure: nil, validate_only: nil)
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [Google::Ads::GoogleAds::V2::Services::MutateCustomerFeedsResponse]
              # @yieldparam operation [GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_customer_feeds request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V2::Services::MutateCustomerFeedsRequest
              ...
              # {Google::Ads::GoogleAds::V2::Services::CustomerFeedService::Client::Configuration::Rpcs}
              ...
              #     Google::Ads::GoogleAds::V2::Services::CustomerFeedService::Client.configure do |config|
              #       config.timeout = 10_000
              #       config.rpcs.get_customer_feed.timeout = 20_000
              #     end
              #
...
begin
  require "google/ads/google_ads/v2/services/customer_feed_service/helpers"
rescue LoadError
end
