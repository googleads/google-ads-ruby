...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v2/services/media_file_service.proto,
    ...
    module GoogleAds
      module V2
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V2::Services::MediaFileService::Stub]
          class MediaFileServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v2/services/media_file_service_services_pb"
              ...
              @media_file_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V2::Services::MediaFileService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V2::Resources::MediaFile]
            ...
            #
            #   media_file_client = Google::Ads::GoogleAds::MediaFile.new(version: :v2)
            #   formatted_resource_name = Google::Ads::GoogleAds::V2::Services::MediaFileServiceClient.media_file_path("[CUSTOMER]", "[MEDIA_FILE]")
            ...
            def get_media_file \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::GetMediaFileRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V2::Services::MediaFileOperation | Hash>]
            #   The list of operations to perform on individual media file.
            #   A hash of the same form as `Google::Ads::GoogleAds::V2::Services::MediaFileOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V2::Services::MutateMediaFilesResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V2::Services::MutateMediaFilesResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_media_files \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::MutateMediaFilesRequest)
