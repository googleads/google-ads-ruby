        ...
        module Services
          module CustomerExtensionSettingService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V2::Services::CustomerExtensionSettingService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V2::Services::CustomerExtensionSettingService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V2::Services::CustomerExtensionSettingService::Client.new
              #
              # To create a new CustomerExtensionSettingService client with a custom
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V2::Services::CustomerExtensionSettingService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                @customer_extension_setting_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V2::Services::CustomerExtensionSettingService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V2::Services::GetCustomerExtensionSettingRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V2::Services::GetCustomerExtensionSettingRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V2::Resources::CustomerExtensionSetting]
              ...
              def get_customer_extension_setting request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V2::Services::GetCustomerExtensionSettingRequest
              ...
              #   {::Google::Ads::GoogleAds::V2::Services::MutateCustomerExtensionSettingsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V2::Services::MutateCustomerExtensionSettingsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V2::Services::MutateCustomerExtensionSettingsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_customer_extension_settings request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V2::Services::MutateCustomerExtensionSettingsRequest
              ...
              # {::Google::Ads::GoogleAds::V2::Services::CustomerExtensionSettingService::Client::Configuration::Rpcs}
