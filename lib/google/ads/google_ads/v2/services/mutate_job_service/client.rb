        ...
        module Services
          module MutateJobService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V2::Services::MutateJobService::Client::Configuration}
              ...
              #
              #     ::Google::Ads::GoogleAds::V2::Services::MutateJobService::Client.configure do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V2::Services::MutateJobService::Client.new
              #
              # To create a new MutateJobService client with a custom
              # configuration:
              #
              #     client = ::Google::Ads::GoogleAds::V2::Services::MutateJobService::Client.new do |config|
              #       config.timeout = 10.0
              #     end
              #
              ...
              def initialize
                ...
                @mutate_job_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V2::Services::MutateJobService::Stub,
              ...
              #
              # @return [::Google::Ads::GoogleAds::V2::Services::MutateJobService::Operations]
              #
              ...
              #   Pass arguments to `create_mutate_job` via a request object, either of type
              #   {::Google::Ads::GoogleAds::V2::Services::CreateMutateJobRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V2::Services::CreateMutateJobRequest, ::Hash]
              ...
              #   Pass arguments to `create_mutate_job` via keyword arguments. Note that at
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V2::Services::CreateMutateJobResponse]
              ...
              def create_mutate_job request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V2::Services::CreateMutateJobRequest
              ...
              #   Pass arguments to `get_mutate_job` via a request object, either of type
              #   {::Google::Ads::GoogleAds::V2::Services::GetMutateJobRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V2::Services::GetMutateJobRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   Pass arguments to `get_mutate_job` via keyword arguments. Note that at
              #   least one keyword argument is required. To specify no parameters, or to keep all
              #   the default parameter values, pass an empty Hash as a request object (see above).
              #
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V2::Resources::MutateJob]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def get_mutate_job request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V2::Services::GetMutateJobRequest
              ...
              #   Pass arguments to `list_mutate_job_results` via a request object, either of type
              #   {::Google::Ads::GoogleAds::V2::Services::ListMutateJobResultsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V2::Services::ListMutateJobResultsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   Pass arguments to `list_mutate_job_results` via keyword arguments. Note that at
              #   least one keyword argument is required. To specify no parameters, or to keep all
              #   the default parameter values, pass an empty Hash as a request object (see above).
              #
              #   @param resource_name [::String]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Gapic::PagedEnumerable<::Google::Ads::GoogleAds::V2::Services::MutateJobResult>]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Gapic::PagedEnumerable<::Google::Ads::GoogleAds::V2::Services::MutateJobResult>]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              def list_mutate_job_results request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V2::Services::ListMutateJobResultsRequest
              ...
              #   Pass arguments to `run_mutate_job` via a request object, either of type
              #   {::Google::Ads::GoogleAds::V2::Services::RunMutateJobRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V2::Services::RunMutateJobRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   Pass arguments to `run_mutate_job` via keyword arguments. Note that at
              #   least one keyword argument is required. To specify no parameters, or to keep all
              #   the default parameter values, pass an empty Hash as a request object (see above).
              #
              #   @param resource_name [::String]
              ...
              def run_mutate_job request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V2::Services::RunMutateJobRequest
              ...
              #   Pass arguments to `add_mutate_job_operations` via a request object, either of type
              #   {::Google::Ads::GoogleAds::V2::Services::AddMutateJobOperationsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V2::Services::AddMutateJobOperationsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   Pass arguments to `add_mutate_job_operations` via keyword arguments. Note that at
              #   least one keyword argument is required. To specify no parameters, or to keep all
              #   the default parameter values, pass an empty Hash as a request object (see above).
              #
              #   @param resource_name [::String]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V2::Services::AddMutateJobOperationsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def add_mutate_job_operations request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V2::Services::AddMutateJobOperationsRequest
              ...
              # {::Google::Ads::GoogleAds::V2::Services::MutateJobService::Client::Configuration::Rpcs}
              ...
              #     ::Google::Ads::GoogleAds::V2::Services::MutateJobService::Client.configure do |config|
              #       config.timeout = 10.0
              #       config.rpcs.create_mutate_job.timeout = 20.0
              #     end
              #
