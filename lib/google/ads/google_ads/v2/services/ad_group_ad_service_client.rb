...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v2/services/ad_group_ad_service.proto,
    ...
    module GoogleAds
      module V2
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V2::Services::AdGroupAdService::Stub]
          class AdGroupAdServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v2/services/ad_group_ad_service_services_pb"
              ...
              @ad_group_ad_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V2::Services::AdGroupAdService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V2::Resources::AdGroupAd]
            ...
            #
            #   ad_group_ad_client = Google::Ads::GoogleAds::AdGroupAd.new(version: :v2)
            #   formatted_resource_name = Google::Ads::GoogleAds::V2::Services::AdGroupAdServiceClient.ad_group_ad_path("[CUSTOMER]", "[AD_GROUP_AD]")
            ...
            def get_ad_group_ad \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::GetAdGroupAdRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V2::Services::AdGroupAdOperation | Hash>]
            #   The list of operations to perform on individual ads.
            #   A hash of the same form as `Google::Ads::GoogleAds::V2::Services::AdGroupAdOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V2::Services::MutateAdGroupAdsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V2::Services::MutateAdGroupAdsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_ad_group_ads \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::MutateAdGroupAdsRequest)
