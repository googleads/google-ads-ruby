...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v2/services/keyword_plan_keyword_service.proto,
...
require "google/ads/google_ads/v2/services/keyword_plan_keyword_service_pb"
    ...
    module GoogleAds
      module V2
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V2::Services::KeywordPlanKeywordService::Stub]
          class KeywordPlanKeywordServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v2/services/keyword_plan_keyword_service_services_pb"
              ...
              @keyword_plan_keyword_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V2::Services::KeywordPlanKeywordService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V2::Resources::KeywordPlanKeyword]
            ...
            #
            #   keyword_plan_keyword_client = Google::Ads::GoogleAds::KeywordPlanKeyword.new(version: :v2)
            #   formatted_resource_name = Google::Ads::GoogleAds::V2::Services::KeywordPlanKeywordServiceClient.keyword_plan_keyword_path("[CUSTOMER]", "[KEYWORD_PLAN_KEYWORD]")
            ...
            def get_keyword_plan_keyword \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::GetKeywordPlanKeywordRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V2::Services::KeywordPlanKeywordOperation | Hash>]
            #   The list of operations to perform on individual Keyword Plan keywords.
            #   A hash of the same form as `Google::Ads::GoogleAds::V2::Services::KeywordPlanKeywordOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V2::Services::MutateKeywordPlanKeywordsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V2::Services::MutateKeywordPlanKeywordsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_keyword_plan_keywords \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::MutateKeywordPlanKeywordsRequest)
