...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v2/services/age_range_view_service.proto,
    ...
    module GoogleAds
      module V2
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V2::Services::AgeRangeViewService::Stub]
          class AgeRangeViewServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v2/services/age_range_view_service_services_pb"
              ...
              @age_range_view_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V2::Services::AgeRangeViewService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V2::Resources::AgeRangeView]
            ...
            #
            #   age_range_view_client = Google::Ads::GoogleAds::AgeRangeView.new(version: :v2)
            #   formatted_resource_name = Google::Ads::GoogleAds::V2::Services::AgeRangeViewServiceClient.age_range_view_path("[CUSTOMER]", "[AGE_RANGE_VIEW]")
            ...
            def get_age_range_view \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::GetAgeRangeViewRequest)
