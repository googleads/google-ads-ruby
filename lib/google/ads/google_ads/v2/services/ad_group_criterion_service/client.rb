...
require "google/ads/google_ads/v2/services/ad_group_criterion_service/credentials"
require "google/ads/google_ads/v2/services/ad_group_criterion_service/paths"
        ...
        module Services
          module AdGroupCriterionService
            ...
            class Client
              ...
              #
              # See {Google::Ads::GoogleAds::V2::Services::AdGroupCriterionService::Client::Configuration}
              ...
              #
              #     Google::Ads::GoogleAds::V2::Services::AdGroupCriterionService::Client.configure do |config|
              ...
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V2::Services::AdGroupCriterionService::Client.new
              #
              # To create a new AdGroupCriterionService client with a custom
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V2::Services::AdGroupCriterionService::Client.new do |config|
              #       config.timeout = 10_000
              #     end
              #
              ...
              def initialize
                ...
                @ad_group_criterion_service_stub = Gapic::ServiceStub.new(
                  Google::Ads::GoogleAds::V2::Services::AdGroupCriterionService::Stub,
              ...
              #   @param request [Google::Ads::GoogleAds::V2::Services::GetAdGroupCriterionRequest | Hash]
              #     Returns the requested criterion in full detail.
              ...
              # @yieldparam response [Google::Ads::GoogleAds::V2::Resources::AdGroupCriterion]
              ...
              def get_ad_group_criterion request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V2::Services::GetAdGroupCriterionRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V2::Services::MutateAdGroupCriteriaRequest | Hash]
              #     Creates, updates, or removes criteria. Operation statuses are returned.
              #   @param options [Gapic::CallOptions, Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @overload mutate_ad_group_criteria(customer_id: nil, operations: nil, partial_failure: nil, validate_only: nil)
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [Google::Ads::GoogleAds::V2::Services::MutateAdGroupCriteriaResponse]
              # @yieldparam operation [GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_ad_group_criteria request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V2::Services::MutateAdGroupCriteriaRequest
              ...
              # {Google::Ads::GoogleAds::V2::Services::AdGroupCriterionService::Client::Configuration::Rpcs}
              ...
              #     Google::Ads::GoogleAds::V2::Services::AdGroupCriterionService::Client.configure do |config|
              #       config.timeout = 10_000
              #       config.rpcs.get_ad_group_criterion.timeout = 20_000
              #     end
              #
...
begin
  require "google/ads/google_ads/v2/services/ad_group_criterion_service/helpers"
rescue LoadError
end
