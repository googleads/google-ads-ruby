...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v2/services/ad_group_criterion_simulation_service.proto,
...
require "google/ads/google_ads/v2/services/ad_group_criterion_simulation_service_pb"
    ...
    module GoogleAds
      module V2
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V2::Services::AdGroupCriterionSimulationService::Stub]
          class AdGroupCriterionSimulationServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v2/services/ad_group_criterion_simulation_service_services_pb"
              ...
              @ad_group_criterion_simulation_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V2::Services::AdGroupCriterionSimulationService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V2::Resources::AdGroupCriterionSimulation]
            ...
            #
            #   ad_group_criterion_simulation_client = Google::Ads::GoogleAds::AdGroupCriterionSimulation.new(version: :v2)
            #   formatted_resource_name = Google::Ads::GoogleAds::V2::Services::AdGroupCriterionSimulationServiceClient.ad_group_criterion_simulation_path("[CUSTOMER]", "[AD_GROUP_CRITERION_SIMULATION]")
            ...
            def get_ad_group_criterion_simulation \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::GetAdGroupCriterionSimulationRequest)
