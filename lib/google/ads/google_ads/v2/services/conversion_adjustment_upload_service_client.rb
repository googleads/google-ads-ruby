...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v2/services/conversion_adjustment_upload_service.proto,
...
require "google/ads/google_ads/v2/services/conversion_adjustment_upload_service_pb"
    ...
    module GoogleAds
      module V2
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V2::Services::ConversionAdjustmentUploadService::Stub]
          class ConversionAdjustmentUploadServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v2/services/conversion_adjustment_upload_service_services_pb"
              ...
              @conversion_adjustment_upload_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V2::Services::ConversionAdjustmentUploadService::Stub.method(:new)
              )
            ...
            # @param conversion_adjustments [Array<Google::Ads::GoogleAds::V2::Services::ConversionAdjustment | Hash>]
            #   The conversion adjustments that are being uploaded.
            #   A hash of the same form as `Google::Ads::GoogleAds::V2::Services::ConversionAdjustment`
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V2::Services::UploadConversionAdjustmentsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V2::Services::UploadConversionAdjustmentsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            #   conversion_adjustment_upload_client = Google::Ads::GoogleAds::ConversionAdjustmentUpload.new(version: :v2)
            #
            ...
            def upload_conversion_adjustments \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::UploadConversionAdjustmentsRequest)
