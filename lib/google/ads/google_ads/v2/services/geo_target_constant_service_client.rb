...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v2/services/geo_target_constant_service.proto,
...
require "google/ads/google_ads/v2/services/geo_target_constant_service_pb"
    ...
    module GoogleAds
      module V2
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V2::Services::GeoTargetConstantService::Stub]
          class GeoTargetConstantServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v2/services/geo_target_constant_service_services_pb"
              ...
              @geo_target_constant_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V2::Services::GeoTargetConstantService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V2::Resources::GeoTargetConstant]
            ...
            #
            #   geo_target_constant_client = Google::Ads::GoogleAds::GeoTargetConstant.new(version: :v2)
            #   formatted_resource_name = Google::Ads::GoogleAds::V2::Services::GeoTargetConstantServiceClient.geo_target_constant_path("[GEO_TARGET_CONSTANT]")
            ...
            def get_geo_target_constant \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::GetGeoTargetConstantRequest)
            ...
            #   A hash of the same form as `Google::Protobuf::StringValue`
            #   can also be provided.
            # @param location_names [Google::Ads::GoogleAds::V2::Services::SuggestGeoTargetConstantsRequest::LocationNames | Hash]
            #   The location names to search by. At most 25 names can be set.
            #   A hash of the same form as `Google::Ads::GoogleAds::V2::Services::SuggestGeoTargetConstantsRequest::LocationNames`
            #   can also be provided.
            # @param geo_targets [Google::Ads::GoogleAds::V2::Services::SuggestGeoTargetConstantsRequest::GeoTargets | Hash]
            #   The geo target constant resource names to filter by.
            #   A hash of the same form as `Google::Ads::GoogleAds::V2::Services::SuggestGeoTargetConstantsRequest::GeoTargets`
            #   can also be provided.
            # @param options [Google::Gax::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout,
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V2::Services::SuggestGeoTargetConstantsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def suggest_geo_target_constants \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::SuggestGeoTargetConstantsRequest)
