...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v2/services/shared_set_service.proto,
    ...
    module GoogleAds
      module V2
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V2::Services::SharedSetService::Stub]
          class SharedSetServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v2/services/shared_set_service_services_pb"
              ...
              @shared_set_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V2::Services::SharedSetService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V2::Resources::SharedSet]
            ...
            #
            #   shared_set_client = Google::Ads::GoogleAds::SharedSet.new(version: :v2)
            #   formatted_resource_name = Google::Ads::GoogleAds::V2::Services::SharedSetServiceClient.shared_set_path("[CUSTOMER]", "[SHARED_SET]")
            #   response = shared_set_client.get_shared_set(formatted_resource_name)
            ...
            def get_shared_set \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::GetSharedSetRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V2::Services::SharedSetOperation | Hash>]
            #   The list of operations to perform on individual shared sets.
            #   A hash of the same form as `Google::Ads::GoogleAds::V2::Services::SharedSetOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V2::Services::MutateSharedSetsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V2::Services::MutateSharedSetsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            #   operations = []
            #   response = shared_set_client.mutate_shared_sets(customer_id, operations)
            ...
            def mutate_shared_sets \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V2::Services::MutateSharedSetsRequest)
