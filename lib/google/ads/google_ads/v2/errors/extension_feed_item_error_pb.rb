...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v2/errors/extension_feed_item_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v2.errors.ExtensionFeedItemErrorEnum" do
    end
    add_enum "google.ads.googleads.v2.errors.ExtensionFeedItemErrorEnum.ExtensionFeedItemError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V2
        module Errors
          ExtensionFeedItemErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v2.errors.ExtensionFeedItemErrorEnum").msgclass
          ExtensionFeedItemErrorEnum::ExtensionFeedItemError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v2.errors.ExtensionFeedItemErrorEnum.ExtensionFeedItemError").enummodule
        end
      end
    end
  end
