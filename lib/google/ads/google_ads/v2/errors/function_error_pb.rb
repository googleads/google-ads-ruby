...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v2/errors/function_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v2.errors.FunctionErrorEnum" do
    end
    add_enum "google.ads.googleads.v2.errors.FunctionErrorEnum.FunctionError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V2
        module Errors
          FunctionErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v2.errors.FunctionErrorEnum").msgclass
          FunctionErrorEnum::FunctionError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v2.errors.FunctionErrorEnum.FunctionError").enummodule
        end
      end
    end
  end
