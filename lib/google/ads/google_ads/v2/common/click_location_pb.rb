...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v2/common/click_location.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v2.common.ClickLocation" do
...
module Google
  module Ads
    module GoogleAds
      module V2
        module Common
          ClickLocation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v2.common.ClickLocation").msgclass
        end
      end
    end
  end
