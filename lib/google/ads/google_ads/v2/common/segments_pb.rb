...
require 'google/ads/google_ads/v2/enums/ad_network_type_pb'
require 'google/ads/google_ads/v2/enums/click_type_pb'
require 'google/ads/google_ads/v2/enums/conversion_action_category_pb'
require 'google/ads/google_ads/v2/enums/conversion_attribution_event_type_pb'
require 'google/ads/google_ads/v2/enums/conversion_lag_bucket_pb'
require 'google/ads/google_ads/v2/enums/conversion_or_adjustment_lag_bucket_pb'
...
require 'google/ads/google_ads/v2/enums/search_engine_results_page_type_pb'
require 'google/ads/google_ads/v2/enums/search_term_match_type_pb'
require 'google/ads/google_ads/v2/enums/slot_pb'
require 'google/protobuf/wrappers_pb'
require 'google/api/annotations_pb'
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v2/common/segments.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v2.common.Segments" do
      optional :ad_network_type, :enum, 3, "google.ads.googleads.v2.enums.AdNetworkTypeEnum.AdNetworkType"
      optional :click_type, :enum, 26, "google.ads.googleads.v2.enums.ClickTypeEnum.ClickType"
      optional :conversion_action, :message, 52, "google.protobuf.StringValue"
      optional :conversion_action_category, :enum, 53, "google.ads.googleads.v2.enums.ConversionActionCategoryEnum.ConversionActionCategory"
      ...
      optional :conversion_attribution_event_type, :enum, 2, "google.ads.googleads.v2.enums.ConversionAttributionEventTypeEnum.ConversionAttributionEventType"
      optional :conversion_lag_bucket, :enum, 50, "google.ads.googleads.v2.enums.ConversionLagBucketEnum.ConversionLagBucket"
      optional :conversion_or_adjustment_lag_bucket, :enum, 51, "google.ads.googleads.v2.enums.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucket"
      ...
      optional :device, :enum, 1, "google.ads.googleads.v2.enums.DeviceEnum.Device"
      optional :external_conversion_source, :enum, 55, "google.ads.googleads.v2.enums.ExternalConversionSourceEnum.ExternalConversionSource"
      ...
      optional :hotel_check_in_day_of_week, :enum, 9, "google.ads.googleads.v2.enums.DayOfWeekEnum.DayOfWeek"
      ...
      optional :hotel_date_selection_type, :enum, 13, "google.ads.googleads.v2.enums.HotelDateSelectionTypeEnum.HotelDateSelectionType"
      ...
      optional :keyword, :message, 61, "google.ads.googleads.v2.common.Keyword"
      optional :month, :message, 17, "google.protobuf.StringValue"
      optional :month_of_year, :enum, 18, "google.ads.googleads.v2.enums.MonthOfYearEnum.MonthOfYear"
      optional :partner_hotel_id, :message, 19, "google.protobuf.StringValue"
      optional :placeholder_type, :enum, 20, "google.ads.googleads.v2.enums.PlaceholderTypeEnum.PlaceholderType"
      ...
      optional :product_channel, :enum, 30, "google.ads.googleads.v2.enums.ProductChannelEnum.ProductChannel"
      optional :product_channel_exclusivity, :enum, 31, "google.ads.googleads.v2.enums.ProductChannelExclusivityEnum.ProductChannelExclusivity"
      optional :product_condition, :enum, 32, "google.ads.googleads.v2.enums.ProductConditionEnum.ProductCondition"
      ...
      optional :search_engine_results_page_type, :enum, 70, "google.ads.googleads.v2.enums.SearchEngineResultsPageTypeEnum.SearchEngineResultsPageType"
      optional :search_term_match_type, :enum, 22, "google.ads.googleads.v2.enums.SearchTermMatchTypeEnum.SearchTermMatchType"
      optional :slot, :enum, 23, "google.ads.googleads.v2.enums.SlotEnum.Slot"
    ...
    add_message "google.ads.googleads.v2.common.Keyword" do
      optional :ad_group_criterion, :message, 1, "google.protobuf.StringValue"
      optional :info, :message, 2, "google.ads.googleads.v2.common.KeywordInfo"
    end
  end
end
...
module Google
  module Ads
    module GoogleAds
      module V2
        module Common
          Segments = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v2.common.Segments").msgclass
          Keyword = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v2.common.Keyword").msgclass
        end
      end
    end
  end
