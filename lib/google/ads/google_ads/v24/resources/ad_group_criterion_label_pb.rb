...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          AdGroupCriterionLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.AdGroupCriterionLabel").msgclass
        end
      end
    end
  end
