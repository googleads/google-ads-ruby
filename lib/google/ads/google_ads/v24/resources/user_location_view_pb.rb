...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          UserLocationView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.UserLocationView").msgclass
        end
      end
    end
  end
