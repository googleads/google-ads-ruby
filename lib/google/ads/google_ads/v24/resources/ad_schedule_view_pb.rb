...
# source: google/ads/googleads/v24/resources/ad_schedule_view.proto
...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          AdScheduleView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.AdScheduleView").msgclass
        end
      end
    end
  end
