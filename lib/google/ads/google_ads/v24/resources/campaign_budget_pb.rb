...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          CampaignBudget = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.CampaignBudget").msgclass
        end
      end
    end
  end
