...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          CampaignLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.CampaignLabel").msgclass
        end
      end
    end
  end
