...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          DomainCategory = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.DomainCategory").msgclass
        end
      end
    end
  end
