...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          AdParameter = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.AdParameter").msgclass
        end
      end
    end
  end
