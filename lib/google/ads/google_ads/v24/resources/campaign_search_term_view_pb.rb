...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          CampaignSearchTermView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.CampaignSearchTermView").msgclass
        end
      end
    end
  end
