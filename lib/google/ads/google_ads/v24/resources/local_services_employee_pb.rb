...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          LocalServicesEmployee = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.LocalServicesEmployee").msgclass
          UniversityDegree = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.UniversityDegree").msgclass
          Residency = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.Residency").msgclass
          Fellowship = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.Fellowship").msgclass
        end
      end
    end
  end
