...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          CampaignAggregateAssetView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.CampaignAggregateAssetView").msgclass
        end
      end
    end
  end
