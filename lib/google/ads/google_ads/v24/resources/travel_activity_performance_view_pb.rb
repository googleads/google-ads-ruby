...
# source: google/ads/googleads/v24/resources/travel_activity_performance_view.proto
...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          TravelActivityPerformanceView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.TravelActivityPerformanceView").msgclass
        end
      end
    end
  end
