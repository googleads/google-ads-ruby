...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          AdGroupAdLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.AdGroupAdLabel").msgclass
        end
      end
    end
  end
