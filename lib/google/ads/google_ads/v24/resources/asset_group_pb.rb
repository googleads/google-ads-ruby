...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          AssetGroup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.AssetGroup").msgclass
          AssetCoverage = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.AssetCoverage").msgclass
          AdStrengthActionItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.AdStrengthActionItem").msgclass
          AdStrengthActionItem::AddAssetDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.AdStrengthActionItem.AddAssetDetails").msgclass
          GoogleLocalServicesInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.GoogleLocalServicesInfo").msgclass
          LocalServicesCallout = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.LocalServicesCallout").msgclass
        end
      end
    end
  end
