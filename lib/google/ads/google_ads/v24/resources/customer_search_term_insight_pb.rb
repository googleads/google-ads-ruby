...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          CustomerSearchTermInsight = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.CustomerSearchTermInsight").msgclass
        end
      end
    end
  end
