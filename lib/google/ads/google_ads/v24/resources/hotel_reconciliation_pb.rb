...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          HotelReconciliation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.HotelReconciliation").msgclass
        end
      end
    end
  end
