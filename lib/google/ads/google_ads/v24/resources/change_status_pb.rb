...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          ChangeStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.ChangeStatus").msgclass
        end
      end
    end
  end
