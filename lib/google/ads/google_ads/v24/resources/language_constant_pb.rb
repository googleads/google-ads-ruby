...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          LanguageConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.LanguageConstant").msgclass
        end
      end
    end
  end
