...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          PerformanceMaxPlacementView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.PerformanceMaxPlacementView").msgclass
        end
      end
    end
  end
