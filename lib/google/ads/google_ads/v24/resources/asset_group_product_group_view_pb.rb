...
# source: google/ads/googleads/v24/resources/asset_group_product_group_view.proto
...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          AssetGroupProductGroupView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.AssetGroupProductGroupView").msgclass
        end
      end
    end
  end
