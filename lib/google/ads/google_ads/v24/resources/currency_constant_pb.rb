...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          CurrencyConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.CurrencyConstant").msgclass
        end
      end
    end
  end
