...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          LocationInterestView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.LocationInterestView").msgclass
        end
      end
    end
  end
