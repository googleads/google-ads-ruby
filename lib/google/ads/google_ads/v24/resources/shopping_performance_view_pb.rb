...
# source: google/ads/googleads/v24/resources/shopping_performance_view.proto
...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          ShoppingPerformanceView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.ShoppingPerformanceView").msgclass
        end
      end
    end
  end
