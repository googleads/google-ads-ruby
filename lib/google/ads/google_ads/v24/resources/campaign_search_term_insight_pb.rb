...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          CampaignSearchTermInsight = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.CampaignSearchTermInsight").msgclass
        end
      end
    end
  end
