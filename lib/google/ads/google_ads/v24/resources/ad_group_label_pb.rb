...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          AdGroupLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.AdGroupLabel").msgclass
        end
      end
    end
  end
