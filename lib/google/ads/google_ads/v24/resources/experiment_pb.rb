...
require 'google/ads/google_ads/v24/enums/experiment_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          Experiment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.Experiment").msgclass
        end
      end
    end
  end
