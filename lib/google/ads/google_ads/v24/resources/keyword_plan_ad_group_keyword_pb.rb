...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          KeywordPlanAdGroupKeyword = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.KeywordPlanAdGroupKeyword").msgclass
        end
      end
    end
  end
