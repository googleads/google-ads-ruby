...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          MobileAppCategoryConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.MobileAppCategoryConstant").msgclass
        end
      end
    end
  end
