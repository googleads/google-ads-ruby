...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          Ad = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.Ad").msgclass
        end
      end
    end
  end
