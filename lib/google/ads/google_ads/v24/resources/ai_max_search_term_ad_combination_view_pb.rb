...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          AiMaxSearchTermAdCombinationView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.AiMaxSearchTermAdCombinationView").msgclass
        end
      end
    end
  end
