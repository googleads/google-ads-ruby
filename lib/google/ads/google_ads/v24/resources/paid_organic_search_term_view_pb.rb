...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          PaidOrganicSearchTermView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.PaidOrganicSearchTermView").msgclass
        end
      end
    end
  end
