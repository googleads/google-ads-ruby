...
require 'google/ads/google_ads/v24/enums/asset_group_signal_approval_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V24
        module Resources
          AssetGroupSignal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.resources.AssetGroupSignal").msgclass
        end
      end
    end
  end
