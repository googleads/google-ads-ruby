...
module Google
  module Ads
    module GoogleAds
      module V24
        module Errors
          CampaignLifecycleGoalErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.errors.CampaignLifecycleGoalErrorEnum").msgclass
          CampaignLifecycleGoalErrorEnum::CampaignLifecycleGoalError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.errors.CampaignLifecycleGoalErrorEnum.CampaignLifecycleGoalError").enummodule
        end
      end
    end
  end
