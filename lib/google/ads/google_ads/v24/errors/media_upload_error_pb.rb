...
module Google
  module Ads
    module GoogleAds
      module V24
        module Errors
          MediaUploadErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.errors.MediaUploadErrorEnum").msgclass
          MediaUploadErrorEnum::MediaUploadError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.errors.MediaUploadErrorEnum.MediaUploadError").enummodule
        end
      end
    end
  end
