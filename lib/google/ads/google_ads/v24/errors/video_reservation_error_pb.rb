...
module Google
  module Ads
    module GoogleAds
      module V24
        module Errors
          VideoReservationErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.errors.VideoReservationErrorEnum").msgclass
          VideoReservationErrorEnum::VideoReservationError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.errors.VideoReservationErrorEnum.VideoReservationError").enummodule
        end
      end
    end
  end
