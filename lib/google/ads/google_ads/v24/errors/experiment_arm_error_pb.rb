...
module Google
  module Ads
    module GoogleAds
      module V24
        module Errors
          ExperimentArmErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.errors.ExperimentArmErrorEnum").msgclass
          ExperimentArmErrorEnum::ExperimentArmError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.errors.ExperimentArmErrorEnum.ExperimentArmError").enummodule
        end
      end
    end
  end
