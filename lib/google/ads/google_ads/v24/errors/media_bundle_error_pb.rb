...
module Google
  module Ads
    module GoogleAds
      module V24
        module Errors
          MediaBundleErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.errors.MediaBundleErrorEnum").msgclass
          MediaBundleErrorEnum::MediaBundleError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.errors.MediaBundleErrorEnum.MediaBundleError").enummodule
        end
      end
    end
  end
