...
module Google
  module Ads
    module GoogleAds
      module V24
        module Errors
          BiddingErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.errors.BiddingErrorEnum").msgclass
          BiddingErrorEnum::BiddingError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.errors.BiddingErrorEnum.BiddingError").enummodule
        end
      end
    end
  end
