...
module Google
  module Ads
    module GoogleAds
      module V24
        module Enums
          AssetFieldTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.enums.AssetFieldTypeEnum").msgclass
          AssetFieldTypeEnum::AssetFieldType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.enums.AssetFieldTypeEnum.AssetFieldType").enummodule
        end
      end
    end
  end
