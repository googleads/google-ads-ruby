...
module Google
  module Ads
    module GoogleAds
      module V24
        module Enums
          ConversionActionTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.enums.ConversionActionTypeEnum").msgclass
          ConversionActionTypeEnum::ConversionActionType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.enums.ConversionActionTypeEnum.ConversionActionType").enummodule
        end
      end
    end
  end
