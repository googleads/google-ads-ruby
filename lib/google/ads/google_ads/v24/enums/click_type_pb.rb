...
module Google
  module Ads
    module GoogleAds
      module V24
        module Enums
          ClickTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.enums.ClickTypeEnum").msgclass
          ClickTypeEnum::ClickType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.enums.ClickTypeEnum.ClickType").enummodule
        end
      end
    end
  end
