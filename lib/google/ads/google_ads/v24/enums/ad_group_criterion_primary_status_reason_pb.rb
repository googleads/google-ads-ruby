...
module Google
  module Ads
    module GoogleAds
      module V24
        module Enums
          AdGroupCriterionPrimaryStatusReasonEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.enums.AdGroupCriterionPrimaryStatusReasonEnum").msgclass
          AdGroupCriterionPrimaryStatusReasonEnum::AdGroupCriterionPrimaryStatusReason = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.enums.AdGroupCriterionPrimaryStatusReasonEnum.AdGroupCriterionPrimaryStatusReason").enummodule
        end
      end
    end
  end
