...
module Google
  module Ads
    module GoogleAds
      module V24
        module Enums
          ConversionOriginEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.enums.ConversionOriginEnum").msgclass
          ConversionOriginEnum::ConversionOrigin = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.enums.ConversionOriginEnum.ConversionOrigin").enummodule
        end
      end
    end
  end
