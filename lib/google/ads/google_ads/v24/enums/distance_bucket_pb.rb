...
module Google
  module Ads
    module GoogleAds
      module V24
        module Enums
          DistanceBucketEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.enums.DistanceBucketEnum").msgclass
          DistanceBucketEnum::DistanceBucket = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.enums.DistanceBucketEnum.DistanceBucket").enummodule
        end
      end
    end
  end
