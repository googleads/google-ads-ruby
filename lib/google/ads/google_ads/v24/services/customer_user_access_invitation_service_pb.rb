...
module Google
  module Ads
    module GoogleAds
      module V24
        module Services
          MutateCustomerUserAccessInvitationRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.services.MutateCustomerUserAccessInvitationRequest").msgclass
          CustomerUserAccessInvitationOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.services.CustomerUserAccessInvitationOperation").msgclass
          MutateCustomerUserAccessInvitationResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.services.MutateCustomerUserAccessInvitationResponse").msgclass
          MutateCustomerUserAccessInvitationResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v24.services.MutateCustomerUserAccessInvitationResult").msgclass
        end
      end
    end
  end
