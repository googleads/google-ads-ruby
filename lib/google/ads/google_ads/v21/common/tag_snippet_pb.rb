...
require 'google/ads/google_ads/v21/enums/tracking_code_page_format_pb'
require 'google/ads/google_ads/v21/enums/tracking_code_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Common
          TagSnippet = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.TagSnippet").msgclass
        end
      end
    end
  end
