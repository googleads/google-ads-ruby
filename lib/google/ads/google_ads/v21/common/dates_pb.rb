...
module Google
  module Ads
    module GoogleAds
      module V21
        module Common
          DateRange = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.DateRange").msgclass
          YearMonthRange = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.YearMonthRange").msgclass
          YearMonth = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.YearMonth").msgclass
        end
      end
    end
  end
