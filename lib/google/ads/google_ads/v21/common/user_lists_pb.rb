...
require 'google/ads/google_ads/v21/enums/customer_match_upload_key_type_pb'
require 'google/ads/google_ads/v21/enums/lookalike_expansion_level_pb'
require 'google/ads/google_ads/v21/enums/user_list_crm_data_source_type_pb'
require 'google/ads/google_ads/v21/enums/user_list_date_rule_item_operator_pb'
require 'google/ads/google_ads/v21/enums/user_list_flexible_rule_operator_pb'
require 'google/ads/google_ads/v21/enums/user_list_logical_rule_operator_pb'
require 'google/ads/google_ads/v21/enums/user_list_number_rule_item_operator_pb'
require 'google/ads/google_ads/v21/enums/user_list_prepopulation_status_pb'
require 'google/ads/google_ads/v21/enums/user_list_rule_type_pb'
require 'google/ads/google_ads/v21/enums/user_list_string_rule_item_operator_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Common
          LookalikeUserListInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.LookalikeUserListInfo").msgclass
          SimilarUserListInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.SimilarUserListInfo").msgclass
          CrmBasedUserListInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.CrmBasedUserListInfo").msgclass
          UserListRuleInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.UserListRuleInfo").msgclass
          UserListRuleItemGroupInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.UserListRuleItemGroupInfo").msgclass
          UserListRuleItemInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.UserListRuleItemInfo").msgclass
          UserListDateRuleItemInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.UserListDateRuleItemInfo").msgclass
          UserListNumberRuleItemInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.UserListNumberRuleItemInfo").msgclass
          UserListStringRuleItemInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.UserListStringRuleItemInfo").msgclass
          FlexibleRuleOperandInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.FlexibleRuleOperandInfo").msgclass
          FlexibleRuleUserListInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.FlexibleRuleUserListInfo").msgclass
          RuleBasedUserListInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.RuleBasedUserListInfo").msgclass
          LogicalUserListInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.LogicalUserListInfo").msgclass
          UserListLogicalRuleInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.UserListLogicalRuleInfo").msgclass
          LogicalUserListOperandInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.LogicalUserListOperandInfo").msgclass
          BasicUserListInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.BasicUserListInfo").msgclass
          UserListActionInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.UserListActionInfo").msgclass
        end
      end
    end
  end
