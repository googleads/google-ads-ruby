...
require 'google/ads/google_ads/v21/enums/advertising_channel_sub_type_pb'
require 'google/ads/google_ads/v21/enums/advertising_channel_type_pb'
require 'google/ads/google_ads/v21/enums/criterion_category_channel_availability_mode_pb'
require 'google/ads/google_ads/v21/enums/criterion_category_locale_availability_mode_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Common
          CriterionCategoryAvailability = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.CriterionCategoryAvailability").msgclass
          CriterionCategoryChannelAvailability = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.CriterionCategoryChannelAvailability").msgclass
          CriterionCategoryLocaleAvailability = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.CriterionCategoryLocaleAvailability").msgclass
        end
      end
    end
  end
