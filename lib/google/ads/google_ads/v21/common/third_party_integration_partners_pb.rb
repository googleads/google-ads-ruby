...
module Google
  module Ads
    module GoogleAds
      module V21
        module Common
          CustomerThirdPartyIntegrationPartners = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.CustomerThirdPartyIntegrationPartners").msgclass
          CustomerThirdPartyViewabilityIntegrationPartner = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.CustomerThirdPartyViewabilityIntegrationPartner").msgclass
          CustomerThirdPartyBrandSafetyIntegrationPartner = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.CustomerThirdPartyBrandSafetyIntegrationPartner").msgclass
          CustomerThirdPartyBrandLiftIntegrationPartner = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.CustomerThirdPartyBrandLiftIntegrationPartner").msgclass
          CustomerThirdPartyReachIntegrationPartner = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.CustomerThirdPartyReachIntegrationPartner").msgclass
          CampaignThirdPartyIntegrationPartners = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.CampaignThirdPartyIntegrationPartners").msgclass
          CampaignThirdPartyViewabilityIntegrationPartner = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.CampaignThirdPartyViewabilityIntegrationPartner").msgclass
          CampaignThirdPartyBrandSafetyIntegrationPartner = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.CampaignThirdPartyBrandSafetyIntegrationPartner").msgclass
          CampaignThirdPartyBrandLiftIntegrationPartner = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.CampaignThirdPartyBrandLiftIntegrationPartner").msgclass
          CampaignThirdPartyReachIntegrationPartner = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.CampaignThirdPartyReachIntegrationPartner").msgclass
          ThirdPartyIntegrationPartnerData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.common.ThirdPartyIntegrationPartnerData").msgclass
        end
      end
    end
  end
