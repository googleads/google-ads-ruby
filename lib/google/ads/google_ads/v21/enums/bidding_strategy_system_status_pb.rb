...
module Google
  module Ads
    module GoogleAds
      module V21
        module Enums
          BiddingStrategySystemStatusEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.enums.BiddingStrategySystemStatusEnum").msgclass
          BiddingStrategySystemStatusEnum::BiddingStrategySystemStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.enums.BiddingStrategySystemStatusEnum.BiddingStrategySystemStatus").enummodule
        end
      end
    end
  end
