...
module Google
  module Ads
    module GoogleAds
      module V21
        module Enums
          AdGroupCriterionPrimaryStatusReasonEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.enums.AdGroupCriterionPrimaryStatusReasonEnum").msgclass
          AdGroupCriterionPrimaryStatusReasonEnum::AdGroupCriterionPrimaryStatusReason = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.enums.AdGroupCriterionPrimaryStatusReasonEnum.AdGroupCriterionPrimaryStatusReason").enummodule
        end
      end
    end
  end
