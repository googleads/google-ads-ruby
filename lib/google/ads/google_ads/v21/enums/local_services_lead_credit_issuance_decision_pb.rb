...
module Google
  module Ads
    module GoogleAds
      module V21
        module Enums
          LocalServicesLeadCreditIssuanceDecisionEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.enums.LocalServicesLeadCreditIssuanceDecisionEnum").msgclass
          LocalServicesLeadCreditIssuanceDecisionEnum::CreditIssuanceDecision = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.enums.LocalServicesLeadCreditIssuanceDecisionEnum.CreditIssuanceDecision").enummodule
        end
      end
    end
  end
