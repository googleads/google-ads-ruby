...
module Google
  module Ads
    module GoogleAds
      module V21
        module Enums
          CriterionCategoryLocaleAvailabilityModeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.enums.CriterionCategoryLocaleAvailabilityModeEnum").msgclass
          CriterionCategoryLocaleAvailabilityModeEnum::CriterionCategoryLocaleAvailabilityMode = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.enums.CriterionCategoryLocaleAvailabilityModeEnum.CriterionCategoryLocaleAvailabilityMode").enummodule
        end
      end
    end
  end
