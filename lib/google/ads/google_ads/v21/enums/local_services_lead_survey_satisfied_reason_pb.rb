...
module Google
  module Ads
    module GoogleAds
      module V21
        module Enums
          LocalServicesLeadSurveySatisfiedReasonEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.enums.LocalServicesLeadSurveySatisfiedReasonEnum").msgclass
          LocalServicesLeadSurveySatisfiedReasonEnum::SurveySatisfiedReason = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.enums.LocalServicesLeadSurveySatisfiedReasonEnum.SurveySatisfiedReason").enummodule
        end
      end
    end
  end
