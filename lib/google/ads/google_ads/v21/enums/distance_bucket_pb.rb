...
module Google
  module Ads
    module GoogleAds
      module V21
        module Enums
          DistanceBucketEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.enums.DistanceBucketEnum").msgclass
          DistanceBucketEnum::DistanceBucket = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.enums.DistanceBucketEnum.DistanceBucket").enummodule
        end
      end
    end
  end
