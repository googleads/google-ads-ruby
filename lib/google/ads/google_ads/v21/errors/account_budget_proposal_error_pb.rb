...
module Google
  module Ads
    module GoogleAds
      module V21
        module Errors
          AccountBudgetProposalErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.errors.AccountBudgetProposalErrorEnum").msgclass
          AccountBudgetProposalErrorEnum::AccountBudgetProposalError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.errors.AccountBudgetProposalErrorEnum.AccountBudgetProposalError").enummodule
        end
      end
    end
  end
