...
module Google
  module Ads
    module GoogleAds
      module V21
        module Errors
          ManagerLinkErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.errors.ManagerLinkErrorEnum").msgclass
          ManagerLinkErrorEnum::ManagerLinkError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.errors.ManagerLinkErrorEnum.ManagerLinkError").enummodule
        end
      end
    end
  end
