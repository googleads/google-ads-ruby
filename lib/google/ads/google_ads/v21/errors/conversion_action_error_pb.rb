...
module Google
  module Ads
    module GoogleAds
      module V21
        module Errors
          ConversionActionErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.errors.ConversionActionErrorEnum").msgclass
          ConversionActionErrorEnum::ConversionActionError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.errors.ConversionActionErrorEnum.ConversionActionError").enummodule
        end
      end
    end
  end
