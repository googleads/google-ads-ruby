...
module Google
  module Ads
    module GoogleAds
      module V21
        module Errors
          SettingErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.errors.SettingErrorEnum").msgclass
          SettingErrorEnum::SettingError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.errors.SettingErrorEnum.SettingError").enummodule
        end
      end
    end
  end
