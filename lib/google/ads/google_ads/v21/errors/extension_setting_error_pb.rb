...
module Google
  module Ads
    module GoogleAds
      module V21
        module Errors
          ExtensionSettingErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.errors.ExtensionSettingErrorEnum").msgclass
          ExtensionSettingErrorEnum::ExtensionSettingError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.errors.ExtensionSettingErrorEnum.ExtensionSettingError").enummodule
        end
      end
    end
  end
