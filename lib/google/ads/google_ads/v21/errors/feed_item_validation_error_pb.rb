...
module Google
  module Ads
    module GoogleAds
      module V21
        module Errors
          FeedItemValidationErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.errors.FeedItemValidationErrorEnum").msgclass
          FeedItemValidationErrorEnum::FeedItemValidationError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.errors.FeedItemValidationErrorEnum.FeedItemValidationError").enummodule
        end
      end
    end
  end
