...
module Google
  module Ads
    module GoogleAds
      module V21
        module Errors
          AssetGroupListingGroupFilterErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.errors.AssetGroupListingGroupFilterErrorEnum").msgclass
          AssetGroupListingGroupFilterErrorEnum::AssetGroupListingGroupFilterError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.errors.AssetGroupListingGroupFilterErrorEnum.AssetGroupListingGroupFilterError").enummodule
        end
      end
    end
  end
