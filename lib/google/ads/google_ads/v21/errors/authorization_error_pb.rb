...
module Google
  module Ads
    module GoogleAds
      module V21
        module Errors
          AuthorizationErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.errors.AuthorizationErrorEnum").msgclass
          AuthorizationErrorEnum::AuthorizationError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.errors.AuthorizationErrorEnum.AuthorizationError").enummodule
        end
      end
    end
  end
