...
require 'google/ads/google_ads/v21/enums/hotel_reconciliation_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          HotelReconciliation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.HotelReconciliation").msgclass
        end
      end
    end
  end
