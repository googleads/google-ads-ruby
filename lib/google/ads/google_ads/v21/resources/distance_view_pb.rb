...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          DistanceView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.DistanceView").msgclass
        end
      end
    end
  end
