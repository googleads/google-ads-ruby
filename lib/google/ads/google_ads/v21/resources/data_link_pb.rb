...
require 'google/ads/google_ads/v21/enums/data_link_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          DataLink = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.DataLink").msgclass
          YoutubeVideoIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.YoutubeVideoIdentifier").msgclass
        end
      end
    end
  end
