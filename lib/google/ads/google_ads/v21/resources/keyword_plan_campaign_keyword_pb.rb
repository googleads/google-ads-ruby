...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          KeywordPlanCampaignKeyword = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.KeywordPlanCampaignKeyword").msgclass
        end
      end
    end
  end
