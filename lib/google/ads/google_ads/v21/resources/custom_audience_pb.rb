...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          CustomAudience = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.CustomAudience").msgclass
          CustomAudienceMember = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.CustomAudienceMember").msgclass
        end
      end
    end
  end
