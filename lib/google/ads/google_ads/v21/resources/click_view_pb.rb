...
begin
  ...
  imports = [
    ["google.ads.googleads.v21.common.ClickLocation", "google/ads/googleads/v21/common/click_location.proto"],
    ["google.ads.googleads.v21.common.KeywordInfo", "google/ads/googleads/v21/common/criteria.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          ClickView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ClickView").msgclass
        end
      end
    end
  end
