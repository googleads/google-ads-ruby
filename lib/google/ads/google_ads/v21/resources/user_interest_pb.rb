...
require 'google/ads/google_ads/v21/enums/user_interest_taxonomy_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          UserInterest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.UserInterest").msgclass
        end
      end
    end
  end
