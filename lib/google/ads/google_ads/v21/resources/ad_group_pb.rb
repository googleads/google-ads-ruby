...
begin
  ...
  imports = [
    ["google.ads.googleads.v21.common.CustomParameter", "google/ads/googleads/v21/common/custom_parameter.proto"],
    ["google.ads.googleads.v21.common.TargetingSetting", "google/ads/googleads/v21/common/targeting_setting.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          AdGroup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AdGroup").msgclass
          AdGroup::AudienceSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AdGroup.AudienceSetting").msgclass
          AdGroup::DemandGenAdGroupSettings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AdGroup.DemandGenAdGroupSettings").msgclass
          AdGroup::DemandGenAdGroupSettings::DemandGenChannelControls = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AdGroup.DemandGenAdGroupSettings.DemandGenChannelControls").msgclass
          AdGroup::DemandGenAdGroupSettings::DemandGenChannelControls::DemandGenSelectedChannels = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AdGroup.DemandGenAdGroupSettings.DemandGenChannelControls.DemandGenSelectedChannels").msgclass
          AdGroup::VideoAdGroupSettings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AdGroup.VideoAdGroupSettings").msgclass
          AdGroup::VideoAdGroupSettings::VideoAdSequenceStepSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AdGroup.VideoAdGroupSettings.VideoAdSequenceStepSetting").msgclass
          AdGroup::AiMaxAdGroupSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AdGroup.AiMaxAdGroupSetting").msgclass
        end
      end
    end
  end
