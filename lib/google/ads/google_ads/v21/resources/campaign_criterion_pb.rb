...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          CampaignCriterion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.CampaignCriterion").msgclass
        end
      end
    end
  end
