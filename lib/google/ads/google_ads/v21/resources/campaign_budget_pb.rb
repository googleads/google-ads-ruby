...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          CampaignBudget = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.CampaignBudget").msgclass
        end
      end
    end
  end
