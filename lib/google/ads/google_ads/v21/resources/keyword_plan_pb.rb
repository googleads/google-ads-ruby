...
require 'google/ads/google_ads/v21/enums/keyword_plan_forecast_interval_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v21.common.DateRange", "google/ads/googleads/v21/common/dates.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          KeywordPlan = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.KeywordPlan").msgclass
          KeywordPlanForecastPeriod = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.KeywordPlanForecastPeriod").msgclass
        end
      end
    end
  end
