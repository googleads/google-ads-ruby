...
require 'google/ads/google_ads/v21/enums/offline_user_data_job_failure_reason_pb'
require 'google/ads/google_ads/v21/enums/offline_user_data_job_match_rate_range_pb'
require 'google/ads/google_ads/v21/enums/offline_user_data_job_status_pb'
require 'google/ads/google_ads/v21/enums/offline_user_data_job_type_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v21.common.CustomerMatchUserListMetadata", "google/ads/googleads/v21/common/offline_user_data.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          OfflineUserDataJob = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.OfflineUserDataJob").msgclass
          OfflineUserDataJobMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.OfflineUserDataJobMetadata").msgclass
        end
      end
    end
  end
