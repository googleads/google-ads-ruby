...
require 'google/ads/google_ads/v21/enums/linked_product_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          ProductLinkInvitation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ProductLinkInvitation").msgclass
          HotelCenterLinkInvitationIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.HotelCenterLinkInvitationIdentifier").msgclass
          MerchantCenterLinkInvitationIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.MerchantCenterLinkInvitationIdentifier").msgclass
          AdvertisingPartnerLinkInvitationIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AdvertisingPartnerLinkInvitationIdentifier").msgclass
        end
      end
    end
  end
