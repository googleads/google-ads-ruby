...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          CampaignDraft = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.CampaignDraft").msgclass
        end
      end
    end
  end
