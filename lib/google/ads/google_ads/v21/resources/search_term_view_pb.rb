...
require 'google/ads/google_ads/v21/enums/search_term_targeting_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          SearchTermView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.SearchTermView").msgclass
        end
      end
    end
  end
