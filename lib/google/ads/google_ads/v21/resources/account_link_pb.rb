...
require 'google/ads/google_ads/v21/enums/account_link_status_pb'
require 'google/ads/google_ads/v21/enums/linked_account_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          AccountLink = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AccountLink").msgclass
          ThirdPartyAppAnalyticsLinkIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ThirdPartyAppAnalyticsLinkIdentifier").msgclass
        end
      end
    end
  end
