...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          AssetGroup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AssetGroup").msgclass
          AssetCoverage = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AssetCoverage").msgclass
          AdStrengthActionItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AdStrengthActionItem").msgclass
          AdStrengthActionItem::AddAssetDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AdStrengthActionItem.AddAssetDetails").msgclass
        end
      end
    end
  end
