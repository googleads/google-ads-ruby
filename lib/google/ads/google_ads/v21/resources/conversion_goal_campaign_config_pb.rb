...
require 'google/ads/google_ads/v21/enums/goal_config_level_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          ConversionGoalCampaignConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ConversionGoalCampaignConfig").msgclass
        end
      end
    end
  end
