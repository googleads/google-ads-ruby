...
begin
  ...
  imports = [
    ["google.ads.googleads.v21.common.LocalServicesDocumentReadOnly", "google/ads/googleads/v21/common/local_services.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          LocalServicesVerificationArtifact = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.LocalServicesVerificationArtifact").msgclass
          BackgroundCheckVerificationArtifact = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.BackgroundCheckVerificationArtifact").msgclass
          InsuranceVerificationArtifact = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.InsuranceVerificationArtifact").msgclass
          LicenseVerificationArtifact = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.LicenseVerificationArtifact").msgclass
          BusinessRegistrationCheckVerificationArtifact = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.BusinessRegistrationCheckVerificationArtifact").msgclass
          BusinessRegistrationNumber = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.BusinessRegistrationNumber").msgclass
          BusinessRegistrationDocument = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.BusinessRegistrationDocument").msgclass
        end
      end
    end
  end
