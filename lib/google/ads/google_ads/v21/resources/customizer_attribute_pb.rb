...
require 'google/ads/google_ads/v21/enums/customizer_attribute_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          CustomizerAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.CustomizerAttribute").msgclass
        end
      end
    end
  end
