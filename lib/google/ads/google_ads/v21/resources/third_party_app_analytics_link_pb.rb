...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          ThirdPartyAppAnalyticsLink = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ThirdPartyAppAnalyticsLink").msgclass
        end
      end
    end
  end
