...
require 'google/ads/google_ads/v21/enums/call_tracking_display_location_pb'
require 'google/ads/google_ads/v21/enums/call_type_pb'
require 'google/ads/google_ads/v21/enums/google_voice_call_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          CallView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.CallView").msgclass
        end
      end
    end
  end
