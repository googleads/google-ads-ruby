...
require 'google/ads/google_ads/v21/enums/shared_set_status_pb'
require 'google/ads/google_ads/v21/enums/shared_set_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          SharedSet = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.SharedSet").msgclass
        end
      end
    end
  end
