...
require 'google/ads/google_ads/v21/common/policy_summary_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v21.common.AssetLinkPrimaryStatusDetails", "google/ads/googleads/v21/common/asset_policy.proto"],
    ["google.ads.googleads.v21.common.PolicySummary", "google/ads/googleads/v21/common/policy_summary.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          AssetGroupAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AssetGroupAsset").msgclass
        end
      end
    end
  end
