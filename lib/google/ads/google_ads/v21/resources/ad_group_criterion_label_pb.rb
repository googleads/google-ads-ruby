...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          AdGroupCriterionLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AdGroupCriterionLabel").msgclass
        end
      end
    end
  end
