...
require 'google/ads/google_ads/v21/enums/conversion_value_rule_set_status_pb'
require 'google/ads/google_ads/v21/enums/value_rule_set_attachment_type_pb'
require 'google/ads/google_ads/v21/enums/value_rule_set_dimension_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          ConversionValueRuleSet = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ConversionValueRuleSet").msgclass
        end
      end
    end
  end
