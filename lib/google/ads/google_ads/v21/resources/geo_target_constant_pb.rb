...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          GeoTargetConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.GeoTargetConstant").msgclass
        end
      end
    end
  end
