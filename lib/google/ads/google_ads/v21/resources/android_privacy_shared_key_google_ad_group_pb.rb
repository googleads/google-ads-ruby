...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          AndroidPrivacySharedKeyGoogleAdGroup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AndroidPrivacySharedKeyGoogleAdGroup").msgclass
        end
      end
    end
  end
