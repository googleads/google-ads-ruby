...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          BillingSetup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.BillingSetup").msgclass
          BillingSetup::PaymentsAccountInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.BillingSetup.PaymentsAccountInfo").msgclass
        end
      end
    end
  end
