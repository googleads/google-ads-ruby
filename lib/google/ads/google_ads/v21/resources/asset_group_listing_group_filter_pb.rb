...
require 'google/ads/google_ads/v21/enums/listing_group_filter_custom_attribute_index_pb'
require 'google/ads/google_ads/v21/enums/listing_group_filter_listing_source_pb'
require 'google/ads/google_ads/v21/enums/listing_group_filter_product_category_level_pb'
require 'google/ads/google_ads/v21/enums/listing_group_filter_product_channel_pb'
require 'google/ads/google_ads/v21/enums/listing_group_filter_product_condition_pb'
require 'google/ads/google_ads/v21/enums/listing_group_filter_product_type_level_pb'
require 'google/ads/google_ads/v21/enums/listing_group_filter_type_enum_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          AssetGroupListingGroupFilter = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AssetGroupListingGroupFilter").msgclass
          ListingGroupFilterDimensionPath = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ListingGroupFilterDimensionPath").msgclass
          ListingGroupFilterDimension = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ListingGroupFilterDimension").msgclass
          ListingGroupFilterDimension::ProductCategory = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ListingGroupFilterDimension.ProductCategory").msgclass
          ListingGroupFilterDimension::ProductBrand = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ListingGroupFilterDimension.ProductBrand").msgclass
          ListingGroupFilterDimension::ProductChannel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ListingGroupFilterDimension.ProductChannel").msgclass
          ListingGroupFilterDimension::ProductCondition = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ListingGroupFilterDimension.ProductCondition").msgclass
          ListingGroupFilterDimension::ProductCustomAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ListingGroupFilterDimension.ProductCustomAttribute").msgclass
          ListingGroupFilterDimension::ProductItemId = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ListingGroupFilterDimension.ProductItemId").msgclass
          ListingGroupFilterDimension::ProductType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ListingGroupFilterDimension.ProductType").msgclass
          ListingGroupFilterDimension::Webpage = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ListingGroupFilterDimension.Webpage").msgclass
          ListingGroupFilterDimension::WebpageCondition = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ListingGroupFilterDimension.WebpageCondition").msgclass
        end
      end
    end
  end
