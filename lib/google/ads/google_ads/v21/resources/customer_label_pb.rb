...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          CustomerLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.CustomerLabel").msgclass
        end
      end
    end
  end
