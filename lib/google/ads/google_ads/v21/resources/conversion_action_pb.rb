...
require 'google/ads/google_ads/v21/enums/attribution_model_pb'
require 'google/ads/google_ads/v21/enums/conversion_action_category_pb'
require 'google/ads/google_ads/v21/enums/conversion_action_counting_type_pb'
require 'google/ads/google_ads/v21/enums/conversion_action_status_pb'
require 'google/ads/google_ads/v21/enums/conversion_action_type_pb'
require 'google/ads/google_ads/v21/enums/conversion_origin_pb'
require 'google/ads/google_ads/v21/enums/data_driven_model_status_pb'
require 'google/ads/google_ads/v21/enums/mobile_app_vendor_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v21.common.TagSnippet", "google/ads/googleads/v21/common/tag_snippet.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          ConversionAction = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ConversionAction").msgclass
          ConversionAction::AttributionModelSettings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ConversionAction.AttributionModelSettings").msgclass
          ConversionAction::ValueSettings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ConversionAction.ValueSettings").msgclass
          ConversionAction::ThirdPartyAppAnalyticsSettings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ConversionAction.ThirdPartyAppAnalyticsSettings").msgclass
          ConversionAction::FirebaseSettings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ConversionAction.FirebaseSettings").msgclass
          ConversionAction::GoogleAnalytics4Settings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ConversionAction.GoogleAnalytics4Settings").msgclass
        end
      end
    end
  end
