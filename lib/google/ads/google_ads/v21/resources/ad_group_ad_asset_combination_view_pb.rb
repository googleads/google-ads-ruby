...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          AdGroupAdAssetCombinationView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AdGroupAdAssetCombinationView").msgclass
        end
      end
    end
  end
