...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          GroupContentSuitabilityPlacementView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.GroupContentSuitabilityPlacementView").msgclass
        end
      end
    end
  end
