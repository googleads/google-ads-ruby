...
# source: google/ads/googleads/v21/resources/multi_party_auth_review.proto

require 'google/protobuf'

require 'google/ads/google_ads/v21/enums/multi_party_auth_operation_type_pb'
require 'google/ads/google_ads/v21/enums/multi_party_auth_review_status_pb'
require 'google/ads/google_ads/v21/enums/multi_party_auth_review_target_resource_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          MultiPartyAuthReview = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.MultiPartyAuthReview").msgclass
          CustomerUserAccessReview = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.CustomerUserAccessReview").msgclass
          CustomerUserAccessInvitationReview = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.CustomerUserAccessInvitationReview").msgclass
        end
      end
    end
  end
