...
require 'google/ads/google_ads/v21/enums/account_budget_proposal_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          AccountBudgetProposal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AccountBudgetProposal").msgclass
        end
      end
    end
  end
