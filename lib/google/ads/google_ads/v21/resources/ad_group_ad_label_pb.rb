...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          AdGroupAdLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AdGroupAdLabel").msgclass
        end
      end
    end
  end
