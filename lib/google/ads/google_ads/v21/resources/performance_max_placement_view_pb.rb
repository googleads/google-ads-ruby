...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          PerformanceMaxPlacementView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.PerformanceMaxPlacementView").msgclass
        end
      end
    end
  end
