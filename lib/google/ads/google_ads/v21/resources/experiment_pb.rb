...
begin
  ...
  imports = [
    ["google.ads.googleads.v21.common.MetricGoal", "google/ads/googleads/v21/common/metric_goal.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          Experiment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.Experiment").msgclass
        end
      end
    end
  end
