...
require 'google/ads/google_ads/v21/common/third_party_integration_partners_pb'
require 'google/ads/google_ads/v21/enums/brand_safety_suitability_pb'
require 'google/ads/google_ads/v21/enums/conversion_tracking_status_enum_pb'
require 'google/ads/google_ads/v21/enums/customer_pay_per_conversion_eligibility_failure_reason_pb'
require 'google/ads/google_ads/v21/enums/customer_status_pb'
require 'google/ads/google_ads/v21/enums/eu_political_advertising_status_pb'
require 'google/ads/google_ads/v21/enums/local_services_verification_status_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v21.common.CustomerThirdPartyIntegrationPartners", "google/ads/googleads/v21/common/third_party_integration_partners.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          Customer = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.Customer").msgclass
          CallReportingSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.CallReportingSetting").msgclass
          ConversionTrackingSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ConversionTrackingSetting").msgclass
          RemarketingSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.RemarketingSetting").msgclass
          CustomerAgreementSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.CustomerAgreementSetting").msgclass
          LocalServicesSettings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.LocalServicesSettings").msgclass
          GranularLicenseStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.GranularLicenseStatus").msgclass
          GranularInsuranceStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.GranularInsuranceStatus").msgclass
          VideoCustomer = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.VideoCustomer").msgclass
        end
      end
    end
  end
