...
require 'google/ads/google_ads/v21/common/text_label_pb'
require 'google/ads/google_ads/v21/enums/label_status_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v21.common.TextLabel", "google/ads/googleads/v21/common/text_label.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          Label = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.Label").msgclass
        end
      end
    end
  end
