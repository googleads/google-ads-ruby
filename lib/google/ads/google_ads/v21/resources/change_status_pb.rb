...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          ChangeStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ChangeStatus").msgclass
        end
      end
    end
  end
