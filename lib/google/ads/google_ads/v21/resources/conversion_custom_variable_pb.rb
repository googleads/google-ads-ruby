...
require 'google/ads/google_ads/v21/enums/conversion_custom_variable_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          ConversionCustomVariable = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ConversionCustomVariable").msgclass
        end
      end
    end
  end
