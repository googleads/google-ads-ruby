...
require 'google/ads/google_ads/v21/enums/mobile_device_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          MobileDeviceConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.MobileDeviceConstant").msgclass
        end
      end
    end
  end
