...
require 'google/ads/google_ads/v21/enums/lead_form_field_user_input_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          LeadFormSubmissionData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.LeadFormSubmissionData").msgclass
          LeadFormSubmissionField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.LeadFormSubmissionField").msgclass
          CustomLeadFormSubmissionField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.CustomLeadFormSubmissionField").msgclass
        end
      end
    end
  end
