...
require 'google/ads/google_ads/v21/enums/user_list_customer_type_category_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          UserListCustomerType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.UserListCustomerType").msgclass
        end
      end
    end
  end
