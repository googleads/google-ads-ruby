...
require 'google/ads/google_ads/v21/resources/offline_conversion_upload_client_summary_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v21.resources.OfflineConversionSummary", "google/ads/googleads/v21/resources/offline_conversion_upload_client_summary.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          OfflineConversionUploadConversionActionSummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.OfflineConversionUploadConversionActionSummary").msgclass
        end
      end
    end
  end
