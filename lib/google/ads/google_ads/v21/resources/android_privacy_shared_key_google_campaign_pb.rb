...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          AndroidPrivacySharedKeyGoogleCampaign = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AndroidPrivacySharedKeyGoogleCampaign").msgclass
        end
      end
    end
  end
