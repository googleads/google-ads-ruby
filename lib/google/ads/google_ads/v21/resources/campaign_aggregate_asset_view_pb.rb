...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          CampaignAggregateAssetView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.CampaignAggregateAssetView").msgclass
        end
      end
    end
  end
