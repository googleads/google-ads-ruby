...
require 'google/ads/google_ads/v21/enums/bid_modifier_source_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v21.common.HotelDateSelectionTypeInfo", "google/ads/googleads/v21/common/criteria.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          AdGroupBidModifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AdGroupBidModifier").msgclass
        end
      end
    end
  end
