...
require 'google/ads/google_ads/v21/enums/conversion_value_rule_status_pb'
require 'google/ads/google_ads/v21/enums/value_rule_device_type_pb'
require 'google/ads/google_ads/v21/enums/value_rule_geo_location_match_type_pb'
require 'google/ads/google_ads/v21/enums/value_rule_operation_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          ConversionValueRule = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ConversionValueRule").msgclass
          ConversionValueRule::ValueRuleAction = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ConversionValueRule.ValueRuleAction").msgclass
          ConversionValueRule::ValueRuleGeoLocationCondition = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ConversionValueRule.ValueRuleGeoLocationCondition").msgclass
          ConversionValueRule::ValueRuleDeviceCondition = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ConversionValueRule.ValueRuleDeviceCondition").msgclass
          ConversionValueRule::ValueRuleAudienceCondition = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ConversionValueRule.ValueRuleAudienceCondition").msgclass
          ConversionValueRule::ValueRuleItineraryCondition = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ConversionValueRule.ValueRuleItineraryCondition").msgclass
          ConversionValueRule::ValueRuleItineraryAdvanceBookingWindow = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ConversionValueRule.ValueRuleItineraryAdvanceBookingWindow").msgclass
          ConversionValueRule::ValueRuleItineraryTravelLength = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ConversionValueRule.ValueRuleItineraryTravelLength").msgclass
          ConversionValueRule::ValueRuleItineraryTravelStartDay = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.ConversionValueRule.ValueRuleItineraryTravelStartDay").msgclass
        end
      end
    end
  end
