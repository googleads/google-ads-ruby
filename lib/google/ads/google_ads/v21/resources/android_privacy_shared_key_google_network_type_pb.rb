...
require 'google/ads/google_ads/v21/enums/android_privacy_interaction_type_pb'
require 'google/ads/google_ads/v21/enums/android_privacy_network_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          AndroidPrivacySharedKeyGoogleNetworkType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AndroidPrivacySharedKeyGoogleNetworkType").msgclass
        end
      end
    end
  end
