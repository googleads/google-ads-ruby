...
require 'google/ads/google_ads/v21/enums/operating_system_version_operator_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          OperatingSystemVersionConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.OperatingSystemVersionConstant").msgclass
        end
      end
    end
  end
