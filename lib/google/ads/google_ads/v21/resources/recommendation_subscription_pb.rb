...
require 'google/ads/google_ads/v21/enums/recommendation_subscription_status_pb'
require 'google/ads/google_ads/v21/enums/recommendation_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          RecommendationSubscription = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.RecommendationSubscription").msgclass
        end
      end
    end
  end
