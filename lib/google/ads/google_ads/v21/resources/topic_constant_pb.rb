...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          TopicConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.TopicConstant").msgclass
        end
      end
    end
  end
