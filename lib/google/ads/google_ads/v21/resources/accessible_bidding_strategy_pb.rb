...
module Google
  module Ads
    module GoogleAds
      module V21
        module Resources
          AccessibleBiddingStrategy = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AccessibleBiddingStrategy").msgclass
          AccessibleBiddingStrategy::MaximizeConversionValue = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AccessibleBiddingStrategy.MaximizeConversionValue").msgclass
          AccessibleBiddingStrategy::MaximizeConversions = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AccessibleBiddingStrategy.MaximizeConversions").msgclass
          AccessibleBiddingStrategy::TargetCpa = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AccessibleBiddingStrategy.TargetCpa").msgclass
          AccessibleBiddingStrategy::TargetImpressionShare = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AccessibleBiddingStrategy.TargetImpressionShare").msgclass
          AccessibleBiddingStrategy::TargetRoas = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AccessibleBiddingStrategy.TargetRoas").msgclass
          AccessibleBiddingStrategy::TargetSpend = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.resources.AccessibleBiddingStrategy.TargetSpend").msgclass
        end
      end
    end
  end
