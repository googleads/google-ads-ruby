...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          RemoveCampaignAutomaticallyCreatedAssetRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.RemoveCampaignAutomaticallyCreatedAssetRequest").msgclass
          RemoveCampaignAutomaticallyCreatedAssetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.RemoveCampaignAutomaticallyCreatedAssetOperation").msgclass
          RemoveCampaignAutomaticallyCreatedAssetResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.RemoveCampaignAutomaticallyCreatedAssetResponse").msgclass
        end
      end
    end
  end
