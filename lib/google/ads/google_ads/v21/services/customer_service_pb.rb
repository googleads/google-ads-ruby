...
require 'google/ads/google_ads/v21/enums/access_role_pb'
require 'google/ads/google_ads/v21/enums/response_content_type_pb'
require 'google/ads/google_ads/v21/resources/customer_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v21.resources.Customer", "google/ads/googleads/v21/resources/customer.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          MutateCustomerRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCustomerRequest").msgclass
          CreateCustomerClientRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.CreateCustomerClientRequest").msgclass
          CustomerOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.CustomerOperation").msgclass
          CreateCustomerClientResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.CreateCustomerClientResponse").msgclass
          MutateCustomerResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCustomerResponse").msgclass
          MutateCustomerResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCustomerResult").msgclass
          ListAccessibleCustomersRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.ListAccessibleCustomersRequest").msgclass
          ListAccessibleCustomersResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.ListAccessibleCustomersResponse").msgclass
        end
      end
    end
  end
