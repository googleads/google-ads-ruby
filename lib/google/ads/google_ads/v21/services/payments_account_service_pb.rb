...
require 'google/ads/google_ads/v21/resources/payments_account_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v21.resources.PaymentsAccount", "google/ads/googleads/v21/resources/payments_account.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          ListPaymentsAccountsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.ListPaymentsAccountsRequest").msgclass
          ListPaymentsAccountsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.ListPaymentsAccountsResponse").msgclass
        end
      end
    end
  end
