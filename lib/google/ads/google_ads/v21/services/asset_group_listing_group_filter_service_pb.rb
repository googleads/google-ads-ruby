...
require 'google/ads/google_ads/v21/resources/asset_group_listing_group_filter_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v21.resources.AssetGroupListingGroupFilter", "google/ads/googleads/v21/resources/asset_group_listing_group_filter.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          MutateAssetGroupListingGroupFiltersRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateAssetGroupListingGroupFiltersRequest").msgclass
          AssetGroupListingGroupFilterOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.AssetGroupListingGroupFilterOperation").msgclass
          MutateAssetGroupListingGroupFiltersResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateAssetGroupListingGroupFiltersResponse").msgclass
          MutateAssetGroupListingGroupFilterResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateAssetGroupListingGroupFilterResult").msgclass
        end
      end
    end
  end
