...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          MutateAssetSetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateAssetSetsRequest").msgclass
          AssetSetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.AssetSetOperation").msgclass
          MutateAssetSetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateAssetSetsResponse").msgclass
          MutateAssetSetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateAssetSetResult").msgclass
        end
      end
    end
  end
