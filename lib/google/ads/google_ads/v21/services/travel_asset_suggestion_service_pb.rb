...
require 'google/ads/google_ads/v21/enums/call_to_action_type_pb'
require 'google/ads/google_ads/v21/enums/hotel_asset_suggestion_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          SuggestTravelAssetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.SuggestTravelAssetsRequest").msgclass
          SuggestTravelAssetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.SuggestTravelAssetsResponse").msgclass
          HotelAssetSuggestion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.HotelAssetSuggestion").msgclass
          HotelTextAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.HotelTextAsset").msgclass
          HotelImageAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.HotelImageAsset").msgclass
        end
      end
    end
  end
