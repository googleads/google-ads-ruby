...
require 'google/ads/google_ads/v21/resources/ad_group_asset_set_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v21.resources.AdGroupAssetSet", "google/ads/googleads/v21/resources/ad_group_asset_set.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          MutateAdGroupAssetSetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateAdGroupAssetSetsRequest").msgclass
          AdGroupAssetSetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.AdGroupAssetSetOperation").msgclass
          MutateAdGroupAssetSetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateAdGroupAssetSetsResponse").msgclass
          MutateAdGroupAssetSetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateAdGroupAssetSetResult").msgclass
        end
      end
    end
  end
