...
require 'google/ads/google_ads/v21/resources/user_list_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v21.resources.UserList", "google/ads/googleads/v21/resources/user_list.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          MutateUserListsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateUserListsRequest").msgclass
          UserListOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.UserListOperation").msgclass
          MutateUserListsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateUserListsResponse").msgclass
          MutateUserListResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateUserListResult").msgclass
        end
      end
    end
  end
