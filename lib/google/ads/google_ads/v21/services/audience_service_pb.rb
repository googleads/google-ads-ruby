...
require 'google/ads/google_ads/v21/resources/audience_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v21.resources.Audience", "google/ads/googleads/v21/resources/audience.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          MutateAudiencesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateAudiencesRequest").msgclass
          MutateAudiencesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateAudiencesResponse").msgclass
          AudienceOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.AudienceOperation").msgclass
          MutateAudienceResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateAudienceResult").msgclass
        end
      end
    end
  end
