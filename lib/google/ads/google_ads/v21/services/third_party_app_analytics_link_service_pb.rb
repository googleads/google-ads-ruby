...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          RegenerateShareableLinkIdRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.RegenerateShareableLinkIdRequest").msgclass
          RegenerateShareableLinkIdResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.RegenerateShareableLinkIdResponse").msgclass
        end
      end
    end
  end
