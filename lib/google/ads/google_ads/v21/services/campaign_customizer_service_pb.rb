...
require 'google/ads/google_ads/v21/resources/campaign_customizer_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v21.resources.CampaignCustomizer", "google/ads/googleads/v21/resources/campaign_customizer.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          MutateCampaignCustomizersRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCampaignCustomizersRequest").msgclass
          CampaignCustomizerOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.CampaignCustomizerOperation").msgclass
          MutateCampaignCustomizersResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCampaignCustomizersResponse").msgclass
          MutateCampaignCustomizerResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCampaignCustomizerResult").msgclass
        end
      end
    end
  end
