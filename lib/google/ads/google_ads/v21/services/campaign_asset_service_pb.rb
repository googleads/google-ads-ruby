...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          MutateCampaignAssetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCampaignAssetsRequest").msgclass
          CampaignAssetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.CampaignAssetOperation").msgclass
          MutateCampaignAssetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCampaignAssetsResponse").msgclass
          MutateCampaignAssetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCampaignAssetResult").msgclass
        end
      end
    end
  end
