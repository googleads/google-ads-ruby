...
# source: google/ads/googleads/v21/services/multi_party_auth_review_service.proto

require 'google/protobuf'

require 'google/ads/google_ads/v21/enums/multi_party_auth_review_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          ResolveMultiPartyAuthReviewRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.ResolveMultiPartyAuthReviewRequest").msgclass
          ResolveMultiPartyAuthReviewResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.ResolveMultiPartyAuthReviewResponse").msgclass
          ResolveMultiPartyAuthReviewOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.ResolveMultiPartyAuthReviewOperation").msgclass
          ResolveMultiPartyAuthReviewResultOrError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.ResolveMultiPartyAuthReviewResultOrError").msgclass
          ResolveMultiPartyAuthReviewResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.ResolveMultiPartyAuthReviewResult").msgclass
        end
      end
    end
  end
