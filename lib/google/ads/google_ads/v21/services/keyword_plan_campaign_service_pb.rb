...
require 'google/ads/google_ads/v21/resources/keyword_plan_campaign_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v21.resources.KeywordPlanCampaign", "google/ads/googleads/v21/resources/keyword_plan_campaign.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          MutateKeywordPlanCampaignsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateKeywordPlanCampaignsRequest").msgclass
          KeywordPlanCampaignOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.KeywordPlanCampaignOperation").msgclass
          MutateKeywordPlanCampaignsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateKeywordPlanCampaignsResponse").msgclass
          MutateKeywordPlanCampaignResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateKeywordPlanCampaignResult").msgclass
        end
      end
    end
  end
