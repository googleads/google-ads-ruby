...
require 'google/ads/google_ads/v21/resources/bidding_strategy_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v21.resources.BiddingStrategy", "google/ads/googleads/v21/resources/bidding_strategy.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          MutateBiddingStrategiesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateBiddingStrategiesRequest").msgclass
          BiddingStrategyOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.BiddingStrategyOperation").msgclass
          MutateBiddingStrategiesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateBiddingStrategiesResponse").msgclass
          MutateBiddingStrategyResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateBiddingStrategyResult").msgclass
        end
      end
    end
  end
