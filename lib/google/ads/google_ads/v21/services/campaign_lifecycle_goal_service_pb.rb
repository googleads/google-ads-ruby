...
require 'google/ads/google_ads/v21/resources/campaign_lifecycle_goal_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v21.resources.CampaignLifecycleGoal", "google/ads/googleads/v21/resources/campaign_lifecycle_goal.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          ConfigureCampaignLifecycleGoalsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.ConfigureCampaignLifecycleGoalsRequest").msgclass
          CampaignLifecycleGoalOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.CampaignLifecycleGoalOperation").msgclass
          ConfigureCampaignLifecycleGoalsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.ConfigureCampaignLifecycleGoalsResponse").msgclass
          ConfigureCampaignLifecycleGoalsResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.ConfigureCampaignLifecycleGoalsResult").msgclass
        end
      end
    end
  end
