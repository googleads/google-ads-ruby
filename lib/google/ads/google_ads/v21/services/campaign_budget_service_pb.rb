...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          MutateCampaignBudgetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCampaignBudgetsRequest").msgclass
          CampaignBudgetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.CampaignBudgetOperation").msgclass
          MutateCampaignBudgetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCampaignBudgetsResponse").msgclass
          MutateCampaignBudgetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCampaignBudgetResult").msgclass
        end
      end
    end
  end
