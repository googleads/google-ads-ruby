...
require 'google/ads/google_ads/v21/resources/customer_negative_criterion_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v21.resources.CustomerNegativeCriterion", "google/ads/googleads/v21/resources/customer_negative_criterion.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          MutateCustomerNegativeCriteriaRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCustomerNegativeCriteriaRequest").msgclass
          CustomerNegativeCriterionOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.CustomerNegativeCriterionOperation").msgclass
          MutateCustomerNegativeCriteriaResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCustomerNegativeCriteriaResponse").msgclass
          MutateCustomerNegativeCriteriaResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCustomerNegativeCriteriaResult").msgclass
        end
      end
    end
  end
