...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          MutateCampaignAssetSetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCampaignAssetSetsRequest").msgclass
          CampaignAssetSetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.CampaignAssetSetOperation").msgclass
          MutateCampaignAssetSetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCampaignAssetSetsResponse").msgclass
          MutateCampaignAssetSetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCampaignAssetSetResult").msgclass
        end
      end
    end
  end
