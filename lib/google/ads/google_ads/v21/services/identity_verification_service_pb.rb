...
require 'google/ads/google_ads/v21/enums/identity_verification_program_pb'
require 'google/ads/google_ads/v21/enums/identity_verification_program_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          StartIdentityVerificationRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.StartIdentityVerificationRequest").msgclass
          GetIdentityVerificationRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.GetIdentityVerificationRequest").msgclass
          GetIdentityVerificationResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.GetIdentityVerificationResponse").msgclass
          IdentityVerification = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.IdentityVerification").msgclass
          IdentityVerificationProgress = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.IdentityVerificationProgress").msgclass
          IdentityVerificationRequirement = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.IdentityVerificationRequirement").msgclass
        end
      end
    end
  end
