...
require 'google/ads/google_ads/v21/resources/customizer_attribute_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v21.resources.CustomizerAttribute", "google/ads/googleads/v21/resources/customizer_attribute.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          MutateCustomizerAttributesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCustomizerAttributesRequest").msgclass
          CustomizerAttributeOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.CustomizerAttributeOperation").msgclass
          MutateCustomizerAttributesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCustomizerAttributesResponse").msgclass
          MutateCustomizerAttributeResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCustomizerAttributeResult").msgclass
        end
      end
    end
  end
