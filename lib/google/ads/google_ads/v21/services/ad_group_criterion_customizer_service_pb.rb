...
require 'google/ads/google_ads/v21/resources/ad_group_criterion_customizer_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v21.resources.AdGroupCriterionCustomizer", "google/ads/googleads/v21/resources/ad_group_criterion_customizer.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          MutateAdGroupCriterionCustomizersRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateAdGroupCriterionCustomizersRequest").msgclass
          AdGroupCriterionCustomizerOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.AdGroupCriterionCustomizerOperation").msgclass
          MutateAdGroupCriterionCustomizersResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateAdGroupCriterionCustomizersResponse").msgclass
          MutateAdGroupCriterionCustomizerResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateAdGroupCriterionCustomizerResult").msgclass
        end
      end
    end
  end
