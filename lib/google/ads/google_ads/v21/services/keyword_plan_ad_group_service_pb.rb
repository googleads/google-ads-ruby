...
require 'google/ads/google_ads/v21/resources/keyword_plan_ad_group_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v21.resources.KeywordPlanAdGroup", "google/ads/googleads/v21/resources/keyword_plan_ad_group.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          MutateKeywordPlanAdGroupsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateKeywordPlanAdGroupsRequest").msgclass
          KeywordPlanAdGroupOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.KeywordPlanAdGroupOperation").msgclass
          MutateKeywordPlanAdGroupsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateKeywordPlanAdGroupsResponse").msgclass
          MutateKeywordPlanAdGroupResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateKeywordPlanAdGroupResult").msgclass
        end
      end
    end
  end
