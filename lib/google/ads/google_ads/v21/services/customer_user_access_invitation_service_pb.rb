...
begin
  ...
  imports = [
    ["google.ads.googleads.v21.resources.CustomerUserAccessInvitation", "google/ads/googleads/v21/resources/customer_user_access_invitation.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          MutateCustomerUserAccessInvitationRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCustomerUserAccessInvitationRequest").msgclass
          CustomerUserAccessInvitationOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.CustomerUserAccessInvitationOperation").msgclass
          MutateCustomerUserAccessInvitationResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCustomerUserAccessInvitationResponse").msgclass
          MutateCustomerUserAccessInvitationResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCustomerUserAccessInvitationResult").msgclass
        end
      end
    end
  end
