...
require 'google/ads/google_ads/v21/resources/customer_customizer_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v21.resources.CustomerCustomizer", "google/ads/googleads/v21/resources/customer_customizer.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          MutateCustomerCustomizersRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCustomerCustomizersRequest").msgclass
          CustomerCustomizerOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.CustomerCustomizerOperation").msgclass
          MutateCustomerCustomizersResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCustomerCustomizersResponse").msgclass
          MutateCustomerCustomizerResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCustomerCustomizerResult").msgclass
        end
      end
    end
  end
