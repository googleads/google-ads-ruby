...
require 'google/ads/google_ads/v21/resources/experiment_arm_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v21.resources.ExperimentArm", "google/ads/googleads/v21/resources/experiment_arm.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          MutateExperimentArmsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateExperimentArmsRequest").msgclass
          ExperimentArmOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.ExperimentArmOperation").msgclass
          MutateExperimentArmsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateExperimentArmsResponse").msgclass
          MutateExperimentArmResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateExperimentArmResult").msgclass
        end
      end
    end
  end
