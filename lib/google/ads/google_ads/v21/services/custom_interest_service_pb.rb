...
require 'google/ads/google_ads/v21/resources/custom_interest_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v21.resources.CustomInterest", "google/ads/googleads/v21/resources/custom_interest.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          MutateCustomInterestsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCustomInterestsRequest").msgclass
          CustomInterestOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.CustomInterestOperation").msgclass
          MutateCustomInterestsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCustomInterestsResponse").msgclass
          MutateCustomInterestResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCustomInterestResult").msgclass
        end
      end
    end
  end
