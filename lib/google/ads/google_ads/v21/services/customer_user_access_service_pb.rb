...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v21.resources.CustomerUserAccess", "google/ads/googleads/v21/resources/customer_user_access.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          MutateCustomerUserAccessRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCustomerUserAccessRequest").msgclass
          CustomerUserAccessOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.CustomerUserAccessOperation").msgclass
          MutateCustomerUserAccessResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCustomerUserAccessResponse").msgclass
          MutateCustomerUserAccessResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.MutateCustomerUserAccessResult").msgclass
        end
      end
    end
  end
