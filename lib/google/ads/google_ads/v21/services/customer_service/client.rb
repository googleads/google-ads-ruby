        ...
        module Services
          module CustomerService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V21::Services::CustomerService::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all CustomerService clients
              #   ::Google::Ads::GoogleAds::V21::Services::CustomerService::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              #   client = ::Google::Ads::GoogleAds::V21::Services::CustomerService::Client.new
              #
              #   # Create a client using a custom configuration
              #   client = ::Google::Ads::GoogleAds::V21::Services::CustomerService::Client.new do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                @customer_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V21::Services::CustomerService::Stub,
                ...
                @customer_service_stub.stub_logger&.info do |entry|
              ...
              #   {::Google::Ads::GoogleAds::V21::Services::MutateCustomerRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V21::Services::MutateCustomerRequest, ::Hash]
              ...
              #   @param operation [::Google::Ads::GoogleAds::V21::Services::CustomerOperation, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V21::Services::MutateCustomerResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V21::Services::MutateCustomerResponse]
              #
              ...
              #   request = Google::Ads::GoogleAds::V21::Services::MutateCustomerRequest.new
              #
              #   # Call the mutate_customer method.
              #   result = client.mutate_customer request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V21::Services::MutateCustomerResponse.
              #   p result
              #
              def mutate_customer request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V21::Services::MutateCustomerRequest
              ...
              #   {::Google::Ads::GoogleAds::V21::Services::ListAccessibleCustomersRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V21::Services::ListAccessibleCustomersRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V21::Services::ListAccessibleCustomersResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V21::Services::ListAccessibleCustomersResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::GoogleAds::V21::Services::ListAccessibleCustomersRequest.new
              #
              #   # Call the list_accessible_customers method.
              #   result = client.list_accessible_customers request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V21::Services::ListAccessibleCustomersResponse.
              #   p result
              #
              def list_accessible_customers request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V21::Services::ListAccessibleCustomersRequest
              ...
              #   {::Google::Ads::GoogleAds::V21::Services::CreateCustomerClientRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V21::Services::CreateCustomerClientRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #     created.
              #   @param customer_client [::Google::Ads::GoogleAds::V21::Resources::Customer, ::Hash]
              ...
              #   @param access_role [::Google::Ads::GoogleAds::V21::Enums::AccessRoleEnum::AccessRole]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V21::Services::CreateCustomerClientResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V21::Services::CreateCustomerClientResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V21::Services::CreateCustomerClientResponse.
              #   p result
              #
              def create_customer_client request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V21::Services::CreateCustomerClientRequest
              ...
              # {::Google::Ads::GoogleAds::V21::Services::CustomerService::Client::Configuration::Rpcs}
              ...
              #   # mutate_customer to 20 seconds,
              #   # and all remaining timeouts to 10 seconds.
              #   ::Google::Ads::GoogleAds::V21::Services::CustomerService::Client.configure do |config|
              #     config.timeout = 10.0
              #     config.rpcs.mutate_customer.timeout = 20.0
              #   end
              #
