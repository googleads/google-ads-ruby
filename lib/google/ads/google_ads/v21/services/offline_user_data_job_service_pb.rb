...
require 'google/ads/google_ads/v21/resources/offline_user_data_job_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v21.resources.OfflineUserDataJob", "google/ads/googleads/v21/resources/offline_user_data_job.proto"],
    ["google.ads.googleads.v21.common.UserData", "google/ads/googleads/v21/common/offline_user_data.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V21
        module Services
          CreateOfflineUserDataJobRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.CreateOfflineUserDataJobRequest").msgclass
          CreateOfflineUserDataJobResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.CreateOfflineUserDataJobResponse").msgclass
          RunOfflineUserDataJobRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.RunOfflineUserDataJobRequest").msgclass
          AddOfflineUserDataJobOperationsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.AddOfflineUserDataJobOperationsRequest").msgclass
          OfflineUserDataJobOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.OfflineUserDataJobOperation").msgclass
          AddOfflineUserDataJobOperationsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v21.services.AddOfflineUserDataJobOperationsResponse").msgclass
        end
      end
    end
  end
