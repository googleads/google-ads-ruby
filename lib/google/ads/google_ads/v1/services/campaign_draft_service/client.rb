...
require "google/ads/google_ads/v1/services/campaign_draft_service/credentials"
require "google/ads/google_ads/v1/services/campaign_draft_service/paths"
require "google/ads/google_ads/v1/services/campaign_draft_service/operations"
        ...
        module Services
          module CampaignDraftService
            ...
            class Client
              ...
              #
              # See {Google::Ads::GoogleAds::V1::Services::CampaignDraftService::Client::Configuration}
              ...
              #
              #     Google::Ads::GoogleAds::V1::Services::CampaignDraftService::Client.configure do |config|
              ...
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V1::Services::CampaignDraftService::Client.new
              #
              # To create a new CampaignDraftService client with a custom
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V1::Services::CampaignDraftService::Client.new do |config|
              #       config.timeout = 10_000
              #     end
              #
              ...
              def initialize
                ...
                @campaign_draft_service_stub = Gapic::ServiceStub.new(
                  Google::Ads::GoogleAds::V1::Services::CampaignDraftService::Stub,
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::GetCampaignDraftRequest | Hash]
              #     Returns the requested campaign draft in full detail.
              ...
              # @yieldparam response [Google::Ads::GoogleAds::V1::Resources::CampaignDraft]
              ...
              def get_campaign_draft request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::GetCampaignDraftRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::MutateCampaignDraftsRequest | Hash]
              #     Creates, updates, or removes campaign drafts. Operation statuses are
              #     returned.
              #   @param options [Gapic::CallOptions, Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [Google::Ads::GoogleAds::V1::Services::MutateCampaignDraftsResponse]
              # @yieldparam operation [GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_campaign_drafts request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::MutateCampaignDraftsRequest
              ...
              # {Google::Ads::GoogleAds::V1::Services::CampaignDraftService::Client#list_campaign_draft_async_errors CampaignDraftService.ListCampaignDraftAsyncErrors} to view the list of
              # error reasons.
              #
              # @overload promote_campaign_draft(request, options = nil)
              #   @param request [Google::Ads::GoogleAds::V1::Services::PromoteCampaignDraftRequest | Hash]
              #     Promotes the changes in a draft back to the base campaign.
              #
              #     This method returns a Long Running Operation (LRO) indicating if the
              #     Promote is done. Use [Operations.GetOperation] to poll the LRO until it
              ...
              def promote_campaign_draft request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::PromoteCampaignDraftRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::ListCampaignDraftAsyncErrorsRequest | Hash]
              #     Returns all errors that occurred during CampaignDraft promote. Throws an
              #     error if called before campaign draft is promoted.
              #     Supports standard list paging.
              #   @param options [Gapic::CallOptions, Hash]
              ...
              def list_campaign_draft_async_errors request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::ListCampaignDraftAsyncErrorsRequest
              ...
              # {Google::Ads::GoogleAds::V1::Services::CampaignDraftService::Client::Configuration::Rpcs}
...
begin
  require "google/ads/google_ads/v1/services/campaign_draft_service/helpers"
rescue LoadError
end
