...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v1/services/merchant_center_link_service.proto,
    ...
    module GoogleAds
      module V1
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V1::Services::MerchantCenterLinkService::Stub]
          class MerchantCenterLinkServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v1/services/merchant_center_link_service_services_pb"
              ...
              @merchant_center_link_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V1::Services::MerchantCenterLinkService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::ListMerchantCenterLinksResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::ListMerchantCenterLinksResponse]
            ...
            def list_merchant_center_links \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::ListMerchantCenterLinksRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Resources::MerchantCenterLink]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Resources::MerchantCenterLink]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def get_merchant_center_link \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::GetMerchantCenterLinkRequest)
            ...
            # @param operation [Google::Ads::GoogleAds::V1::Services::MerchantCenterLinkOperation | Hash]
            #   The operation to perform on the link
            #   A hash of the same form as `Google::Ads::GoogleAds::V1::Services::MerchantCenterLinkOperation`
            #   can also be provided.
            # @param options [Google::Gax::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout,
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::MutateMerchantCenterLinkResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::MutateMerchantCenterLinkResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_merchant_center_link \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::MutateMerchantCenterLinkRequest)
