      ...
      module V1
        module Services
          ...
          class HotelPerformanceViewServiceClient
            ...
            #
            #   hotel_performance_view_service_client = Google::Ads::GoogleAds::HotelPerformanceView.new(version: :v1)
            #   formatted_resource_name = Google::Ads::GoogleAds::V1::Services::HotelPerformanceViewServiceClient.customer_path("[CUSTOMER]")
