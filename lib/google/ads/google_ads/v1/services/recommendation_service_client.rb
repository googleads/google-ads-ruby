...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v1/services/recommendation_service.proto,
...
require "google/ads/google_ads/v1/services/recommendation_service_pb"
    ...
    module GoogleAds
      module V1
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V1::Services::RecommendationService::Stub]
          class RecommendationServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v1/services/recommendation_service_services_pb"
              ...
              @recommendation_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V1::Services::RecommendationService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V1::Resources::Recommendation]
            ...
            def get_recommendation \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::GetRecommendationRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V1::Services::ApplyRecommendationOperation | Hash>]
            #   The list of operations to apply recommendations.
            #   If partial_failure=false all recommendations should be of the same type
            #   There is a limit of 100 operations per request.
            #   A hash of the same form as `Google::Ads::GoogleAds::V1::Services::ApplyRecommendationOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::ApplyRecommendationResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::ApplyRecommendationResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def apply_recommendation \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::ApplyRecommendationRequest)
            ...
            # @param customer_id [String]
            #   The ID of the customer with the recommendation.
            # @param operations [Array<Google::Ads::GoogleAds::V1::Services::DismissRecommendationRequest::DismissRecommendationOperation | Hash>]
            #   The list of operations to dismiss recommendations.
            #   If partial_failure=false all recommendations should be of the same type
            #   There is a limit of 100 operations per request.
            #   A hash of the same form as `Google::Ads::GoogleAds::V1::Services::DismissRecommendationRequest::DismissRecommendationOperation`
            #   can also be provided.
            # @param partial_failure [true, false]
            #   If true, successful operations will be carried out and invalid
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::DismissRecommendationResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::DismissRecommendationResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def dismiss_recommendation \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::DismissRecommendationRequest)
