...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v1/services/ad_group_extension_setting_service.proto,
    ...
    module GoogleAds
      module V1
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V1::Services::AdGroupExtensionSettingService::Stub]
          class AdGroupExtensionSettingServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v1/services/ad_group_extension_setting_service_services_pb"
              ...
              @ad_group_extension_setting_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V1::Services::AdGroupExtensionSettingService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V1::Resources::AdGroupExtensionSetting]
            ...
            def get_ad_group_extension_setting \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::GetAdGroupExtensionSettingRequest)
            ...
            #   modified.
            # @param operations [Array<Google::Ads::GoogleAds::V1::Services::AdGroupExtensionSettingOperation | Hash>]
            #   The list of operations to perform on individual ad group extension
            #   settings.
            #   A hash of the same form as `Google::Ads::GoogleAds::V1::Services::AdGroupExtensionSettingOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::MutateAdGroupExtensionSettingsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::MutateAdGroupExtensionSettingsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_ad_group_extension_settings \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::MutateAdGroupExtensionSettingsRequest)
