...
require "google/ads/google_ads/v1/services/campaign_experiment_service/credentials"
require "google/ads/google_ads/v1/services/campaign_experiment_service/paths"
require "google/ads/google_ads/v1/services/campaign_experiment_service/operations"
        ...
        module Services
          module CampaignExperimentService
            ...
            class Client
              ...
              #
              # See {Google::Ads::GoogleAds::V1::Services::CampaignExperimentService::Client::Configuration}
              ...
              #
              #     Google::Ads::GoogleAds::V1::Services::CampaignExperimentService::Client.configure do |config|
              ...
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V1::Services::CampaignExperimentService::Client.new
              #
              # To create a new CampaignExperimentService client with a custom
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V1::Services::CampaignExperimentService::Client.new do |config|
              #       config.timeout = 10_000
              #     end
              #
              ...
              def initialize
                ...
                @campaign_experiment_service_stub = Gapic::ServiceStub.new(
                  Google::Ads::GoogleAds::V1::Services::CampaignExperimentService::Stub,
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::GetCampaignExperimentRequest | Hash]
              #     Returns the requested campaign experiment in full detail.
              ...
              # @yieldparam response [Google::Ads::GoogleAds::V1::Resources::CampaignExperiment]
              ...
              def get_campaign_experiment request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::GetCampaignExperimentRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::CreateCampaignExperimentRequest | Hash]
              #     Creates a campaign experiment based on a campaign draft. The draft campaign
              #     will be forked into a real campaign (called the experiment campaign) that
              #     will begin serving ads if successfully created.
              #
              ...
              def create_campaign_experiment request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::CreateCampaignExperimentRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::MutateCampaignExperimentsRequest | Hash]
              #     Updates campaign experiments. Operation statuses are returned.
              #   @param options [Gapic::CallOptions, Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [Google::Ads::GoogleAds::V1::Services::MutateCampaignExperimentsResponse]
              # @yieldparam operation [GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_campaign_experiments request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::MutateCampaignExperimentsRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::GraduateCampaignExperimentRequest | Hash]
              #     Graduates a campaign experiment to a full campaign. The base and experiment
              #     campaigns will start running independently with their own budgets.
              #   @param options [Gapic::CallOptions, Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [Google::Ads::GoogleAds::V1::Services::GraduateCampaignExperimentResponse]
              # @yieldparam operation [GRPC::ActiveCall::Operation]
              #
              ...
              def graduate_campaign_experiment request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::GraduateCampaignExperimentRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::PromoteCampaignExperimentRequest | Hash]
              #     Promotes the changes in a experiment campaign back to the base campaign.
              #
              #     The campaign experiment is updated immediately with status PROMOTING.
              #     This method return a long running operation that tracks the promoting of
              ...
              def promote_campaign_experiment request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::PromoteCampaignExperimentRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::EndCampaignExperimentRequest | Hash]
              #     Immediately ends a campaign experiment, changing the experiment's scheduled
              #     end date and without waiting for end of day. End date is updated to be the
              #     time of the request.
              #   @param options [Gapic::CallOptions, Hash]
              ...
              def end_campaign_experiment request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::EndCampaignExperimentRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::ListCampaignExperimentAsyncErrorsRequest | Hash]
              #     Returns all errors that occurred during CampaignExperiment create or
              #     promote (whichever occurred last).
              #     Supports standard list paging.
              #   @param options [Gapic::CallOptions, Hash]
              ...
              def list_campaign_experiment_async_errors request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::ListCampaignExperimentAsyncErrorsRequest
              ...
              # {Google::Ads::GoogleAds::V1::Services::CampaignExperimentService::Client::Configuration::Rpcs}
...
begin
  require "google/ads/google_ads/v1/services/campaign_experiment_service/helpers"
rescue LoadError
end
