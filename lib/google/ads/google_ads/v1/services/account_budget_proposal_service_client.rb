...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v1/services/account_budget_proposal_service.proto,
...
require "google/ads/google_ads/v1/services/account_budget_proposal_service_pb"
    ...
    module GoogleAds
      module V1
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V1::Services::AccountBudgetProposalService::Stub]
          class AccountBudgetProposalServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v1/services/account_budget_proposal_service_services_pb"
              ...
              @account_budget_proposal_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V1::Services::AccountBudgetProposalService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V1::Resources::AccountBudgetProposal]
            ...
            def get_account_budget_proposal \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::GetAccountBudgetProposalRequest)
            ...
            # @param operation [Google::Ads::GoogleAds::V1::Services::AccountBudgetProposalOperation | Hash]
            #   The operation to perform on an individual account-level budget proposal.
            #   A hash of the same form as `Google::Ads::GoogleAds::V1::Services::AccountBudgetProposalOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::MutateAccountBudgetProposalResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::MutateAccountBudgetProposalResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_account_budget_proposal \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::MutateAccountBudgetProposalRequest)
