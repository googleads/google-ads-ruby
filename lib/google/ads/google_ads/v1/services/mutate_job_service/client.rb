...
require "google/ads/google_ads/v1/services/mutate_job_service/credentials"
require "google/ads/google_ads/v1/services/mutate_job_service/paths"
require "google/ads/google_ads/v1/services/mutate_job_service/operations"
        ...
        module Services
          module MutateJobService
            ...
            class Client
              ...
              #
              # See {Google::Ads::GoogleAds::V1::Services::MutateJobService::Client::Configuration}
              ...
              #
              #     Google::Ads::GoogleAds::V1::Services::MutateJobService::Client.configure do |config|
              ...
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V1::Services::MutateJobService::Client.new
              #
              # To create a new MutateJobService client with a custom
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V1::Services::MutateJobService::Client.new do |config|
              #       config.timeout = 10_000
              #     end
              #
              ...
              def initialize
                ...
                @mutate_job_service_stub = Gapic::ServiceStub.new(
                  Google::Ads::GoogleAds::V1::Services::MutateJobService::Stub,
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::CreateMutateJobRequest | Hash]
              #     Creates a mutate job.
              ...
              # @yieldparam response [Google::Ads::GoogleAds::V1::Services::CreateMutateJobResponse]
              ...
              def create_mutate_job request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::CreateMutateJobRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::GetMutateJobRequest | Hash]
              #     Returns the mutate job.
              #   @param options [Gapic::CallOptions, Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [Google::Ads::GoogleAds::V1::Resources::MutateJob]
              # @yieldparam operation [GRPC::ActiveCall::Operation]
              #
              ...
              def get_mutate_job request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::GetMutateJobRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::ListMutateJobResultsRequest | Hash]
              #     Returns the results of the mutate job. The job must be done.
              #     Supports standard list paging.
              #   @param options [Gapic::CallOptions, Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [Gapic::PagedEnumerable<Google::Ads::GoogleAds::V1::Services::MutateJobResult>]
              # @yieldparam operation [GRPC::ActiveCall::Operation]
              #
              # @return [Gapic::PagedEnumerable<Google::Ads::GoogleAds::V1::Services::MutateJobResult>]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              def list_mutate_job_results request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::ListMutateJobResultsRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::RunMutateJobRequest | Hash]
              #     Runs the mutate job.
              #
              #     The Operation.metadata field type is MutateJobMetadata. When finished, the
              #     long running operation will not contain errors or a response. Instead, use
              ...
              def run_mutate_job request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::RunMutateJobRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::AddMutateJobOperationsRequest | Hash]
              #     Add operations to the mutate job.
              #   @param options [Gapic::CallOptions, Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [Google::Ads::GoogleAds::V1::Services::AddMutateJobOperationsResponse]
              # @yieldparam operation [GRPC::ActiveCall::Operation]
              #
              ...
              def add_mutate_job_operations request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::AddMutateJobOperationsRequest
              ...
              # {Google::Ads::GoogleAds::V1::Services::MutateJobService::Client::Configuration::Rpcs}
...
begin
  require "google/ads/google_ads/v1/services/mutate_job_service/helpers"
rescue LoadError
end
