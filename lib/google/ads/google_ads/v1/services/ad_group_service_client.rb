...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v1/services/ad_group_service.proto,
    ...
    module GoogleAds
      module V1
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V1::Services::AdGroupService::Stub]
          class AdGroupServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v1/services/ad_group_service_services_pb"
              ...
              @ad_group_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V1::Services::AdGroupService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V1::Resources::AdGroup]
            ...
            #
            #   ad_group_client = Google::Ads::GoogleAds::AdGroup.new(version: :v1)
            #   formatted_resource_name = Google::Ads::GoogleAds::V1::Services::AdGroupServiceClient.ad_group_path("[CUSTOMER]", "[AD_GROUP]")
            ...
            def get_ad_group \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::GetAdGroupRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V1::Services::AdGroupOperation | Hash>]
            #   The list of operations to perform on individual ad groups.
            #   A hash of the same form as `Google::Ads::GoogleAds::V1::Services::AdGroupOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::MutateAdGroupsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::MutateAdGroupsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_ad_groups \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::MutateAdGroupsRequest)
