...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v1/services/ad_parameter_service.proto,
    ...
    module GoogleAds
      module V1
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V1::Services::AdParameterService::Stub]
          class AdParameterServiceClient
            ...
            def initialize \
              ...
              @ad_parameter_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V1::Services::AdParameterService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V1::Resources::AdParameter]
            ...
            #
            #   ad_parameter_service_client = Google::Ads::GoogleAds::AdParameter.new(version: :v1)
            #   formatted_resource_name = Google::Ads::GoogleAds::V1::Services::AdParameterServiceClient.ad_parameter_path("[CUSTOMER]", "[AD_PARAMETER]")
            ...
            def get_ad_parameter \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::GetAdParameterRequest)
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V1::Services::AdParameterOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::MutateAdParametersResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_ad_parameters \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::MutateAdParametersRequest)
