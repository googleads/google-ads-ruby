...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v1/services/keyword_plan_service.proto,
...
require "google/ads/google_ads/v1/services/keyword_plan_service_pb"
    ...
    module GoogleAds
      module V1
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V1::Services::KeywordPlanService::Stub]
          class KeywordPlanServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v1/services/keyword_plan_service_services_pb"
              ...
              @keyword_plan_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V1::Services::KeywordPlanService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V1::Resources::KeywordPlan]
            ...
            def get_keyword_plan \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::GetKeywordPlanRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V1::Services::KeywordPlanOperation | Hash>]
            #   The list of operations to perform on individual keyword plans.
            #   A hash of the same form as `Google::Ads::GoogleAds::V1::Services::KeywordPlanOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::MutateKeywordPlansResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::MutateKeywordPlansResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_keyword_plans \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::MutateKeywordPlansRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::GenerateForecastMetricsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::GenerateForecastMetricsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def generate_forecast_metrics \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::GenerateForecastMetricsRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::GenerateHistoricalMetricsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::GenerateHistoricalMetricsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def generate_historical_metrics \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::GenerateHistoricalMetricsRequest)
