...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v1/services/feed_mapping_service.proto,
    ...
    module GoogleAds
      module V1
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V1::Services::FeedMappingService::Stub]
          class FeedMappingServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v1/services/feed_mapping_service_services_pb"
              ...
              @feed_mapping_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V1::Services::FeedMappingService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V1::Resources::FeedMapping]
            ...
            def get_feed_mapping \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::GetFeedMappingRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V1::Services::FeedMappingOperation | Hash>]
            #   The list of operations to perform on individual feed mappings.
            #   A hash of the same form as `Google::Ads::GoogleAds::V1::Services::FeedMappingOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::MutateFeedMappingsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::MutateFeedMappingsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_feed_mappings \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::MutateFeedMappingsRequest)
