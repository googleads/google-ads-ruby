...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v1/services/bidding_strategy_service.proto,
    ...
    module GoogleAds
      module V1
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V1::Services::BiddingStrategyService::Stub]
          class BiddingStrategyServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v1/services/bidding_strategy_service_services_pb"
              ...
              @bidding_strategy_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V1::Services::BiddingStrategyService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V1::Resources::BiddingStrategy]
            ...
            def get_bidding_strategy \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::GetBiddingStrategyRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V1::Services::BiddingStrategyOperation | Hash>]
            #   The list of operations to perform on individual bidding strategies.
            #   A hash of the same form as `Google::Ads::GoogleAds::V1::Services::BiddingStrategyOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::MutateBiddingStrategiesResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::MutateBiddingStrategiesResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_bidding_strategies \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::MutateBiddingStrategiesRequest)
