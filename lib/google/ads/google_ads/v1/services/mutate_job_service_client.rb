...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v1/services/mutate_job_service.proto,
...
require "google/ads/google_ads/v1/services/mutate_job_service_pb"
    ...
    module GoogleAds
      module V1
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V1::Services::MutateJobService::Stub]
          class MutateJobServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v1/services/mutate_job_service_services_pb"
              ...
              @mutate_job_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V1::Services::MutateJobService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::CreateMutateJobResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::CreateMutateJobResponse]
            ...
            def create_mutate_job \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::CreateMutateJobRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Resources::MutateJob]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def get_mutate_job \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::GetMutateJobRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Gax::PagedEnumerable<Google::Ads::GoogleAds::V1::Services::MutateJobResult>]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Gax::PagedEnumerable<Google::Ads::GoogleAds::V1::Services::MutateJobResult>]
            #   An enumerable of Google::Ads::GoogleAds::V1::Services::MutateJobResult instances.
            ...
            def list_mutate_job_results \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::ListMutateJobResultsRequest)
            ...
            def run_mutate_job \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::RunMutateJobRequest)
            ...
            #   response.
            # @param mutate_operations [Array<Google::Ads::GoogleAds::V1::Services::MutateOperation | Hash>]
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V1::Services::MutateOperation`
            #   can also be provided.
            # @param options [Google::Gax::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout,
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::AddMutateJobOperationsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::AddMutateJobOperationsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def add_mutate_job_operations \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::AddMutateJobOperationsRequest)
