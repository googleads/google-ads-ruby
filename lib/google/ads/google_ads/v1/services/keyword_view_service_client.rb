...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v1/services/keyword_view_service.proto,
...
require "google/ads/google_ads/v1/services/keyword_view_service_pb"
    ...
    module GoogleAds
      module V1
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V1::Services::KeywordViewService::Stub]
          class KeywordViewServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v1/services/keyword_view_service_services_pb"
              ...
              @keyword_view_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V1::Services::KeywordViewService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V1::Resources::KeywordView]
            ...
            def get_keyword_view \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::GetKeywordViewRequest)
