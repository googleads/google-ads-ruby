...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v1/services/label_service.proto,
    ...
    module GoogleAds
      module V1
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V1::Services::LabelService::Stub]
          class LabelServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v1/services/label_service_services_pb"
              ...
              @label_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V1::Services::LabelService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V1::Resources::Label]
            ...
            def get_label \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::GetLabelRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V1::Services::LabelOperation | Hash>]
            #   The list of operations to perform on labels.
            #   A hash of the same form as `Google::Ads::GoogleAds::V1::Services::LabelOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::MutateLabelsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::MutateLabelsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_labels \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::MutateLabelsRequest)
