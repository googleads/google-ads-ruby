...
require "google/ads/google_ads/v1/services/user_list_service/credentials"
require "google/ads/google_ads/v1/services/user_list_service/paths"
        ...
        module Services
          module UserListService
            ...
            class Client
              ...
              #
              # See {Google::Ads::GoogleAds::V1::Services::UserListService::Client::Configuration}
              ...
              #
              #     Google::Ads::GoogleAds::V1::Services::UserListService::Client.configure do |config|
              ...
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V1::Services::UserListService::Client.new
              #
              # To create a new UserListService client with a custom
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V1::Services::UserListService::Client.new do |config|
              #       config.timeout = 10_000
              #     end
              #
              ...
              def initialize
                ...
                @user_list_service_stub = Gapic::ServiceStub.new(
                  Google::Ads::GoogleAds::V1::Services::UserListService::Stub,
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::GetUserListRequest | Hash]
              #     Returns the requested user list.
              ...
              # @yieldparam response [Google::Ads::GoogleAds::V1::Resources::UserList]
              ...
              def get_user_list request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::GetUserListRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::MutateUserListsRequest | Hash]
              #     Creates or updates user lists. Operation statuses are returned.
              #   @param options [Gapic::CallOptions, Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [Google::Ads::GoogleAds::V1::Services::MutateUserListsResponse]
              # @yieldparam operation [GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_user_lists request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::MutateUserListsRequest
              ...
              # {Google::Ads::GoogleAds::V1::Services::UserListService::Client::Configuration::Rpcs}
...
begin
  require "google/ads/google_ads/v1/services/user_list_service/helpers"
rescue LoadError
end
