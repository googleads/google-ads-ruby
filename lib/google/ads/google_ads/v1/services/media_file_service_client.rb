...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v1/services/media_file_service.proto,
    ...
    module GoogleAds
      module V1
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V1::Services::MediaFileService::Stub]
          class MediaFileServiceClient
            ...
            def initialize \
              ...
              @media_file_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V1::Services::MediaFileService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V1::Resources::MediaFile]
            ...
            def get_media_file \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::GetMediaFileRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V1::Services::MediaFileOperation | Hash>]
            #   The list of operations to perform on individual media file.
            #   A hash of the same form as `Google::Ads::GoogleAds::V1::Services::MediaFileOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::MutateMediaFilesResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::MutateMediaFilesResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_media_files \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::MutateMediaFilesRequest)
