...
require "google/ads/google_ads/v1/services/merchant_center_link_service/credentials"
require "google/ads/google_ads/v1/services/merchant_center_link_service/paths"
        ...
        module Services
          module MerchantCenterLinkService
            ...
            class Client
              ...
              #
              # See {Google::Ads::GoogleAds::V1::Services::MerchantCenterLinkService::Client::Configuration}
              ...
              #
              #     Google::Ads::GoogleAds::V1::Services::MerchantCenterLinkService::Client.configure do |config|
              ...
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V1::Services::MerchantCenterLinkService::Client.new
              #
              # To create a new MerchantCenterLinkService client with a custom
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V1::Services::MerchantCenterLinkService::Client.new do |config|
              #       config.timeout = 10_000
              #     end
              #
              ...
              def initialize
                ...
                @merchant_center_link_service_stub = Gapic::ServiceStub.new(
                  Google::Ads::GoogleAds::V1::Services::MerchantCenterLinkService::Stub,
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::ListMerchantCenterLinksRequest | Hash]
              #     Returns Merchant Center links available for this customer.
              ...
              # @yieldparam response [Google::Ads::GoogleAds::V1::Services::ListMerchantCenterLinksResponse]
              ...
              def list_merchant_center_links request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::ListMerchantCenterLinksRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::GetMerchantCenterLinkRequest | Hash]
              #     Returns the Merchant Center link in full detail.
              #   @param options [Gapic::CallOptions, Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [Google::Ads::GoogleAds::V1::Resources::MerchantCenterLink]
              # @yieldparam operation [GRPC::ActiveCall::Operation]
              #
              ...
              def get_merchant_center_link request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::GetMerchantCenterLinkRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::MutateMerchantCenterLinkRequest | Hash]
              #     Updates status or removes a Merchant Center link.
              #   @param options [Gapic::CallOptions, Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [Google::Ads::GoogleAds::V1::Services::MutateMerchantCenterLinkResponse]
              # @yieldparam operation [GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_merchant_center_link request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::MutateMerchantCenterLinkRequest
              ...
              # {Google::Ads::GoogleAds::V1::Services::MerchantCenterLinkService::Client::Configuration::Rpcs}
              ...
              #     Google::Ads::GoogleAds::V1::Services::MerchantCenterLinkService::Client.configure do |config|
              #       config.timeout = 10_000
              #       config.rpcs.list_merchant_center_links.timeout = 20_000
              #     end
              #
...
begin
  require "google/ads/google_ads/v1/services/merchant_center_link_service/helpers"
rescue LoadError
end
