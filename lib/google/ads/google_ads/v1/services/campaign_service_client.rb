...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v1/services/campaign_service.proto,
    ...
    module GoogleAds
      module V1
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V1::Services::CampaignService::Stub]
          class CampaignServiceClient
            ...
            def initialize \
              ...
              @campaign_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V1::Services::CampaignService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V1::Resources::Campaign]
            ...
            def get_campaign \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::GetCampaignRequest)
            ...
            #   A hash of the same form as `Google::Ads::GoogleAds::V1::Services::CampaignOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::MutateCampaignsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            ...
            def mutate_campaigns \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::MutateCampaignsRequest)
