...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v1/services/billing_setup_service.proto,
...
require "google/ads/google_ads/v1/services/billing_setup_service_pb"
    ...
    module GoogleAds
      module V1
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V1::Services::BillingSetupService::Stub]
          class BillingSetupServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v1/services/billing_setup_service_services_pb"
              ...
              @billing_setup_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V1::Services::BillingSetupService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V1::Resources::BillingSetup]
            ...
            def get_billing_setup \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::GetBillingSetupRequest)
            ...
            # @param operation [Google::Ads::GoogleAds::V1::Services::BillingSetupOperation | Hash]
            #   The operation to perform.
            #   A hash of the same form as `Google::Ads::GoogleAds::V1::Services::BillingSetupOperation`
            #   can also be provided.
            # @param options [Google::Gax::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout,
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::MutateBillingSetupResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::MutateBillingSetupResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_billing_setup \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::MutateBillingSetupRequest)
