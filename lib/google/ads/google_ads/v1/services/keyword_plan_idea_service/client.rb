...
require "google/ads/google_ads/v1/services/keyword_plan_idea_service/credentials"
        ...
        module Services
          module KeywordPlanIdeaService
            ...
            class Client
              ...
              #
              # See {Google::Ads::GoogleAds::V1::Services::KeywordPlanIdeaService::Client::Configuration}
              ...
              #
              #     Google::Ads::GoogleAds::V1::Services::KeywordPlanIdeaService::Client.configure do |config|
              ...
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V1::Services::KeywordPlanIdeaService::Client.new
              #
              # To create a new KeywordPlanIdeaService client with a custom
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V1::Services::KeywordPlanIdeaService::Client.new do |config|
              #       config.timeout = 10_000
              #     end
              #
              ...
              def initialize
                ...
                @keyword_plan_idea_service_stub = Gapic::ServiceStub.new(
                  Google::Ads::GoogleAds::V1::Services::KeywordPlanIdeaService::Stub,
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::GenerateKeywordIdeasRequest | Hash]
              #     Returns a list of keyword ideas.
              ...
              # @yieldparam response [Google::Ads::GoogleAds::V1::Services::GenerateKeywordIdeaResponse]
              ...
              def generate_keyword_ideas request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::GenerateKeywordIdeasRequest
              ...
              # {Google::Ads::GoogleAds::V1::Services::KeywordPlanIdeaService::Client::Configuration::Rpcs}
              ...
              #     Google::Ads::GoogleAds::V1::Services::KeywordPlanIdeaService::Client.configure do |config|
              #       config.timeout = 10_000
              #       config.rpcs.generate_keyword_ideas.timeout = 20_000
              #     end
              #
...
begin
  require "google/ads/google_ads/v1/services/keyword_plan_idea_service/helpers"
rescue LoadError
end
