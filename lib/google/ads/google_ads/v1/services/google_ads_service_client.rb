...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v1/services/google_ads_service.proto,
    ...
    module GoogleAds
      module V1
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V1::Services::GoogleAdsService::Stub]
          class GoogleAdsServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v1/services/google_ads_service_services_pb"
              ...
              @google_ads_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V1::Services::GoogleAdsService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Gax::PagedEnumerable<Google::Ads::GoogleAds::V1::Services::GoogleAdsRow>]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Gax::PagedEnumerable<Google::Ads::GoogleAds::V1::Services::GoogleAdsRow>]
            #   An enumerable of Google::Ads::GoogleAds::V1::Services::GoogleAdsRow instances.
            ...
            #
            #   google_ads_service_client = Google::Ads::GoogleAds::GoogleAds.new(version: :v1)
            #
            ...
            def search \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::SearchGoogleAdsRequest)
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::MutateGoogleAdsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::MutateGoogleAdsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::MutateGoogleAdsRequest)
