...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v1/services/ad_group_ad_service.proto,
    ...
    module GoogleAds
      module V1
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V1::Services::AdGroupAdService::Stub]
          class AdGroupAdServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v1/services/ad_group_ad_service_services_pb"
              ...
              @ad_group_ad_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V1::Services::AdGroupAdService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V1::Resources::AdGroupAd]
            ...
            def get_ad_group_ad \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::GetAdGroupAdRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V1::Services::AdGroupAdOperation | Hash>]
            #   The list of operations to perform on individual ads.
            #   A hash of the same form as `Google::Ads::GoogleAds::V1::Services::AdGroupAdOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::MutateAdGroupAdsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::MutateAdGroupAdsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_ad_group_ads \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::MutateAdGroupAdsRequest)
