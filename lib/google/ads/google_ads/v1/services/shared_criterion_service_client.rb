...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v1/services/shared_criterion_service.proto,
    ...
    module GoogleAds
      module V1
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V1::Services::SharedCriterionService::Stub]
          class SharedCriterionServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v1/services/shared_criterion_service_services_pb"
              ...
              @shared_criterion_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V1::Services::SharedCriterionService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V1::Resources::SharedCriterion]
            ...
            def get_shared_criterion \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::GetSharedCriterionRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V1::Services::SharedCriterionOperation | Hash>]
            #   The list of operations to perform on individual shared criteria.
            #   A hash of the same form as `Google::Ads::GoogleAds::V1::Services::SharedCriterionOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::MutateSharedCriteriaResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::MutateSharedCriteriaResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_shared_criteria \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::MutateSharedCriteriaRequest)
