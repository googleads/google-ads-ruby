...
require "google/ads/google_ads/v1/services/asset_service/credentials"
require "google/ads/google_ads/v1/services/asset_service/paths"
        ...
        module Services
          module AssetService
            ...
            class Client
              ...
              #
              # See {Google::Ads::GoogleAds::V1::Services::AssetService::Client::Configuration}
              ...
              #
              #     Google::Ads::GoogleAds::V1::Services::AssetService::Client.configure do |config|
              ...
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V1::Services::AssetService::Client.new
              #
              # To create a new AssetService client with a custom
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V1::Services::AssetService::Client.new do |config|
              #       config.timeout = 10_000
              #     end
              #
              ...
              def initialize
                ...
                @asset_service_stub = Gapic::ServiceStub.new(
                  Google::Ads::GoogleAds::V1::Services::AssetService::Stub,
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::GetAssetRequest | Hash]
              #     Returns the requested asset in full detail.
              ...
              # @yieldparam response [Google::Ads::GoogleAds::V1::Resources::Asset]
              ...
              def get_asset request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::GetAssetRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::MutateAssetsRequest | Hash]
              #     Creates assets. Operation statuses are returned.
              #   @param options [Gapic::CallOptions, Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [Google::Ads::GoogleAds::V1::Services::MutateAssetsResponse]
              # @yieldparam operation [GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_assets request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::MutateAssetsRequest
              ...
              # {Google::Ads::GoogleAds::V1::Services::AssetService::Client::Configuration::Rpcs}
...
begin
  require "google/ads/google_ads/v1/services/asset_service/helpers"
rescue LoadError
end
