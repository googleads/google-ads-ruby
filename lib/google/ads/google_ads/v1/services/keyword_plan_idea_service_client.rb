...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v1/services/keyword_plan_idea_service.proto,
...
require "google/ads/google_ads/v1/services/keyword_plan_idea_service_pb"
    ...
    module GoogleAds
      module V1
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V1::Services::KeywordPlanIdeaService::Stub]
          class KeywordPlanIdeaServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v1/services/keyword_plan_idea_service_services_pb"
              ...
              @keyword_plan_idea_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V1::Services::KeywordPlanIdeaService::Stub.method(:new)
              )
            ...
            #   A hash of the same form as `Google::Protobuf::StringValue`
            #   can also be provided.
            # @param keyword_plan_network [Google::Ads::GoogleAds::V1::Enums::KeywordPlanNetworkEnum::KeywordPlanNetwork]
            #   Targeting network.
            # @param keyword_and_url_seed [Google::Ads::GoogleAds::V1::Services::KeywordAndUrlSeed | Hash]
            #   A Keyword and a specific Url to generate ideas from
            #   e.g. cars, www.example.com/cars.
            #   A hash of the same form as `Google::Ads::GoogleAds::V1::Services::KeywordAndUrlSeed`
            #   can also be provided.
            # @param keyword_seed [Google::Ads::GoogleAds::V1::Services::KeywordSeed | Hash]
            #   A Keyword or phrase to generate ideas from, e.g. cars.
            #   A hash of the same form as `Google::Ads::GoogleAds::V1::Services::KeywordSeed`
            #   can also be provided.
            # @param url_seed [Google::Ads::GoogleAds::V1::Services::UrlSeed | Hash]
            #   A specific url to generate ideas from, e.g. www.example.com/cars.
            #   A hash of the same form as `Google::Ads::GoogleAds::V1::Services::UrlSeed`
            #   can also be provided.
            # @param options [Google::Gax::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout,
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::GenerateKeywordIdeaResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::GenerateKeywordIdeaResponse]
            ...
            def generate_keyword_ideas \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::GenerateKeywordIdeasRequest)
