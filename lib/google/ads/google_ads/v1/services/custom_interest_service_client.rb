...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v1/services/custom_interest_service.proto,
    ...
    module GoogleAds
      module V1
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V1::Services::CustomInterestService::Stub]
          class CustomInterestServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v1/services/custom_interest_service_services_pb"
              ...
              @custom_interest_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V1::Services::CustomInterestService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V1::Resources::CustomInterest]
            ...
            def get_custom_interest \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::GetCustomInterestRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V1::Services::CustomInterestOperation | Hash>]
            #   The list of operations to perform on individual custom interests.
            #   A hash of the same form as `Google::Ads::GoogleAds::V1::Services::CustomInterestOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::MutateCustomInterestsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::MutateCustomInterestsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_custom_interests \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::MutateCustomInterestsRequest)
