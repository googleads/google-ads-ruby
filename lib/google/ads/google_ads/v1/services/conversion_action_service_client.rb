...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v1/services/conversion_action_service.proto,
    ...
    module GoogleAds
      module V1
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V1::Services::ConversionActionService::Stub]
          class ConversionActionServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v1/services/conversion_action_service_services_pb"
              ...
              @conversion_action_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V1::Services::ConversionActionService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V1::Resources::ConversionAction]
            ...
            def get_conversion_action \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::GetConversionActionRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V1::Services::ConversionActionOperation | Hash>]
            #   The list of operations to perform on individual conversion actions.
            #   A hash of the same form as `Google::Ads::GoogleAds::V1::Services::ConversionActionOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::MutateConversionActionsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::MutateConversionActionsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_conversion_actions \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::MutateConversionActionsRequest)
