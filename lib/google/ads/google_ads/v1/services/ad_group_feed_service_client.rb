...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v1/services/ad_group_feed_service.proto,
    ...
    module GoogleAds
      module V1
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V1::Services::AdGroupFeedService::Stub]
          class AdGroupFeedServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v1/services/ad_group_feed_service_services_pb"
              ...
              @ad_group_feed_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V1::Services::AdGroupFeedService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V1::Resources::AdGroupFeed]
            ...
            def get_ad_group_feed \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::GetAdGroupFeedRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V1::Services::AdGroupFeedOperation | Hash>]
            #   The list of operations to perform on individual ad group feeds.
            #   A hash of the same form as `Google::Ads::GoogleAds::V1::Services::AdGroupFeedOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::MutateAdGroupFeedsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::MutateAdGroupFeedsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_ad_group_feeds \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::MutateAdGroupFeedsRequest)
