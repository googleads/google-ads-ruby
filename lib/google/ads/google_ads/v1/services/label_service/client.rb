...
require "google/ads/google_ads/v1/services/label_service/credentials"
require "google/ads/google_ads/v1/services/label_service/paths"
        ...
        module Services
          module LabelService
            ...
            class Client
              ...
              #
              # See {Google::Ads::GoogleAds::V1::Services::LabelService::Client::Configuration}
              ...
              #
              #     Google::Ads::GoogleAds::V1::Services::LabelService::Client.configure do |config|
              ...
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V1::Services::LabelService::Client.new
              #
              # To create a new LabelService client with a custom
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V1::Services::LabelService::Client.new do |config|
              #       config.timeout = 10_000
              #     end
              #
              ...
              def initialize
                ...
                @label_service_stub = Gapic::ServiceStub.new(
                  Google::Ads::GoogleAds::V1::Services::LabelService::Stub,
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::GetLabelRequest | Hash]
              #     Returns the requested label in full detail.
              ...
              # @yieldparam response [Google::Ads::GoogleAds::V1::Resources::Label]
              ...
              def get_label request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::GetLabelRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::MutateLabelsRequest | Hash]
              #     Creates, updates, or removes labels. Operation statuses are returned.
              #   @param options [Gapic::CallOptions, Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [Google::Ads::GoogleAds::V1::Services::MutateLabelsResponse]
              # @yieldparam operation [GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_labels request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::MutateLabelsRequest
              ...
              # {Google::Ads::GoogleAds::V1::Services::LabelService::Client::Configuration::Rpcs}
...
begin
  require "google/ads/google_ads/v1/services/label_service/helpers"
rescue LoadError
end
