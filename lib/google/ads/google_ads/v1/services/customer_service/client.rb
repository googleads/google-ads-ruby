...
require "google/ads/google_ads/v1/services/customer_service/credentials"
require "google/ads/google_ads/v1/services/customer_service/paths"
        ...
        module Services
          module CustomerService
            ...
            class Client
              ...
              #
              # See {Google::Ads::GoogleAds::V1::Services::CustomerService::Client::Configuration}
              ...
              #
              #     Google::Ads::GoogleAds::V1::Services::CustomerService::Client.configure do |config|
              ...
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V1::Services::CustomerService::Client.new
              #
              # To create a new CustomerService client with a custom
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V1::Services::CustomerService::Client.new do |config|
              #       config.timeout = 10_000
              #     end
              #
              ...
              def initialize
                ...
                @customer_service_stub = Gapic::ServiceStub.new(
                  Google::Ads::GoogleAds::V1::Services::CustomerService::Stub,
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::GetCustomerRequest | Hash]
              #     Returns the requested customer in full detail.
              ...
              # @yieldparam response [Google::Ads::GoogleAds::V1::Resources::Customer]
              ...
              def get_customer request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::GetCustomerRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::MutateCustomerRequest | Hash]
              #     Updates a customer. Operation statuses are returned.
              #   @param options [Gapic::CallOptions, Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [Google::Ads::GoogleAds::V1::Services::MutateCustomerResponse]
              # @yieldparam operation [GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_customer request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::MutateCustomerRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::ListAccessibleCustomersRequest | Hash]
              #     Returns resource names of customers directly accessible by the
              #     user authenticating the call.
              #   @param options [Gapic::CallOptions, Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [Google::Ads::GoogleAds::V1::Services::ListAccessibleCustomersResponse]
              # @yieldparam operation [GRPC::ActiveCall::Operation]
              #
              ...
              def list_accessible_customers request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::ListAccessibleCustomersRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::CreateCustomerClientRequest | Hash]
              #     Creates a new client under manager. The new client customer is returned.
              #   @param options [Gapic::CallOptions, Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @overload create_customer_client(customer_id: nil, customer_client: nil)
              #   @param customer_id [String]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [Google::Ads::GoogleAds::V1::Services::CreateCustomerClientResponse]
              # @yieldparam operation [GRPC::ActiveCall::Operation]
              #
              ...
              def create_customer_client request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::CreateCustomerClientRequest
              ...
              # {Google::Ads::GoogleAds::V1::Services::CustomerService::Client::Configuration::Rpcs}
...
begin
  require "google/ads/google_ads/v1/services/customer_service/helpers"
rescue LoadError
end
