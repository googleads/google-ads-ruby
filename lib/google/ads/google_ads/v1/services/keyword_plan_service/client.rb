...
require "google/ads/google_ads/v1/services/keyword_plan_service/credentials"
require "google/ads/google_ads/v1/services/keyword_plan_service/paths"
        ...
        module Services
          module KeywordPlanService
            ...
            class Client
              ...
              #
              # See {Google::Ads::GoogleAds::V1::Services::KeywordPlanService::Client::Configuration}
              ...
              #
              #     Google::Ads::GoogleAds::V1::Services::KeywordPlanService::Client.configure do |config|
              ...
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V1::Services::KeywordPlanService::Client.new
              #
              # To create a new KeywordPlanService client with a custom
              # configuration:
              #
              #     client = Google::Ads::GoogleAds::V1::Services::KeywordPlanService::Client.new do |config|
              #       config.timeout = 10_000
              #     end
              #
              ...
              def initialize
                ...
                @keyword_plan_service_stub = Gapic::ServiceStub.new(
                  Google::Ads::GoogleAds::V1::Services::KeywordPlanService::Stub,
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::GetKeywordPlanRequest | Hash]
              #     Returns the requested plan in full detail.
              ...
              # @yieldparam response [Google::Ads::GoogleAds::V1::Resources::KeywordPlan]
              ...
              def get_keyword_plan request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::GetKeywordPlanRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::MutateKeywordPlansRequest | Hash]
              #     Creates, updates, or removes keyword plans. Operation statuses are
              #     returned.
              #   @param options [Gapic::CallOptions, Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [Google::Ads::GoogleAds::V1::Services::MutateKeywordPlansResponse]
              # @yieldparam operation [GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_keyword_plans request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::MutateKeywordPlansRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::GenerateForecastMetricsRequest | Hash]
              #     Returns the requested Keyword Plan forecasts.
              #   @param options [Gapic::CallOptions, Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [Google::Ads::GoogleAds::V1::Services::GenerateForecastMetricsResponse]
              # @yieldparam operation [GRPC::ActiveCall::Operation]
              #
              ...
              def generate_forecast_metrics request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::GenerateForecastMetricsRequest
              ...
              #   @param request [Google::Ads::GoogleAds::V1::Services::GenerateHistoricalMetricsRequest | Hash]
              #     Returns the requested Keyword Plan historical metrics.
              #   @param options [Gapic::CallOptions, Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [Google::Ads::GoogleAds::V1::Services::GenerateHistoricalMetricsResponse]
              # @yieldparam operation [GRPC::ActiveCall::Operation]
              #
              ...
              def generate_historical_metrics request, options = nil
                ...
                request = Gapic::Protobuf.coerce request, to: Google::Ads::GoogleAds::V1::Services::GenerateHistoricalMetricsRequest
              ...
              # {Google::Ads::GoogleAds::V1::Services::KeywordPlanService::Client::Configuration::Rpcs}
              ...
              #     Google::Ads::GoogleAds::V1::Services::KeywordPlanService::Client.configure do |config|
              #       config.timeout = 10_000
              #       config.rpcs.get_keyword_plan.timeout = 20_000
              #     end
              #
...
begin
  require "google/ads/google_ads/v1/services/keyword_plan_service/helpers"
rescue LoadError
end
