...
# https://github.com/googleapis/googleapis/blob/master/google/ads/google_ads/v1/services/user_list_service.proto,
    ...
    module GoogleAds
      module V1
        module Services
          ...
          #   @return [Google::Ads::GoogleAds::V1::Services::UserListService::Stub]
          class UserListServiceClient
            ...
            def initialize \
              ...
              require "google/ads/google_ads/v1/services/user_list_service_services_pb"
              ...
              @user_list_service_stub = Google::Gax::Grpc.create_stub(
                ...
                &Google::Ads::GoogleAds::V1::Services::UserListService::Stub.method(:new)
              )
            ...
            # @yieldparam result [Google::Ads::GoogleAds::V1::Resources::UserList]
            ...
            def get_user_list \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::GetUserListRequest)
            ...
            # @param operations [Array<Google::Ads::GoogleAds::V1::Services::UserListOperation | Hash>]
            #   The list of operations to perform on individual user lists.
            #   A hash of the same form as `Google::Ads::GoogleAds::V1::Services::UserListOperation`
            ...
            #   retries, etc.
            # @yield [result, operation] Access the result along with the RPC operation
            # @yieldparam result [Google::Ads::GoogleAds::V1::Services::MutateUserListsResponse]
            # @yieldparam operation [GRPC::ActiveCall::Operation]
            # @return [Google::Ads::GoogleAds::V1::Services::MutateUserListsResponse]
            # @raise [Google::Gax::GaxError] if the RPC is aborted.
            # @example
            #   require "google/ads/google_ads"
            #
            ...
            def mutate_user_lists \
              ...
              req = Google::Gax::to_proto(req, Google::Ads::GoogleAds::V1::Services::MutateUserListsRequest)
