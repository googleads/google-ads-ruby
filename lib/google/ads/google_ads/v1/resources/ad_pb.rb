...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v1/resources/ad.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v1.resources.Ad" do
      ...
      oneof :ad_data do
        ...
        optional :shopping_comparison_listing_ad, :message, 36, "google.ads.googleads.v1.common.ShoppingComparisonListingAdInfo"
      end
    end
  end
end
