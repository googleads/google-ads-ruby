...
require 'google/ads/google_ads/v1/enums/product_bidding_category_status_pb'
require 'google/api/field_behavior_pb'
require 'google/api/resource_pb'
require 'google/protobuf/wrappers_pb'
require 'google/api/annotations_pb'
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v1/resources/product_bidding_category_constant.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v1.resources.ProductBiddingCategoryConstant" do
      ...
      optional :level, :enum, 5, "google.ads.googleads.v1.enums.ProductBiddingCategoryLevelEnum.ProductBiddingCategoryLevel"
      optional :status, :enum, 6, "google.ads.googleads.v1.enums.ProductBiddingCategoryStatusEnum.ProductBiddingCategoryStatus"
