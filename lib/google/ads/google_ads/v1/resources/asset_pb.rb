...
require 'google/ads/google_ads/v1/common/asset_types_pb'
require 'google/ads/google_ads/v1/enums/asset_type_pb'
require 'google/api/field_behavior_pb'
require 'google/api/resource_pb'
require 'google/protobuf/wrappers_pb'
require 'google/api/annotations_pb'
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v1/resources/asset.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v1.resources.Asset" do
      optional :resource_name, :string, 1
      optional :id, :message, 2, "google.protobuf.Int64Value"
      optional :name, :message, 3, "google.protobuf.StringValue"
      optional :type, :enum, 4, "google.ads.googleads.v1.enums.AssetTypeEnum.AssetType"
      oneof :asset_data do
...
module Google
  module Ads
    module GoogleAds
      module V1
        module Resources
          Asset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v1.resources.Asset").msgclass
        end
      end
    end
  end
