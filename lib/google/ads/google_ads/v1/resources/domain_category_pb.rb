...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v1/resources/domain_category.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v1.resources.DomainCategory" do
...
module Google
  module Ads
    module GoogleAds
      module V1
        module Resources
          DomainCategory = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v1.resources.DomainCategory").msgclass
        end
      end
    end
  end
