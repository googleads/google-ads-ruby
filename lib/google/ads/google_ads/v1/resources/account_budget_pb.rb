...
require 'google/ads/google_ads/v1/enums/account_budget_status_pb'
...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v1/resources/account_budget.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v1.resources.AccountBudget" do
      optional :resource_name, :string, 1
      optional :id, :message, 2, "google.protobuf.Int64Value"
      optional :billing_setup, :message, 3, "google.protobuf.StringValue"
      optional :status, :enum, 4, "google.ads.googleads.v1.enums.AccountBudgetStatusEnum.AccountBudgetStatus"
      ...
      optional :pending_proposal, :message, 22, "google.ads.googleads.v1.resources.AccountBudget.PendingAccountBudgetProposal"
      ...
      oneof :approved_end_time do
        ...
        optional :approved_end_time_type, :enum, 11, "google.ads.googleads.v1.enums.TimeTypeEnum.TimeType"
      end
      oneof :proposed_spending_limit do
        optional :proposed_spending_limit_micros, :message, 12, "google.protobuf.Int64Value"
        optional :proposed_spending_limit_type, :enum, 13, "google.ads.googleads.v1.enums.SpendingLimitTypeEnum.SpendingLimitType"
      end
      oneof :approved_spending_limit do
        optional :approved_spending_limit_micros, :message, 14, "google.protobuf.Int64Value"
        optional :approved_spending_limit_type, :enum, 15, "google.ads.googleads.v1.enums.SpendingLimitTypeEnum.SpendingLimitType"
      end
      oneof :adjusted_spending_limit do
        optional :adjusted_spending_limit_micros, :message, 16, "google.protobuf.Int64Value"
        optional :adjusted_spending_limit_type, :enum, 17, "google.ads.googleads.v1.enums.SpendingLimitTypeEnum.SpendingLimitType"
      end
    end
    add_message "google.ads.googleads.v1.resources.AccountBudget.PendingAccountBudgetProposal" do
      optional :account_budget_proposal, :message, 1, "google.protobuf.StringValue"
      optional :proposal_type, :enum, 2, "google.ads.googleads.v1.enums.AccountBudgetProposalTypeEnum.AccountBudgetProposalType"
      ...
      oneof :end_time do
        ...
        optional :end_time_type, :enum, 6, "google.ads.googleads.v1.enums.TimeTypeEnum.TimeType"
      end
      oneof :spending_limit do
        optional :spending_limit_micros, :message, 7, "google.protobuf.Int64Value"
        optional :spending_limit_type, :enum, 8, "google.ads.googleads.v1.enums.SpendingLimitTypeEnum.SpendingLimitType"
      end
    end
  end
end
...
module Google
  module Ads
    module GoogleAds
      module V1
        module Resources
          AccountBudget = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v1.resources.AccountBudget").msgclass
          AccountBudget::PendingAccountBudgetProposal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v1.resources.AccountBudget.PendingAccountBudgetProposal").msgclass
        end
      end
    end
  end
