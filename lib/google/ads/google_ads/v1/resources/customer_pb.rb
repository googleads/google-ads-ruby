...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v1/resources/customer.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v1.resources.Customer" do
    ...
    add_message "google.ads.googleads.v1.resources.ConversionTrackingSetting" do
    ...
    add_message "google.ads.googleads.v1.resources.RemarketingSetting" do
...
module Google
  module Ads
    module GoogleAds
      module V1
        module Resources
          Customer = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v1.resources.Customer").msgclass
          CallReportingSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v1.resources.CallReportingSetting").msgclass
          ConversionTrackingSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v1.resources.ConversionTrackingSetting").msgclass
          RemarketingSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v1.resources.RemarketingSetting").msgclass
        end
      end
    end
  end
