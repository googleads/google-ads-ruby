...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v1/resources/campaign_criterion_simulation.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v1.resources.CampaignCriterionSimulation" do
      ...
      oneof :point_list do
        optional :bid_modifier_point_list, :message, 8, "google.ads.googleads.v1.common.BidModifierSimulationPointList"
      end
    end
  end
end
...
module Google
  module Ads
    module GoogleAds
      module V1
        module Resources
          CampaignCriterionSimulation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v1.resources.CampaignCriterionSimulation").msgclass
        end
      end
    end
  end
