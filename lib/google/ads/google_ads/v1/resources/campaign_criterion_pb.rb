...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v1/resources/campaign_criterion.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v1.resources.CampaignCriterion" do
      ...
      oneof :criterion do
        ...
        optional :location_group, :message, 34, "google.ads.googleads.v1.common.LocationGroupInfo"
      end
    end
  end
end
