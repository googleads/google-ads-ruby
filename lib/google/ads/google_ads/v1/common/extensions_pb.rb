...
require 'google/ads/google_ads/v1/enums/app_store_pb'
require 'google/ads/google_ads/v1/enums/call_conversion_reporting_state_pb'
require 'google/ads/google_ads/v1/enums/price_extension_price_qualifier_pb'
require 'google/ads/google_ads/v1/enums/price_extension_price_unit_pb'
require 'google/ads/google_ads/v1/enums/price_extension_type_pb'
require 'google/ads/google_ads/v1/enums/promotion_extension_discount_modifier_pb'
require 'google/ads/google_ads/v1/enums/promotion_extension_occasion_pb'
require 'google/protobuf/wrappers_pb'
require 'google/api/annotations_pb'
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v1/common/extensions.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v1.common.AppFeedItem" do
      optional :link_text, :message, 1, "google.protobuf.StringValue"
      optional :app_id, :message, 2, "google.protobuf.StringValue"
      optional :app_store, :enum, 3, "google.ads.googleads.v1.enums.AppStoreEnum.AppStore"
      ...
      repeated :url_custom_parameters, :message, 7, "google.ads.googleads.v1.common.CustomParameter"
      optional :final_url_suffix, :message, 8, "google.protobuf.StringValue"
    end
    add_message "google.ads.googleads.v1.common.CallFeedItem" do
      ...
      optional :call_conversion_reporting_state, :enum, 6, "google.ads.googleads.v1.enums.CallConversionReportingStateEnum.CallConversionReportingState"
    end
    ...
    add_message "google.ads.googleads.v1.common.PriceFeedItem" do
      optional :type, :enum, 1, "google.ads.googleads.v1.enums.PriceExtensionTypeEnum.PriceExtensionType"
      optional :price_qualifier, :enum, 2, "google.ads.googleads.v1.enums.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifier"
      ...
      repeated :price_offerings, :message, 5, "google.ads.googleads.v1.common.PriceOffer"
      optional :final_url_suffix, :message, 6, "google.protobuf.StringValue"
    end
    add_message "google.ads.googleads.v1.common.PriceOffer" do
      optional :header, :message, 1, "google.protobuf.StringValue"
      optional :description, :message, 2, "google.protobuf.StringValue"
      optional :price, :message, 3, "google.ads.googleads.v1.common.Money"
      optional :unit, :enum, 4, "google.ads.googleads.v1.enums.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit"
    ...
    add_message "google.ads.googleads.v1.common.PromotionFeedItem" do
      optional :promotion_target, :message, 1, "google.protobuf.StringValue"
      optional :discount_modifier, :enum, 2, "google.ads.googleads.v1.enums.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifier"
      ...
      optional :occasion, :enum, 9, "google.ads.googleads.v1.enums.PromotionExtensionOccasionEnum.PromotionExtensionOccasion"
      ...
      repeated :url_custom_parameters, :message, 13, "google.ads.googleads.v1.common.CustomParameter"
      ...
      oneof :discount_type do
        ...
        optional :money_amount_off, :message, 4, "google.ads.googleads.v1.common.Money"
      end
      oneof :promotion_trigger do
        optional :promotion_code, :message, 5, "google.protobuf.StringValue"
        optional :orders_over_amount, :message, 6, "google.ads.googleads.v1.common.Money"
      end
    end
    add_message "google.ads.googleads.v1.common.StructuredSnippetFeedItem" do
      optional :header, :message, 1, "google.protobuf.StringValue"
      repeated :values, :message, 2, "google.protobuf.StringValue"
    end
    add_message "google.ads.googleads.v1.common.SitelinkFeedItem" do
      optional :link_text, :message, 1, "google.protobuf.StringValue"
    ...
    module GoogleAds
      module V1
        module Common
          ...
          PromotionFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v1.common.PromotionFeedItem").msgclass
          StructuredSnippetFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v1.common.StructuredSnippetFeedItem").msgclass
          SitelinkFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v1.common.SitelinkFeedItem").msgclass
        end
      end
    end
  end
