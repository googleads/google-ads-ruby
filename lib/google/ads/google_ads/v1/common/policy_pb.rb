...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v1/common/policy.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v1.common.PolicyViolationKey" do
    ...
    add_message "google.ads.googleads.v1.common.PolicyTopicEntry" do
      ...
      optional :type, :enum, 2, "google.ads.googleads.v1.enums.PolicyTopicEntryTypeEnum.PolicyTopicEntryType"
      repeated :evidences, :message, 3, "google.ads.googleads.v1.common.PolicyTopicEvidence"
      repeated :constraints, :message, 4, "google.ads.googleads.v1.common.PolicyTopicConstraint"
    end
    add_message "google.ads.googleads.v1.common.PolicyTopicEvidence" do
      oneof :value do
        optional :http_code, :message, 2, "google.protobuf.Int32Value"
        optional :website_list, :message, 3, "google.ads.googleads.v1.common.PolicyTopicEvidence.WebsiteList"
        optional :text_list, :message, 4, "google.ads.googleads.v1.common.PolicyTopicEvidence.TextList"
    ...
    add_message "google.ads.googleads.v1.common.PolicyTopicEvidence.WebsiteList" do
      repeated :websites, :message, 1, "google.protobuf.StringValue"
    end
    add_message "google.ads.googleads.v1.common.PolicyTopicEvidence.DestinationTextList" do
    ...
    add_message "google.ads.googleads.v1.common.PolicyTopicConstraint" do
      oneof :value do
        optional :country_constraint_list, :message, 1, "google.ads.googleads.v1.common.PolicyTopicConstraint.CountryConstraintList"
        optional :reseller_constraint, :message, 2, "google.ads.googleads.v1.common.PolicyTopicConstraint.ResellerConstraint"
        optional :certificate_missing_in_country_list, :message, 3, "google.ads.googleads.v1.common.PolicyTopicConstraint.CountryConstraintList"
        optional :certificate_domain_mismatch_in_country_list, :message, 4, "google.ads.googleads.v1.common.PolicyTopicConstraint.CountryConstraintList"
      end
    end
    add_message "google.ads.googleads.v1.common.PolicyTopicConstraint.CountryConstraintList" do
      optional :total_targeted_countries, :message, 1, "google.protobuf.Int32Value"
      repeated :countries, :message, 2, "google.ads.googleads.v1.common.PolicyTopicConstraint.CountryConstraint"
    end
    add_message "google.ads.googleads.v1.common.PolicyTopicConstraint.ResellerConstraint" do
    end
    add_message "google.ads.googleads.v1.common.PolicyTopicConstraint.CountryConstraint" do
...
module Google
  module Ads
    module GoogleAds
      module V1
        module Common
          PolicyViolationKey = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v1.common.PolicyViolationKey").msgclass
          PolicyValidationParameter = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v1.common.PolicyValidationParameter").msgclass
          PolicyTopicEntry = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v1.common.PolicyTopicEntry").msgclass
          PolicyTopicEvidence = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v1.common.PolicyTopicEvidence").msgclass
          PolicyTopicEvidence::TextList = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v1.common.PolicyTopicEvidence.TextList").msgclass
          ...
          PolicyTopicConstraint::CountryConstraint = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v1.common.PolicyTopicConstraint.CountryConstraint").msgclass
        end
      end
    end
  end
