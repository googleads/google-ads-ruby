...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v1/common/simulation.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v1.common.BidModifierSimulationPointList" do
      repeated :points, :message, 1, "google.ads.googleads.v1.common.BidModifierSimulationPoint"
    end
    ...
    add_message "google.ads.googleads.v1.common.BidModifierSimulationPoint" do
