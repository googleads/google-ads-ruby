...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v1/errors/bidding_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v1.errors.BiddingErrorEnum" do
    end
    add_enum "google.ads.googleads.v1.errors.BiddingErrorEnum.BiddingError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V1
        module Errors
          BiddingErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v1.errors.BiddingErrorEnum").msgclass
          BiddingErrorEnum::BiddingError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v1.errors.BiddingErrorEnum.BiddingError").enummodule
        end
      end
    end
  end
