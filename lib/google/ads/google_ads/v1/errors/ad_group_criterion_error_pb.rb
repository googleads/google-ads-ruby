...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v1/errors/ad_group_criterion_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v1.errors.AdGroupCriterionErrorEnum" do
    end
    add_enum "google.ads.googleads.v1.errors.AdGroupCriterionErrorEnum.AdGroupCriterionError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V1
        module Errors
          AdGroupCriterionErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v1.errors.AdGroupCriterionErrorEnum").msgclass
          AdGroupCriterionErrorEnum::AdGroupCriterionError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v1.errors.AdGroupCriterionErrorEnum.AdGroupCriterionError").enummodule
        end
      end
    end
  end
