...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v1/errors/campaign_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v1.errors.CampaignErrorEnum" do
    end
    add_enum "google.ads.googleads.v1.errors.CampaignErrorEnum.CampaignError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V1
        module Errors
          CampaignErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v1.errors.CampaignErrorEnum").msgclass
          CampaignErrorEnum::CampaignError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v1.errors.CampaignErrorEnum.CampaignError").enummodule
        end
      end
    end
  end
