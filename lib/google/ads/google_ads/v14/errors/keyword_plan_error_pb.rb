...
module Google
  module Ads
    module GoogleAds
      module V14
        module Errors
          KeywordPlanErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.errors.KeywordPlanErrorEnum").msgclass
          KeywordPlanErrorEnum::KeywordPlanError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.errors.KeywordPlanErrorEnum.KeywordPlanError").enummodule
        end
      end
    end
  end
