...
module Google
  module Ads
    module GoogleAds
      module V14
        module Errors
          FunctionErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.errors.FunctionErrorEnum").msgclass
          FunctionErrorEnum::FunctionError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.errors.FunctionErrorEnum.FunctionError").enummodule
        end
      end
    end
  end
