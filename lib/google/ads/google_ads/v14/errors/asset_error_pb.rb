...
module Google
  module Ads
    module GoogleAds
      module V14
        module Errors
          AssetErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.errors.AssetErrorEnum").msgclass
          AssetErrorEnum::AssetError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.errors.AssetErrorEnum.AssetError").enummodule
        end
      end
    end
  end
