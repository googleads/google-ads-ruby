...
module Google
  module Ads
    module GoogleAds
      module V14
        module Errors
          ConversionUploadErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.errors.ConversionUploadErrorEnum").msgclass
          ConversionUploadErrorEnum::ConversionUploadError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.errors.ConversionUploadErrorEnum.ConversionUploadError").enummodule
        end
      end
    end
  end
