...
module Google
  module Ads
    module GoogleAds
      module V14
        module Errors
          ExperimentArmErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.errors.ExperimentArmErrorEnum").msgclass
          ExperimentArmErrorEnum::ExperimentArmError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.errors.ExperimentArmErrorEnum.ExperimentArmError").enummodule
        end
      end
    end
  end
