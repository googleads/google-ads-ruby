...
module Google
  module Ads
    module GoogleAds
      module V14
        module Errors
          AssetGroupErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.errors.AssetGroupErrorEnum").msgclass
          AssetGroupErrorEnum::AssetGroupError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.errors.AssetGroupErrorEnum.AssetGroupError").enummodule
        end
      end
    end
  end
