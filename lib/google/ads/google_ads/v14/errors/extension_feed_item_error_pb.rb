...
module Google
  module Ads
    module GoogleAds
      module V14
        module Errors
          ExtensionFeedItemErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.errors.ExtensionFeedItemErrorEnum").msgclass
          ExtensionFeedItemErrorEnum::ExtensionFeedItemError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.errors.ExtensionFeedItemErrorEnum.ExtensionFeedItemError").enummodule
        end
      end
    end
  end
