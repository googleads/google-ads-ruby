...
module Google
  module Ads
    module GoogleAds
      module V14
        module Enums
          PricePlaceholderFieldEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.enums.PricePlaceholderFieldEnum").msgclass
          PricePlaceholderFieldEnum::PricePlaceholderField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.enums.PricePlaceholderFieldEnum.PricePlaceholderField").enummodule
        end
      end
    end
  end
