...
module Google
  module Ads
    module GoogleAds
      module V14
        module Enums
          PromotionExtensionOccasionEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.enums.PromotionExtensionOccasionEnum").msgclass
          PromotionExtensionOccasionEnum::PromotionExtensionOccasion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.enums.PromotionExtensionOccasionEnum.PromotionExtensionOccasion").enummodule
        end
      end
    end
  end
