...
module Google
  module Ads
    module GoogleAds
      module V14
        module Resources
          CampaignLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.CampaignLabel").msgclass
        end
      end
    end
  end
