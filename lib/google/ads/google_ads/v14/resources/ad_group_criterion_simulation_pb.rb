...
module Google
  module Ads
    module GoogleAds
      module V14
        module Resources
          AdGroupCriterionSimulation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.AdGroupCriterionSimulation").msgclass
        end
      end
    end
  end
