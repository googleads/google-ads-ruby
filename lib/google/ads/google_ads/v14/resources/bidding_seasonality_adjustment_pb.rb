...
# source: google/ads/googleads/v14/resources/bidding_seasonality_adjustment.proto
...
module Google
  module Ads
    module GoogleAds
      module V14
        module Resources
          BiddingSeasonalityAdjustment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.BiddingSeasonalityAdjustment").msgclass
        end
      end
    end
  end
