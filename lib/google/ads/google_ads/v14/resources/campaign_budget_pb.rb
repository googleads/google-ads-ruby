...
module Google
  module Ads
    module GoogleAds
      module V14
        module Resources
          CampaignBudget = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.CampaignBudget").msgclass
        end
      end
    end
  end
