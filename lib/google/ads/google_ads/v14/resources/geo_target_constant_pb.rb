...
module Google
  module Ads
    module GoogleAds
      module V14
        module Resources
          GeoTargetConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.GeoTargetConstant").msgclass
        end
      end
    end
  end
