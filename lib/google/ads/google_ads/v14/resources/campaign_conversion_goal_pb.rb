...
module Google
  module Ads
    module GoogleAds
      module V14
        module Resources
          CampaignConversionGoal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.CampaignConversionGoal").msgclass
        end
      end
    end
  end
