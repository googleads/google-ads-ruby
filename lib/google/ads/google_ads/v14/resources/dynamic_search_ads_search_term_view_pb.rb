...
# source: google/ads/googleads/v14/resources/dynamic_search_ads_search_term_view.proto
...
module Google
  module Ads
    module GoogleAds
      module V14
        module Resources
          DynamicSearchAdsSearchTermView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.DynamicSearchAdsSearchTermView").msgclass
        end
      end
    end
  end
