...
module Google
  module Ads
    module GoogleAds
      module V14
        module Resources
          CustomerLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.CustomerLabel").msgclass
        end
      end
    end
  end
