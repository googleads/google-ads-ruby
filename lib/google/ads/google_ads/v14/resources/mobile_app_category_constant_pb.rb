...
# source: google/ads/googleads/v14/resources/mobile_app_category_constant.proto
...
module Google
  module Ads
    module GoogleAds
      module V14
        module Resources
          MobileAppCategoryConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.MobileAppCategoryConstant").msgclass
        end
      end
    end
  end
