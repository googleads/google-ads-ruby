...
module Google
  module Ads
    module GoogleAds
      module V14
        module Resources
          KeywordPlanAdGroup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.KeywordPlanAdGroup").msgclass
        end
      end
    end
  end
