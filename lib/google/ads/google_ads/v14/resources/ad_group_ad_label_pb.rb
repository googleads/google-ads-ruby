...
# source: google/ads/googleads/v14/resources/ad_group_ad_label.proto
...
module Google
  module Ads
    module GoogleAds
      module V14
        module Resources
          AdGroupAdLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.AdGroupAdLabel").msgclass
        end
      end
    end
  end
