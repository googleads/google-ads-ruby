...
# source: google/ads/googleads/v14/resources/campaign_bid_modifier.proto
...
begin
  ...
  imports = [
    ["google.ads.googleads.v14.common.InteractionTypeInfo", "google/ads/googleads/v14/common/criteria.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V14
        module Resources
          CampaignBidModifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.CampaignBidModifier").msgclass
        end
      end
    end
  end
