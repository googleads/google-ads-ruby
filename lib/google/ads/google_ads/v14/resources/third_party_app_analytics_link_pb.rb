...
module Google
  module Ads
    module GoogleAds
      module V14
        module Resources
          ThirdPartyAppAnalyticsLink = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.ThirdPartyAppAnalyticsLink").msgclass
        end
      end
    end
  end
