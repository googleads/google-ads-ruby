...
# source: google/ads/googleads/v14/resources/shopping_performance_view.proto
...
module Google
  module Ads
    module GoogleAds
      module V14
        module Resources
          ShoppingPerformanceView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.ShoppingPerformanceView").msgclass
        end
      end
    end
  end
