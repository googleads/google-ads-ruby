...
module Google
  module Ads
    module GoogleAds
      module V14
        module Resources
          CustomerConversionGoal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.CustomerConversionGoal").msgclass
        end
      end
    end
  end
