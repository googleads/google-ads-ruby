...
module Google
  module Ads
    module GoogleAds
      module V14
        module Resources
          CampaignAssetSet = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.CampaignAssetSet").msgclass
        end
      end
    end
  end
