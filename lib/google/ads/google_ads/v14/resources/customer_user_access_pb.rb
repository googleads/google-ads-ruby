...
module Google
  module Ads
    module GoogleAds
      module V14
        module Resources
          CustomerUserAccess = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.CustomerUserAccess").msgclass
        end
      end
    end
  end
