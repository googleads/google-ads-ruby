...
module Google
  module Ads
    module GoogleAds
      module V14
        module Resources
          Invoice = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.Invoice").msgclass
          Invoice::AccountSummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.Invoice.AccountSummary").msgclass
          Invoice::AccountBudgetSummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.Invoice.AccountBudgetSummary").msgclass
          Invoice::InvalidActivitySummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.Invoice.InvalidActivitySummary").msgclass
        end
      end
    end
  end
