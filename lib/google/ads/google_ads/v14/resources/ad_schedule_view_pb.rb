...
module Google
  module Ads
    module GoogleAds
      module V14
        module Resources
          AdScheduleView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.AdScheduleView").msgclass
        end
      end
    end
  end
