...
# source: google/ads/googleads/v14/resources/carrier_constant.proto
...
module Google
  module Ads
    module GoogleAds
      module V14
        module Resources
          CarrierConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.CarrierConstant").msgclass
        end
      end
    end
  end
