...
# source: google/ads/googleads/v14/resources/detail_placement_view.proto
...
module Google
  module Ads
    module GoogleAds
      module V14
        module Resources
          DetailPlacementView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.DetailPlacementView").msgclass
        end
      end
    end
  end
