...
# source: google/ads/googleads/v14/resources/campaign_search_term_insight.proto
...
module Google
  module Ads
    module GoogleAds
      module V14
        module Resources
          CampaignSearchTermInsight = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.CampaignSearchTermInsight").msgclass
        end
      end
    end
  end
