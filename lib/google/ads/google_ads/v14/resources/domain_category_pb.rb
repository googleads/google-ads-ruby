...
module Google
  module Ads
    module GoogleAds
      module V14
        module Resources
          DomainCategory = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.DomainCategory").msgclass
        end
      end
    end
  end
