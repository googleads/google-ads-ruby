...
module Google
  module Ads
    module GoogleAds
      module V14
        module Resources
          KeywordThemeConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v14.resources.KeywordThemeConstant").msgclass
        end
      end
    end
  end
