...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v9/errors/authentication_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v9.errors.AuthenticationErrorEnum" do
    end
    add_enum "google.ads.googleads.v9.errors.AuthenticationErrorEnum.AuthenticationError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V9
        module Errors
          AuthenticationErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v9.errors.AuthenticationErrorEnum").msgclass
          AuthenticationErrorEnum::AuthenticationError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v9.errors.AuthenticationErrorEnum.AuthenticationError").enummodule
        end
      end
    end
  end
