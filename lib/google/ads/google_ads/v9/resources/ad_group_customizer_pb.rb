...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v9/resources/ad_group_customizer.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v9.resources.AdGroupCustomizer" do
...
module Google
  module Ads
    module GoogleAds
      module V9
        module Resources
          AdGroupCustomizer = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v9.resources.AdGroupCustomizer").msgclass
        end
      end
    end
  end
