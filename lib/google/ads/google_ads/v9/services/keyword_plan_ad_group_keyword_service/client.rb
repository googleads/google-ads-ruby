        ...
        module Services
          module KeywordPlanAdGroupKeywordService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V9::Services::KeywordPlanAdGroupKeywordService::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all KeywordPlanAdGroupKeywordService clients
              #   ::Google::Ads::GoogleAds::V9::Services::KeywordPlanAdGroupKeywordService::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              #   client = ::Google::Ads::GoogleAds::V9::Services::KeywordPlanAdGroupKeywordService::Client.new
              #
              #   # Create a client using a custom configuration
              #   client = ::Google::Ads::GoogleAds::V9::Services::KeywordPlanAdGroupKeywordService::Client.new do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/google_ads/v9/services/keyword_plan_ad_group_keyword_service_services_pb"
                ...
                @keyword_plan_ad_group_keyword_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V9::Services::KeywordPlanAdGroupKeywordService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V9::Services::GetKeywordPlanAdGroupKeywordRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V9::Services::GetKeywordPlanAdGroupKeywordRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V9::Resources::KeywordPlanAdGroupKeyword]
              ...
              def get_keyword_plan_ad_group_keyword request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V9::Services::GetKeywordPlanAdGroupKeywordRequest
              ...
              #   {::Google::Ads::GoogleAds::V9::Services::MutateKeywordPlanAdGroupKeywordsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V9::Services::MutateKeywordPlanAdGroupKeywordsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #     modified.
              #   @param operations [::Array<::Google::Ads::GoogleAds::V9::Services::KeywordPlanAdGroupKeywordOperation, ::Hash>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V9::Services::MutateKeywordPlanAdGroupKeywordsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V9::Services::MutateKeywordPlanAdGroupKeywordsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              def mutate_keyword_plan_ad_group_keywords request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V9::Services::MutateKeywordPlanAdGroupKeywordsRequest
              ...
              # {::Google::Ads::GoogleAds::V9::Services::KeywordPlanAdGroupKeywordService::Client::Configuration::Rpcs}
