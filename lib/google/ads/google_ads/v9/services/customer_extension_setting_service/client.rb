        ...
        module Services
          module CustomerExtensionSettingService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V9::Services::CustomerExtensionSettingService::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all CustomerExtensionSettingService clients
              #   ::Google::Ads::GoogleAds::V9::Services::CustomerExtensionSettingService::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              #   client = ::Google::Ads::GoogleAds::V9::Services::CustomerExtensionSettingService::Client.new
              #
              #   # Create a client using a custom configuration
              #   client = ::Google::Ads::GoogleAds::V9::Services::CustomerExtensionSettingService::Client.new do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/google_ads/v9/services/customer_extension_setting_service_services_pb"
                ...
                @customer_extension_setting_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V9::Services::CustomerExtensionSettingService::Stub,
              ...
              #   Pass arguments to `get_customer_extension_setting` via a request object, either of type
              #   {::Google::Ads::GoogleAds::V9::Services::GetCustomerExtensionSettingRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V9::Services::GetCustomerExtensionSettingRequest, ::Hash]
              ...
              #   Pass arguments to `get_customer_extension_setting` via keyword arguments. Note that at
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V9::Resources::CustomerExtensionSetting]
              ...
              def get_customer_extension_setting request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V9::Services::GetCustomerExtensionSettingRequest
                ...
                @customer_extension_setting_service_stub.call_rpc :get_customer_extension_setting, request,
              ...
              #   Pass arguments to `mutate_customer_extension_settings` via a request object, either of type
              #   {::Google::Ads::GoogleAds::V9::Services::MutateCustomerExtensionSettingsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V9::Services::MutateCustomerExtensionSettingsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @overload mutate_customer_extension_settings(customer_id: nil, operations: nil, partial_failure: nil, validate_only: nil, response_content_type: nil)
              #   Pass arguments to `mutate_customer_extension_settings` via keyword arguments. Note that at
              #   least one keyword argument is required. To specify no parameters, or to keep all
              #   the default parameter values, pass an empty Hash as a request object (see above).
              #
              ...
              #     modified.
              #   @param operations [::Array<::Google::Ads::GoogleAds::V9::Services::CustomerExtensionSettingOperation, ::Hash>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V9::Services::MutateCustomerExtensionSettingsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V9::Services::MutateCustomerExtensionSettingsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              def mutate_customer_extension_settings request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V9::Services::MutateCustomerExtensionSettingsRequest
                ...
                @customer_extension_setting_service_stub.call_rpc :mutate_customer_extension_settings, request,
                                                                  options: options do |response, operation|
                  yield response, operation if block_given?
                  return response
                end
              ...
              # {::Google::Ads::GoogleAds::V9::Services::CustomerExtensionSettingService::Client::Configuration::Rpcs}
              ...
              #   # get_customer_extension_setting to 20 seconds,
              #   # and all remaining timeouts to 10 seconds.
              #   ::Google::Ads::GoogleAds::V9::Services::CustomerExtensionSettingService::Client.configure do |config|
              #     config.timeout = 10.0
              #     config.rpcs.get_customer_extension_setting.timeout = 20.0
              #   end
              #
