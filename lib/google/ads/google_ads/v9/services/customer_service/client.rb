        ...
        module Services
          module CustomerService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V9::Services::CustomerService::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all CustomerService clients
              #   ::Google::Ads::GoogleAds::V9::Services::CustomerService::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              #   client = ::Google::Ads::GoogleAds::V9::Services::CustomerService::Client.new
              #
              #   # Create a client using a custom configuration
              #   client = ::Google::Ads::GoogleAds::V9::Services::CustomerService::Client.new do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/google_ads/v9/services/customer_service_services_pb"
                ...
                @customer_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V9::Services::CustomerService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V9::Services::GetCustomerRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V9::Services::GetCustomerRequest, ::Hash]
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V9::Resources::Customer]
              ...
              def get_customer request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V9::Services::GetCustomerRequest
              ...
              #   {::Google::Ads::GoogleAds::V9::Services::MutateCustomerRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V9::Services::MutateCustomerRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param operation [::Google::Ads::GoogleAds::V9::Services::CustomerOperation, ::Hash]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V9::Services::MutateCustomerResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def mutate_customer request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V9::Services::MutateCustomerRequest
              ...
              #   {::Google::Ads::GoogleAds::V9::Services::ListAccessibleCustomersRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V9::Services::ListAccessibleCustomersRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V9::Services::ListAccessibleCustomersResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def list_accessible_customers request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V9::Services::ListAccessibleCustomersRequest
              ...
              #   {::Google::Ads::GoogleAds::V9::Services::CreateCustomerClientRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V9::Services::CreateCustomerClientRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param customer_client [::Google::Ads::GoogleAds::V9::Resources::Customer, ::Hash]
              ...
              #   @param access_role [::Google::Ads::GoogleAds::V9::Enums::AccessRoleEnum::AccessRole]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V9::Services::CreateCustomerClientResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              def create_customer_client request, options = nil
                ...
                request = ::Gapic::Protobuf.coerce request,
                                                   to: ::Google::Ads::GoogleAds::V9::Services::CreateCustomerClientRequest
              ...
              # {::Google::Ads::GoogleAds::V9::Services::CustomerService::Client::Configuration::Rpcs}
