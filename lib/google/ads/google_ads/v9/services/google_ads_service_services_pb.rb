...
# Source: google/ads/googleads/v9/services/google_ads_service.proto for package 'Google.Ads.GoogleAds.V9.Services'
        ...
        module Services
          module GoogleAdsService
            ...
            class Service
              ...
              self.service_name = 'google.ads.googleads.v9.services.GoogleAdsService'
              ...
              #   [QuotaError]()
              #   [RequestError]()
              rpc :Search, ::Google::Ads::GoogleAds::V9::Services::SearchGoogleAdsRequest, ::Google::Ads::GoogleAds::V9::Services::SearchGoogleAdsResponse
              ...
              #   [QuotaError]()
              #   [RequestError]()
              rpc :SearchStream, ::Google::Ads::GoogleAds::V9::Services::SearchGoogleAdsStreamRequest, stream(::Google::Ads::GoogleAds::V9::Services::SearchGoogleAdsStreamResponse)
              ...
              rpc :Mutate, ::Google::Ads::GoogleAds::V9::Services::MutateGoogleAdsRequest, ::Google::Ads::GoogleAds::V9::Services::MutateGoogleAdsResponse
            end
