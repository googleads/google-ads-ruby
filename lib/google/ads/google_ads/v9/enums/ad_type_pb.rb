...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v9/enums/ad_type.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v9.enums.AdTypeEnum" do
    end
    add_enum "google.ads.googleads.v9.enums.AdTypeEnum.AdType" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
      value :TEXT_AD, 2
...
module Google
  module Ads
    module GoogleAds
      module V9
        module Enums
          AdTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v9.enums.AdTypeEnum").msgclass
          AdTypeEnum::AdType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v9.enums.AdTypeEnum.AdType").enummodule
        end
      end
    end
  end
