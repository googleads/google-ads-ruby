...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v9/enums/vanity_pharma_text.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v9.enums.VanityPharmaTextEnum" do
    end
    add_enum "google.ads.googleads.v9.enums.VanityPharmaTextEnum.VanityPharmaText" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V9
        module Enums
          VanityPharmaTextEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v9.enums.VanityPharmaTextEnum").msgclass
          VanityPharmaTextEnum::VanityPharmaText = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v9.enums.VanityPharmaTextEnum.VanityPharmaText").enummodule
        end
      end
    end
  end
