...
# source: google/ads/googleads/v25/resources/domain_category.proto
...
module Google
  module Ads
    module GoogleAds
      module V25
        module Resources
          DomainCategory = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v25.resources.DomainCategory").msgclass
        end
      end
    end
  end
