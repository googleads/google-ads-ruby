...
# source: google/ads/googleads/v25/resources/dynamic_search_ads_search_term_view.proto
...
module Google
  module Ads
    module GoogleAds
      module V25
        module Resources
          DynamicSearchAdsSearchTermView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v25.resources.DynamicSearchAdsSearchTermView").msgclass
        end
      end
    end
  end
