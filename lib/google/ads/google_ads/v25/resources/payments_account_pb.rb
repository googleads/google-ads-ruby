...
# source: google/ads/googleads/v25/resources/payments_account.proto
...
module Google
  module Ads
    module GoogleAds
      module V25
        module Resources
          PaymentsAccount = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v25.resources.PaymentsAccount").msgclass
        end
      end
    end
  end
