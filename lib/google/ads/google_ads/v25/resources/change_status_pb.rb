...
module Google
  module Ads
    module GoogleAds
      module V25
        module Resources
          ChangeStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v25.resources.ChangeStatus").msgclass
        end
      end
    end
  end
