...
module Google
  module Ads
    module GoogleAds
      module V25
        module Resources
          CampaignBudget = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v25.resources.CampaignBudget").msgclass
        end
      end
    end
  end
