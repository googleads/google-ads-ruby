...
require "google/ads/google_ads/v25/services/reach_plan_service_pb"
        ...
        module Services
          module ReachPlanService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V25::Services::ReachPlanService::Client::Configuration}
              # for a description of the configuration fields.
              #
              # @example
              #
              #   # Modify the configuration for all ReachPlanService clients
              #   ::Google::Ads::GoogleAds::V25::Services::ReachPlanService::Client.configure do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              #   client = ::Google::Ads::GoogleAds::V25::Services::ReachPlanService::Client.new
              #
              #   # Create a client using a custom configuration
              #   client = ::Google::Ads::GoogleAds::V25::Services::ReachPlanService::Client.new do |config|
              #     config.timeout = 10.0
              #   end
              #
              ...
              def initialize
                ...
                require "gapic/grpc"
                require "google/ads/google_ads/v25/services/reach_plan_service_services_pb"
                ...
                @reach_plan_service_stub = ::Gapic::ServiceStub.new(
                  ::Google::Ads::GoogleAds::V25::Services::ReachPlanService::Stub,
              ...
              #   {::Google::Ads::GoogleAds::V25::Services::GenerateConversionRatesRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V25::Services::GenerateConversionRatesRequest, ::Hash]
              ...
              #   @param reach_application_info [::Google::Ads::GoogleAds::V25::Common::AdditionalApplicationInfo, ::Hash]
              #     Optional. Additional information on the application issuing the request.
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V25::Services::GenerateConversionRatesResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V25::Services::GenerateConversionRatesResponse]
              #
              ...
              #   request = Google::Ads::GoogleAds::V25::Services::GenerateConversionRatesRequest.new
              #
              #   # Call the generate_conversion_rates method.
              #   result = client.generate_conversion_rates request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V25::Services::GenerateConversionRatesResponse.
              #   p result
              #
              def generate_conversion_rates request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V25::Services::GenerateConversionRatesRequest
              ...
              #   {::Google::Ads::GoogleAds::V25::Services::ListPlannableLocationsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V25::Services::ListPlannableLocationsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V25::Services::ListPlannableLocationsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V25::Services::ListPlannableLocationsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::GoogleAds::V25::Services::ListPlannableLocationsRequest.new
              #
              #   # Call the list_plannable_locations method.
              #   result = client.list_plannable_locations request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V25::Services::ListPlannableLocationsResponse.
              #   p result
              #
              def list_plannable_locations request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V25::Services::ListPlannableLocationsRequest
              ...
              #   {::Google::Ads::GoogleAds::V25::Services::ListPlannableProductsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V25::Services::ListPlannableProductsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #     {::Google::Ads::GoogleAds::V25::Services::ReachPlanService::Client#list_plannable_locations ReachPlanService.ListPlannableLocations}.
              #   @param reach_application_info [::Google::Ads::GoogleAds::V25::Common::AdditionalApplicationInfo, ::Hash]
              #     Optional. Additional information on the application issuing the request.
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V25::Services::ListPlannableProductsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V25::Services::ListPlannableProductsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::GoogleAds::V25::Services::ListPlannableProductsRequest.new
              #
              #   # Call the list_plannable_products method.
              #   result = client.list_plannable_products request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V25::Services::ListPlannableProductsResponse.
              #   p result
              #
              def list_plannable_products request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V25::Services::ListPlannableProductsRequest
              ...
              #   {::Google::Ads::GoogleAds::V25::Services::GenerateReachForecastRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V25::Services::GenerateReachForecastRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              #
              # @overload generate_reach_forecast(customer_id: nil, currency_code: nil, campaign_duration: nil, cookie_frequency_cap_setting: nil, min_effective_frequency: nil, effective_frequency_limit: nil, targeting: nil, planned_products: nil, forecast_metric_options: nil, customer_reach_group: nil, reach_application_info: nil)
              ...
              #   @param campaign_duration [::Google::Ads::GoogleAds::V25::Services::CampaignDuration, ::Hash]
              #     Required. Campaign duration.
              #   @param cookie_frequency_cap_setting [::Google::Ads::GoogleAds::V25::Services::FrequencyCap, ::Hash]
              ...
              #   @param effective_frequency_limit [::Google::Ads::GoogleAds::V25::Services::EffectiveFrequencyLimit, ::Hash]
              ...
              #   @param targeting [::Google::Ads::GoogleAds::V25::Services::Targeting, ::Hash]
              ...
              #   @param planned_products [::Array<::Google::Ads::GoogleAds::V25::Services::PlannedProduct, ::Hash>]
              #     Required. The products to be forecast.
              #     The max number of allowed planned products is 15.
              #   @param forecast_metric_options [::Google::Ads::GoogleAds::V25::Services::ForecastMetricOptions, ::Hash]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V25::Services::GenerateReachForecastResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V25::Services::GenerateReachForecastResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::GoogleAds::V25::Services::GenerateReachForecastRequest.new
              #
              #   # Call the generate_reach_forecast method.
              #   result = client.generate_reach_forecast request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V25::Services::GenerateReachForecastResponse.
              #   p result
              #
              def generate_reach_forecast request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V25::Services::GenerateReachForecastRequest
              ...
              #   {::Google::Ads::GoogleAds::V25::Services::ListPlannableUserListsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V25::Services::ListPlannableUserListsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V25::Services::ListPlannableUserListsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V25::Services::ListPlannableUserListsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::GoogleAds::V25::Services::ListPlannableUserListsRequest.new
              #
              #   # Call the list_plannable_user_lists method.
              #   result = client.list_plannable_user_lists request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V25::Services::ListPlannableUserListsResponse.
              #   p result
              #
              def list_plannable_user_lists request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V25::Services::ListPlannableUserListsRequest
              ...
              # using
              # {::Google::Ads::GoogleAds::V25::Services::ReachPlanService::Client#generate_reach_forecast ReachPlanService.GenerateReachForecast}.
              #
              # List of thrown errors:
              #   [AuthenticationError]()
              #   [AuthorizationError]()
              ...
              #   {::Google::Ads::GoogleAds::V25::Services::ListPlannableUserInterestsRequest} or an equivalent Hash.
              #
              #   @param request [::Google::Ads::GoogleAds::V25::Services::ListPlannableUserInterestsRequest, ::Hash]
              #     A request object representing the call parameters. Required. To specify no
              #     parameters, or to keep all the default parameter values, pass an empty Hash.
              #   @param options [::Gapic::CallOptions, ::Hash]
              #     Overrides the default settings for this call, e.g, timeout, retries, etc. Optional.
              ...
              #   @param customer_id [::String]
              #     Required. The ID of the customer.
              #   @param user_interest_taxonomy_types [::Array<::Google::Ads::GoogleAds::V25::Enums::UserInterestTaxonomyTypeEnum::UserInterestTaxonomyType>]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V25::Services::ListPlannableUserInterestsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              # @return [::Google::Ads::GoogleAds::V25::Services::ListPlannableUserInterestsResponse]
              #
              # @raise [Google::Ads::GoogleAds::Error] if the RPC is aborted.
              #
              # @example Basic example
              ...
              #
              #   # Create a request. To set request fields, pass in keyword arguments.
              #   request = Google::Ads::GoogleAds::V25::Services::ListPlannableUserInterestsRequest.new
              #
              #   # Call the list_plannable_user_interests method.
              #   result = client.list_plannable_user_interests request
              #
              #   # The returned object is of type Google::Ads::GoogleAds::V25::Services::ListPlannableUserInterestsResponse.
              #   p result
              #
              def list_plannable_user_interests request, options = nil
                raise ::ArgumentError, "request must be provided" if request.nil?

                request = ::Gapic::Protobuf.coerce request, to: ::Google::Ads::GoogleAds::V25::Services::ListPlannableUserInterestsRequest
              ...
              # {::Google::Ads::GoogleAds::V25::Services::ReachPlanService::Client::Configuration::Rpcs}
