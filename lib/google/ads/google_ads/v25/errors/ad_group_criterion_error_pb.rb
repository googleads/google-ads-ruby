...
module Google
  module Ads
    module GoogleAds
      module V25
        module Errors
          AdGroupCriterionErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v25.errors.AdGroupCriterionErrorEnum").msgclass
          AdGroupCriterionErrorEnum::AdGroupCriterionError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v25.errors.AdGroupCriterionErrorEnum.AdGroupCriterionError").enummodule
        end
      end
    end
  end
