...
module Google
  module Ads
    module GoogleAds
      module V25
        module Errors
          AssetLinkErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v25.errors.AssetLinkErrorEnum").msgclass
          AssetLinkErrorEnum::AssetLinkError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v25.errors.AssetLinkErrorEnum.AssetLinkError").enummodule
        end
      end
    end
  end
