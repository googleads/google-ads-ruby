...
module Google
  module Ads
    module GoogleAds
      module V25
        module Errors
          FeedMappingErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v25.errors.FeedMappingErrorEnum").msgclass
          FeedMappingErrorEnum::FeedMappingError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v25.errors.FeedMappingErrorEnum.FeedMappingError").enummodule
        end
      end
    end
  end
