...
module Google
  module Ads
    module GoogleAds
      module V25
        module Enums
          BiddingStrategySystemStatusEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v25.enums.BiddingStrategySystemStatusEnum").msgclass
          BiddingStrategySystemStatusEnum::BiddingStrategySystemStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v25.enums.BiddingStrategySystemStatusEnum.BiddingStrategySystemStatus").enummodule
        end
      end
    end
  end
