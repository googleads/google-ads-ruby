...
module Google
  module Ads
    module GoogleAds
      module V25
        module Enums
          AdTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v25.enums.AdTypeEnum").msgclass
          AdTypeEnum::AdType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v25.enums.AdTypeEnum.AdType").enummodule
        end
      end
    end
  end
