...
module Google
  module Ads
    module GoogleAds
      module V25
        module Enums
          PromotionExtensionOccasionEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v25.enums.PromotionExtensionOccasionEnum").msgclass
          PromotionExtensionOccasionEnum::PromotionExtensionOccasion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v25.enums.PromotionExtensionOccasionEnum.PromotionExtensionOccasion").enummodule
        end
      end
    end
  end
