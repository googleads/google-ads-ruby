...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v8/common/offline_user_data.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v8.common.OfflineUserAddressInfo" do
    ...
    add_message "google.ads.googleads.v8.common.UserIdentifier" do
      ...
      oneof :identifier do
        ...
        optional :address_info, :message, 5, "google.ads.googleads.v8.common.OfflineUserAddressInfo"
      end
    end
    add_message "google.ads.googleads.v8.common.TransactionAttribute" do
    ...
    add_message "google.ads.googleads.v8.common.UserData" do
      ...
      optional :transaction_attribute, :message, 2, "google.ads.googleads.v8.common.TransactionAttribute"
      optional :user_attribute, :message, 3, "google.ads.googleads.v8.common.UserAttribute"
    end
    ...
    add_message "google.ads.googleads.v8.common.StoreSalesMetadata" do
      ...
      optional :third_party_metadata, :message, 3, "google.ads.googleads.v8.common.StoreSalesThirdPartyMetadata"
    end
    add_message "google.ads.googleads.v8.common.StoreSalesThirdPartyMetadata" do
...
module Google
  module Ads
    module GoogleAds
      module V8
        module Common
          OfflineUserAddressInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.common.OfflineUserAddressInfo").msgclass
          ...
          StoreSalesMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.common.StoreSalesMetadata").msgclass
          StoreSalesThirdPartyMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.common.StoreSalesThirdPartyMetadata").msgclass
        end
      end
    end
  end
