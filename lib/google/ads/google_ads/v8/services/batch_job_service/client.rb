        ...
        module Services
          module BatchJobService
            ...
            class Client
              ...
              #
              # See {::Google::Ads::GoogleAds::V8::Services::BatchJobService::Client::Configuration}
              ...
              # @yieldparam response [::Google::Ads::GoogleAds::V8::Services::MutateBatchJobResponse]
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V8::Resources::BatchJob]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Gapic::PagedEnumerable<::Google::Ads::GoogleAds::V8::Services::BatchJobResult>]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              #
              # @yield [response, operation] Access the result along with the RPC operation
              # @yieldparam response [::Google::Ads::GoogleAds::V8::Services::AddBatchJobOperationsResponse]
              # @yieldparam operation [::GRPC::ActiveCall::Operation]
              #
              ...
              # {::Google::Ads::GoogleAds::V8::Services::BatchJobService::Client::Configuration::Rpcs}
