...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v8/resources/ad_group_ad.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v8.resources.AdGroupAd" do
      optional :resource_name, :string, 1
      optional :status, :enum, 3, "google.ads.googleads.v8.enums.AdGroupAdStatusEnum.AdGroupAdStatus"
...
module Google
  module Ads
    module GoogleAds
      module V8
        module Resources
          AdGroupAd = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.resources.AdGroupAd").msgclass
          AdGroupAdPolicySummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.resources.AdGroupAdPolicySummary").msgclass
        end
      end
    end
  end
