...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v8/resources/call_view.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v8.resources.CallView" do
      ...
      optional :call_tracking_display_location, :enum, 7, "google.ads.googleads.v8.enums.CallTrackingDisplayLocationEnum.CallTrackingDisplayLocation"
      optional :type, :enum, 8, "google.ads.googleads.v8.enums.CallTypeEnum.CallType"
      optional :call_status, :enum, 9, "google.ads.googleads.v8.enums.GoogleVoiceCallStatusEnum.GoogleVoiceCallStatus"
    end
  end
end
...
module Google
  module Ads
    module GoogleAds
      module V8
        module Resources
          CallView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.resources.CallView").msgclass
        end
      end
    end
  end
