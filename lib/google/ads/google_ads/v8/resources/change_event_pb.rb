...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v8/resources/change_event.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v8.resources.ChangeEvent" do
      optional :resource_name, :string, 1
      optional :change_date_time, :string, 2
      optional :change_resource_type, :enum, 3, "google.ads.googleads.v8.enums.ChangeEventResourceTypeEnum.ChangeEventResourceType"
      optional :change_resource_name, :string, 4
      optional :client_type, :enum, 5, "google.ads.googleads.v8.enums.ChangeClientTypeEnum.ChangeClientType"
      optional :user_email, :string, 6
      optional :old_resource, :message, 7, "google.ads.googleads.v8.resources.ChangeEvent.ChangedResource"
      optional :new_resource, :message, 8, "google.ads.googleads.v8.resources.ChangeEvent.ChangedResource"
      optional :resource_change_operation, :enum, 9, "google.ads.googleads.v8.enums.ResourceChangeOperationEnum.ResourceChangeOperation"
    ...
    add_message "google.ads.googleads.v8.resources.ChangeEvent.ChangedResource" do
      ...
      optional :ad_group, :message, 2, "google.ads.googleads.v8.resources.AdGroup"
      optional :ad_group_criterion, :message, 3, "google.ads.googleads.v8.resources.AdGroupCriterion"
      optional :campaign, :message, 4, "google.ads.googleads.v8.resources.Campaign"
      optional :campaign_budget, :message, 5, "google.ads.googleads.v8.resources.CampaignBudget"
      optional :ad_group_bid_modifier, :message, 6, "google.ads.googleads.v8.resources.AdGroupBidModifier"
      optional :campaign_criterion, :message, 7, "google.ads.googleads.v8.resources.CampaignCriterion"
      optional :feed, :message, 8, "google.ads.googleads.v8.resources.Feed"
      optional :feed_item, :message, 9, "google.ads.googleads.v8.resources.FeedItem"
...
module Google
  module Ads
    module GoogleAds
      module V8
        module Resources
          ChangeEvent = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.resources.ChangeEvent").msgclass
          ChangeEvent::ChangedResource = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v8.resources.ChangeEvent.ChangedResource").msgclass
        end
      end
    end
  end
