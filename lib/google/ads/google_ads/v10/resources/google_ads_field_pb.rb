...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v10/resources/google_ads_field.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v10.resources.GoogleAdsField" do
      optional :resource_name, :string, 1
      proto3_optional :name, :string, 21
      optional :category, :enum, 3, "google.ads.googleads.v10.enums.GoogleAdsFieldCategoryEnum.GoogleAdsFieldCategory"
      ...
      optional :data_type, :enum, 12, "google.ads.googleads.v10.enums.GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType"
...
module Google
  module Ads
    module GoogleAds
      module V10
        module Resources
          GoogleAdsField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.resources.GoogleAdsField").msgclass
        end
      end
    end
  end
