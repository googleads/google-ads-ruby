...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v10/resources/bidding_data_exclusion.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v10.resources.BiddingDataExclusion" do
      ...
      repeated :advertising_channel_types, :enum, 11, "google.ads.googleads.v10.enums.AdvertisingChannelTypeEnum.AdvertisingChannelType"
    end
  end
end
...
module Google
  module Ads
    module GoogleAds
      module V10
        module Resources
          BiddingDataExclusion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.resources.BiddingDataExclusion").msgclass
        end
      end
    end
  end
