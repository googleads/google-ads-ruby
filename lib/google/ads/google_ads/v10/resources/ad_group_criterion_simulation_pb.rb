...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v10/resources/ad_group_criterion_simulation.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v10.resources.AdGroupCriterionSimulation" do
      ...
      oneof :point_list do
        ...
        optional :percent_cpc_bid_point_list, :message, 13, "google.ads.googleads.v10.common.PercentCpcBidSimulationPointList"
      end
    end
  end
end
...
module Google
  module Ads
    module GoogleAds
      module V10
        module Resources
          AdGroupCriterionSimulation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.resources.AdGroupCriterionSimulation").msgclass
        end
      end
    end
  end
