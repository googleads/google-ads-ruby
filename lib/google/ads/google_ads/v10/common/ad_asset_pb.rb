...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v10/common/ad_asset.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v10.common.AdTextAsset" do
      proto3_optional :text, :string, 4
      optional :pinned_field, :enum, 2, "google.ads.googleads.v10.enums.ServedAssetFieldTypeEnum.ServedAssetFieldType"
      optional :asset_performance_label, :enum, 5, "google.ads.googleads.v10.enums.AssetPerformanceLabelEnum.AssetPerformanceLabel"
      optional :policy_summary_info, :message, 6, "google.ads.googleads.v10.common.AdAssetPolicySummary"
    end
    add_message "google.ads.googleads.v10.common.AdImageAsset" do
      proto3_optional :asset, :string, 2
    end
    add_message "google.ads.googleads.v10.common.AdVideoAsset" do
      proto3_optional :asset, :string, 2
    end
...
module Google
  module Ads
    module GoogleAds
      module V10
        module Common
          AdTextAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.common.AdTextAsset").msgclass
