...
require 'google/ads/google_ads/v10/common/feed_common_pb'
require 'google/ads/google_ads/v10/enums/call_conversion_reporting_state_pb'
require 'google/ads/google_ads/v10/enums/call_to_action_type_pb'
require 'google/ads/google_ads/v10/enums/lead_form_call_to_action_type_pb'
require 'google/ads/google_ads/v10/enums/lead_form_desired_intent_pb'
require 'google/ads/google_ads/v10/enums/lead_form_field_user_input_type_pb'
require 'google/ads/google_ads/v10/enums/lead_form_post_submit_call_to_action_type_pb'
require 'google/ads/google_ads/v10/enums/mime_type_pb'
require 'google/ads/google_ads/v10/enums/mobile_app_vendor_pb'
require 'google/ads/google_ads/v10/enums/price_extension_price_qualifier_pb'
require 'google/ads/google_ads/v10/enums/price_extension_price_unit_pb'
...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v10/common/asset_types.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v10.common.YoutubeVideoAsset" do
      proto3_optional :youtube_video_id, :string, 2
      optional :youtube_video_title, :string, 3
    end
    add_message "google.ads.googleads.v10.common.MediaBundleAsset" do
      proto3_optional :data, :bytes, 2
    end
    add_message "google.ads.googleads.v10.common.ImageAsset" do
      proto3_optional :data, :bytes, 5
      proto3_optional :file_size, :int64, 6
      optional :mime_type, :enum, 3, "google.ads.googleads.v10.enums.MimeTypeEnum.MimeType"
      optional :full_size, :message, 4, "google.ads.googleads.v10.common.ImageDimension"
    end
    add_message "google.ads.googleads.v10.common.ImageDimension" do
      proto3_optional :height_pixels, :int64, 4
      proto3_optional :width_pixels, :int64, 5
      proto3_optional :url, :string, 6
    end
    add_message "google.ads.googleads.v10.common.TextAsset" do
      proto3_optional :text, :string, 2
    end
    add_message "google.ads.googleads.v10.common.LeadFormAsset" do
      optional :business_name, :string, 10
      optional :call_to_action_type, :enum, 17, "google.ads.googleads.v10.enums.LeadFormCallToActionTypeEnum.LeadFormCallToActionType"
      ...
      optional :desired_intent, :enum, 21, "google.ads.googleads.v10.enums.LeadFormDesiredIntentEnum.LeadFormDesiredIntent"
    ...
    add_message "google.ads.googleads.v10.common.LeadFormSingleChoiceAnswers" do
      repeated :answers, :string, 1
    end
    add_message "google.ads.googleads.v10.common.LeadFormDeliveryMethod" do
      oneof :delivery_details do
        optional :webhook, :message, 1, "google.ads.googleads.v10.common.WebhookDelivery"
      end
    end
    add_message "google.ads.googleads.v10.common.WebhookDelivery" do
    ...
    add_message "google.ads.googleads.v10.common.BookOnGoogleAsset" do
    end
    add_message "google.ads.googleads.v10.common.PromotionAsset" do
      optional :promotion_target, :string, 1
      optional :discount_modifier, :enum, 2, "google.ads.googleads.v10.enums.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifier"
      optional :redemption_start_date, :string, 7
      optional :redemption_end_date, :string, 8
      optional :occasion, :enum, 9, "google.ads.googleads.v10.enums.PromotionExtensionOccasionEnum.PromotionExtensionOccasion"
      optional :language_code, :string, 10
      optional :start_date, :string, 11
      optional :end_date, :string, 12
      repeated :ad_schedule_targets, :message, 13, "google.ads.googleads.v10.common.AdScheduleInfo"
      oneof :discount_type do
        optional :percent_off, :int64, 3
        optional :money_amount_off, :message, 4, "google.ads.googleads.v10.common.Money"
      end
      oneof :promotion_trigger do
        optional :promotion_code, :string, 5
        optional :orders_over_amount, :message, 6, "google.ads.googleads.v10.common.Money"
      end
    end
    add_message "google.ads.googleads.v10.common.CalloutAsset" do
      optional :callout_text, :string, 1
      optional :start_date, :string, 2
      optional :end_date, :string, 3
      repeated :ad_schedule_targets, :message, 4, "google.ads.googleads.v10.common.AdScheduleInfo"
    end
    add_message "google.ads.googleads.v10.common.StructuredSnippetAsset" do
      optional :header, :string, 1
      repeated :values, :string, 2
    end
    add_message "google.ads.googleads.v10.common.SitelinkAsset" do
      ...
      repeated :ad_schedule_targets, :message, 6, "google.ads.googleads.v10.common.AdScheduleInfo"
    end
    add_message "google.ads.googleads.v10.common.PageFeedAsset" do
      optional :page_url, :string, 1
      repeated :labels, :string, 2
    end
    add_message "google.ads.googleads.v10.common.DynamicEducationAsset" do
    ...
    add_message "google.ads.googleads.v10.common.MobileAppAsset" do
      optional :app_id, :string, 1
      optional :app_store, :enum, 2, "google.ads.googleads.v10.enums.MobileAppVendorEnum.MobileAppVendor"
      optional :link_text, :string, 3
      optional :start_date, :string, 4
      optional :end_date, :string, 5
    end
    add_message "google.ads.googleads.v10.common.HotelCalloutAsset" do
      optional :text, :string, 1
      optional :language_code, :string, 2
    end
    add_message "google.ads.googleads.v10.common.CallAsset" do
      optional :country_code, :string, 1
      optional :phone_number, :string, 2
      optional :call_conversion_reporting_state, :enum, 3, "google.ads.googleads.v10.enums.CallConversionReportingStateEnum.CallConversionReportingState"
      optional :call_conversion_action, :string, 4
      repeated :ad_schedule_targets, :message, 5, "google.ads.googleads.v10.common.AdScheduleInfo"
    end
    add_message "google.ads.googleads.v10.common.PriceAsset" do
      optional :type, :enum, 1, "google.ads.googleads.v10.enums.PriceExtensionTypeEnum.PriceExtensionType"
      optional :price_qualifier, :enum, 2, "google.ads.googleads.v10.enums.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifier"
      optional :language_code, :string, 3
      repeated :price_offerings, :message, 4, "google.ads.googleads.v10.common.PriceOffering"
    end
    add_message "google.ads.googleads.v10.common.PriceOffering" do
      optional :header, :string, 1
      optional :description, :string, 2
      optional :price, :message, 3, "google.ads.googleads.v10.common.Money"
      optional :unit, :enum, 4, "google.ads.googleads.v10.enums.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit"
...
module Google
  module Ads
    module GoogleAds
      module V10
        module Common
          YoutubeVideoAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.common.YoutubeVideoAsset").msgclass
          MediaBundleAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.common.MediaBundleAsset").msgclass
          ImageAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.common.ImageAsset").msgclass
          ImageDimension = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.common.ImageDimension").msgclass
          ...
          BookOnGoogleAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.common.BookOnGoogleAsset").msgclass
          PromotionAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.common.PromotionAsset").msgclass
          CalloutAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.common.CalloutAsset").msgclass
          StructuredSnippetAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.common.StructuredSnippetAsset").msgclass
          SitelinkAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.common.SitelinkAsset").msgclass
          PageFeedAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.common.PageFeedAsset").msgclass
          DynamicEducationAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.common.DynamicEducationAsset").msgclass
          MobileAppAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.common.MobileAppAsset").msgclass
          HotelCalloutAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.common.HotelCalloutAsset").msgclass
          CallAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.common.CallAsset").msgclass
