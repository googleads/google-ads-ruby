...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v10/errors/feed_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v10.errors.FeedErrorEnum" do
    end
    add_enum "google.ads.googleads.v10.errors.FeedErrorEnum.FeedError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
      ...
      value :LEGACY_EXTENSION_TYPE_READ_ONLY, 24
    end
  end
end
...
module Google
  module Ads
    module GoogleAds
      module V10
        module Errors
          FeedErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.errors.FeedErrorEnum").msgclass
          FeedErrorEnum::FeedError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.errors.FeedErrorEnum.FeedError").enummodule
        end
      end
    end
  end
