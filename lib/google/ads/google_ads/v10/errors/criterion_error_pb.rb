...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v10/errors/criterion_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v10.errors.CriterionErrorEnum" do
    end
    add_enum "google.ads.googleads.v10.errors.CriterionErrorEnum.CriterionError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V10
        module Errors
          CriterionErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.errors.CriterionErrorEnum").msgclass
          CriterionErrorEnum::CriterionError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.errors.CriterionErrorEnum.CriterionError").enummodule
        end
      end
    end
  end
