...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v10/errors/manager_link_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v10.errors.ManagerLinkErrorEnum" do
    end
    add_enum "google.ads.googleads.v10.errors.ManagerLinkErrorEnum.ManagerLinkError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V10
        module Errors
          ManagerLinkErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.errors.ManagerLinkErrorEnum").msgclass
          ManagerLinkErrorEnum::ManagerLinkError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.errors.ManagerLinkErrorEnum.ManagerLinkError").enummodule
        end
      end
    end
  end
