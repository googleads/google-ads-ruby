...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v10/errors/asset_link_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v10.errors.AssetLinkErrorEnum" do
    end
    add_enum "google.ads.googleads.v10.errors.AssetLinkErrorEnum.AssetLinkError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V10
        module Errors
          AssetLinkErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.errors.AssetLinkErrorEnum").msgclass
          AssetLinkErrorEnum::AssetLinkError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v10.errors.AssetLinkErrorEnum.AssetLinkError").enummodule
        end
      end
    end
  end
