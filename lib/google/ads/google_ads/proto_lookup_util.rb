    ...
    module GoogleAds
      class ProtoLookupUtil
        ...
        RESOURCES = {
          ...
          PendingAccountBudgetProposal: ['resources', 'account_budget_pb',
              'AccountBudget::PendingAccountBudgetProposal'],
          AccountBudgetProposal: ['resources', 'account_budget_proposal_pb',
              'AccountBudgetProposal'],
          AdGroupAd: ['resources', 'ad_group_ad_pb', 'AdGroupAd'],
          AdGroupAdPolicySummary: ['resources', 'ad_group_ad_pb',
          ...
          AdGroupAudienceView: ['resources', 'ad_group_audience_view_pb',
              'AdGroupAudienceView'],
          ...
          PaymentsAccountInfo: ['resources', 'billing_setup_pb',
          ...
          ConversionAction: ['resources', 'conversion_action_pb',
              'ConversionAction'],
          AttributionModelSettings: ['resources', 'conversion_action_pb',
              'ConversionAction::AttributionModelSettings'],
          ValueSettings: ['resources', 'conversion_action_pb',
              'ConversionAction::ValueSettings'],
          CustomerClientLink: ['resources', 'customer_client_link_pb',
              'CustomerClientLink'],
          CustomerManagerLink: ['resources', 'customer_manager_link_pb',
              'CustomerManagerLink'],
          Customer: ['resources', 'customer_pb', 'Customer'],
          CallReportingSetting: ['resources', 'customer_pb',
              'CallReportingSetting'],
          DisplayKeywordView: ['resources', 'display_keyword_view_pb',
              'DisplayKeywordView'],
          ...
          GoogleAdsField: ['resources', 'google_ads_field_pb',
              'GoogleAdsField'],
          HotelGroupView: ['resources', 'hotel_group_view_pb',
              'HotelGroupView'],
          KeywordView: ['resources', 'keyword_view_pb', 'KeywordView'],
          ManagedPlacementView: ['resources', 'managed_placement_view_pb',
          ...
          ParentalStatusView: ['resources', 'parental_status_view_pb',
              'ParentalStatusView'],
          ProductGroupView: ['resources', 'product_group_view_pb',
              'ProductGroupView'],
          ...
          ExpandedTextAdInfo: ['common', 'ad_type_infos_pb',
              'ExpandedTextAdInfo'],
          DynamicSearchAdInfo: ['common', 'ad_type_infos_pb',
              'DynamicSearchAdInfo'],
          ...
          ShoppingSmartAdInfo: ['common', 'ad_type_infos_pb',
              'ShoppingSmartAdInfo'],
          ShoppingProductAdInfo: ['common', 'ad_type_infos_pb',
          ...
          ProductChannelExclusivityInfo: ['common', 'criteria_pb',
          ...
          PolicyValidationParameter: ['common', 'policy_pb',
          ...
          LocationNames: ['services', 'geo_target_constant_service_pb',
              'SuggestGeoTargetConstantsRequest::LocationNames'],
          GeoTargets: ['services', 'geo_target_constant_service_pb',
              'SuggestGeoTargetConstantsRequest::GeoTargets']
        }.freeze

        ENUMS = {
          AccountBudgetProposalStatus: ['account_budget_proposal_status_pb',
              'AccountBudgetProposalStatus'],
          AccountBudgetProposalType: ['account_budget_proposal_type_pb',
              'AccountBudgetProposalType'],
          AccountBudgetStatus: ['account_budget_status_pb',
              'AccountBudgetStatus'],
          AdGroupAdRotationMode: ['ad_group_ad_rotation_mode_pb',
          ...
          CallConversionReportingState: ['call_conversion_reporting_state_pb',
          ...
          ChangeStatusOperation: ['change_status_operation_pb',
              'ChangeStatusOperation'],
          ChangeStatusResourceType: ['change_status_resource_type_pb',
              'ChangeStatusResourceType'],
          ConversionActionCategory: ['conversion_action_category_pb',
              'ConversionActionCategory'],
          ConversionActionCountingType: ['conversion_action_counting_type_pb',
              'ConversionActionCountingType'],
          ConversionActionStatus: ['conversion_action_status_pb',
              'ConversionActionStatus'],
          ConversionActionType: ['conversion_action_type_pb',
              'ConversionActionType'],
          DataDrivenModelStatus: ['data_driven_model_status_pb',
              'DataDrivenModelStatus'],
          DayOfWeek: ['day_of_week_pb', 'DayOfWeek'],
          Device: ['device_pb', 'Device'],
          DisplayAdFormatSetting: ['display_ad_format_setting_pb',
              'DisplayAdFormatSetting'],
          GenderType: ['gender_type_pb', 'GenderType'],
          GeoTargetConstantStatus: ['geo_target_constant_status_pb',
          ...
          PolicyApprovalStatus: ['policy_approval_status_pb',
              'PolicyApprovalStatus'],
          PolicyReviewStatus: ['policy_review_status_pb',
              'PolicyReviewStatus'],
          ...
          Slot: ['slot_pb', 'Slot'],
          SpendingLimitType: ['spending_limit_type_pb',
              'SpendingLimitType'],
        ...
        SERVICES = {
          AccountBudgetProposal: ['account_budget_proposal_service_client',
              'AccountBudgetProposalServiceClient'],
          AccountBudget: ['account_budget_service_client',
              'AccountBudgetServiceClient'],
          AdGroupAd: ['ad_group_ad_service_client', 'AdGroupAdServiceClient'],
          AdGroupAudienceView: ['ad_group_audience_view_service_client',
          ...
          ChangeStatus: ['change_status_service_client',
              'ChangeStatusServiceClient'],
          ConversionAction: ['conversion_action_service_client',
              'ConversionActionServiceClient'],
          CustomerClientLink: ['customer_client_link_service_client',
              'CustomerClientLinkServiceClient'],
          CustomerManagerLink: ['customer_manager_link_service_client',
              'CustomerManagerLinkServiceClient'],
          Customer: ['customer_service_client', 'CustomerServiceClient'],
          DisplayKeywordView: ['display_keyword_view_service_client',
          ...
          TopicConstant: ['topic_constant_service_client',
        ...
        OPERATIONS = {
          AccountBudgetProposal: ['account_budget_proposal_service_pb',
