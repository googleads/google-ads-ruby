    ...
    module GoogleAds
      class ProtoLookupUtil
        ...
        RESOURCES = {
          ...
          CampaignAudienceView: ['resources', 'campaign_audience_view_pb',
          ...
          CampaignSharedSet: ['resources', 'campaign_shared_set_pb',
              'CampaignSharedSet'],
          CarrierConstant: ['resources', 'carrier_constant_pb',
              'CarrierConstant'],
          ...
          FeedItemAttributeValue: ['resources', 'feed_item_pb',
              'FeedItemAttributeValue'],
          FeedMapping: ['resources', 'feed_mapping_pb', 'FeedMapping'],
          AttributeFieldMapping: ['resources', 'feed_mapping_pb',
              'AttributeFieldMapping'],
          Feed: ['resources', 'feed_pb', 'Feed'],
          PlacesLocationFeedData: ['resources', 'feed_pb',
              'Feed::PlacesLocationFeedData'],
          OAuthInfo: ['resources', 'feed_pb',
              'Feed::PlacesLocationFeedData::OAuthInfo'],
          AffiliateLocationFeedData: ['resources', 'feed_pb',
              'Feed::AffiliateLocationFeedData'],
          FeedAttribute: ['resources', 'feed_pb', 'FeedAttribute'],
          FeedAttributeOperation: ['resources', 'feed_pb',
              'FeedAttributeOperation'],
          Operator: ['resources', 'feed_pb',
          ...
          HotelGroupView: ['resources', 'hotel_group_view_pb',
              'HotelGroupView'],
          HotelPerformanceView: ['resources', 'hotel_performance_view_pb',
              'HotelPerformanceView'],
          KeywordPlanAdGroup: ['resources', 'keyword_plan_ad_group_pb',
              'KeywordPlanAdGroup'],
          KeywordPlanCampaign: ['resources', 'keyword_plan_campaign_pb',
              'KeywordPlanCampaign'],
          KeywordPlanGeoTarget: ['resources', 'keyword_plan_campaign_pb',
              'KeywordPlanGeoTarget'],
          KeywordPlanKeyword: ['resources', 'keyword_plan_keyword_pb',
              'KeywordPlanKeyword'],
          KeywordPlanNegativeKeyword: ['resources',
              'keyword_plan_negative_keyword_pb', 'KeywordPlanNegativeKeyword'],
          KeywordPlan: ['resources', 'keyword_plan_pb', 'KeywordPlan'],
          KeywordPlanForecastPeriod: ['resources', 'keyword_plan_pb',
              'KeywordPlanForecastPeriod'],
          KeywordView: ['resources', 'keyword_view_pb', 'KeywordView'],
          LanguageConstant: ['resources', 'language_constant_pb',
              'LanguageConstant'],
          ...
          ParentalStatusView: ['resources', 'parental_status_view_pb',
              'ParentalStatusView'],
          PaymentsAccount: ['resources', 'payments_account_pb',
              'PaymentsAccount'],
          ...
          SearchTermView: ['resources', 'search_term_view_pb',
              'SearchTermView'],
          ...
          DisplayCallToAction: ['common', 'ad_type_infos_pb',
              'DisplayCallToAction'],
          ...
          CriterionCategoryAvailability: ['common',
              'criterion_category_availability_pb',
              'CriterionCategoryAvailability'],
          CriterionCategoryChannelAvailability: ['common',
              'criterion_category_availability_pb',
              'CriterionCategoryChannelAvailability'],
          CriterionCategoryLocaleAvailability: ['common',
              'criterion_category_availability_pb',
              'CriterionCategoryLocaleAvailability'],
          CustomParameter: ['common', 'custom_parameter_pb', 'CustomParameter'],
          DateRange: ['common', 'dates_pb', 'DateRange'],
          ExplorerAutoOptimizerSetting: ['common',
              'explorer_auto_optimizer_setting_pb',
              'ExplorerAutoOptimizerSetting'],
          Price: ['common', 'feed_common_pb', 'Price'],
          FrequencyCapEntry: ['common', 'frequency_cap_pb',
              'FrequencyCapEntry'],
          FrequencyCapKey: ['common', 'frequency_cap_pb', 'FrequencyCapKey'],
          KeywordPlanHistoricalMetrics: ['common', 'keyword_plan_common_pb',
              'KeywordPlanHistoricalMetrics'],
          MatchingFunction: ['common', 'matching_function_pb',
              'MatchingFunction'],
          ...
          RealTimeBiddingSetting: ['common', 'real_time_bidding_setting_pb',
              'RealTimeBiddingSetting'],
          TagSnippet: ['common', 'tag_snippet_pb', 'TagSnippet'],
          SimilarUserListInfo: ['common', 'user_lists_pb',
              'SimilarUserListInfo'],
          CrmBasedUserListInfo: ['common', 'user_lists_pb',
        ...
        ENUMS = {
          ...
          AccountBudgetStatus: ['account_budget_status_pb',
              'AccountBudgetStatus'],
          AdCustomizerPlaceholderField: ['ad_customizer_placeholder_field_pb',
          ...
          AffiliateLocationFeedRelationshipType: [
              'affiliate_location_feed_relationship_type_pb',
              'AffiliateLocationFeedRelationshipType'],
          AgeRangeType: ['age_range_type_pb', 'AgeRangeType'],
          AppPlaceholderField: ['app_placeholder_field_pb',
              'AppPlaceholderField'],
          ...
          CallPlaceholderField: ['call_placeholder_field_pb',
              'CallPlaceholderField'],
          CalloutPlaceholderField: ['callout_placeholder_field_pb',
          ...
          CriterionCategoryLocaleAvailabilityMode: [
              'criterion_category_locale_availability_mode_pb',
              'CriterionCategoryLocaleAvailabilityMode'],
          CustomPlaceholderField: ['custom_placeholder_field_pb',
              'CustomPlaceholderField'],
          CustomerMatchUploadKeyType: ['customer_match_upload_key_type_pb',
          ...
          EducationPlaceholderField: ['education_placeholder_field_pb',
          ...
          FeedMappingCriterionType: ['feed_mapping_criterion_type_pb',
          ...
          FlightPlaceholderField: ['flight_placeholder_field_pb',
              'FlightPlaceholderField'],
          FrequencyCapEventType: ['frequency_cap_event_type_pb',
              'FrequencyCapEventType'],
          FrequencyCapLevel: ['frequency_cap_level_pb', 'FrequencyCapLevel'],
          FrequencyCapTimeUnit: ['frequency_cap_time_unit_pb',
              'FrequencyCapTimeUnit'],
          GenderType: ['gender_type_pb', 'GenderType'],
          GeoTargetingRestriction: ['geo_targeting_restriction_pb',
          ...
          HotelPlaceholderField: ['hotel_placeholder_field_pb',
          ...
          JobPlaceholderField: ['job_placeholder_field_pb',
              'JobPlaceholderField'],
          KeywordMatchType: ['keyword_match_type_pb', 'KeywordMatchType'],
          KeywordPlanCompetitionLevel: ['keyword_plan_competition_level_pb',
              'KeywordPlanCompetitionLevel'],
          KeywordPlanForecastInterval: ['keyword_plan_forecast_interval_pb',
          ...
          LocalPlaceholderField: ['local_placeholder_field_pb',
              'LocalPlaceholderField'],
          ManagerLinkStatus: ['manager_link_status_pb', 'ManagerLinkStatus'],
          MessagePlaceholderField: ['message_placeholder_field_pb',
          ...
          PolicyTopicEvidenceDestinationMismatchUrlType: [
              ...
              'PolicyTopicEvidenceDestinationMismatchUrlType'],
          PreferredContentType: ['preferred_content_type_pb',
              'PreferredContentType'],
          PricePlaceholderField: ['price_placeholder_field_pb',
          ...
          PromotionPlaceholderField: ['promotion_placeholder_field_pb',
          ...
          RealEstatePlaceholderField: ['real_estate_placeholder_field_pb',
              'RealEstatePlaceholderField'],
          SearchTermMatchType: ['search_term_match_type_pb',
              'SearchTermMatchType'],
          SearchTermTargetingStatus: ['search_term_targeting_status_pb',
              'SearchTermTargetingStatus'],
          SharedSetStatus: ['shared_set_status_pb', 'SharedSetStatus'],
          SharedSetType: ['shared_set_type_pb', 'SharedSetType'],
          SitelinkPlaceholderField: ['sitelink_placeholder_field_pb',
              'SitelinkPlaceholderField'],
          Slot: ['slot_pb', 'Slot'],
          SpendingLimitType: ['spending_limit_type_pb',
              'SpendingLimitType'],
          StructuredSnippetPlaceholderField: [
              'structured_snippet_placeholder_field_pb',
              'StructuredSnippetPlaceholderField'],
          ...
          TravelPlaceholderField: ['travel_placeholder_field_pb',
              'TravelPlaceholderField'],
          UserInterestTaxonomyType: ['user_interest_taxonomy_type_pb',
              'UserInterestTaxonomyType'],
          UserListAccessStatus: ['user_list_access_status_pb',
              'UserListAccessStatus'],
          UserListClosingReason: ['user_list_closing_reason_pb',
              'UserListClosingReason'],
          UserListCrmDataSourceType: ['user_list_crm_data_source_type_pb',
              'UserListCrmDataSourceType'],
          UserListMembershipStatus: ['user_list_membership_status_pb',
        ...
        SERVICES = {
          ...
          AdGroupFeed: ['ad_group_feed_service_client',
          ...
          CampaignAudienceView: ['campaign_audience_view_service_client',
          ...
          CampaignFeed: ['campaign_feed_service_client',
          ...
          CarrierConstant: ['carrier_constant_service_client',
          ...
          CustomerClient: ['customer_client_service_client',
              'CustomerClientServiceClient'],
          CustomerFeed: ['customer_feed_service_client',
          ...
          FeedMapping: ['feed_mapping_service_client',
          ...
          HotelPerformanceView: ['hotel_performance_view_service_client',
              'HotelPerformanceViewServiceClient'],
          KeywordPlanAdGroup: ['keyword_plan_ad_group_service_client',
              'KeywordPlanAdGroupServiceClient'],
          KeywordPlanCampaign: ['keyword_plan_campaign_service_client',
              'KeywordPlanCampaignServiceClient'],
          KeywordPlanIdea: ['keyword_plan_idea_service_client',
              'KeywordPlanIdeaServiceClient'],
          KeywordPlanKeyword: ['keyword_plan_keyword_service_client',
          ...
          KeywordPlan: ['keyword_plan_service_client',
              'KeywordPlanServiceClient'],
          KeywordView: ['keyword_view_service_client',
              'KeywordViewServiceClient'],
          LanguageConstant: ['language_constant_service_client',
          ...
          PaymentsAccount: ['payments_account_service_client',
          ...
          SearchTermView: ['search_term_view_service_client',
          ...
          UserInterest: ['user_interest_service_client',
        ...
        OPERATIONS = {
          ...
          KeywordPlanAdGroup: ['keyword_plan_ad_group_service_pb',
              'KeywordPlanAdGroupOperation'],
          KeywordPlanCampaign: ['keyword_plan_campaign_service_pb',
              'KeywordPlanCampaignOperation'],
          KeywordPlanKeyword: ['keyword_plan_keyword_service_pb',
              'KeywordPlanKeywordOperation'],
          KeywordPlanNegativeKeyword: [
              'keyword_plan_negative_keyword_service_pb',
