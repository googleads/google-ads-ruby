...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v11/resources/campaign_feed.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v11.resources.CampaignFeed" do
...
module Google
  module Ads
    module GoogleAds
      module V11
        module Resources
          CampaignFeed = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v11.resources.CampaignFeed").msgclass
        end
      end
    end
  end
