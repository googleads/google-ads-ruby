...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v11/resources/customer_user_access.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v11.resources.CustomerUserAccess" do
...
module Google
  module Ads
    module GoogleAds
      module V11
        module Resources
          CustomerUserAccess = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v11.resources.CustomerUserAccess").msgclass
        end
      end
    end
  end
