...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v11/common/policy_summary.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v11.common.PolicySummary" do
...
module Google
  module Ads
    module GoogleAds
      module V11
        module Common
          PolicySummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v11.common.PolicySummary").msgclass
        end
      end
    end
  end
