...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v11/enums/criterion_type.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v11.enums.CriterionTypeEnum" do
    end
    add_enum "google.ads.googleads.v11.enums.CriterionTypeEnum.CriterionType" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
      value :KEYWORD, 2
      value :PLACEMENT, 3
...
module Google
  module Ads
    module GoogleAds
      module V11
        module Enums
          CriterionTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v11.enums.CriterionTypeEnum").msgclass
          CriterionTypeEnum::CriterionType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v11.enums.CriterionTypeEnum.CriterionType").enummodule
        end
      end
    end
  end
