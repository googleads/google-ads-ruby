...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v11/enums/ad_group_type.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v11.enums.AdGroupTypeEnum" do
    end
    add_enum "google.ads.googleads.v11.enums.AdGroupTypeEnum.AdGroupType" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V11
        module Enums
          AdGroupTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v11.enums.AdGroupTypeEnum").msgclass
          AdGroupTypeEnum::AdGroupType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v11.enums.AdGroupTypeEnum.AdGroupType").enummodule
        end
      end
    end
  end
