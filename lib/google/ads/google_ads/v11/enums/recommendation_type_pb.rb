...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v11/enums/recommendation_type.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v11.enums.RecommendationTypeEnum" do
    end
    add_enum "google.ads.googleads.v11.enums.RecommendationTypeEnum.RecommendationType" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V11
        module Enums
          RecommendationTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v11.enums.RecommendationTypeEnum").msgclass
          RecommendationTypeEnum::RecommendationType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v11.enums.RecommendationTypeEnum.RecommendationType").enummodule
        end
      end
    end
  end
