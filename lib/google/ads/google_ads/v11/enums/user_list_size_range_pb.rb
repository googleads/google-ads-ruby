...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v11/enums/user_list_size_range.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v11.enums.UserListSizeRangeEnum" do
    end
    add_enum "google.ads.googleads.v11.enums.UserListSizeRangeEnum.UserListSizeRange" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V11
        module Enums
          UserListSizeRangeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v11.enums.UserListSizeRangeEnum").msgclass
          UserListSizeRangeEnum::UserListSizeRange = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v11.enums.UserListSizeRangeEnum.UserListSizeRange").enummodule
        end
      end
    end
  end
