...
module Google
  module Ads
    module GoogleAds
      module V17
        module Errors
          AccessInvitationErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.errors.AccessInvitationErrorEnum").msgclass
          AccessInvitationErrorEnum::AccessInvitationError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.errors.AccessInvitationErrorEnum.AccessInvitationError").enummodule
        end
      end
    end
  end
