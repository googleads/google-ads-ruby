...
module Google
  module Ads
    module GoogleAds
      module V17
        module Errors
          FunctionErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.errors.FunctionErrorEnum").msgclass
          FunctionErrorEnum::FunctionError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.errors.FunctionErrorEnum.FunctionError").enummodule
        end
      end
    end
  end
