...
module Google
  module Ads
    module GoogleAds
      module V17
        module Errors
          MediaFileErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.errors.MediaFileErrorEnum").msgclass
          MediaFileErrorEnum::MediaFileError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.errors.MediaFileErrorEnum.MediaFileError").enummodule
        end
      end
    end
  end
