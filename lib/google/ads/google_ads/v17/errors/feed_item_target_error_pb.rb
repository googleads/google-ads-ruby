...
module Google
  module Ads
    module GoogleAds
      module V17
        module Errors
          FeedItemTargetErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.errors.FeedItemTargetErrorEnum").msgclass
          FeedItemTargetErrorEnum::FeedItemTargetError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.errors.FeedItemTargetErrorEnum.FeedItemTargetError").enummodule
        end
      end
    end
  end
