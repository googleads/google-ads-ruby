...
module Google
  module Ads
    module GoogleAds
      module V17
        module Errors
          CampaignCriterionErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.errors.CampaignCriterionErrorEnum").msgclass
          CampaignCriterionErrorEnum::CampaignCriterionError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.errors.CampaignCriterionErrorEnum.CampaignCriterionError").enummodule
        end
      end
    end
  end
