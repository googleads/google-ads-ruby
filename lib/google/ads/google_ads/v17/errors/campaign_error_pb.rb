...
module Google
  module Ads
    module GoogleAds
      module V17
        module Errors
          CampaignErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.errors.CampaignErrorEnum").msgclass
          CampaignErrorEnum::CampaignError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.errors.CampaignErrorEnum.CampaignError").enummodule
        end
      end
    end
  end
