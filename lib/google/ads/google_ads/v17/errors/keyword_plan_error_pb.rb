...
module Google
  module Ads
    module GoogleAds
      module V17
        module Errors
          KeywordPlanErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.errors.KeywordPlanErrorEnum").msgclass
          KeywordPlanErrorEnum::KeywordPlanError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.errors.KeywordPlanErrorEnum.KeywordPlanError").enummodule
        end
      end
    end
  end
