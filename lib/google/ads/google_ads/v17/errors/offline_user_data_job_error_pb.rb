...
module Google
  module Ads
    module GoogleAds
      module V17
        module Errors
          OfflineUserDataJobErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.errors.OfflineUserDataJobErrorEnum").msgclass
          OfflineUserDataJobErrorEnum::OfflineUserDataJobError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.errors.OfflineUserDataJobErrorEnum.OfflineUserDataJobError").enummodule
        end
      end
    end
  end
