...
module Google
  module Ads
    module GoogleAds
      module V17
        module Errors
          MediaBundleErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.errors.MediaBundleErrorEnum").msgclass
          MediaBundleErrorEnum::MediaBundleError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.errors.MediaBundleErrorEnum.MediaBundleError").enummodule
        end
      end
    end
  end
