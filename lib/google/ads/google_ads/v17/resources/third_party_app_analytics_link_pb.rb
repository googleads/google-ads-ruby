...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          ThirdPartyAppAnalyticsLink = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.ThirdPartyAppAnalyticsLink").msgclass
        end
      end
    end
  end
