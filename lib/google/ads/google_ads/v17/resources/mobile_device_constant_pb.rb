...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          MobileDeviceConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.MobileDeviceConstant").msgclass
        end
      end
    end
  end
