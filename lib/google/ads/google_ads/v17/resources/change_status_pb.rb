...
require 'google/ads/google_ads/v17/enums/change_status_operation_pb'
require 'google/ads/google_ads/v17/enums/change_status_resource_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          ChangeStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.ChangeStatus").msgclass
        end
      end
    end
  end
