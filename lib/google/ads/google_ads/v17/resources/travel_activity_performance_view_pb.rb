...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          TravelActivityPerformanceView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.TravelActivityPerformanceView").msgclass
        end
      end
    end
  end
