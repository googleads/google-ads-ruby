...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          AdParameter = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.AdParameter").msgclass
        end
      end
    end
  end
