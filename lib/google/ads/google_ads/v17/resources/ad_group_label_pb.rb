...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          AdGroupLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.AdGroupLabel").msgclass
        end
      end
    end
  end
