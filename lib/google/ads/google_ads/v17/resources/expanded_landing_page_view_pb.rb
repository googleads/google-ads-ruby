...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          ExpandedLandingPageView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.ExpandedLandingPageView").msgclass
        end
      end
    end
  end
