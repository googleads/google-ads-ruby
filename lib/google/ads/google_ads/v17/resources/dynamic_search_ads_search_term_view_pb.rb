...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          DynamicSearchAdsSearchTermView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.DynamicSearchAdsSearchTermView").msgclass
        end
      end
    end
  end
