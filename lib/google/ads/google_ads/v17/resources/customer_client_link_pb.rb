...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          CustomerClientLink = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.CustomerClientLink").msgclass
        end
      end
    end
  end
