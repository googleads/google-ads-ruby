...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          LanguageConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.LanguageConstant").msgclass
        end
      end
    end
  end
