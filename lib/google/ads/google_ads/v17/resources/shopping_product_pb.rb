...
require 'google/ads/google_ads/v17/enums/product_availability_pb'
...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          ShoppingProduct = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.ShoppingProduct").msgclass
          ShoppingProduct::ProductIssue = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.ShoppingProduct.ProductIssue").msgclass
        end
      end
    end
  end
