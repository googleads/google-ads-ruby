...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          DetailPlacementView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.DetailPlacementView").msgclass
        end
      end
    end
  end
