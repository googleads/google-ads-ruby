...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          GroupPlacementView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.GroupPlacementView").msgclass
        end
      end
    end
  end
