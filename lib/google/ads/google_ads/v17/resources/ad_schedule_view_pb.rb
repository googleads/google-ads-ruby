...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          AdScheduleView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.AdScheduleView").msgclass
        end
      end
    end
  end
