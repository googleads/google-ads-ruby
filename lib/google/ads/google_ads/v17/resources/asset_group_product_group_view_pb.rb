...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          AssetGroupProductGroupView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.AssetGroupProductGroupView").msgclass
        end
      end
    end
  end
