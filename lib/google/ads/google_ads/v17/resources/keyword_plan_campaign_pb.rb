...
require 'google/ads/google_ads/v17/enums/keyword_plan_network_pb'
...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          KeywordPlanCampaign = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.KeywordPlanCampaign").msgclass
          KeywordPlanGeoTarget = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.KeywordPlanGeoTarget").msgclass
        end
      end
    end
  end
