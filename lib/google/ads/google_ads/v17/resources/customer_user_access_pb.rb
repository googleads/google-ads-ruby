...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          CustomerUserAccess = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.CustomerUserAccess").msgclass
        end
      end
    end
  end
