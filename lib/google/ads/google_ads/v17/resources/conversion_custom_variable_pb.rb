...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          ConversionCustomVariable = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.ConversionCustomVariable").msgclass
        end
      end
    end
  end
