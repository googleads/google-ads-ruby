...
require 'google/ads/google_ads/v17/enums/local_services_employee_status_pb'
require 'google/ads/google_ads/v17/enums/local_services_employee_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          LocalServicesEmployee = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.LocalServicesEmployee").msgclass
          UniversityDegree = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.UniversityDegree").msgclass
          Residency = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.Residency").msgclass
          Fellowship = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.Fellowship").msgclass
        end
      end
    end
  end
