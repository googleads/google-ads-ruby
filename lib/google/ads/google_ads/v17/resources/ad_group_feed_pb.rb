...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          AdGroupFeed = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.AdGroupFeed").msgclass
        end
      end
    end
  end
