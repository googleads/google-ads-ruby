...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          AdGroupCriterionCustomizer = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.AdGroupCriterionCustomizer").msgclass
        end
      end
    end
  end
