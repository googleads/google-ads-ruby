...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          KeywordThemeConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.KeywordThemeConstant").msgclass
        end
      end
    end
  end
