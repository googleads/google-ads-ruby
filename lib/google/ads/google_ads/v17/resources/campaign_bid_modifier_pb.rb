...
begin
  ...
  imports = [
    ["google.ads.googleads.v17.common.InteractionTypeInfo", "google/ads/googleads/v17/common/criteria.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          CampaignBidModifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.CampaignBidModifier").msgclass
        end
      end
    end
  end
