...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          CustomerSearchTermInsight = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.CustomerSearchTermInsight").msgclass
        end
      end
    end
  end
