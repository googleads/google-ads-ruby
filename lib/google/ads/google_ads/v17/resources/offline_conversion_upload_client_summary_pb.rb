...
require 'google/ads/google_ads/v17/errors/collection_size_error_pb'
require 'google/ads/google_ads/v17/errors/conversion_adjustment_upload_error_pb'
require 'google/ads/google_ads/v17/errors/conversion_upload_error_pb'
require 'google/ads/google_ads/v17/errors/date_error_pb'
require 'google/ads/google_ads/v17/errors/distinct_error_pb'
require 'google/ads/google_ads/v17/errors/field_error_pb'
require 'google/ads/google_ads/v17/errors/mutate_error_pb'
require 'google/ads/google_ads/v17/errors/not_allowlisted_error_pb'
require 'google/ads/google_ads/v17/errors/string_format_error_pb'
require 'google/ads/google_ads/v17/errors/string_length_error_pb'
...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          OfflineConversionUploadClientSummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.OfflineConversionUploadClientSummary").msgclass
          OfflineConversionSummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.OfflineConversionSummary").msgclass
          OfflineConversionAlert = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.OfflineConversionAlert").msgclass
          OfflineConversionError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.OfflineConversionError").msgclass
        end
      end
    end
  end
