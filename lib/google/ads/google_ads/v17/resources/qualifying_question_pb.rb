...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          QualifyingQuestion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.QualifyingQuestion").msgclass
        end
      end
    end
  end
