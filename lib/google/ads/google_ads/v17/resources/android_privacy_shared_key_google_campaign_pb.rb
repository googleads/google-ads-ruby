...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          AndroidPrivacySharedKeyGoogleCampaign = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.AndroidPrivacySharedKeyGoogleCampaign").msgclass
        end
      end
    end
  end
