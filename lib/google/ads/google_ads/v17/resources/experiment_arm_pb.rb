...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          ExperimentArm = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.ExperimentArm").msgclass
        end
      end
    end
  end
