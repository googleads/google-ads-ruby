...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          CustomerManagerLink = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.CustomerManagerLink").msgclass
        end
      end
    end
  end
