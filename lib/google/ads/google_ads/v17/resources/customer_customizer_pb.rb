...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          CustomerCustomizer = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.CustomerCustomizer").msgclass
        end
      end
    end
  end
