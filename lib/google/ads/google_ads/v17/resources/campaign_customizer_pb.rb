...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          CampaignCustomizer = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.CampaignCustomizer").msgclass
        end
      end
    end
  end
