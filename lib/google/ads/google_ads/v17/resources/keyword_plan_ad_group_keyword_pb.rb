...
module Google
  module Ads
    module GoogleAds
      module V17
        module Resources
          KeywordPlanAdGroupKeyword = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.resources.KeywordPlanAdGroupKeyword").msgclass
        end
      end
    end
  end
