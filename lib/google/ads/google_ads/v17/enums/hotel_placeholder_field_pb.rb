...
module Google
  module Ads
    module GoogleAds
      module V17
        module Enums
          HotelPlaceholderFieldEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.enums.HotelPlaceholderFieldEnum").msgclass
          HotelPlaceholderFieldEnum::HotelPlaceholderField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.enums.HotelPlaceholderFieldEnum.HotelPlaceholderField").enummodule
        end
      end
    end
  end
