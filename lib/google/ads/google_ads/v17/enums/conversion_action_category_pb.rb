...
module Google
  module Ads
    module GoogleAds
      module V17
        module Enums
          ConversionActionCategoryEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.enums.ConversionActionCategoryEnum").msgclass
          ConversionActionCategoryEnum::ConversionActionCategory = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.enums.ConversionActionCategoryEnum.ConversionActionCategory").enummodule
        end
      end
    end
  end
