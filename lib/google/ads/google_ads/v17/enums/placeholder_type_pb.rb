...
module Google
  module Ads
    module GoogleAds
      module V17
        module Enums
          PlaceholderTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.enums.PlaceholderTypeEnum").msgclass
          PlaceholderTypeEnum::PlaceholderType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.enums.PlaceholderTypeEnum.PlaceholderType").enummodule
        end
      end
    end
  end
