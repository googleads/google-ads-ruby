...
module Google
  module Ads
    module GoogleAds
      module V17
        module Enums
          BiddingStrategyTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.enums.BiddingStrategyTypeEnum").msgclass
          BiddingStrategyTypeEnum::BiddingStrategyType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.enums.BiddingStrategyTypeEnum.BiddingStrategyType").enummodule
        end
      end
    end
  end
