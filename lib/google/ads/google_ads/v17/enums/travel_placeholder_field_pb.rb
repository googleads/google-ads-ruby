...
module Google
  module Ads
    module GoogleAds
      module V17
        module Enums
          TravelPlaceholderFieldEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.enums.TravelPlaceholderFieldEnum").msgclass
          TravelPlaceholderFieldEnum::TravelPlaceholderField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.enums.TravelPlaceholderFieldEnum.TravelPlaceholderField").enummodule
        end
      end
    end
  end
