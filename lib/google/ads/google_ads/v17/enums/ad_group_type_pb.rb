...
module Google
  module Ads
    module GoogleAds
      module V17
        module Enums
          AdGroupTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.enums.AdGroupTypeEnum").msgclass
          AdGroupTypeEnum::AdGroupType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.enums.AdGroupTypeEnum.AdGroupType").enummodule
        end
      end
    end
  end
