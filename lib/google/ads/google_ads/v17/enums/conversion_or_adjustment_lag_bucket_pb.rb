...
module Google
  module Ads
    module GoogleAds
      module V17
        module Enums
          ConversionOrAdjustmentLagBucketEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.enums.ConversionOrAdjustmentLagBucketEnum").msgclass
          ConversionOrAdjustmentLagBucketEnum::ConversionOrAdjustmentLagBucket = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.enums.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucket").enummodule
        end
      end
    end
  end
