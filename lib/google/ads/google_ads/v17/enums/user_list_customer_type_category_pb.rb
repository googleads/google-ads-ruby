...
module Google
  module Ads
    module GoogleAds
      module V17
        module Enums
          UserListCustomerTypeCategoryEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.enums.UserListCustomerTypeCategoryEnum").msgclass
          UserListCustomerTypeCategoryEnum::UserListCustomerTypeCategory = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.enums.UserListCustomerTypeCategoryEnum.UserListCustomerTypeCategory").enummodule
        end
      end
    end
  end
