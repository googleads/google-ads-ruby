...
module Google
  module Ads
    module GoogleAds
      module V17
        module Enums
          FeedItemQualityDisapprovalReasonEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.enums.FeedItemQualityDisapprovalReasonEnum").msgclass
          FeedItemQualityDisapprovalReasonEnum::FeedItemQualityDisapprovalReason = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v17.enums.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason").enummodule
        end
      end
    end
  end
