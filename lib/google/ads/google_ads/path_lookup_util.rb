    ...
    module GoogleAds
      class PathLookupUtil
        ...
        def carrier_constant(criterion_id)
          @proto_lookup_util.service(:CarrierConstant).carrier_constant_path(
              criterion_id.to_s)
        end
        ...
        def conversion_action(customer_id, conversion_action_id)
          @proto_lookup_util.service(:ConversionAction).conversion_action_path(
        ...
        def keyword_plan_ad_group(customer_id, kp_ad_group_id)
          @proto_lookup_util.service(:KeywordPlanAdGroup).
              keyword_plan_ad_group_path(customer_id.to_s, kp_ad_group_id.to_s)
        end

        def keyword_plan_campaign(customer_id, kp_campaign_id)
          @proto_lookup_util.service(:KeywordPlanCampaign).
              keyword_plan_campaign_path(customer_id.to_s, kp_campaign_id.to_s)
        end
        ...
        def keyword_plan_negative_keyword(customer_id, kp_negative_keyword_id)
