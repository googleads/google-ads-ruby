...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v7/resources/campaign.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v7.resources.Campaign" do
      optional :resource_name, :string, 1
      proto3_optional :id, :int64, 59
      proto3_optional :name, :string, 58
      optional :status, :enum, 5, "google.ads.googleads.v7.enums.CampaignStatusEnum.CampaignStatus"
      optional :serving_status, :enum, 21, "google.ads.googleads.v7.enums.CampaignServingStatusEnum.CampaignServingStatus"
      optional :ad_serving_optimization_status, :enum, 8, "google.ads.googleads.v7.enums.AdServingOptimizationStatusEnum.AdServingOptimizationStatus"
      optional :advertising_channel_type, :enum, 9, "google.ads.googleads.v7.enums.AdvertisingChannelTypeEnum.AdvertisingChannelType"
      optional :advertising_channel_sub_type, :enum, 10, "google.ads.googleads.v7.enums.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType"
      proto3_optional :tracking_url_template, :string, 60
      repeated :url_custom_parameters, :message, 12, "google.ads.googleads.v7.common.CustomParameter"
      optional :real_time_bidding_setting, :message, 39, "google.ads.googleads.v7.common.RealTimeBiddingSetting"
      optional :network_settings, :message, 14, "google.ads.googleads.v7.resources.Campaign.NetworkSettings"
      optional :hotel_setting, :message, 32, "google.ads.googleads.v7.resources.Campaign.HotelSettingInfo"
      optional :dynamic_search_ads_setting, :message, 33, "google.ads.googleads.v7.resources.Campaign.DynamicSearchAdsSetting"
      optional :shopping_setting, :message, 36, "google.ads.googleads.v7.resources.Campaign.ShoppingSetting"
      optional :targeting_setting, :message, 43, "google.ads.googleads.v7.common.TargetingSetting"
      optional :geo_target_type_setting, :message, 47, "google.ads.googleads.v7.resources.Campaign.GeoTargetTypeSetting"
      optional :local_campaign_setting, :message, 50, "google.ads.googleads.v7.resources.Campaign.LocalCampaignSetting"
      optional :app_campaign_setting, :message, 51, "google.ads.googleads.v7.resources.Campaign.AppCampaignSetting"
      repeated :labels, :string, 61
      optional :experiment_type, :enum, 17, "google.ads.googleads.v7.enums.CampaignExperimentTypeEnum.CampaignExperimentType"
      proto3_optional :base_campaign, :string, 56
      proto3_optional :campaign_budget, :string, 62
      optional :bidding_strategy_type, :enum, 22, "google.ads.googleads.v7.enums.BiddingStrategyTypeEnum.BiddingStrategyType"
      proto3_optional :start_date, :string, 63
      proto3_optional :end_date, :string, 64
      proto3_optional :final_url_suffix, :string, 65
      repeated :frequency_caps, :message, 40, "google.ads.googleads.v7.common.FrequencyCapEntry"
      optional :video_brand_safety_suitability, :enum, 42, "google.ads.googleads.v7.enums.BrandSafetySuitabilityEnum.BrandSafetySuitability"
      optional :vanity_pharma, :message, 44, "google.ads.googleads.v7.resources.Campaign.VanityPharma"
      optional :selective_optimization, :message, 45, "google.ads.googleads.v7.resources.Campaign.SelectiveOptimization"
      optional :optimization_goal_setting, :message, 54, "google.ads.googleads.v7.resources.Campaign.OptimizationGoalSetting"
      optional :tracking_setting, :message, 46, "google.ads.googleads.v7.resources.Campaign.TrackingSetting"
      optional :payment_mode, :enum, 52, "google.ads.googleads.v7.enums.PaymentModeEnum.PaymentMode"
      proto3_optional :optimization_score, :double, 66
      repeated :excluded_parent_asset_field_types, :enum, 69, "google.ads.googleads.v7.enums.AssetFieldTypeEnum.AssetFieldType"
      oneof :campaign_bidding_strategy do
        optional :bidding_strategy, :string, 67
        optional :commission, :message, 49, "google.ads.googleads.v7.common.Commission"
        optional :manual_cpc, :message, 24, "google.ads.googleads.v7.common.ManualCpc"
        optional :manual_cpm, :message, 25, "google.ads.googleads.v7.common.ManualCpm"
        optional :manual_cpv, :message, 37, "google.ads.googleads.v7.common.ManualCpv"
        optional :maximize_conversions, :message, 30, "google.ads.googleads.v7.common.MaximizeConversions"
        optional :maximize_conversion_value, :message, 31, "google.ads.googleads.v7.common.MaximizeConversionValue"
        optional :target_cpa, :message, 26, "google.ads.googleads.v7.common.TargetCpa"
        optional :target_impression_share, :message, 48, "google.ads.googleads.v7.common.TargetImpressionShare"
        optional :target_roas, :message, 29, "google.ads.googleads.v7.common.TargetRoas"
        optional :target_spend, :message, 27, "google.ads.googleads.v7.common.TargetSpend"
        optional :percent_cpc, :message, 34, "google.ads.googleads.v7.common.PercentCpc"
        optional :target_cpm, :message, 41, "google.ads.googleads.v7.common.TargetCpm"
      end
    end
    add_message "google.ads.googleads.v7.resources.Campaign.NetworkSettings" do
    ...
    add_message "google.ads.googleads.v7.resources.Campaign.HotelSettingInfo" do
    ...
    add_message "google.ads.googleads.v7.resources.Campaign.DynamicSearchAdsSetting" do
    ...
    add_message "google.ads.googleads.v7.resources.Campaign.VanityPharma" do
    ...
    add_message "google.ads.googleads.v7.resources.Campaign.GeoTargetTypeSetting" do
...
module Google
  module Ads
    module GoogleAds
      module V7
        module Resources
          Campaign = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v7.resources.Campaign").msgclass
          Campaign::NetworkSettings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v7.resources.Campaign.NetworkSettings").msgclass
