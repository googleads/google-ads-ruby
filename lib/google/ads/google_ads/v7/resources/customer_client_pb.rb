...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v7/resources/customer_client.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v7.resources.CustomerClient" do
...
module Google
  module Ads
    module GoogleAds
      module V7
        module Resources
          CustomerClient = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v7.resources.CustomerClient").msgclass
        end
      end
    end
  end
