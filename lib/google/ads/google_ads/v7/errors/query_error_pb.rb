...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("google/ads/googleads/v7/errors/query_error.proto", :syntax => :proto3) do
    add_message "google.ads.googleads.v7.errors.QueryErrorEnum" do
    end
    add_enum "google.ads.googleads.v7.errors.QueryErrorEnum.QueryError" do
      value :UNSPECIFIED, 0
      value :UNKNOWN, 1
...
module Google
  module Ads
    module GoogleAds
      module V7
        module Errors
          QueryErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v7.errors.QueryErrorEnum").msgclass
          QueryErrorEnum::QueryError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v7.errors.QueryErrorEnum.QueryError").enummodule
        end
      end
    end
  end
