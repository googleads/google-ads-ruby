...
require 'google/ads/google_ads/v15/resources/campaign_label_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.resources.CampaignLabel", "google/ads/googleads/v15/resources/campaign_label.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateCampaignLabelsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCampaignLabelsRequest").msgclass
          CampaignLabelOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.CampaignLabelOperation").msgclass
          ...
          MutateCampaignLabelResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCampaignLabelResult").msgclass
        end
      end
    end
  end
