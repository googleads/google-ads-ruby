...
require 'google/ads/google_ads/v15/resources/campaign_lifecycle_goal_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.resources.CampaignLifecycleGoal", "google/ads/googleads/v15/resources/campaign_lifecycle_goal.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          ConfigureCampaignLifecycleGoalsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.ConfigureCampaignLifecycleGoalsRequest").msgclass
          CampaignLifecycleGoalOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.CampaignLifecycleGoalOperation").msgclass
          ConfigureCampaignLifecycleGoalsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.ConfigureCampaignLifecycleGoalsResponse").msgclass
          ConfigureCampaignLifecycleGoalsResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.ConfigureCampaignLifecycleGoalsResult").msgclass
        end
      end
    end
  end
