...
require 'google/ads/google_ads/v15/resources/keyword_plan_ad_group_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.resources.KeywordPlanAdGroup", "google/ads/googleads/v15/resources/keyword_plan_ad_group.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateKeywordPlanAdGroupsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateKeywordPlanAdGroupsRequest").msgclass
          KeywordPlanAdGroupOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.KeywordPlanAdGroupOperation").msgclass
          MutateKeywordPlanAdGroupsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateKeywordPlanAdGroupsResponse").msgclass
          MutateKeywordPlanAdGroupResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateKeywordPlanAdGroupResult").msgclass
        end
      end
    end
  end
