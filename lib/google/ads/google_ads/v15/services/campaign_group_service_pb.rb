...
require 'google/ads/google_ads/v15/resources/campaign_group_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.resources.CampaignGroup", "google/ads/googleads/v15/resources/campaign_group.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateCampaignGroupsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCampaignGroupsRequest").msgclass
          CampaignGroupOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.CampaignGroupOperation").msgclass
          MutateCampaignGroupsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCampaignGroupsResponse").msgclass
          MutateCampaignGroupResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCampaignGroupResult").msgclass
        end
      end
    end
  end
