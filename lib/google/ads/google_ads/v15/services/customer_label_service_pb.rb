...
require 'google/ads/google_ads/v15/resources/customer_label_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.resources.CustomerLabel", "google/ads/googleads/v15/resources/customer_label.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateCustomerLabelsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCustomerLabelsRequest").msgclass
          CustomerLabelOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.CustomerLabelOperation").msgclass
          MutateCustomerLabelsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCustomerLabelsResponse").msgclass
          MutateCustomerLabelResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCustomerLabelResult").msgclass
        end
      end
    end
  end
