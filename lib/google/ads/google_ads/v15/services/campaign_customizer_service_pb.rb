...
require 'google/ads/google_ads/v15/resources/campaign_customizer_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.resources.CampaignCustomizer", "google/ads/googleads/v15/resources/campaign_customizer.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateCampaignCustomizersRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCampaignCustomizersRequest").msgclass
          CampaignCustomizerOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.CampaignCustomizerOperation").msgclass
          MutateCampaignCustomizersResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCampaignCustomizersResponse").msgclass
          MutateCampaignCustomizerResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCampaignCustomizerResult").msgclass
        end
      end
    end
  end
