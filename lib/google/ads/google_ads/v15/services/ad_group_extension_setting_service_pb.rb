...
require 'google/ads/google_ads/v15/resources/ad_group_extension_setting_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.resources.AdGroupExtensionSetting", "google/ads/googleads/v15/resources/ad_group_extension_setting.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateAdGroupExtensionSettingsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateAdGroupExtensionSettingsRequest").msgclass
          AdGroupExtensionSettingOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.AdGroupExtensionSettingOperation").msgclass
          MutateAdGroupExtensionSettingsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateAdGroupExtensionSettingsResponse").msgclass
          MutateAdGroupExtensionSettingResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateAdGroupExtensionSettingResult").msgclass
        end
      end
    end
  end
