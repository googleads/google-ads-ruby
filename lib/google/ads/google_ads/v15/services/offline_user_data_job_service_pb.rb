...
require 'google/ads/google_ads/v15/resources/offline_user_data_job_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.resources.OfflineUserDataJob", "google/ads/googleads/v15/resources/offline_user_data_job.proto"],
    ["google.ads.googleads.v15.common.UserData", "google/ads/googleads/v15/common/offline_user_data.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          CreateOfflineUserDataJobRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.CreateOfflineUserDataJobRequest").msgclass
          CreateOfflineUserDataJobResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.CreateOfflineUserDataJobResponse").msgclass
          RunOfflineUserDataJobRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.RunOfflineUserDataJobRequest").msgclass
          AddOfflineUserDataJobOperationsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.AddOfflineUserDataJobOperationsRequest").msgclass
          OfflineUserDataJobOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.OfflineUserDataJobOperation").msgclass
          AddOfflineUserDataJobOperationsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.AddOfflineUserDataJobOperationsResponse").msgclass
        end
      end
    end
  end
