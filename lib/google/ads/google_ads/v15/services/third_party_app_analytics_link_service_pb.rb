...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          RegenerateShareableLinkIdRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.RegenerateShareableLinkIdRequest").msgclass
          RegenerateShareableLinkIdResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.RegenerateShareableLinkIdResponse").msgclass
        end
      end
    end
  end
