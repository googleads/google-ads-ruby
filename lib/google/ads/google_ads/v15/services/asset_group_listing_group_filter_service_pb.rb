...
require 'google/ads/google_ads/v15/resources/asset_group_listing_group_filter_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.resources.AssetGroupListingGroupFilter", "google/ads/googleads/v15/resources/asset_group_listing_group_filter.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateAssetGroupListingGroupFiltersRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateAssetGroupListingGroupFiltersRequest").msgclass
          AssetGroupListingGroupFilterOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.AssetGroupListingGroupFilterOperation").msgclass
          MutateAssetGroupListingGroupFiltersResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateAssetGroupListingGroupFiltersResponse").msgclass
          MutateAssetGroupListingGroupFilterResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateAssetGroupListingGroupFilterResult").msgclass
        end
      end
    end
  end
