...
require 'google/ads/google_ads/v15/resources/keyword_plan_campaign_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.resources.KeywordPlanCampaign", "google/ads/googleads/v15/resources/keyword_plan_campaign.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateKeywordPlanCampaignsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateKeywordPlanCampaignsRequest").msgclass
          KeywordPlanCampaignOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.KeywordPlanCampaignOperation").msgclass
          MutateKeywordPlanCampaignsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateKeywordPlanCampaignsResponse").msgclass
          MutateKeywordPlanCampaignResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateKeywordPlanCampaignResult").msgclass
        end
      end
    end
  end
