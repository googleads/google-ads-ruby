...
require 'google/ads/google_ads/v15/enums/smart_campaign_not_eligible_reason_pb'
require 'google/ads/google_ads/v15/enums/smart_campaign_status_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.resources.SmartCampaignSetting", "google/ads/googleads/v15/resources/smart_campaign_setting.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          GetSmartCampaignStatusRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.GetSmartCampaignStatusRequest").msgclass
          SmartCampaignNotEligibleDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.SmartCampaignNotEligibleDetails").msgclass
          SmartCampaignEligibleDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.SmartCampaignEligibleDetails").msgclass
          SmartCampaignPausedDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.SmartCampaignPausedDetails").msgclass
          SmartCampaignRemovedDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.SmartCampaignRemovedDetails").msgclass
          SmartCampaignEndedDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.SmartCampaignEndedDetails").msgclass
          GetSmartCampaignStatusResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.GetSmartCampaignStatusResponse").msgclass
          MutateSmartCampaignSettingsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateSmartCampaignSettingsRequest").msgclass
          SmartCampaignSettingOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.SmartCampaignSettingOperation").msgclass
          MutateSmartCampaignSettingsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateSmartCampaignSettingsResponse").msgclass
          MutateSmartCampaignSettingResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateSmartCampaignSettingResult").msgclass
        end
      end
    end
  end
