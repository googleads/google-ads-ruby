...
require 'google/ads/google_ads/v15/resources/customer_asset_set_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.resources.CustomerAssetSet", "google/ads/googleads/v15/resources/customer_asset_set.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateCustomerAssetSetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCustomerAssetSetsRequest").msgclass
          CustomerAssetSetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.CustomerAssetSetOperation").msgclass
          MutateCustomerAssetSetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCustomerAssetSetsResponse").msgclass
          MutateCustomerAssetSetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCustomerAssetSetResult").msgclass
        end
      end
    end
  end
