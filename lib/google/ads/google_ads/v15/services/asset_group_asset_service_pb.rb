...
require 'google/ads/google_ads/v15/resources/asset_group_asset_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.resources.AssetGroupAsset", "google/ads/googleads/v15/resources/asset_group_asset.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateAssetGroupAssetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateAssetGroupAssetsRequest").msgclass
          AssetGroupAssetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.AssetGroupAssetOperation").msgclass
          MutateAssetGroupAssetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateAssetGroupAssetsResponse").msgclass
          MutateAssetGroupAssetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateAssetGroupAssetResult").msgclass
        end
      end
    end
  end
