...
require 'google/ads/google_ads/v15/resources/custom_audience_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.resources.CustomAudience", "google/ads/googleads/v15/resources/custom_audience.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateCustomAudiencesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCustomAudiencesRequest").msgclass
          CustomAudienceOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.CustomAudienceOperation").msgclass
          MutateCustomAudiencesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCustomAudiencesResponse").msgclass
          MutateCustomAudienceResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCustomAudienceResult").msgclass
        end
      end
    end
  end
