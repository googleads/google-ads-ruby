...
require 'google/ads/google_ads/v15/resources/ad_group_label_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.resources.AdGroupLabel", "google/ads/googleads/v15/resources/ad_group_label.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateAdGroupLabelsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateAdGroupLabelsRequest").msgclass
          AdGroupLabelOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.AdGroupLabelOperation").msgclass
          MutateAdGroupLabelsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateAdGroupLabelsResponse").msgclass
          MutateAdGroupLabelResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateAdGroupLabelResult").msgclass
        end
      end
    end
  end
