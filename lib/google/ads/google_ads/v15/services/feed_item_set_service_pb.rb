...
require 'google/ads/google_ads/v15/resources/feed_item_set_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.resources.FeedItemSet", "google/ads/googleads/v15/resources/feed_item_set.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateFeedItemSetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateFeedItemSetsRequest").msgclass
          FeedItemSetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.FeedItemSetOperation").msgclass
          MutateFeedItemSetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateFeedItemSetsResponse").msgclass
          MutateFeedItemSetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateFeedItemSetResult").msgclass
        end
      end
    end
  end
