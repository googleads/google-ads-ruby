...
require 'google/ads/google_ads/v15/resources/campaign_conversion_goal_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.resources.CampaignConversionGoal", "google/ads/googleads/v15/resources/campaign_conversion_goal.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateCampaignConversionGoalsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCampaignConversionGoalsRequest").msgclass
          CampaignConversionGoalOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.CampaignConversionGoalOperation").msgclass
          MutateCampaignConversionGoalsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCampaignConversionGoalsResponse").msgclass
          MutateCampaignConversionGoalResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCampaignConversionGoalResult").msgclass
        end
      end
    end
  end
