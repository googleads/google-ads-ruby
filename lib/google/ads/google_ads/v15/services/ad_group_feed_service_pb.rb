...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateAdGroupFeedsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateAdGroupFeedsRequest").msgclass
          AdGroupFeedOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.AdGroupFeedOperation").msgclass
          MutateAdGroupFeedsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateAdGroupFeedsResponse").msgclass
          MutateAdGroupFeedResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateAdGroupFeedResult").msgclass
        end
      end
    end
  end
