...
require 'google/ads/google_ads/v15/resources/campaign_draft_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.resources.CampaignDraft", "google/ads/googleads/v15/resources/campaign_draft.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateCampaignDraftsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCampaignDraftsRequest").msgclass
          PromoteCampaignDraftRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.PromoteCampaignDraftRequest").msgclass
          CampaignDraftOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.CampaignDraftOperation").msgclass
          MutateCampaignDraftsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCampaignDraftsResponse").msgclass
          MutateCampaignDraftResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCampaignDraftResult").msgclass
          ListCampaignDraftAsyncErrorsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.ListCampaignDraftAsyncErrorsRequest").msgclass
          ListCampaignDraftAsyncErrorsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.ListCampaignDraftAsyncErrorsResponse").msgclass
        end
      end
    end
  end
