...
require 'google/ads/google_ads/v15/resources/experiment_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.resources.Experiment", "google/ads/googleads/v15/resources/experiment.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateExperimentsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateExperimentsRequest").msgclass
          ExperimentOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.ExperimentOperation").msgclass
          MutateExperimentsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateExperimentsResponse").msgclass
          MutateExperimentResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateExperimentResult").msgclass
          EndExperimentRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.EndExperimentRequest").msgclass
          ListExperimentAsyncErrorsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.ListExperimentAsyncErrorsRequest").msgclass
          ListExperimentAsyncErrorsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.ListExperimentAsyncErrorsResponse").msgclass
          GraduateExperimentRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.GraduateExperimentRequest").msgclass
          CampaignBudgetMapping = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.CampaignBudgetMapping").msgclass
          ScheduleExperimentRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.ScheduleExperimentRequest").msgclass
          ScheduleExperimentMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.ScheduleExperimentMetadata").msgclass
          PromoteExperimentRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.PromoteExperimentRequest").msgclass
          PromoteExperimentMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.PromoteExperimentMetadata").msgclass
        end
      end
    end
  end
