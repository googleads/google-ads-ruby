...
require 'google/ads/google_ads/v15/resources/campaign_bid_modifier_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.resources.CampaignBidModifier", "google/ads/googleads/v15/resources/campaign_bid_modifier.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateCampaignBidModifiersRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCampaignBidModifiersRequest").msgclass
          CampaignBidModifierOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.CampaignBidModifierOperation").msgclass
          MutateCampaignBidModifiersResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCampaignBidModifiersResponse").msgclass
          MutateCampaignBidModifierResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCampaignBidModifierResult").msgclass
        end
      end
    end
  end
