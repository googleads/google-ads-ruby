...
require 'google/ads/google_ads/v15/resources/customer_sk_ad_network_conversion_value_schema_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.resources.CustomerSkAdNetworkConversionValueSchema", "google/ads/googleads/v15/resources/customer_sk_ad_network_conversion_value_schema.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          CustomerSkAdNetworkConversionValueSchemaOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.CustomerSkAdNetworkConversionValueSchemaOperation").msgclass
          MutateCustomerSkAdNetworkConversionValueSchemaRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCustomerSkAdNetworkConversionValueSchemaRequest").msgclass
          MutateCustomerSkAdNetworkConversionValueSchemaResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCustomerSkAdNetworkConversionValueSchemaResult").msgclass
          MutateCustomerSkAdNetworkConversionValueSchemaResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCustomerSkAdNetworkConversionValueSchemaResponse").msgclass
        end
      end
    end
  end
