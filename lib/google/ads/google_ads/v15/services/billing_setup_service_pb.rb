...
require 'google/ads/google_ads/v15/resources/billing_setup_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.resources.BillingSetup", "google/ads/googleads/v15/resources/billing_setup.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateBillingSetupRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateBillingSetupRequest").msgclass
          BillingSetupOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.BillingSetupOperation").msgclass
          MutateBillingSetupResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateBillingSetupResponse").msgclass
          MutateBillingSetupResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateBillingSetupResult").msgclass
        end
      end
    end
  end
