...
require 'google/ads/google_ads/v15/resources/shared_criterion_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.resources.SharedCriterion", "google/ads/googleads/v15/resources/shared_criterion.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateSharedCriteriaRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateSharedCriteriaRequest").msgclass
          SharedCriterionOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.SharedCriterionOperation").msgclass
          MutateSharedCriteriaResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateSharedCriteriaResponse").msgclass
          MutateSharedCriterionResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateSharedCriterionResult").msgclass
        end
      end
    end
  end
