...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          SuggestKeywordThemeConstantsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.SuggestKeywordThemeConstantsRequest").msgclass
          SuggestKeywordThemeConstantsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.SuggestKeywordThemeConstantsResponse").msgclass
        end
      end
    end
  end
