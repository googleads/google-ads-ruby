...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.resources.Invoice", "google/ads/googleads/v15/resources/invoice.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          ListInvoicesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.ListInvoicesRequest").msgclass
          ListInvoicesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.ListInvoicesResponse").msgclass
        end
      end
    end
  end
