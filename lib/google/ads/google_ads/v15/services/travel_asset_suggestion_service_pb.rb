...
require 'google/ads/google_ads/v15/enums/call_to_action_type_pb'
require 'google/ads/google_ads/v15/enums/hotel_asset_suggestion_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          SuggestTravelAssetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.SuggestTravelAssetsRequest").msgclass
          SuggestTravelAssetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.SuggestTravelAssetsResponse").msgclass
          HotelAssetSuggestion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.HotelAssetSuggestion").msgclass
          HotelTextAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.HotelTextAsset").msgclass
          HotelImageAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.HotelImageAsset").msgclass
        end
      end
    end
  end
