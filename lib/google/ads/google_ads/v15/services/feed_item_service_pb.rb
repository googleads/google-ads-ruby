...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateFeedItemsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateFeedItemsRequest").msgclass
          FeedItemOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.FeedItemOperation").msgclass
          MutateFeedItemsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateFeedItemsResponse").msgclass
          MutateFeedItemResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateFeedItemResult").msgclass
        end
      end
    end
  end
