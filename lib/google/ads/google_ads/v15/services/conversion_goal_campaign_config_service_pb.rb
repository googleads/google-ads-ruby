...
require 'google/ads/google_ads/v15/resources/conversion_goal_campaign_config_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.resources.ConversionGoalCampaignConfig", "google/ads/googleads/v15/resources/conversion_goal_campaign_config.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateConversionGoalCampaignConfigsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateConversionGoalCampaignConfigsRequest").msgclass
          ConversionGoalCampaignConfigOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.ConversionGoalCampaignConfigOperation").msgclass
          MutateConversionGoalCampaignConfigsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateConversionGoalCampaignConfigsResponse").msgclass
          MutateConversionGoalCampaignConfigResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateConversionGoalCampaignConfigResult").msgclass
        end
      end
    end
  end
