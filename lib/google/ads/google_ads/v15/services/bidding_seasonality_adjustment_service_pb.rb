...
require 'google/ads/google_ads/v15/resources/bidding_seasonality_adjustment_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.resources.BiddingSeasonalityAdjustment", "google/ads/googleads/v15/resources/bidding_seasonality_adjustment.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateBiddingSeasonalityAdjustmentsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateBiddingSeasonalityAdjustmentsRequest").msgclass
          BiddingSeasonalityAdjustmentOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.BiddingSeasonalityAdjustmentOperation").msgclass
          MutateBiddingSeasonalityAdjustmentsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateBiddingSeasonalityAdjustmentsResponse").msgclass
          MutateBiddingSeasonalityAdjustmentsResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateBiddingSeasonalityAdjustmentsResult").msgclass
        end
      end
    end
  end
