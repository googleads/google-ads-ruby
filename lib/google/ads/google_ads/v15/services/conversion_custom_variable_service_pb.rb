...
require 'google/ads/google_ads/v15/resources/conversion_custom_variable_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.resources.ConversionCustomVariable", "google/ads/googleads/v15/resources/conversion_custom_variable.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateConversionCustomVariablesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateConversionCustomVariablesRequest").msgclass
          ConversionCustomVariableOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.ConversionCustomVariableOperation").msgclass
          MutateConversionCustomVariablesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateConversionCustomVariablesResponse").msgclass
          MutateConversionCustomVariableResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateConversionCustomVariableResult").msgclass
        end
      end
    end
  end
