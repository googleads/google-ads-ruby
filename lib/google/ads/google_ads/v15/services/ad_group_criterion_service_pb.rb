...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.common.PolicyViolationKey", "google/ads/googleads/v15/common/policy.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateAdGroupCriteriaRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateAdGroupCriteriaRequest").msgclass
          AdGroupCriterionOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.AdGroupCriterionOperation").msgclass
          MutateAdGroupCriteriaResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateAdGroupCriteriaResponse").msgclass
          MutateAdGroupCriterionResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateAdGroupCriterionResult").msgclass
        end
      end
    end
  end
