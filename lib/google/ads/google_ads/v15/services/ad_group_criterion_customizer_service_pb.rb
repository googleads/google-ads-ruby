...
require 'google/ads/google_ads/v15/resources/ad_group_criterion_customizer_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.resources.AdGroupCriterionCustomizer", "google/ads/googleads/v15/resources/ad_group_criterion_customizer.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateAdGroupCriterionCustomizersRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateAdGroupCriterionCustomizersRequest").msgclass
          AdGroupCriterionCustomizerOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.AdGroupCriterionCustomizerOperation").msgclass
          MutateAdGroupCriterionCustomizersResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateAdGroupCriterionCustomizersResponse").msgclass
          MutateAdGroupCriterionCustomizerResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateAdGroupCriterionCustomizerResult").msgclass
        end
      end
    end
  end
