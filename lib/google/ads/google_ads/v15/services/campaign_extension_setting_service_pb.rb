...
require 'google/ads/google_ads/v15/resources/campaign_extension_setting_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.resources.CampaignExtensionSetting", "google/ads/googleads/v15/resources/campaign_extension_setting.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateCampaignExtensionSettingsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCampaignExtensionSettingsRequest").msgclass
          CampaignExtensionSettingOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.CampaignExtensionSettingOperation").msgclass
          MutateCampaignExtensionSettingsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCampaignExtensionSettingsResponse").msgclass
          MutateCampaignExtensionSettingResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCampaignExtensionSettingResult").msgclass
        end
      end
    end
  end
