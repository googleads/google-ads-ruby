...
require 'google/ads/google_ads/v15/resources/customer_extension_setting_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.resources.CustomerExtensionSetting", "google/ads/googleads/v15/resources/customer_extension_setting.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateCustomerExtensionSettingsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCustomerExtensionSettingsRequest").msgclass
          CustomerExtensionSettingOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.CustomerExtensionSettingOperation").msgclass
          MutateCustomerExtensionSettingsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCustomerExtensionSettingsResponse").msgclass
          MutateCustomerExtensionSettingResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateCustomerExtensionSettingResult").msgclass
        end
      end
    end
  end
