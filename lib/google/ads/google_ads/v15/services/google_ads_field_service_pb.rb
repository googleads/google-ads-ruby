...
require 'google/ads/google_ads/v15/resources/google_ads_field_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.resources.GoogleAdsField", "google/ads/googleads/v15/resources/google_ads_field.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          GetGoogleAdsFieldRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.GetGoogleAdsFieldRequest").msgclass
          SearchGoogleAdsFieldsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.SearchGoogleAdsFieldsRequest").msgclass
          SearchGoogleAdsFieldsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.SearchGoogleAdsFieldsResponse").msgclass
        end
      end
    end
  end
