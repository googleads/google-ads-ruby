...
require 'google/ads/google_ads/v15/resources/keyword_plan_campaign_keyword_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.resources.KeywordPlanCampaignKeyword", "google/ads/googleads/v15/resources/keyword_plan_campaign_keyword.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateKeywordPlanCampaignKeywordsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateKeywordPlanCampaignKeywordsRequest").msgclass
          KeywordPlanCampaignKeywordOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.KeywordPlanCampaignKeywordOperation").msgclass
          MutateKeywordPlanCampaignKeywordsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateKeywordPlanCampaignKeywordsResponse").msgclass
          MutateKeywordPlanCampaignKeywordResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateKeywordPlanCampaignKeywordResult").msgclass
        end
      end
    end
  end
