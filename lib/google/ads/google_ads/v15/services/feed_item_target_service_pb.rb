...
require 'google/ads/google_ads/v15/resources/feed_item_target_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.resources.FeedItemTarget", "google/ads/googleads/v15/resources/feed_item_target.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateFeedItemTargetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateFeedItemTargetsRequest").msgclass
          FeedItemTargetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.FeedItemTargetOperation").msgclass
          MutateFeedItemTargetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateFeedItemTargetsResponse").msgclass
          MutateFeedItemTargetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateFeedItemTargetResult").msgclass
        end
      end
    end
  end
