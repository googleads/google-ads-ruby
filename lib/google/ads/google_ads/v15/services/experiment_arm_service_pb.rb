...
require 'google/ads/google_ads/v15/resources/experiment_arm_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.resources.ExperimentArm", "google/ads/googleads/v15/resources/experiment_arm.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          MutateExperimentArmsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateExperimentArmsRequest").msgclass
          ExperimentArmOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.ExperimentArmOperation").msgclass
          MutateExperimentArmsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateExperimentArmsResponse").msgclass
          MutateExperimentArmResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateExperimentArmResult").msgclass
        end
      end
    end
  end
