...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.common.PolicyValidationParameter", "google/ads/googleads/v15/common/policy.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Services
          GetAdRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.GetAdRequest").msgclass
          MutateAdsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateAdsRequest").msgclass
          AdOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.AdOperation").msgclass
          MutateAdsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateAdsResponse").msgclass
          MutateAdResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.services.MutateAdResult").msgclass
        end
      end
    end
  end
