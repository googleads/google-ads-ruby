...
module Google
  module Ads
    module GoogleAds
      module V15
        module Enums
          ListingGroupFilterProductCategoryLevelEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.ListingGroupFilterProductCategoryLevelEnum").msgclass
          ListingGroupFilterProductCategoryLevelEnum::ListingGroupFilterProductCategoryLevel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.ListingGroupFilterProductCategoryLevelEnum.ListingGroupFilterProductCategoryLevel").enummodule
        end
      end
    end
  end
