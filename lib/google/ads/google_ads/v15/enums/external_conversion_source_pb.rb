...
module Google
  module Ads
    module GoogleAds
      module V15
        module Enums
          ExternalConversionSourceEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.ExternalConversionSourceEnum").msgclass
          ExternalConversionSourceEnum::ExternalConversionSource = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.ExternalConversionSourceEnum.ExternalConversionSource").enummodule
        end
      end
    end
  end
