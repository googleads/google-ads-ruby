...
module Google
  module Ads
    module GoogleAds
      module V15
        module Enums
          DistanceBucketEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.DistanceBucketEnum").msgclass
          DistanceBucketEnum::DistanceBucket = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.DistanceBucketEnum.DistanceBucket").enummodule
        end
      end
    end
  end
