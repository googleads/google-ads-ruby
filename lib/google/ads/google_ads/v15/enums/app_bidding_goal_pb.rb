...
module Google
  module Ads
    module GoogleAds
      module V15
        module Enums
          AppBiddingGoalEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.AppBiddingGoalEnum").msgclass
          AppBiddingGoalEnum::AppBiddingGoal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.AppBiddingGoalEnum.AppBiddingGoal").enummodule
        end
      end
    end
  end
