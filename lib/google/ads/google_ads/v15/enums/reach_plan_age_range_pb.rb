...
module Google
  module Ads
    module GoogleAds
      module V15
        module Enums
          ReachPlanAgeRangeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.ReachPlanAgeRangeEnum").msgclass
          ReachPlanAgeRangeEnum::ReachPlanAgeRange = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.ReachPlanAgeRangeEnum.ReachPlanAgeRange").enummodule
        end
      end
    end
  end
