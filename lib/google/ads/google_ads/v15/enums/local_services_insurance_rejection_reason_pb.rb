...
module Google
  module Ads
    module GoogleAds
      module V15
        module Enums
          LocalServicesInsuranceRejectionReasonEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.LocalServicesInsuranceRejectionReasonEnum").msgclass
          LocalServicesInsuranceRejectionReasonEnum::LocalServicesInsuranceRejectionReason = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.LocalServicesInsuranceRejectionReasonEnum.LocalServicesInsuranceRejectionReason").enummodule
        end
      end
    end
  end
