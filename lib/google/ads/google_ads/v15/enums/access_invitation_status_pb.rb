...
module Google
  module Ads
    module GoogleAds
      module V15
        module Enums
          AccessInvitationStatusEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.AccessInvitationStatusEnum").msgclass
          AccessInvitationStatusEnum::AccessInvitationStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.AccessInvitationStatusEnum.AccessInvitationStatus").enummodule
        end
      end
    end
  end
