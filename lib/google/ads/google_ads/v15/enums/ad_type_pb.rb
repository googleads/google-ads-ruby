...
module Google
  module Ads
    module GoogleAds
      module V15
        module Enums
          AdTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.AdTypeEnum").msgclass
          AdTypeEnum::AdType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.AdTypeEnum.AdType").enummodule
        end
      end
    end
  end
