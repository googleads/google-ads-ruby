...
module Google
  module Ads
    module GoogleAds
      module V15
        module Enums
          ExtensionTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.ExtensionTypeEnum").msgclass
          ExtensionTypeEnum::ExtensionType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.ExtensionTypeEnum.ExtensionType").enummodule
        end
      end
    end
  end
