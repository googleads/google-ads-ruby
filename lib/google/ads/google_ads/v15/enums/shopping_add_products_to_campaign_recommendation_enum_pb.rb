...
module Google
  module Ads
    module GoogleAds
      module V15
        module Enums
          ShoppingAddProductsToCampaignRecommendationEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.ShoppingAddProductsToCampaignRecommendationEnum").msgclass
          ShoppingAddProductsToCampaignRecommendationEnum::Reason = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.ShoppingAddProductsToCampaignRecommendationEnum.Reason").enummodule
        end
      end
    end
  end
