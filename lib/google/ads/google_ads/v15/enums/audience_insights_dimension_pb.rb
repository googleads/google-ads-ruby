...
module Google
  module Ads
    module GoogleAds
      module V15
        module Enums
          AudienceInsightsDimensionEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.AudienceInsightsDimensionEnum").msgclass
          AudienceInsightsDimensionEnum::AudienceInsightsDimension = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimension").enummodule
        end
      end
    end
  end
