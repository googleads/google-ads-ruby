...
module Google
  module Ads
    module GoogleAds
      module V15
        module Enums
          ChangeStatusResourceTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.ChangeStatusResourceTypeEnum").msgclass
          ChangeStatusResourceTypeEnum::ChangeStatusResourceType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.ChangeStatusResourceTypeEnum.ChangeStatusResourceType").enummodule
        end
      end
    end
  end
