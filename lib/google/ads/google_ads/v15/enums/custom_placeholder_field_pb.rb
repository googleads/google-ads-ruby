...
module Google
  module Ads
    module GoogleAds
      module V15
        module Enums
          CustomPlaceholderFieldEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.CustomPlaceholderFieldEnum").msgclass
          CustomPlaceholderFieldEnum::CustomPlaceholderField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.CustomPlaceholderFieldEnum.CustomPlaceholderField").enummodule
        end
      end
    end
  end
