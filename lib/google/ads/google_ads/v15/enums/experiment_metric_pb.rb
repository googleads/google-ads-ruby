...
module Google
  module Ads
    module GoogleAds
      module V15
        module Enums
          ExperimentMetricEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.ExperimentMetricEnum").msgclass
          ExperimentMetricEnum::ExperimentMetric = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.ExperimentMetricEnum.ExperimentMetric").enummodule
        end
      end
    end
  end
