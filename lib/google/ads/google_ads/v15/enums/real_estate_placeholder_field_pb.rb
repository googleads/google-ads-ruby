...
module Google
  module Ads
    module GoogleAds
      module V15
        module Enums
          RealEstatePlaceholderFieldEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.RealEstatePlaceholderFieldEnum").msgclass
          RealEstatePlaceholderFieldEnum::RealEstatePlaceholderField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.RealEstatePlaceholderFieldEnum.RealEstatePlaceholderField").enummodule
        end
      end
    end
  end
