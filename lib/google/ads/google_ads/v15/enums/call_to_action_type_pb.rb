...
module Google
  module Ads
    module GoogleAds
      module V15
        module Enums
          CallToActionTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.CallToActionTypeEnum").msgclass
          CallToActionTypeEnum::CallToActionType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.CallToActionTypeEnum.CallToActionType").enummodule
        end
      end
    end
  end
