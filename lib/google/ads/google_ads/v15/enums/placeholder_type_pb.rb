...
module Google
  module Ads
    module GoogleAds
      module V15
        module Enums
          PlaceholderTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.PlaceholderTypeEnum").msgclass
          PlaceholderTypeEnum::PlaceholderType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.PlaceholderTypeEnum.PlaceholderType").enummodule
        end
      end
    end
  end
