...
module Google
  module Ads
    module GoogleAds
      module V15
        module Enums
          TravelPlaceholderFieldEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.TravelPlaceholderFieldEnum").msgclass
          TravelPlaceholderFieldEnum::TravelPlaceholderField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.TravelPlaceholderFieldEnum.TravelPlaceholderField").enummodule
        end
      end
    end
  end
