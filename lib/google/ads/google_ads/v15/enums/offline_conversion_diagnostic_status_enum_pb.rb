...
module Google
  module Ads
    module GoogleAds
      module V15
        module Enums
          OfflineConversionDiagnosticStatusEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.OfflineConversionDiagnosticStatusEnum").msgclass
          OfflineConversionDiagnosticStatusEnum::OfflineConversionDiagnosticStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.OfflineConversionDiagnosticStatusEnum.OfflineConversionDiagnosticStatus").enummodule
        end
      end
    end
  end
