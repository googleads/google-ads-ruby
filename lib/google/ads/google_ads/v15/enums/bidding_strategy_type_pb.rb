...
module Google
  module Ads
    module GoogleAds
      module V15
        module Enums
          BiddingStrategyTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.BiddingStrategyTypeEnum").msgclass
          BiddingStrategyTypeEnum::BiddingStrategyType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.BiddingStrategyTypeEnum.BiddingStrategyType").enummodule
        end
      end
    end
  end
