...
module Google
  module Ads
    module GoogleAds
      module V15
        module Enums
          JobPlaceholderFieldEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.JobPlaceholderFieldEnum").msgclass
          JobPlaceholderFieldEnum::JobPlaceholderField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.JobPlaceholderFieldEnum.JobPlaceholderField").enummodule
        end
      end
    end
  end
