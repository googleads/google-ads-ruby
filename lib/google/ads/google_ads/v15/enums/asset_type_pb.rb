...
module Google
  module Ads
    module GoogleAds
      module V15
        module Enums
          AssetTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.AssetTypeEnum").msgclass
          AssetTypeEnum::AssetType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.AssetTypeEnum.AssetType").enummodule
        end
      end
    end
  end
