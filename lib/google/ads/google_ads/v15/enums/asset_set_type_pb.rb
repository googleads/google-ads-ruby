...
module Google
  module Ads
    module GoogleAds
      module V15
        module Enums
          AssetSetTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.AssetSetTypeEnum").msgclass
          AssetSetTypeEnum::AssetSetType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.AssetSetTypeEnum.AssetSetType").enummodule
        end
      end
    end
  end
