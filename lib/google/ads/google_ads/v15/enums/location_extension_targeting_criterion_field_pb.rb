...
module Google
  module Ads
    module GoogleAds
      module V15
        module Enums
          LocationExtensionTargetingCriterionFieldEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.LocationExtensionTargetingCriterionFieldEnum").msgclass
          LocationExtensionTargetingCriterionFieldEnum::LocationExtensionTargetingCriterionField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.enums.LocationExtensionTargetingCriterionFieldEnum.LocationExtensionTargetingCriterionField").enummodule
        end
      end
    end
  end
