...
module Google
  module Ads
    module GoogleAds
      module V15
        module Common
          LookalikeUserListInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.LookalikeUserListInfo").msgclass
          SimilarUserListInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.SimilarUserListInfo").msgclass
          CrmBasedUserListInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.CrmBasedUserListInfo").msgclass
          UserListRuleInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.UserListRuleInfo").msgclass
          UserListRuleItemGroupInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.UserListRuleItemGroupInfo").msgclass
          UserListRuleItemInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.UserListRuleItemInfo").msgclass
          UserListDateRuleItemInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.UserListDateRuleItemInfo").msgclass
          UserListNumberRuleItemInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.UserListNumberRuleItemInfo").msgclass
          UserListStringRuleItemInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.UserListStringRuleItemInfo").msgclass
          FlexibleRuleOperandInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.FlexibleRuleOperandInfo").msgclass
          FlexibleRuleUserListInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.FlexibleRuleUserListInfo").msgclass
          RuleBasedUserListInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.RuleBasedUserListInfo").msgclass
          LogicalUserListInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.LogicalUserListInfo").msgclass
          UserListLogicalRuleInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.UserListLogicalRuleInfo").msgclass
          LogicalUserListOperandInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.LogicalUserListOperandInfo").msgclass
          BasicUserListInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.BasicUserListInfo").msgclass
          UserListActionInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.UserListActionInfo").msgclass
        end
      end
    end
  end
