...
module Google
  module Ads
    module GoogleAds
      module V15
        module Common
          TagSnippet = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.TagSnippet").msgclass
        end
      end
    end
  end
