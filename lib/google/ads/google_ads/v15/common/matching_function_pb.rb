...
module Google
  module Ads
    module GoogleAds
      module V15
        module Common
          MatchingFunction = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.MatchingFunction").msgclass
          Operand = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.Operand").msgclass
          Operand::ConstantOperand = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.Operand.ConstantOperand").msgclass
          Operand::FeedAttributeOperand = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.Operand.FeedAttributeOperand").msgclass
          Operand::FunctionOperand = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.Operand.FunctionOperand").msgclass
          Operand::RequestContextOperand = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.Operand.RequestContextOperand").msgclass
        end
      end
    end
  end
