...
module Google
  module Ads
    module GoogleAds
      module V15
        module Common
          UrlCollection = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.UrlCollection").msgclass
        end
      end
    end
  end
