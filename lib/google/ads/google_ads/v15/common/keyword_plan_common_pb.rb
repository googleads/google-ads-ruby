...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.common.YearMonthRange", "google/ads/googleads/v15/common/dates.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Common
          KeywordPlanHistoricalMetrics = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.KeywordPlanHistoricalMetrics").msgclass
          HistoricalMetricsOptions = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.HistoricalMetricsOptions").msgclass
          MonthlySearchVolume = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.MonthlySearchVolume").msgclass
          KeywordPlanAggregateMetrics = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.KeywordPlanAggregateMetrics").msgclass
          KeywordPlanAggregateMetricResults = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.KeywordPlanAggregateMetricResults").msgclass
          KeywordPlanDeviceSearches = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.KeywordPlanDeviceSearches").msgclass
          KeywordAnnotations = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.KeywordAnnotations").msgclass
          KeywordConcept = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.KeywordConcept").msgclass
          ConceptGroup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.ConceptGroup").msgclass
        end
      end
    end
  end
