...
require 'google/ads/google_ads/v15/enums/asset_offline_evaluation_error_reasons_pb'
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Common
          AdAssetPolicySummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.AdAssetPolicySummary").msgclass
          AssetLinkPrimaryStatusDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.AssetLinkPrimaryStatusDetails").msgclass
          AssetDisapproved = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.AssetDisapproved").msgclass
        end
      end
    end
  end
