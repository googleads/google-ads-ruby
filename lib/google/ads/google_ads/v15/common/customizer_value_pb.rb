...
module Google
  module Ads
    module GoogleAds
      module V15
        module Common
          CustomizerValue = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.CustomizerValue").msgclass
        end
      end
    end
  end
