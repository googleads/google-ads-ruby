...
module Google
  module Ads
    module GoogleAds
      module V15
        module Common
          TargetingSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.TargetingSetting").msgclass
          TargetRestriction = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.TargetRestriction").msgclass
          TargetRestrictionOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.TargetRestrictionOperation").msgclass
          TargetRestrictionOperation::Operator = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.TargetRestrictionOperation.Operator").enummodule
        end
      end
    end
  end
