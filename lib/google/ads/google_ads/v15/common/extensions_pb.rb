...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.common.CustomParameter", "google/ads/googleads/v15/common/custom_parameter.proto"],
    ["google.ads.googleads.v15.common.Money", "google/ads/googleads/v15/common/feed_common.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Common
          AppFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.AppFeedItem").msgclass
          CallFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.CallFeedItem").msgclass
          CalloutFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.CalloutFeedItem").msgclass
          LocationFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.LocationFeedItem").msgclass
          AffiliateLocationFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.AffiliateLocationFeedItem").msgclass
          TextMessageFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.TextMessageFeedItem").msgclass
          PriceFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.PriceFeedItem").msgclass
          PriceOffer = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.PriceOffer").msgclass
          PromotionFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.PromotionFeedItem").msgclass
          StructuredSnippetFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.StructuredSnippetFeedItem").msgclass
          SitelinkFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.SitelinkFeedItem").msgclass
          HotelCalloutFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.HotelCalloutFeedItem").msgclass
          ImageFeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.common.ImageFeedItem").msgclass
        end
      end
    end
  end
