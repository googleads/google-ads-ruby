...
require 'google/ads/google_ads/v15/enums/access_invitation_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          CustomerUserAccessInvitation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.CustomerUserAccessInvitation").msgclass
        end
      end
    end
  end
