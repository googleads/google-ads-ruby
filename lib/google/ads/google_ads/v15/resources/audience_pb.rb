...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.common.AudienceDimension", "google/ads/googleads/v15/common/audiences.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          Audience = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.Audience").msgclass
        end
      end
    end
  end
