...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.common.MetricGoal", "google/ads/googleads/v15/common/metric_goal.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          Experiment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.Experiment").msgclass
        end
      end
    end
  end
