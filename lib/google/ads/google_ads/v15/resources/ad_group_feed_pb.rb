...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          AdGroupFeed = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AdGroupFeed").msgclass
        end
      end
    end
  end
