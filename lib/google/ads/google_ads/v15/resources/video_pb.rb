...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          Video = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.Video").msgclass
        end
      end
    end
  end
