...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          TopicConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.TopicConstant").msgclass
        end
      end
    end
  end
