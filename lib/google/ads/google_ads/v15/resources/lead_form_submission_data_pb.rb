...
require 'google/ads/google_ads/v15/enums/lead_form_field_user_input_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          LeadFormSubmissionData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.LeadFormSubmissionData").msgclass
          LeadFormSubmissionField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.LeadFormSubmissionField").msgclass
          CustomLeadFormSubmissionField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.CustomLeadFormSubmissionField").msgclass
        end
      end
    end
  end
