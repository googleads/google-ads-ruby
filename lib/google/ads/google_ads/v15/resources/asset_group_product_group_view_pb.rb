...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          AssetGroupProductGroupView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AssetGroupProductGroupView").msgclass
        end
      end
    end
  end
