...
require 'google/ads/google_ads/v15/enums/conversion_custom_variable_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          ConversionCustomVariable = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.ConversionCustomVariable").msgclass
        end
      end
    end
  end
