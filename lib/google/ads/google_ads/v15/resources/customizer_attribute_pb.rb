...
require 'google/ads/google_ads/v15/enums/customizer_attribute_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          CustomizerAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.CustomizerAttribute").msgclass
        end
      end
    end
  end
