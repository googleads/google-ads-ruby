...
require 'google/ads/google_ads/v15/enums/account_budget_proposal_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          AccountBudgetProposal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AccountBudgetProposal").msgclass
        end
      end
    end
  end
