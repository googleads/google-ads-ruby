...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          AdGroupCriterionSimulation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AdGroupCriterionSimulation").msgclass
        end
      end
    end
  end
