...
require 'google/ads/google_ads/v15/enums/campaign_group_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          CampaignGroup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.CampaignGroup").msgclass
        end
      end
    end
  end
