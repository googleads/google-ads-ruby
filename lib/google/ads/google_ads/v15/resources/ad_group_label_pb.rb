...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          AdGroupLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AdGroupLabel").msgclass
        end
      end
    end
  end
