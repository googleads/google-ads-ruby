...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          CampaignLifecycleGoal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.CampaignLifecycleGoal").msgclass
          CustomerAcquisitionGoalSettings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.CustomerAcquisitionGoalSettings").msgclass
        end
      end
    end
  end
