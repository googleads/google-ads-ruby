...
require 'google/ads/google_ads/v15/enums/bid_modifier_source_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.common.HotelDateSelectionTypeInfo", "google/ads/googleads/v15/common/criteria.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          AdGroupBidModifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AdGroupBidModifier").msgclass
        end
      end
    end
  end
