...
require 'google/ads/google_ads/v15/enums/campaign_criterion_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          CampaignCriterion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.CampaignCriterion").msgclass
        end
      end
    end
  end
