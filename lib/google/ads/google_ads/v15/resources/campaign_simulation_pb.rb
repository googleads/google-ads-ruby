...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          CampaignSimulation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.CampaignSimulation").msgclass
        end
      end
    end
  end
