...
require 'google/ads/google_ads/v15/common/asset_types_pb'
...
require 'google/ads/google_ads/v15/enums/asset_type_pb'
...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.common.YoutubeVideoAsset", "google/ads/googleads/v15/common/asset_types.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          Asset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.Asset").msgclass
          AssetFieldTypePolicySummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AssetFieldTypePolicySummary").msgclass
          AssetPolicySummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AssetPolicySummary").msgclass
        end
      end
    end
  end
