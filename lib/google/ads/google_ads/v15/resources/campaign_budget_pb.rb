...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          CampaignBudget = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.CampaignBudget").msgclass
        end
      end
    end
  end
