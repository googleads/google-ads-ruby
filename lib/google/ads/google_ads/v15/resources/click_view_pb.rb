...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.common.ClickLocation", "google/ads/googleads/v15/common/click_location.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          ClickView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.ClickView").msgclass
        end
      end
    end
  end
