...
require 'google/ads/google_ads/v15/enums/product_category_state_pb'
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          ProductCategoryConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.ProductCategoryConstant").msgclass
          ProductCategoryConstant::ProductCategoryLocalization = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.ProductCategoryConstant.ProductCategoryLocalization").msgclass
        end
      end
    end
  end
