...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.common.TargetCpaSimulationPointList", "google/ads/googleads/v15/common/simulation.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          BiddingStrategySimulation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.BiddingStrategySimulation").msgclass
        end
      end
    end
  end
