...
require 'google/ads/google_ads/v15/enums/keyword_match_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          KeywordPlanCampaignKeyword = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.KeywordPlanCampaignKeyword").msgclass
        end
      end
    end
  end
