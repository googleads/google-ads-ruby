...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          GoogleAdsField = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.GoogleAdsField").msgclass
        end
      end
    end
  end
