...
require 'google/ads/google_ads/v15/enums/account_link_status_pb'
require 'google/ads/google_ads/v15/enums/linked_account_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          AccountLink = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AccountLink").msgclass
          ThirdPartyAppAnalyticsLinkIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.ThirdPartyAppAnalyticsLinkIdentifier").msgclass
          DataPartnerLinkIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.DataPartnerLinkIdentifier").msgclass
          GoogleAdsLinkIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.GoogleAdsLinkIdentifier").msgclass
          AdvertisingPartnerLinkIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AdvertisingPartnerLinkIdentifier").msgclass
        end
      end
    end
  end
