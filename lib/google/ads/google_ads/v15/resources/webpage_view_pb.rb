...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          WebpageView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.WebpageView").msgclass
        end
      end
    end
  end
