...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          SharedCriterion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.SharedCriterion").msgclass
        end
      end
    end
  end
