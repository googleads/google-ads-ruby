...
require 'google/ads/google_ads/v15/enums/placement_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          DetailPlacementView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.DetailPlacementView").msgclass
        end
      end
    end
  end
