...
require 'google/ads/google_ads/v15/enums/offline_conversion_diagnostic_status_enum_pb'
require 'google/ads/google_ads/v15/enums/offline_event_upload_client_enum_pb'
require 'google/ads/google_ads/v15/errors/collection_size_error_pb'
require 'google/ads/google_ads/v15/errors/conversion_adjustment_upload_error_pb'
require 'google/ads/google_ads/v15/errors/conversion_upload_error_pb'
require 'google/ads/google_ads/v15/errors/date_error_pb'
require 'google/ads/google_ads/v15/errors/distinct_error_pb'
require 'google/ads/google_ads/v15/errors/field_error_pb'
require 'google/ads/google_ads/v15/errors/mutate_error_pb'
require 'google/ads/google_ads/v15/errors/not_allowlisted_error_pb'
require 'google/ads/google_ads/v15/errors/string_format_error_pb'
require 'google/ads/google_ads/v15/errors/string_length_error_pb'
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          OfflineConversionUploadClientSummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.OfflineConversionUploadClientSummary").msgclass
          OfflineConversionSummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.OfflineConversionSummary").msgclass
          OfflineConversionAlert = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.OfflineConversionAlert").msgclass
          OfflineConversionError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.OfflineConversionError").msgclass
        end
      end
    end
  end
