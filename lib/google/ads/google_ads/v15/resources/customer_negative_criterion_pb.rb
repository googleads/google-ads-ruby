...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.common.ContentLabelInfo", "google/ads/googleads/v15/common/criteria.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          CustomerNegativeCriterion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.CustomerNegativeCriterion").msgclass
        end
      end
    end
  end
