...
require 'google/ads/google_ads/v15/enums/ad_group_criterion_approval_status_pb'
require 'google/ads/google_ads/v15/enums/ad_group_criterion_status_pb'
require 'google/ads/google_ads/v15/enums/bidding_source_pb'
require 'google/ads/google_ads/v15/enums/criterion_system_serving_status_pb'
require 'google/ads/google_ads/v15/enums/criterion_type_pb'
require 'google/ads/google_ads/v15/enums/quality_score_bucket_pb'
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          AdGroupCriterion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AdGroupCriterion").msgclass
          AdGroupCriterion::QualityInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AdGroupCriterion.QualityInfo").msgclass
          AdGroupCriterion::PositionEstimates = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AdGroupCriterion.PositionEstimates").msgclass
        end
      end
    end
  end
