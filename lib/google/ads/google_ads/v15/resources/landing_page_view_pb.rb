...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          LandingPageView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.LandingPageView").msgclass
        end
      end
    end
  end
