...
require 'google/ads/google_ads/v15/enums/asset_set_asset_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          AssetSetAsset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AssetSetAsset").msgclass
        end
      end
    end
  end
