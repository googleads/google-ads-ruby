...
require 'google/ads/google_ads/v15/common/local_services_pb'
require 'google/ads/google_ads/v15/enums/local_services_insurance_rejection_reason_pb'
require 'google/ads/google_ads/v15/enums/local_services_license_rejection_reason_pb'
require 'google/ads/google_ads/v15/enums/local_services_verification_artifact_status_pb'
require 'google/ads/google_ads/v15/enums/local_services_verification_artifact_type_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.common.LocalServicesDocumentReadOnly", "google/ads/googleads/v15/common/local_services.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          LocalServicesVerificationArtifact = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.LocalServicesVerificationArtifact").msgclass
          BackgroundCheckVerificationArtifact = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.BackgroundCheckVerificationArtifact").msgclass
          InsuranceVerificationArtifact = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.InsuranceVerificationArtifact").msgclass
          LicenseVerificationArtifact = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.LicenseVerificationArtifact").msgclass
        end
      end
    end
  end
