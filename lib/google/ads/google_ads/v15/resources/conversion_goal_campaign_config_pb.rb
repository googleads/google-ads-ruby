...
require 'google/ads/google_ads/v15/enums/goal_config_level_pb'
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          ConversionGoalCampaignConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.ConversionGoalCampaignConfig").msgclass
        end
      end
    end
  end
