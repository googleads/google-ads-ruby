...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          CustomAudience = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.CustomAudience").msgclass
          CustomAudienceMember = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.CustomAudienceMember").msgclass
        end
      end
    end
  end
