...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          HotelReconciliation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.HotelReconciliation").msgclass
        end
      end
    end
  end
