...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          CustomInterest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.CustomInterest").msgclass
          CustomInterestMember = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.CustomInterestMember").msgclass
        end
      end
    end
  end
