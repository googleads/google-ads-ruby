...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.common.LocationSet", "google/ads/googleads/v15/common/asset_set_types.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          AssetSet = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AssetSet").msgclass
          AssetSet::MerchantCenterFeed = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AssetSet.MerchantCenterFeed").msgclass
          AssetSet::HotelPropertyData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AssetSet.HotelPropertyData").msgclass
        end
      end
    end
  end
