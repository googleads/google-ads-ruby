...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          SearchTermView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.SearchTermView").msgclass
        end
      end
    end
  end
