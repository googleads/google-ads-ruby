...
require 'google/ads/google_ads/v15/common/asset_usage_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.common.AssetUsage", "google/ads/googleads/v15/common/asset_usage.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          AssetGroupTopCombinationView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AssetGroupTopCombinationView").msgclass
          AssetGroupAssetCombinationData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AssetGroupAssetCombinationData").msgclass
        end
      end
    end
  end
