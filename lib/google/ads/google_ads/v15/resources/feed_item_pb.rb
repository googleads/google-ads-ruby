...
require 'google/ads/google_ads/v15/enums/feed_item_quality_approval_status_pb'
require 'google/ads/google_ads/v15/enums/feed_item_quality_disapproval_reason_pb'
require 'google/ads/google_ads/v15/enums/feed_item_status_pb'
require 'google/ads/google_ads/v15/enums/feed_item_validation_status_pb'
require 'google/ads/google_ads/v15/enums/geo_targeting_restriction_pb'
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          FeedItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.FeedItem").msgclass
          FeedItemAttributeValue = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.FeedItemAttributeValue").msgclass
          FeedItemPlaceholderPolicyInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.FeedItemPlaceholderPolicyInfo").msgclass
          FeedItemValidationError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.FeedItemValidationError").msgclass
        end
      end
    end
  end
