...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          AndroidPrivacySharedKeyGoogleCampaign = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AndroidPrivacySharedKeyGoogleCampaign").msgclass
        end
      end
    end
  end
