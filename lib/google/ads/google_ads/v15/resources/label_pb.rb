...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.common.TextLabel", "google/ads/googleads/v15/common/text_label.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          Label = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.Label").msgclass
        end
      end
    end
  end
