...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          Feed = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.Feed").msgclass
          Feed::PlacesLocationFeedData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.Feed.PlacesLocationFeedData").msgclass
          Feed::PlacesLocationFeedData::OAuthInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.Feed.PlacesLocationFeedData.OAuthInfo").msgclass
          Feed::AffiliateLocationFeedData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.Feed.AffiliateLocationFeedData").msgclass
          FeedAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.FeedAttribute").msgclass
          FeedAttributeOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.FeedAttributeOperation").msgclass
          FeedAttributeOperation::Operator = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.FeedAttributeOperation.Operator").enummodule
        end
      end
    end
  end
