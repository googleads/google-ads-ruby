...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.common.CriterionCategoryAvailability", "google/ads/googleads/v15/common/criterion_category_availability.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          UserInterest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.UserInterest").msgclass
        end
      end
    end
  end
