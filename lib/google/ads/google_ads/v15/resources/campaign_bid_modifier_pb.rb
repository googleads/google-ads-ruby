...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.common.InteractionTypeInfo", "google/ads/googleads/v15/common/criteria.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          CampaignBidModifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.CampaignBidModifier").msgclass
        end
      end
    end
  end
