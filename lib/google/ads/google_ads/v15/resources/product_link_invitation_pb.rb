...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          ProductLinkInvitation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.ProductLinkInvitation").msgclass
          HotelCenterLinkInvitationIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.HotelCenterLinkInvitationIdentifier").msgclass
          MerchantCenterLinkInvitationIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.MerchantCenterLinkInvitationIdentifier").msgclass
        end
      end
    end
  end
