...
require 'google/ads/google_ads/v15/enums/asset_group_signal_approval_status_pb'
...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.common.AudienceInfo", "google/ads/googleads/v15/common/criteria.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          AssetGroupSignal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AssetGroupSignal").msgclass
        end
      end
    end
  end
