...
require 'google/ads/google_ads/v15/enums/manager_link_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          CustomerManagerLink = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.CustomerManagerLink").msgclass
        end
      end
    end
  end
