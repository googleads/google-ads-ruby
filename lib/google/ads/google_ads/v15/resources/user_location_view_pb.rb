...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          UserLocationView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.UserLocationView").msgclass
        end
      end
    end
  end
