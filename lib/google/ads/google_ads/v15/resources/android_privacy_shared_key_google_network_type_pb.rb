...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          AndroidPrivacySharedKeyGoogleNetworkType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AndroidPrivacySharedKeyGoogleNetworkType").msgclass
        end
      end
    end
  end
