...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          AgeRangeView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AgeRangeView").msgclass
        end
      end
    end
  end
