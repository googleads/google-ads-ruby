...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v15.common.TargetingSetting", "google/ads/googleads/v15/common/targeting_setting.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          AdGroup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AdGroup").msgclass
          AdGroup::AudienceSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AdGroup.AudienceSetting").msgclass
        end
      end
    end
  end
