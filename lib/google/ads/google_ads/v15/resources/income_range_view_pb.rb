...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          IncomeRangeView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.IncomeRangeView").msgclass
        end
      end
    end
  end
