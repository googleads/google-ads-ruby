...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          SmartCampaignSearchTermView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.SmartCampaignSearchTermView").msgclass
        end
      end
    end
  end
