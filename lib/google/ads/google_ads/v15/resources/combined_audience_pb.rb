...
require 'google/ads/google_ads/v15/enums/combined_audience_status_pb'
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          CombinedAudience = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.CombinedAudience").msgclass
        end
      end
    end
  end
