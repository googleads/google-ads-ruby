...
begin
  ...
  imports = [
    ["google.ads.googleads.v15.common.CpcBidSimulationPointList", "google/ads/googleads/v15/common/simulation.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          AdGroupSimulation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AdGroupSimulation").msgclass
        end
      end
    end
  end
