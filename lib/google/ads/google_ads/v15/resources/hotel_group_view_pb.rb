...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          HotelGroupView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.HotelGroupView").msgclass
        end
      end
    end
  end
