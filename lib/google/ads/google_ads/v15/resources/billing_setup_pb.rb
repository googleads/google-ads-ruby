...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          BillingSetup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.BillingSetup").msgclass
          BillingSetup::PaymentsAccountInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.BillingSetup.PaymentsAccountInfo").msgclass
        end
      end
    end
  end
