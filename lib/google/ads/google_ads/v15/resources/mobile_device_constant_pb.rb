...
require 'google/ads/google_ads/v15/enums/mobile_device_type_pb'
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          MobileDeviceConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.MobileDeviceConstant").msgclass
        end
      end
    end
  end
