...
require 'google/ads/google_ads/v15/enums/keyword_plan_network_pb'
...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          KeywordPlanCampaign = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.KeywordPlanCampaign").msgclass
          KeywordPlanGeoTarget = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.KeywordPlanGeoTarget").msgclass
        end
      end
    end
  end
