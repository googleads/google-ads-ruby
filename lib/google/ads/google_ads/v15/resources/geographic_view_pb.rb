...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          GeographicView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.GeographicView").msgclass
        end
      end
    end
  end
