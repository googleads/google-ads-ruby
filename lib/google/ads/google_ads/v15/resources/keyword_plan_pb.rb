...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          KeywordPlan = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.KeywordPlan").msgclass
          KeywordPlanForecastPeriod = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.KeywordPlanForecastPeriod").msgclass
        end
      end
    end
  end
