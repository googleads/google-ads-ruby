...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          ChangeStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.ChangeStatus").msgclass
        end
      end
    end
  end
