...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          AdGroupAdAssetCombinationView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.AdGroupAdAssetCombinationView").msgclass
        end
      end
    end
  end
