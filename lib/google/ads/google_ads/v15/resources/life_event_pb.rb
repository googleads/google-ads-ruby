...
module Google
  module Ads
    module GoogleAds
      module V15
        module Resources
          LifeEvent = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.resources.LifeEvent").msgclass
        end
      end
    end
  end
