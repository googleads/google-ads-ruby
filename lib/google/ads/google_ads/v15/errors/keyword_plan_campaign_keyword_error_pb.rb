...
module Google
  module Ads
    module GoogleAds
      module V15
        module Errors
          KeywordPlanCampaignKeywordErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.KeywordPlanCampaignKeywordErrorEnum").msgclass
          KeywordPlanCampaignKeywordErrorEnum::KeywordPlanCampaignKeywordError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.KeywordPlanCampaignKeywordErrorEnum.KeywordPlanCampaignKeywordError").enummodule
        end
      end
    end
  end
