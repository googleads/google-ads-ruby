...
module Google
  module Ads
    module GoogleAds
      module V15
        module Errors
          CustomInterestErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.CustomInterestErrorEnum").msgclass
          CustomInterestErrorEnum::CustomInterestError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.CustomInterestErrorEnum.CustomInterestError").enummodule
        end
      end
    end
  end
