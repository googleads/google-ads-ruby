...
module Google
  module Ads
    module GoogleAds
      module V15
        module Errors
          ThirdPartyAppAnalyticsLinkErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.ThirdPartyAppAnalyticsLinkErrorEnum").msgclass
          ThirdPartyAppAnalyticsLinkErrorEnum::ThirdPartyAppAnalyticsLinkError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.ThirdPartyAppAnalyticsLinkErrorEnum.ThirdPartyAppAnalyticsLinkError").enummodule
        end
      end
    end
  end
