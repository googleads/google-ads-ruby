...
module Google
  module Ads
    module GoogleAds
      module V15
        module Errors
          ExperimentErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.ExperimentErrorEnum").msgclass
          ExperimentErrorEnum::ExperimentError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.ExperimentErrorEnum.ExperimentError").enummodule
        end
      end
    end
  end
