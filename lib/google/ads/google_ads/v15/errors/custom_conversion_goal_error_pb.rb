...
module Google
  module Ads
    module GoogleAds
      module V15
        module Errors
          CustomConversionGoalErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.CustomConversionGoalErrorEnum").msgclass
          CustomConversionGoalErrorEnum::CustomConversionGoalError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.CustomConversionGoalErrorEnum.CustomConversionGoalError").enummodule
        end
      end
    end
  end
