...
module Google
  module Ads
    module GoogleAds
      module V15
        module Errors
          FeedItemErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.FeedItemErrorEnum").msgclass
          FeedItemErrorEnum::FeedItemError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.FeedItemErrorEnum.FeedItemError").enummodule
        end
      end
    end
  end
