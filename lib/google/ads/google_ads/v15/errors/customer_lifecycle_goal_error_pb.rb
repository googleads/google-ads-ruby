...
module Google
  module Ads
    module GoogleAds
      module V15
        module Errors
          CustomerLifecycleGoalErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.CustomerLifecycleGoalErrorEnum").msgclass
          CustomerLifecycleGoalErrorEnum::CustomerLifecycleGoalError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.CustomerLifecycleGoalErrorEnum.CustomerLifecycleGoalError").enummodule
        end
      end
    end
  end
