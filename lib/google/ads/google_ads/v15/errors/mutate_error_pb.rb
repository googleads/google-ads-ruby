...
module Google
  module Ads
    module GoogleAds
      module V15
        module Errors
          MutateErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.MutateErrorEnum").msgclass
          MutateErrorEnum::MutateError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.MutateErrorEnum.MutateError").enummodule
        end
      end
    end
  end
