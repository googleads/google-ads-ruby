...
module Google
  module Ads
    module GoogleAds
      module V15
        module Errors
          CampaignSharedSetErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.CampaignSharedSetErrorEnum").msgclass
          CampaignSharedSetErrorEnum::CampaignSharedSetError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.CampaignSharedSetErrorEnum.CampaignSharedSetError").enummodule
        end
      end
    end
  end
