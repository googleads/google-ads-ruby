...
module Google
  module Ads
    module GoogleAds
      module V15
        module Errors
          CampaignDraftErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.CampaignDraftErrorEnum").msgclass
          CampaignDraftErrorEnum::CampaignDraftError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.CampaignDraftErrorEnum.CampaignDraftError").enummodule
        end
      end
    end
  end
