...
module Google
  module Ads
    module GoogleAds
      module V15
        module Errors
          GeoTargetConstantSuggestionErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.GeoTargetConstantSuggestionErrorEnum").msgclass
          GeoTargetConstantSuggestionErrorEnum::GeoTargetConstantSuggestionError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.GeoTargetConstantSuggestionErrorEnum.GeoTargetConstantSuggestionError").enummodule
        end
      end
    end
  end
