...
module Google
  module Ads
    module GoogleAds
      module V15
        module Errors
          AdGroupBidModifierErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.AdGroupBidModifierErrorEnum").msgclass
          AdGroupBidModifierErrorEnum::AdGroupBidModifierError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.AdGroupBidModifierErrorEnum.AdGroupBidModifierError").enummodule
        end
      end
    end
  end
