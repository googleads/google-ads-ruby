...
module Google
  module Ads
    module GoogleAds
      module V15
        module Errors
          FeedErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.FeedErrorEnum").msgclass
          FeedErrorEnum::FeedError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.FeedErrorEnum.FeedError").enummodule
        end
      end
    end
  end
