...
module Google
  module Ads
    module GoogleAds
      module V15
        module Errors
          AssetGroupListingGroupFilterErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.AssetGroupListingGroupFilterErrorEnum").msgclass
          AssetGroupListingGroupFilterErrorEnum::AssetGroupListingGroupFilterError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.AssetGroupListingGroupFilterErrorEnum.AssetGroupListingGroupFilterError").enummodule
        end
      end
    end
  end
