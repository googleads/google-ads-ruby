...
module Google
  module Ads
    module GoogleAds
      module V15
        module Errors
          ConversionValueRuleErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.ConversionValueRuleErrorEnum").msgclass
          ConversionValueRuleErrorEnum::ConversionValueRuleError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.ConversionValueRuleErrorEnum.ConversionValueRuleError").enummodule
        end
      end
    end
  end
