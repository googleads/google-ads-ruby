...
module Google
  module Ads
    module GoogleAds
      module V15
        module Errors
          CampaignExperimentErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.CampaignExperimentErrorEnum").msgclass
          CampaignExperimentErrorEnum::CampaignExperimentError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.CampaignExperimentErrorEnum.CampaignExperimentError").enummodule
        end
      end
    end
  end
