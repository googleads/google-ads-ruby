...
module Google
  module Ads
    module GoogleAds
      module V15
        module Errors
          OperationAccessDeniedErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.OperationAccessDeniedErrorEnum").msgclass
          OperationAccessDeniedErrorEnum::OperationAccessDeniedError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.OperationAccessDeniedErrorEnum.OperationAccessDeniedError").enummodule
        end
      end
    end
  end
