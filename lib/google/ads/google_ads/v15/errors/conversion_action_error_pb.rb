...
module Google
  module Ads
    module GoogleAds
      module V15
        module Errors
          ConversionActionErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.ConversionActionErrorEnum").msgclass
          ConversionActionErrorEnum::ConversionActionError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.ConversionActionErrorEnum.ConversionActionError").enummodule
        end
      end
    end
  end
