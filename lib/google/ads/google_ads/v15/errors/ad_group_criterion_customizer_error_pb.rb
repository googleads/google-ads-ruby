...
module Google
  module Ads
    module GoogleAds
      module V15
        module Errors
          AdGroupCriterionCustomizerErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.AdGroupCriterionCustomizerErrorEnum").msgclass
          AdGroupCriterionCustomizerErrorEnum::AdGroupCriterionCustomizerError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.AdGroupCriterionCustomizerErrorEnum.AdGroupCriterionCustomizerError").enummodule
        end
      end
    end
  end
