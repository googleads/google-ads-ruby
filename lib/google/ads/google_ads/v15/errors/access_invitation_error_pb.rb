...
module Google
  module Ads
    module GoogleAds
      module V15
        module Errors
          AccessInvitationErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.AccessInvitationErrorEnum").msgclass
          AccessInvitationErrorEnum::AccessInvitationError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.AccessInvitationErrorEnum.AccessInvitationError").enummodule
        end
      end
    end
  end
