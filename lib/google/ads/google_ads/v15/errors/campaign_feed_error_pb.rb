...
module Google
  module Ads
    module GoogleAds
      module V15
        module Errors
          CampaignFeedErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.CampaignFeedErrorEnum").msgclass
          CampaignFeedErrorEnum::CampaignFeedError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.CampaignFeedErrorEnum.CampaignFeedError").enummodule
        end
      end
    end
  end
