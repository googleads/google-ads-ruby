...
module Google
  module Ads
    module GoogleAds
      module V15
        module Errors
          AdGroupAdErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.AdGroupAdErrorEnum").msgclass
          AdGroupAdErrorEnum::AdGroupAdError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.AdGroupAdErrorEnum.AdGroupAdError").enummodule
        end
      end
    end
  end
