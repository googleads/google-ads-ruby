...
module Google
  module Ads
    module GoogleAds
      module V15
        module Errors
          MediaFileErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.MediaFileErrorEnum").msgclass
          MediaFileErrorEnum::MediaFileError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v15.errors.MediaFileErrorEnum.MediaFileError").enummodule
        end
      end
    end
  end
