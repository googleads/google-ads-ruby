...
module Google
  module Ads
    module GoogleAds
      module V20
        module Enums
          ProductChannelExclusivityEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.ProductChannelExclusivityEnum").msgclass
          ProductChannelExclusivityEnum::ProductChannelExclusivity = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.ProductChannelExclusivityEnum.ProductChannelExclusivity").enummodule
        end
      end
    end
  end
