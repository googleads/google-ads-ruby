...
module Google
  module Ads
    module GoogleAds
      module V20
        module Enums
          SlotEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.SlotEnum").msgclass
          SlotEnum::Slot = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.SlotEnum.Slot").enummodule
        end
      end
    end
  end
