...
module Google
  module Ads
    module GoogleAds
      module V20
        module Enums
          ListingGroupFilterProductCategoryLevelEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.ListingGroupFilterProductCategoryLevelEnum").msgclass
          ListingGroupFilterProductCategoryLevelEnum::ListingGroupFilterProductCategoryLevel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.ListingGroupFilterProductCategoryLevelEnum.ListingGroupFilterProductCategoryLevel").enummodule
        end
      end
    end
  end
