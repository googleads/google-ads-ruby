...
module Google
  module Ads
    module GoogleAds
      module V20
        module Enums
          BrandRequestRejectionReasonEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.BrandRequestRejectionReasonEnum").msgclass
          BrandRequestRejectionReasonEnum::BrandRequestRejectionReason = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.BrandRequestRejectionReasonEnum.BrandRequestRejectionReason").enummodule
        end
      end
    end
  end
