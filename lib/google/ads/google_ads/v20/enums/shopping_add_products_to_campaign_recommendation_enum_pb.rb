...
module Google
  module Ads
    module GoogleAds
      module V20
        module Enums
          ShoppingAddProductsToCampaignRecommendationEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.ShoppingAddProductsToCampaignRecommendationEnum").msgclass
          ShoppingAddProductsToCampaignRecommendationEnum::Reason = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.ShoppingAddProductsToCampaignRecommendationEnum.Reason").enummodule
        end
      end
    end
  end
