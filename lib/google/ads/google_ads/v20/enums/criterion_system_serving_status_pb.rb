...
module Google
  module Ads
    module GoogleAds
      module V20
        module Enums
          CriterionSystemServingStatusEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.CriterionSystemServingStatusEnum").msgclass
          CriterionSystemServingStatusEnum::CriterionSystemServingStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.CriterionSystemServingStatusEnum.CriterionSystemServingStatus").enummodule
        end
      end
    end
  end
