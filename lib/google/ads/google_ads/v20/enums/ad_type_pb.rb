...
module Google
  module Ads
    module GoogleAds
      module V20
        module Enums
          AdTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.AdTypeEnum").msgclass
          AdTypeEnum::AdType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.AdTypeEnum.AdType").enummodule
        end
      end
    end
  end
