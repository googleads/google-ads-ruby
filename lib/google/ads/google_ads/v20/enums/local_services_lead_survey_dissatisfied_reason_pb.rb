...
module Google
  module Ads
    module GoogleAds
      module V20
        module Enums
          LocalServicesLeadSurveyDissatisfiedReasonEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.LocalServicesLeadSurveyDissatisfiedReasonEnum").msgclass
          LocalServicesLeadSurveyDissatisfiedReasonEnum::SurveyDissatisfiedReason = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.LocalServicesLeadSurveyDissatisfiedReasonEnum.SurveyDissatisfiedReason").enummodule
        end
      end
    end
  end
