...
module Google
  module Ads
    module GoogleAds
      module V20
        module Enums
          HotelReconciliationStatusEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.HotelReconciliationStatusEnum").msgclass
          HotelReconciliationStatusEnum::HotelReconciliationStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.HotelReconciliationStatusEnum.HotelReconciliationStatus").enummodule
        end
      end
    end
  end
