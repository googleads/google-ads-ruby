...
module Google
  module Ads
    module GoogleAds
      module V20
        module Enums
          ListingGroupFilterCustomAttributeIndexEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.ListingGroupFilterCustomAttributeIndexEnum").msgclass
          ListingGroupFilterCustomAttributeIndexEnum::ListingGroupFilterCustomAttributeIndex = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.ListingGroupFilterCustomAttributeIndexEnum.ListingGroupFilterCustomAttributeIndex").enummodule
        end
      end
    end
  end
