...
module Google
  module Ads
    module GoogleAds
      module V20
        module Enums
          ConversionValueRulePrimaryDimensionEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.ConversionValueRulePrimaryDimensionEnum").msgclass
          ConversionValueRulePrimaryDimensionEnum::ConversionValueRulePrimaryDimension = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.ConversionValueRulePrimaryDimensionEnum.ConversionValueRulePrimaryDimension").enummodule
        end
      end
    end
  end
