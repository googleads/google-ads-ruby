...
module Google
  module Ads
    module GoogleAds
      module V20
        module Enums
          UserIdentifierSourceEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.UserIdentifierSourceEnum").msgclass
          UserIdentifierSourceEnum::UserIdentifierSource = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.UserIdentifierSourceEnum.UserIdentifierSource").enummodule
        end
      end
    end
  end
