...
module Google
  module Ads
    module GoogleAds
      module V20
        module Enums
          MediaTypeEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.MediaTypeEnum").msgclass
          MediaTypeEnum::MediaType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.MediaTypeEnum.MediaType").enummodule
        end
      end
    end
  end
