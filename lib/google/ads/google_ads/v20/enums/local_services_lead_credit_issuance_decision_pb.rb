...
module Google
  module Ads
    module GoogleAds
      module V20
        module Enums
          LocalServicesLeadCreditIssuanceDecisionEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.LocalServicesLeadCreditIssuanceDecisionEnum").msgclass
          LocalServicesLeadCreditIssuanceDecisionEnum::CreditIssuanceDecision = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.LocalServicesLeadCreditIssuanceDecisionEnum.CreditIssuanceDecision").enummodule
        end
      end
    end
  end
