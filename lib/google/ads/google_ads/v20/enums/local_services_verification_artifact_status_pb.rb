...
module Google
  module Ads
    module GoogleAds
      module V20
        module Enums
          LocalServicesVerificationArtifactStatusEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.LocalServicesVerificationArtifactStatusEnum").msgclass
          LocalServicesVerificationArtifactStatusEnum::LocalServicesVerificationArtifactStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.enums.LocalServicesVerificationArtifactStatusEnum.LocalServicesVerificationArtifactStatus").enummodule
        end
      end
    end
  end
