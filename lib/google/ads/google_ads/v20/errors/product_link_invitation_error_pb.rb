...
module Google
  module Ads
    module GoogleAds
      module V20
        module Errors
          ProductLinkInvitationErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.errors.ProductLinkInvitationErrorEnum").msgclass
          ProductLinkInvitationErrorEnum::ProductLinkInvitationError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.errors.ProductLinkInvitationErrorEnum.ProductLinkInvitationError").enummodule
        end
      end
    end
  end
