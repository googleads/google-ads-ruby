...
module Google
  module Ads
    module GoogleAds
      module V20
        module Errors
          InternalErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.errors.InternalErrorEnum").msgclass
          InternalErrorEnum::InternalError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.errors.InternalErrorEnum.InternalError").enummodule
        end
      end
    end
  end
