...
module Google
  module Ads
    module GoogleAds
      module V20
        module Errors
          CampaignDraftErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.errors.CampaignDraftErrorEnum").msgclass
          CampaignDraftErrorEnum::CampaignDraftError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.errors.CampaignDraftErrorEnum.CampaignDraftError").enummodule
        end
      end
    end
  end
