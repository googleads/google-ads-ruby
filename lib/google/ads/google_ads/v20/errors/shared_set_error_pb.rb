...
module Google
  module Ads
    module GoogleAds
      module V20
        module Errors
          SharedSetErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.errors.SharedSetErrorEnum").msgclass
          SharedSetErrorEnum::SharedSetError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.errors.SharedSetErrorEnum.SharedSetError").enummodule
        end
      end
    end
  end
