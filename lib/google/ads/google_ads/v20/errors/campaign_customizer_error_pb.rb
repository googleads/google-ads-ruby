...
module Google
  module Ads
    module GoogleAds
      module V20
        module Errors
          CampaignCustomizerErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.errors.CampaignCustomizerErrorEnum").msgclass
          CampaignCustomizerErrorEnum::CampaignCustomizerError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.errors.CampaignCustomizerErrorEnum.CampaignCustomizerError").enummodule
        end
      end
    end
  end
