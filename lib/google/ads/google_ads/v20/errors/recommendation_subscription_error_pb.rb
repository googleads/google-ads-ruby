...
module Google
  module Ads
    module GoogleAds
      module V20
        module Errors
          RecommendationSubscriptionErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.errors.RecommendationSubscriptionErrorEnum").msgclass
          RecommendationSubscriptionErrorEnum::RecommendationSubscriptionError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.errors.RecommendationSubscriptionErrorEnum.RecommendationSubscriptionError").enummodule
        end
      end
    end
  end
