...
module Google
  module Ads
    module GoogleAds
      module V20
        module Errors
          AutomaticallyCreatedAssetRemovalErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.errors.AutomaticallyCreatedAssetRemovalErrorEnum").msgclass
          AutomaticallyCreatedAssetRemovalErrorEnum::AutomaticallyCreatedAssetRemovalError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.errors.AutomaticallyCreatedAssetRemovalErrorEnum.AutomaticallyCreatedAssetRemovalError").enummodule
        end
      end
    end
  end
