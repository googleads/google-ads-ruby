...
module Google
  module Ads
    module GoogleAds
      module V20
        module Errors
          SizeLimitErrorEnum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.errors.SizeLimitErrorEnum").msgclass
          SizeLimitErrorEnum::SizeLimitError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.errors.SizeLimitErrorEnum.SizeLimitError").enummodule
        end
      end
    end
  end
