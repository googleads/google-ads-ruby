...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v20.common.UserData", "google/ads/googleads/v20/common/offline_user_data.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          CreateOfflineUserDataJobRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.CreateOfflineUserDataJobRequest").msgclass
          CreateOfflineUserDataJobResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.CreateOfflineUserDataJobResponse").msgclass
          RunOfflineUserDataJobRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.RunOfflineUserDataJobRequest").msgclass
          AddOfflineUserDataJobOperationsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.AddOfflineUserDataJobOperationsRequest").msgclass
          OfflineUserDataJobOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.OfflineUserDataJobOperation").msgclass
          AddOfflineUserDataJobOperationsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.AddOfflineUserDataJobOperationsResponse").msgclass
        end
      end
    end
  end
