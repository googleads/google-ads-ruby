...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          MutateSharedSetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateSharedSetsRequest").msgclass
          SharedSetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.SharedSetOperation").msgclass
          MutateSharedSetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateSharedSetsResponse").msgclass
          MutateSharedSetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateSharedSetResult").msgclass
        end
      end
    end
  end
