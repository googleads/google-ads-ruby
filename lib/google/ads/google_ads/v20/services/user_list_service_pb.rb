...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          MutateUserListsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateUserListsRequest").msgclass
          UserListOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.UserListOperation").msgclass
          MutateUserListsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateUserListsResponse").msgclass
          MutateUserListResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateUserListResult").msgclass
        end
      end
    end
  end
