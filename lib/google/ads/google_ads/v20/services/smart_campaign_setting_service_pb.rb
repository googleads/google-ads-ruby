...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          GetSmartCampaignStatusRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.GetSmartCampaignStatusRequest").msgclass
          SmartCampaignNotEligibleDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.SmartCampaignNotEligibleDetails").msgclass
          SmartCampaignEligibleDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.SmartCampaignEligibleDetails").msgclass
          SmartCampaignPausedDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.SmartCampaignPausedDetails").msgclass
          SmartCampaignRemovedDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.SmartCampaignRemovedDetails").msgclass
          SmartCampaignEndedDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.SmartCampaignEndedDetails").msgclass
          GetSmartCampaignStatusResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.GetSmartCampaignStatusResponse").msgclass
          MutateSmartCampaignSettingsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateSmartCampaignSettingsRequest").msgclass
          SmartCampaignSettingOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.SmartCampaignSettingOperation").msgclass
          MutateSmartCampaignSettingsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateSmartCampaignSettingsResponse").msgclass
          MutateSmartCampaignSettingResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateSmartCampaignSettingResult").msgclass
        end
      end
    end
  end
