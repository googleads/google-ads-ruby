...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          MutateCampaignCustomizersRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCampaignCustomizersRequest").msgclass
          CampaignCustomizerOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.CampaignCustomizerOperation").msgclass
          MutateCampaignCustomizersResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCampaignCustomizersResponse").msgclass
          MutateCampaignCustomizerResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCampaignCustomizerResult").msgclass
        end
      end
    end
  end
