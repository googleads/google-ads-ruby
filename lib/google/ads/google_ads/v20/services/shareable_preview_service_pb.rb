...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          GenerateShareablePreviewsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.GenerateShareablePreviewsRequest").msgclass
          ShareablePreview = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.ShareablePreview").msgclass
          AssetGroupIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.AssetGroupIdentifier").msgclass
          GenerateShareablePreviewsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.GenerateShareablePreviewsResponse").msgclass
          ShareablePreviewOrError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.ShareablePreviewOrError").msgclass
          ShareablePreviewResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.ShareablePreviewResult").msgclass
        end
      end
    end
  end
