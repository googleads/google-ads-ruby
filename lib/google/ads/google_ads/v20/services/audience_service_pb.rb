...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          MutateAudiencesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateAudiencesRequest").msgclass
          MutateAudiencesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateAudiencesResponse").msgclass
          AudienceOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.AudienceOperation").msgclass
          MutateAudienceResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateAudienceResult").msgclass
        end
      end
    end
  end
