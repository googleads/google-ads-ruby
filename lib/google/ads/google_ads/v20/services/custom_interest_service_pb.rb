...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          MutateCustomInterestsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCustomInterestsRequest").msgclass
          CustomInterestOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.CustomInterestOperation").msgclass
          MutateCustomInterestsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCustomInterestsResponse").msgclass
          MutateCustomInterestResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCustomInterestResult").msgclass
        end
      end
    end
  end
