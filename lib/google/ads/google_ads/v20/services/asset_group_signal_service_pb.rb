...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          MutateAssetGroupSignalsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateAssetGroupSignalsRequest").msgclass
          AssetGroupSignalOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.AssetGroupSignalOperation").msgclass
          MutateAssetGroupSignalsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateAssetGroupSignalsResponse").msgclass
          MutateAssetGroupSignalResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateAssetGroupSignalResult").msgclass
        end
      end
    end
  end
