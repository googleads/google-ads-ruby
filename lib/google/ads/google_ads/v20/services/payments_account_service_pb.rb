...
begin
  ...
  imports = [
    ["google.ads.googleads.v20.resources.PaymentsAccount", "google/ads/googleads/v20/resources/payments_account.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          ListPaymentsAccountsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.ListPaymentsAccountsRequest").msgclass
          ListPaymentsAccountsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.ListPaymentsAccountsResponse").msgclass
        end
      end
    end
  end
