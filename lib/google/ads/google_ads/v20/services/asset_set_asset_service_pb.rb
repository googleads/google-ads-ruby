...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          MutateAssetSetAssetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateAssetSetAssetsRequest").msgclass
          AssetSetAssetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.AssetSetAssetOperation").msgclass
          MutateAssetSetAssetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateAssetSetAssetsResponse").msgclass
          MutateAssetSetAssetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateAssetSetAssetResult").msgclass
        end
      end
    end
  end
