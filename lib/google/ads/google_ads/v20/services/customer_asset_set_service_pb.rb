...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          MutateCustomerAssetSetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCustomerAssetSetsRequest").msgclass
          CustomerAssetSetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.CustomerAssetSetOperation").msgclass
          MutateCustomerAssetSetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCustomerAssetSetsResponse").msgclass
          MutateCustomerAssetSetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCustomerAssetSetResult").msgclass
        end
      end
    end
  end
