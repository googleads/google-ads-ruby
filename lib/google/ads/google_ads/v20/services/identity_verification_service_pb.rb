...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          StartIdentityVerificationRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.StartIdentityVerificationRequest").msgclass
          GetIdentityVerificationRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.GetIdentityVerificationRequest").msgclass
          GetIdentityVerificationResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.GetIdentityVerificationResponse").msgclass
          IdentityVerification = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.IdentityVerification").msgclass
          IdentityVerificationProgress = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.IdentityVerificationProgress").msgclass
          IdentityVerificationRequirement = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.IdentityVerificationRequirement").msgclass
        end
      end
    end
  end
