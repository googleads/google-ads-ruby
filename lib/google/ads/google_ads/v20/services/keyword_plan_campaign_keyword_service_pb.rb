...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          MutateKeywordPlanCampaignKeywordsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateKeywordPlanCampaignKeywordsRequest").msgclass
          KeywordPlanCampaignKeywordOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.KeywordPlanCampaignKeywordOperation").msgclass
          MutateKeywordPlanCampaignKeywordsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateKeywordPlanCampaignKeywordsResponse").msgclass
          MutateKeywordPlanCampaignKeywordResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateKeywordPlanCampaignKeywordResult").msgclass
        end
      end
    end
  end
