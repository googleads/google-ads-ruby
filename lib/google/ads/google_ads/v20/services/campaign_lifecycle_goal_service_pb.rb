...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          ConfigureCampaignLifecycleGoalsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.ConfigureCampaignLifecycleGoalsRequest").msgclass
          CampaignLifecycleGoalOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.CampaignLifecycleGoalOperation").msgclass
          ConfigureCampaignLifecycleGoalsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.ConfigureCampaignLifecycleGoalsResponse").msgclass
          ConfigureCampaignLifecycleGoalsResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.ConfigureCampaignLifecycleGoalsResult").msgclass
        end
      end
    end
  end
