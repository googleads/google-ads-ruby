...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          MutateCustomerLabelsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCustomerLabelsRequest").msgclass
          CustomerLabelOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.CustomerLabelOperation").msgclass
          MutateCustomerLabelsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCustomerLabelsResponse").msgclass
          MutateCustomerLabelResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCustomerLabelResult").msgclass
        end
      end
    end
  end
