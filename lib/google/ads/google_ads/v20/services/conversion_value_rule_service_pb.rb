...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          MutateConversionValueRulesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateConversionValueRulesRequest").msgclass
          ConversionValueRuleOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.ConversionValueRuleOperation").msgclass
          MutateConversionValueRulesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateConversionValueRulesResponse").msgclass
          MutateConversionValueRuleResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateConversionValueRuleResult").msgclass
        end
      end
    end
  end
