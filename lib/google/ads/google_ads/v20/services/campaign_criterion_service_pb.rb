...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          MutateCampaignCriteriaRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCampaignCriteriaRequest").msgclass
          CampaignCriterionOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.CampaignCriterionOperation").msgclass
          MutateCampaignCriteriaResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCampaignCriteriaResponse").msgclass
          MutateCampaignCriterionResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCampaignCriterionResult").msgclass
        end
      end
    end
  end
