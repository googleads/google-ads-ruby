...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          ConfigureCustomerLifecycleGoalsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.ConfigureCustomerLifecycleGoalsRequest").msgclass
          CustomerLifecycleGoalOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.CustomerLifecycleGoalOperation").msgclass
          ConfigureCustomerLifecycleGoalsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.ConfigureCustomerLifecycleGoalsResponse").msgclass
          ConfigureCustomerLifecycleGoalsResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.ConfigureCustomerLifecycleGoalsResult").msgclass
        end
      end
    end
  end
