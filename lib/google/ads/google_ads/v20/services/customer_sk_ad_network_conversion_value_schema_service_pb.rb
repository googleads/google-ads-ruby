...
begin
  ...
  imports = [
    ["google.ads.googleads.v20.resources.CustomerSkAdNetworkConversionValueSchema", "google/ads/googleads/v20/resources/customer_sk_ad_network_conversion_value_schema.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          CustomerSkAdNetworkConversionValueSchemaOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.CustomerSkAdNetworkConversionValueSchemaOperation").msgclass
          MutateCustomerSkAdNetworkConversionValueSchemaRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCustomerSkAdNetworkConversionValueSchemaRequest").msgclass
          MutateCustomerSkAdNetworkConversionValueSchemaResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCustomerSkAdNetworkConversionValueSchemaResult").msgclass
          MutateCustomerSkAdNetworkConversionValueSchemaResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCustomerSkAdNetworkConversionValueSchemaResponse").msgclass
        end
      end
    end
  end
