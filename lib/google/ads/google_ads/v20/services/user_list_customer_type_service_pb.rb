...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          MutateUserListCustomerTypesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateUserListCustomerTypesRequest").msgclass
          UserListCustomerTypeOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.UserListCustomerTypeOperation").msgclass
          MutateUserListCustomerTypesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateUserListCustomerTypesResponse").msgclass
          MutateUserListCustomerTypeResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateUserListCustomerTypeResult").msgclass
        end
      end
    end
  end
