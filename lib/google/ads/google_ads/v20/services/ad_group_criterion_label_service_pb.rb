...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          MutateAdGroupCriterionLabelsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateAdGroupCriterionLabelsRequest").msgclass
          AdGroupCriterionLabelOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.AdGroupCriterionLabelOperation").msgclass
          MutateAdGroupCriterionLabelsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateAdGroupCriterionLabelsResponse").msgclass
          MutateAdGroupCriterionLabelResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateAdGroupCriterionLabelResult").msgclass
        end
      end
    end
  end
