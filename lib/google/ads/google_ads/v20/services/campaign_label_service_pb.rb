...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          MutateCampaignLabelsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCampaignLabelsRequest").msgclass
          CampaignLabelOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.CampaignLabelOperation").msgclass
          MutateCampaignLabelsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCampaignLabelsResponse").msgclass
          MutateCampaignLabelResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCampaignLabelResult").msgclass
        end
      end
    end
  end
