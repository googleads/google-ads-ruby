...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          MutateCampaignGroupsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCampaignGroupsRequest").msgclass
          CampaignGroupOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.CampaignGroupOperation").msgclass
          MutateCampaignGroupsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCampaignGroupsResponse").msgclass
          MutateCampaignGroupResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCampaignGroupResult").msgclass
        end
      end
    end
  end
