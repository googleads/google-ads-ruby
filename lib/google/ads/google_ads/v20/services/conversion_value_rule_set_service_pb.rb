...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          MutateConversionValueRuleSetsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateConversionValueRuleSetsRequest").msgclass
          ConversionValueRuleSetOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.ConversionValueRuleSetOperation").msgclass
          MutateConversionValueRuleSetsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateConversionValueRuleSetsResponse").msgclass
          MutateConversionValueRuleSetResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateConversionValueRuleSetResult").msgclass
        end
      end
    end
  end
