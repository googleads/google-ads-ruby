...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          CreateDataLinkRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.CreateDataLinkRequest").msgclass
          CreateDataLinkResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.CreateDataLinkResponse").msgclass
          RemoveDataLinkRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.RemoveDataLinkRequest").msgclass
          RemoveDataLinkResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.RemoveDataLinkResponse").msgclass
          UpdateDataLinkRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.UpdateDataLinkRequest").msgclass
          UpdateDataLinkResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.UpdateDataLinkResponse").msgclass
        end
      end
    end
  end
