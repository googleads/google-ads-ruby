...
module Google
  module Ads
    module GoogleAds
      module V20
        module Services
          MutateCampaignConversionGoalsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCampaignConversionGoalsRequest").msgclass
          CampaignConversionGoalOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.CampaignConversionGoalOperation").msgclass
          MutateCampaignConversionGoalsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCampaignConversionGoalsResponse").msgclass
          MutateCampaignConversionGoalResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.services.MutateCampaignConversionGoalResult").msgclass
        end
      end
    end
  end
