...
module Google
  module Ads
    module GoogleAds
      module V20
        module Common
          AudienceDimension = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.AudienceDimension").msgclass
          AudienceExclusionDimension = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.AudienceExclusionDimension").msgclass
          ExclusionSegment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.ExclusionSegment").msgclass
          AgeDimension = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.AgeDimension").msgclass
          AgeSegment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.AgeSegment").msgclass
          GenderDimension = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.GenderDimension").msgclass
          HouseholdIncomeDimension = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.HouseholdIncomeDimension").msgclass
          ParentalStatusDimension = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.ParentalStatusDimension").msgclass
          AudienceSegmentDimension = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.AudienceSegmentDimension").msgclass
          AudienceSegment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.AudienceSegment").msgclass
          UserListSegment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.UserListSegment").msgclass
          UserInterestSegment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.UserInterestSegment").msgclass
          LifeEventSegment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.LifeEventSegment").msgclass
          DetailedDemographicSegment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.DetailedDemographicSegment").msgclass
          CustomAudienceSegment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.CustomAudienceSegment").msgclass
        end
      end
    end
  end
