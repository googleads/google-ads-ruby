...
module Google
  module Ads
    module GoogleAds
      module V20
        module Common
          TargetingSetting = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.TargetingSetting").msgclass
          TargetRestriction = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.TargetRestriction").msgclass
          TargetRestrictionOperation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.TargetRestrictionOperation").msgclass
          TargetRestrictionOperation::Operator = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.TargetRestrictionOperation.Operator").enummodule
        end
      end
    end
  end
