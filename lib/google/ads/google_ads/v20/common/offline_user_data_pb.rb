...
module Google
  module Ads
    module GoogleAds
      module V20
        module Common
          OfflineUserAddressInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.OfflineUserAddressInfo").msgclass
          UserIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.UserIdentifier").msgclass
          TransactionAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.TransactionAttribute").msgclass
          StoreAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.StoreAttribute").msgclass
          ItemAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.ItemAttribute").msgclass
          UserData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.UserData").msgclass
          UserAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.UserAttribute").msgclass
          EventAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.EventAttribute").msgclass
          EventItemAttribute = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.EventItemAttribute").msgclass
          ShoppingLoyalty = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.ShoppingLoyalty").msgclass
          CustomerMatchUserListMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.CustomerMatchUserListMetadata").msgclass
          StoreSalesMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.StoreSalesMetadata").msgclass
          StoreSalesThirdPartyMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.common.StoreSalesThirdPartyMetadata").msgclass
        end
      end
    end
  end
