...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          AdGroupAdAssetCombinationView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.AdGroupAdAssetCombinationView").msgclass
        end
      end
    end
  end
