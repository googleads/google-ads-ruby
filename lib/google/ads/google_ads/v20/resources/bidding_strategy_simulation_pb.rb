...
begin
  ...
  imports = [
    ["google.ads.googleads.v20.common.TargetCpaSimulationPointList", "google/ads/googleads/v20/common/simulation.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          BiddingStrategySimulation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.BiddingStrategySimulation").msgclass
        end
      end
    end
  end
