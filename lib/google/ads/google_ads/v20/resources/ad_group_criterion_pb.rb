...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          AdGroupCriterion = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.AdGroupCriterion").msgclass
          AdGroupCriterion::QualityInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.AdGroupCriterion.QualityInfo").msgclass
          AdGroupCriterion::PositionEstimates = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.AdGroupCriterion.PositionEstimates").msgclass
        end
      end
    end
  end
