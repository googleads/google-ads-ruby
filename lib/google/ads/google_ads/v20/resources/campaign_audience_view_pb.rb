...
# source: google/ads/googleads/v20/resources/campaign_audience_view.proto
...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          CampaignAudienceView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.CampaignAudienceView").msgclass
        end
      end
    end
  end
