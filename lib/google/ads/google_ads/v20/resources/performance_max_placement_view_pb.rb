...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          PerformanceMaxPlacementView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.PerformanceMaxPlacementView").msgclass
        end
      end
    end
  end
