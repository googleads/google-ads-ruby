...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          RecommendationSubscription = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.RecommendationSubscription").msgclass
        end
      end
    end
  end
