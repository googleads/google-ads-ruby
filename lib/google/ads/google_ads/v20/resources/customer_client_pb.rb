...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          CustomerClient = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.CustomerClient").msgclass
        end
      end
    end
  end
