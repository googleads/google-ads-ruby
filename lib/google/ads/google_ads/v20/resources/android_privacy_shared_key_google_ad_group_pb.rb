...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          AndroidPrivacySharedKeyGoogleAdGroup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.AndroidPrivacySharedKeyGoogleAdGroup").msgclass
        end
      end
    end
  end
