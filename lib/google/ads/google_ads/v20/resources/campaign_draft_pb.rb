...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          CampaignDraft = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.CampaignDraft").msgclass
        end
      end
    end
  end
