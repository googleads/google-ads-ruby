...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          ProductCategoryConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.ProductCategoryConstant").msgclass
          ProductCategoryConstant::ProductCategoryLocalization = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.ProductCategoryConstant.ProductCategoryLocalization").msgclass
        end
      end
    end
  end
