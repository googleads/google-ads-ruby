...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          CampaignBudget = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.CampaignBudget").msgclass
        end
      end
    end
  end
