...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          AdGroupCriterionLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.AdGroupCriterionLabel").msgclass
        end
      end
    end
  end
