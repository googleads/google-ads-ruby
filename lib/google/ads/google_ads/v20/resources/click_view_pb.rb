...
begin
  ...
  imports = [
    ["google.ads.googleads.v20.common.ClickLocation", "google/ads/googleads/v20/common/click_location.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          ClickView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.ClickView").msgclass
        end
      end
    end
  end
