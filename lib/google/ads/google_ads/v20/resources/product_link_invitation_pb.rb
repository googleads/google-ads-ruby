...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          ProductLinkInvitation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.ProductLinkInvitation").msgclass
          HotelCenterLinkInvitationIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.HotelCenterLinkInvitationIdentifier").msgclass
          MerchantCenterLinkInvitationIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.MerchantCenterLinkInvitationIdentifier").msgclass
          AdvertisingPartnerLinkInvitationIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.AdvertisingPartnerLinkInvitationIdentifier").msgclass
        end
      end
    end
  end
