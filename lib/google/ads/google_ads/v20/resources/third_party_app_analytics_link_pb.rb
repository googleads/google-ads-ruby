...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          ThirdPartyAppAnalyticsLink = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.ThirdPartyAppAnalyticsLink").msgclass
        end
      end
    end
  end
