...
begin
  ...
  imports = [
    ["google.ads.googleads.v20.resources.OfflineConversionSummary", "google/ads/googleads/v20/resources/offline_conversion_upload_client_summary.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          OfflineConversionUploadConversionActionSummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.OfflineConversionUploadConversionActionSummary").msgclass
        end
      end
    end
  end
