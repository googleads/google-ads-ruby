...
begin
  ...
  imports = [
    ["google.ads.googleads.v20.common.AudienceInfo", "google/ads/googleads/v20/common/criteria.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          AssetGroupSignal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.AssetGroupSignal").msgclass
        end
      end
    end
  end
