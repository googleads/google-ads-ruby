...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          CustomerLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.CustomerLabel").msgclass
        end
      end
    end
  end
