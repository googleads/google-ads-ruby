...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          LocalServicesLeadConversation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.LocalServicesLeadConversation").msgclass
          PhoneCallDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.PhoneCallDetails").msgclass
          MessageDetails = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.MessageDetails").msgclass
        end
      end
    end
  end
