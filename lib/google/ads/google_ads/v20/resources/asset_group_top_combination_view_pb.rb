...
begin
  ...
  imports = [
    ["google.ads.googleads.v20.common.AssetUsage", "google/ads/googleads/v20/common/asset_usage.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          AssetGroupTopCombinationView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.AssetGroupTopCombinationView").msgclass
          AssetGroupAssetCombinationData = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.AssetGroupAssetCombinationData").msgclass
        end
      end
    end
  end
