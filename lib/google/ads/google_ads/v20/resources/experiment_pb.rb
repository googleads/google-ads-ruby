...
begin
  ...
  imports = [
    ["google.ads.googleads.v20.common.MetricGoal", "google/ads/googleads/v20/common/metric_goal.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          Experiment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.Experiment").msgclass
        end
      end
    end
  end
