...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          OfflineConversionUploadClientSummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.OfflineConversionUploadClientSummary").msgclass
          OfflineConversionSummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.OfflineConversionSummary").msgclass
          OfflineConversionAlert = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.OfflineConversionAlert").msgclass
          OfflineConversionError = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.OfflineConversionError").msgclass
        end
      end
    end
  end
