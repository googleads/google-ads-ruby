...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          AssetGroupProductGroupView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.AssetGroupProductGroupView").msgclass
        end
      end
    end
  end
