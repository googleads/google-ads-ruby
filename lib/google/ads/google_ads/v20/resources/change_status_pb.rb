...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          ChangeStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.ChangeStatus").msgclass
        end
      end
    end
  end
