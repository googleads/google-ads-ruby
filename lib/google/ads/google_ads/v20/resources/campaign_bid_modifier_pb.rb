...
begin
  ...
  imports = [
    ["google.ads.googleads.v20.common.InteractionTypeInfo", "google/ads/googleads/v20/common/criteria.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          CampaignBidModifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.CampaignBidModifier").msgclass
        end
      end
    end
  end
