...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          KeywordPlanCampaign = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.KeywordPlanCampaign").msgclass
          KeywordPlanGeoTarget = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.KeywordPlanGeoTarget").msgclass
        end
      end
    end
  end
