...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          AdGroupSimulation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.AdGroupSimulation").msgclass
        end
      end
    end
  end
