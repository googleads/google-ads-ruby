...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          ConversionGoalCampaignConfig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.ConversionGoalCampaignConfig").msgclass
        end
      end
    end
  end
