...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          OfflineUserDataJob = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.OfflineUserDataJob").msgclass
          OfflineUserDataJobMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.OfflineUserDataJobMetadata").msgclass
        end
      end
    end
  end
