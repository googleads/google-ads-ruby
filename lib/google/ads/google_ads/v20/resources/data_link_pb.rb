...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          DataLink = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.DataLink").msgclass
          YoutubeVideoIdentifier = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.YoutubeVideoIdentifier").msgclass
        end
      end
    end
  end
