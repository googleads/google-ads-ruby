...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          ConversionValueRule = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.ConversionValueRule").msgclass
          ConversionValueRule::ValueRuleAction = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.ConversionValueRule.ValueRuleAction").msgclass
          ConversionValueRule::ValueRuleGeoLocationCondition = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.ConversionValueRule.ValueRuleGeoLocationCondition").msgclass
          ConversionValueRule::ValueRuleDeviceCondition = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.ConversionValueRule.ValueRuleDeviceCondition").msgclass
          ConversionValueRule::ValueRuleAudienceCondition = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.ConversionValueRule.ValueRuleAudienceCondition").msgclass
          ConversionValueRule::ValueRuleItineraryCondition = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.ConversionValueRule.ValueRuleItineraryCondition").msgclass
          ConversionValueRule::ValueRuleItineraryAdvanceBookingWindow = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.ConversionValueRule.ValueRuleItineraryAdvanceBookingWindow").msgclass
          ConversionValueRule::ValueRuleItineraryTravelLength = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.ConversionValueRule.ValueRuleItineraryTravelLength").msgclass
          ConversionValueRule::ValueRuleItineraryTravelStartDay = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.ConversionValueRule.ValueRuleItineraryTravelStartDay").msgclass
        end
      end
    end
  end
