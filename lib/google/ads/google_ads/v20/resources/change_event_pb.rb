...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          ChangeEvent = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.ChangeEvent").msgclass
          ChangeEvent::ChangedResource = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.ChangeEvent.ChangedResource").msgclass
        end
      end
    end
  end
