...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          GeoTargetConstant = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.GeoTargetConstant").msgclass
        end
      end
    end
  end
