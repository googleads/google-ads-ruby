...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          CustomerSkAdNetworkConversionValueSchema = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.CustomerSkAdNetworkConversionValueSchema").msgclass
          CustomerSkAdNetworkConversionValueSchema::SkAdNetworkConversionValueSchema = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema").msgclass
          CustomerSkAdNetworkConversionValueSchema::SkAdNetworkConversionValueSchema::FineGrainedConversionValueMappings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.FineGrainedConversionValueMappings").msgclass
          CustomerSkAdNetworkConversionValueSchema::SkAdNetworkConversionValueSchema::PostbackMapping = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.PostbackMapping").msgclass
          CustomerSkAdNetworkConversionValueSchema::SkAdNetworkConversionValueSchema::CoarseGrainedConversionValueMappings = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.CoarseGrainedConversionValueMappings").msgclass
          CustomerSkAdNetworkConversionValueSchema::SkAdNetworkConversionValueSchema::ConversionValueMapping = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.ConversionValueMapping").msgclass
          CustomerSkAdNetworkConversionValueSchema::SkAdNetworkConversionValueSchema::Event = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.Event").msgclass
          CustomerSkAdNetworkConversionValueSchema::SkAdNetworkConversionValueSchema::Event::RevenueRange = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.Event.RevenueRange").msgclass
          CustomerSkAdNetworkConversionValueSchema::SkAdNetworkConversionValueSchema::Event::EventOccurrenceRange = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.CustomerSkAdNetworkConversionValueSchema.SkAdNetworkConversionValueSchema.Event.EventOccurrenceRange").msgclass
        end
      end
    end
  end
