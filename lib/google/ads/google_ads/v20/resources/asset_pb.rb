...
begin
  ...
  imports = [
    ...
    ["google.ads.googleads.v20.common.YoutubeVideoAsset", "google/ads/googleads/v20/common/asset_types.proto"],
...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          Asset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.Asset").msgclass
          AssetFieldTypePolicySummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.AssetFieldTypePolicySummary").msgclass
          AssetPolicySummary = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.AssetPolicySummary").msgclass
        end
      end
    end
  end
