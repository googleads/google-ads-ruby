...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          CampaignAggregateAssetView = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.CampaignAggregateAssetView").msgclass
        end
      end
    end
  end
