...
begin
  ...
  imports = [
    ["google.ads.googleads.v20.common.DateRange", "google/ads/googleads/v20/common/dates.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          KeywordPlan = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.KeywordPlan").msgclass
          KeywordPlanForecastPeriod = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.KeywordPlanForecastPeriod").msgclass
        end
      end
    end
  end
