...
begin
  ...
  imports = [
    ["google.ads.googleads.v20.common.TextLabel", "google/ads/googleads/v20/common/text_label.proto"],
  ]
...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          Label = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.Label").msgclass
        end
      end
    end
  end
