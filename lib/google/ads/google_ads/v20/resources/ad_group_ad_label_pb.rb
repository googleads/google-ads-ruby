...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          AdGroupAdLabel = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.AdGroupAdLabel").msgclass
        end
      end
    end
  end
