...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          CampaignGroup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.CampaignGroup").msgclass
        end
      end
    end
  end
