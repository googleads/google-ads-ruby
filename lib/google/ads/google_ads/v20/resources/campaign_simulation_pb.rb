...
module Google
  module Ads
    module GoogleAds
      module V20
        module Resources
          CampaignSimulation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("google.ads.googleads.v20.resources.CampaignSimulation").msgclass
        end
      end
    end
  end
