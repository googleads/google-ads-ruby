        ...
        module V2
          class PathLookupUtil
            ...
            def account_budget(customer_id, account_budget_id)
              require 'google/ads/google_ads/v2/services/account_budget_service_client'
            ...
            def ad_group_ad_label(customer_id, ad_group_id, ad_id, label_id)
              require 'google/ads/google_ads/v2/services/ad_group_ad_label_service_client'
            ...
            def ad_group_ad(customer_id, ad_group_id, ad_id)
              require 'google/ads/google_ads/v2/services/ad_group_ad_service_client'
            ...
            def ad_group_audience_view(customer_id, ad_group_id, criterion_id)
              require 'google/ads/google_ads/v2/services/ad_group_audience_view_service_client'
            ...
            def ad_group_bid_modifier(customer_id, ad_group_id, criterion_id)
              require 'google/ads/google_ads/v2/services/ad_group_bid_modifier_service_client'
            ...
            def ad_group_criterion_label(customer_id, ad_group_id, criterion_id,
                label_id)
              require 'google/ads/google_ads/v2/services/ad_group_criterion_label_service_client'
            ...
            def ad_group_criterion(customer_id, ad_group_id, criterion_id)
              require 'google/ads/google_ads/v2/services/ad_group_criterion_service_client'
            ...
            def ad_group_criterion_simulation(customer_id, ad_group_id,
              ...
              require 'google/ads/google_ads/v2/services/ad_group_criterion_simulation_service_client'
            ...
            def ad_group_extension_setting(customer_id, ad_group_id,
                extension_type)
              require 'google/ads/google_ads/v2/services/ad_group_extension_setting_service_client'
            ...
            def ad_group_feed(customer_id, ad_group_id, feed_id)
              require 'google/ads/google_ads/v2/services/ad_group_feed_service_client'
            ...
            def ad_group_label(customer_id, ad_group_id, label_id)
              require 'google/ads/google_ads/v2/services/ad_group_label_service_client'
            ...
            def ad_group(customer_id, ad_group_id)
              require 'google/ads/google_ads/v2/services/ad_group_service_client'
            ...
            def ad_group_simulation(customer_id, ad_group_id, type,
              ...
              require 'google/ads/google_ads/v2/services/ad_group_simulation_service_client'
            ...
            def ad_parameter(customer_id, ad_group_id, criterion_id,
                parameter_index)
              require 'google/ads/google_ads/v2/services/ad_parameter_service_client'
            ...
            def ad_schedule_view(customer_id, campaign_id, criterion_id)
              require 'google/ads/google_ads/v2/services/ad_schedule_view_service_client'
            ...
            def asset(customer_id, asset_id)
              require 'google/ads/google_ads/v2/services/asset_service_client'
              AssetServiceClient
              .asset_path(
                customer_id.to_s,
                asset_id.to_s
            ...
            def bidding_strategy(customer_id, bidding_strategy_id)
              require 'google/ads/google_ads/v2/services/bidding_strategy_service_client'
            ...
            def billing_setup(customer_id, billing_id)
              require 'google/ads/google_ads/v2/services/billing_setup_service_client'
            ...
            def campaign_audience_view(customer_id, campaign_id, criterion_id)
              require 'google/ads/google_ads/v2/services/campaign_audience_view_service_client'
            ...
            def campaign_bid_modifier(customer_id, campaign_bid_modifier_id)
              require 'google/ads/google_ads/v2/services/campaign_bid_modifier_service_client'
            ...
            def campaign_budget(customer_id, campaign_budget_id)
              require 'google/ads/google_ads/v2/services/campaign_budget_service_client'
            ...
            def campaign_criterion(customer_id, campaign_id, criterion_id)
              require 'google/ads/google_ads/v2/services/campaign_criterion_service_client'
            ...
            def campaign_criterion_simulation(customer_id, campaign_id, criterion_id,
              ...
              require 'google/ads/google_ads/v2/services/campaign_criterion_simulation_service_client'
            ...
            def campaign_draft(customer_id, campaign_id, draft_id)
              require 'google/ads/google_ads/v2/services/campaign_draft_service_client'
            ...
            def campaign_experiment(customer_id, experiment_id)
              require 'google/ads/google_ads/v2/services/campaign_experiment_service_client'
            ...
            def campaign_extension_setting(customer_id, campaign_id,
                extension_type)
              require 'google/ads/google_ads/v2/services/campaign_extension_setting_service_client'
            ...
            def campaign_feed(customer_id, campaign_id, feed_id)
              require 'google/ads/google_ads/v2/services/campaign_feed_service_client'
            ...
            def campaign_label(customer_id, campaign_id, label_id)
              require 'google/ads/google_ads/v2/services/campaign_label_service_client'
            ...
            def campaign_shared_set(customer_id, campaign_id, shared_set_id)
              require 'google/ads/google_ads/v2/services/campaign_shared_set_service_client'
            ...
            def campaign(customer_id, campaign_id)
              require 'google/ads/google_ads/v2/services/campaign_service_client'
            ...
            def carrier_constant(criterion_id)
              require 'google/ads/google_ads/v2/services/carrier_constant_service_client'
              CarrierConstantServiceClient.
                  carrier_constant_path(criterion_id.to_s)
            end

            def change_status(customer_id, change_status_id)
              require 'google/ads/google_ads/v2/services/change_status_service_client'
            ...
            def click_view(customer_id, date, gclid)
              require 'google/ads/google_ads/v2/services/click_view_service_client'
            ...
            def conversion_action(customer_id, conversion_action_id)
              require 'google/ads/google_ads/v2/services/conversion_action_service_client'
            ...
            def custom_interest(customer_id, custom_interest_id)
              require 'google/ads/google_ads/v2/services/custom_interest_service_client'
            ...
            def customer_client_link(
              ...
              require 'google/ads/google_ads/v2/services/customer_client_link_service_client'
            ...
            def customer_client(customer_id, client_customer_id)
              require 'google/ads/google_ads/v2/services/customer_client_service_client'
            ...
            def customer_extension_setting(customer_id, extension_type)
              require 'google/ads/google_ads/v2/services/customer_extension_setting_service_client'
            ...
            def customer_feed(customer_id, feed_id)
              require 'google/ads/google_ads/v2/services/customer_feed_service_client'
            ...
            def customer_label(customer_id, label_id)
              require 'google/ads/google_ads/v2/services/customer_label_service_client'
            ...
            def customer_manager_link(
              ...
              require 'google/ads/google_ads/v2/services/customer_manager_link_service_client'
            ...
            def customer_negative_criterion(customer_id, criterion_id)
              require 'google/ads/google_ads/v2/services/customer_negative_criterion_service_client'
            ...
            def customer(customer_id)
              require 'google/ads/google_ads/v2/services/customer_service_client'
            ...
            def detail_placement_view(customer_id, ad_group_id,
                base64_placement)
              require 'google/ads/google_ads/v2/services/detail_placement_view_service_client'
            ...
            def display_keyword_view(customer_id, ad_group_id, criterion_id)
              require 'google/ads/google_ads/v2/services/display_keyword_view_service_client'
            ...
            def domain_category(customer_id, campaign_id, category_base64,
                language_code)
              require 'google/ads/google_ads/v2/services/domain_category_service_client'
            ...
            def dynamic_search_ads_search_term_view(customer_id, ad_group_id,
              ...
              require 'google/ads/google_ads/v2/services/dynamic_search_ads_search_term_view_service_client'
            ...
            def expanded_landing_page_view(customer_id, expanded_final_url_fingerprint)
              require 'google/ads/google_ads/v2/services/expanded_landing_page_view_service_client'
            ...
            def extension_feed_item(customer_id, feed_item_id)
              require 'google/ads/google_ads/v2/services/extension_feed_item_service_client'
            ...
            def feed_item(customer_id, feed_id, feed_item_id)
              require 'google/ads/google_ads/v2/services/feed_item_service_client'
            ...
            def feed_item_target(customer_id, feed_id, feed_item_id,
              ...
              require 'google/ads/google_ads/v2/services/feed_item_target_service_client'
            ...
            def feed_mapping(customer_id, feed_id, feed_mapping_id)
              require 'google/ads/google_ads/v2/services/feed_mapping_service_client'
            ...
            def feed_placeholder_view(customer_id, placeholder_type)
              require 'google/ads/google_ads/v2/services/feed_placeholder_view_service_client'
            ...
            def feed(customer_id, feed_id)
              require 'google/ads/google_ads/v2/services/feed_service_client'
              FeedServiceClient
                .feed_path(
                  customer_id.to_s, feed_id.to_s)
            end
            ...
            def gender_view(customer_id, ad_group_id, criterion_id)
              require 'google/ads/google_ads/v2/services/gender_view_service_client'
            ...
            def geo_target_constant(geo_target_constant_id)
              require 'google/ads/google_ads/v2/services/geo_target_constant_service_client'
            ...
            def geographic_view(customer_id, country_criterion_id,
                location_type)
              require 'google/ads/google_ads/v2/services/geographic_view_service_client'
            ...
            def google_ads_field(google_ads_field)
              require 'google/ads/google_ads/v2/services/google_ads_field_service_client'
            ...
            def group_placement_view(customer_id, ad_group_id, base64_placement)
              require 'google/ads/google_ads/v2/services/group_placement_view_service_client'
            ...
            def hotel_group_view(customer_id, ad_group_id, criterion_id)
              require 'google/ads/google_ads/v2/services/hotel_group_view_service_client'
            ...
            def hotel_performance_view(customer_id)
              require 'google/ads/google_ads/v2/services/hotel_performance_view_service_client'
            ...
            def keyword_plan_ad_group(customer_id, kp_ad_group_id)
              require 'google/ads/google_ads/v2/services/keyword_plan_ad_group_service_client'
            ...
            def keyword_plan_campaign(customer_id, kp_campaign_id)
              require 'google/ads/google_ads/v2/services/keyword_plan_campaign_service_client'
            ...
            def keyword_plan_keyword(customer_id, kp_ad_group_keyword_id)
              require 'google/ads/google_ads/v2/services/keyword_plan_keyword_service_client'
            ...
            def keyword_plan_negative_keyword(customer_id,
              ...
              require 'google/ads/google_ads/v2/services/keyword_plan_negative_keyword_service_client'
            ...
            def keyword_plan(customer_id, kp_plan_id)
              require 'google/ads/google_ads/v2/services/keyword_plan_service_client'
            ...
            def keyword_view(customer_id, ad_group_id, criterion_id)
              require 'google/ads/google_ads/v2/services/keyword_view_service_client'
            ...
            def label(customer_id, label_id)
              require 'google/ads/google_ads/v2/services/label_service_client'
              LabelServiceClient
                .label_path(
                customer_id.to_s,
                label_id.to_s
            ...
            def language_constant(criterion_id)
              require 'google/ads/google_ads/v2/services/language_constant_service_client'
            ...
            def location_view(customer_id, campaign_id, criterion_id)
              require 'google/ads/google_ads/v2/services/location_view_service_client'
            ...
            def managed_placement_view(customer_id, ad_group_id, criterion_id)
              require 'google/ads/google_ads/v2/services/managed_placement_view_service_client'
            ...
            def media_file(customer_id, media_file_id)
              require 'google/ads/google_ads/v2/services/media_file_service_client'
            ...
            def merchant_center_link(customer_id, merchant_center_id)
              require 'google/ads/google_ads/v2/services/merchant_center_link_service_client'
            ...
            def mobile_app_category_constant(mobile_app_category_id)
              require 'google/ads/google_ads/v2/services/mobile_app_category_constant_service_client'
            ...
            def mobile_device_constant(criterion_id)
              require 'google/ads/google_ads/v2/services/mobile_device_constant_service_client'
              MobileDeviceConstantServiceClient.
                  mobile_device_constant_path(criterion_id.to_s)
            end

            def mutate_job(customer_id, mutate_job_id)
              require 'google/ads/google_ads/v2/services/mutate_job_service_client'
            ...
            def operating_system_version_constant(criterion_id)
              require 'google/ads/google_ads/v2/services/operating_system_version_constant_service_client'
            ...
            def parental_status_view(customer_id, ad_group_id, criterion_id)
              require 'google/ads/google_ads/v2/services/parental_status_view_service_client'
            ...
            def product_bidding_category_constant(country_code, level, id)
              require 'google/ads/google_ads/v2/services/product_bidding_category_constant_service_client'
            ...
            def product_group_view(customer_id, ad_group_id, criterion_id)
              require 'google/ads/google_ads/v2/services/product_group_view_service_client'
            ...
            def recommendation(customer_id, recommendation_id)
              require 'google/ads/google_ads/v2/services/recommendation_service_client'
            ...
            def remarketing_action(customer_id, remarketing_action_id)
              require 'google/ads/google_ads/v2/services/remarketing_action_service_client'
            ...
            def search_term_view(customer_id, campaign_id, ad_group_id,
                search_term)
              require 'google/ads/google_ads/v2/services/search_term_view_service_client'
            ...
            def shared_criterion(customer_id, shared_set_id, criterion_id)
              require 'google/ads/google_ads/v2/services/shared_criterion_service_client'
            ...
            def shared_set(customer_id, shared_set_id)
              require 'google/ads/google_ads/v2/services/shared_set_service_client'
            ...
            def shopping_performance_view(customer_id)
              require 'google/ads/google_ads/v2/services/shopping_performance_view_service_client'
            ...
            def topic_constant(vertical_id)
              require 'google/ads/google_ads/v2/services/topic_constant_service_client'
            ...
            def topic_view(customer_id, ad_group_id, criterion_id)
              require 'google/ads/google_ads/v2/services/topic_view_service_client'
            ...
            def user_interest(customer_id, user_interest_id)
              require 'google/ads/google_ads/v2/services/user_interest_service_client'
            ...
            def user_list(customer_id, user_list_id)
              require 'google/ads/google_ads/v2/services/user_list_service_client'
            ...
            def video(customer_id, video_id)
              require 'google/ads/google_ads/v2/services/video_service_client'
              VideoServiceClient
                .video_path(
