    ...
    module GoogleAds
      module Utils
        module PathLookupConfig
          ...
          PATH_LOOKUP_V1 = PATH_LOOKUP_BASE.reject { |k, _| [:ad, :currency_constant].include?(k) }
          PATH_LOOKUP_V2 = PATH_LOOKUP_BASE.reject { |k, _| [:currency_constant].include?(k) }
          PATH_LOOKUP_V3 = PATH_LOOKUP_BASE
        end
      end
    end
  end
