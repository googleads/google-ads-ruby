...
require 'google/ads/google_ads/v25/services/offline_user_data_job_service_pb'
...
class TestGoogleAdsClient < Minitest::Test
  ...
  def test_decode_partial_failure_error
    response_with_pfe = Google::Ads::GoogleAds::V25::Services::AddOfflineUserDataJobOperationsResponse.new(
    ...
    assert_equal errors[0].class, Google::Ads::GoogleAds::V25::Errors::GoogleAdsFailure
  end

  def test_decode_warning
    response_with_warning = Google::Ads::GoogleAds::V25::Services::AddOfflineUserDataJobOperationsResponse.new(
  ...
  def test_service
    ...
    service = client.service.v25.campaign
