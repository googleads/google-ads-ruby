...
class TestResourceCreation < Minitest::Test
  def test_resource_creation_default()
    ...
    campaign_op = client.operation.v16.create_resource.campaign
    assert_instance_of(Google::Ads::GoogleAds::V16::Resources::Campaign, campaign_op.create)
  end
  ...
  def test_operation_creation_default()
    ...
    mutate_op = client.operation.v16.mutate
    assert_instance_of(Google::Ads::GoogleAds::V16::Services::MutateOperation, mutate_op)
  end
  ...
  def test_operation_creation_using_block()
    ...
    mutate_op = client.operation.v16.mutate do |op|
      op.campaign_operation = client.operation.v16.create_resource.campaign
    end
    assert_instance_of(Google::Ads::GoogleAds::V16::Services::MutateOperation, mutate_op)
    assert_instance_of(Google::Ads::GoogleAds::V16::Services::CampaignOperation, mutate_op.campaign_operation)
  end
end
