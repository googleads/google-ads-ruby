...
class TestFieldMaskUtil < Minitest::Test
  def test_change_from_previous_value()
    test_object = Google::Ads::GoogleAds::V8::Resources::Campaign.new
  ...
  def test_change_to_null_value()
    ...
    test_object.network_settings = Google::Ads::GoogleAds::V8::Resources::Campaign::NetworkSettings.new
  ...
  def test_repeated_field_addition()
    test_object = Google::Ads::GoogleAds::V8::Resources::Ad.new
  ...
  def test_nested_field_changed()
    ...
    text_ad = Google::Ads::GoogleAds::V8::Common::TextAdInfo.new
    text_ad.headline = 'headline'
    test_object.text_ad = text_ad

    mask = Google::Ads::GoogleAds::FieldMaskUtil.with test_object do
      new_text_ad = Google::Ads::GoogleAds::V8::Common::TextAdInfo.new
  ...
  def test_nested_fields_for_update_from_nil()
    ...
    nested_object =
        Google::Ads::GoogleAds::V8::Resources::Campaign::NetworkSettings.new
