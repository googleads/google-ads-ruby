...
require 'google/ads/google_ads/utils/v2/path_lookup_util'
...
class TestPathLookupUtil < Minitest::Test
  ...
  def test_path_generation_v2()
    util = Google::Ads::GoogleAds::Utils::V2::PathLookupUtil.new
