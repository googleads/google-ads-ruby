...
require 'google/ads/google_ads/utils/v10/path_lookup_util'
...
class TestPathLookupUtil < Minitest::Test
  def test_path_generation_v10()
    util = Google::Ads::GoogleAds::Utils::V10::PathLookupUtil.new
    ...
    expected = 'customers/12/adGroupAdAssetCombinationViews/34~56~78~90'
    assert_equal(expected, util.ad_group_ad_asset_combination_view(12, 34, 56, 78, 90))
    ...
    expected = 'customers/123/assetGroupSignals/456~789'
    assert_equal(expected, util.asset_group_signal(123, 456, 789))
    ...
    expected = 'customers/1234/audiences/5678'
    assert_equal(expected, util.audience(1234, 5678))
    ...
    expected = 'customers/1234/experiments/5678'
    assert_equal(expected, util.experiment(1234, 5678))

    expected = 'customers/123/experimentArms/456~789'
    assert_equal(expected, util.experiment_arm(123, 456, 789))
    ...
    expected = 'customers/1234/leadFormSubmissionData/5678'
    assert_equal(expected, util.lead_form_submission_data(1234, 5678))
  ...
  def test_path_generation_v12()
    util = Google::Ads::GoogleAds::Utils::V12::PathLookupUtil.new
    ...
    expected = 'customers/1234/adGroupAssetSets/567~890'
    assert_equal(expected, util.ad_group_asset_set(1234, 567, 890))
    ...
    expected = 'customers/1234/assetSetTypeViews/5678'
    assert_equal(expected, util.asset_set_type_view(1234, 5678))
    ...
    expected = 'customers/1234/customerAssetSets/5678'
    assert_equal(expected, util.customer_asset_set(1234, 5678))
    ...
    expected = 'customers/1234/perStoreViews/5678'
    assert_equal(expected, util.per_store_view(1234, 5678))
