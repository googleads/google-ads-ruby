...
class TestErrors < Minitest::Test
  ...
  def test_blank_code
    error = build_error
    error.error_code = Google::Ads::GoogleAds::V10::Errors::ErrorCode.new
    error_code = Google::Ads::GoogleAds::Errors.code(error)
  ...
  def build_error
    Google::Ads::GoogleAds::V10::Errors::GoogleAdsError.new.tap do |error|
      location = Google::Ads::GoogleAds::V10::Errors::ErrorLocation.new
      path1 = Google::Ads::GoogleAds::V10::Errors::ErrorLocation::FieldPathElement.new
      path1.field_name = 'operations'
      path1.index = 1
      path2 = Google::Ads::GoogleAds::V10::Errors::ErrorLocation::FieldPathElement.new
      path2.field_name = 'create'
      path3 = Google::Ads::GoogleAds::V10::Errors::ErrorLocation::FieldPathElement.new
      path3.field_name = 'amount_micros'
      error_code = Google::Ads::GoogleAds::V10::Errors::ErrorCode.new
