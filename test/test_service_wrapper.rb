...
require 'google/ads/google_ads/v14/services/google_ads_service_pb'
...
class TestServiceWrapper < Minitest::Test
  ...
  def setup
    ...
    @service_wrapper = Google::Ads::GoogleAds::ServiceWrapper.new(
      service: @service,
      rpc_inputs: {search: Google::Ads::GoogleAds::V14::Services::SearchGoogleAdsRequest},
  ...
  def make_search_request(options)
    Google::Ads::GoogleAds::V14::Services::SearchGoogleAdsRequest.new(options)
  end
end
