...
require 'google/ads/google_ads/v17/services/campaign_service_services_pb'
require 'google/ads/google_ads/v17/services/customer_user_access_service_services_pb'
require 'google/ads/google_ads/v17/services/customer_user_access_invitation_service_services_pb'
require 'google/ads/google_ads/v17/services/google_ads_service_services_pb'
require 'google/ads/google_ads/v17/services/feed_service_services_pb'
require 'google/ads/google_ads/v17/services/customer_service_services_pb'
require 'google/ads/google_ads/v17/resources/customer_user_access_pb'
require 'google/ads/google_ads/v17/resources/customer_user_access_invitation_pb'
require 'google/ads/google_ads/v17/resources/change_event_pb'
...
class TestLoggingInterceptor < Minitest::Test
  ...
  def test_logging_interceptor_logs_some_error_details_if_v17_error
    li.request_response(
      request: make_small_request,
      call: make_fake_call,
      method: :doesnt_matter,
    ) do
      raise make_realistic_error("v17")
    end
  ...
  def test_logging_interceptor_sanitizes_customer_user_access_mutate
    email_address = "abcdefghijkl"
    inviter_user = "zyxwvutsr"
    request = Google::Ads::GoogleAds::V17::Services::MutateCustomerUserAccessRequest.new(
      operation: Google::Ads::GoogleAds::V17::Services::CustomerUserAccessOperation.new(
        update: Google::Ads::GoogleAds::V17::Resources::CustomerUserAccess.new(
          email_address: email_address,
          inviter_user_email_address: inviter_user,
        )
      )
  ...
  def test_logging_interceptor_sanitizes_customer_user_access_invitation_mutate
    email_address = "abcdefghijkl"
    request = Google::Ads::GoogleAds::V17::Services::MutateCustomerUserAccessInvitationRequest.new(
      operation: Google::Ads::GoogleAds::V17::Services::CustomerUserAccessInvitationOperation.new(
        create: Google::Ads::GoogleAds::V17::Resources::CustomerUserAccessInvitation.new(
          email_address: email_address,
        )
      )
    )
  ...
  def test_logging_interceptor_sanitizes_feed_get
    ...
    li.request_response(
      ...
      Google::Ads::GoogleAds::V17::Resources::Feed.new(
        places_location_feed_data: Google::Ads::GoogleAds::V17::
  ...
  def test_logging_interceptor_sanitizes_local_services_lead_contact_details_email
    ...
    li.request_response(
      ...
      Google::Ads::GoogleAds::V17::Resources::LocalServicesLead.new(
        contact_details: Google::Ads::GoogleAds::V17::
  ...
  def test_logging_interceptor_sanitizes_local_services_lead_conversation_text
    ...
    li.request_response(
      ...
      Google::Ads::GoogleAds::V17::Resources::LocalServicesLeadConversation.new(
        message_details: Google::Ads::GoogleAds::V17::
  ...
  def test_logging_interceptor_sanitizes_feed_mutate_request
    ...
    li.request_response(
      request: Google::Ads::GoogleAds::V17::Services::MutateFeedsRequest.new(
        operations: [
          Google::Ads::GoogleAds::V17::Services::FeedOperation.new(
            create: Google::Ads::GoogleAds::V17::Resources::Feed.new(
              places_location_feed_data: Google::Ads::GoogleAds::V17::
                Resources::Feed::PlacesLocationFeedData.new(
                email_address: email_address,
              ),
  ...
  def test_logging_interceptor_sanitizes_customer_client_create_request
    email_address = "abcdefghijkl"
    li.request_response(
      request: Google::Ads::GoogleAds::V17::Services::CreateCustomerClientRequest.new(
        email_address: email_address,
      ),
      call: make_fake_call,
      method: :doesnt_matter,
  ...
  def test_logging_interceptor_sanitizes_search_request
    li.request_response(
      request: Google::Ads::GoogleAds::V17::Services::SearchGoogleAdsRequest.new(
  ...
  def test_logging_interceptor_sanitizes_search_stream_request
    li.request_response(
      request: Google::Ads::GoogleAds::V17::Services::SearchGoogleAdsStreamRequest.new(
        query: "SELECT change_event.user_email FROM change_event",
      ),
      call: make_fake_call,
      method: :doesnt_matter
  ...
  def test_logging_interceptor_sanitizes_search_response
    ...
    li.request_response(
      ...
      Google::Ads::GoogleAds::V17::Services::SearchGoogleAdsResponse.new(
        ...
        results: [
          Google::Ads::GoogleAds::V17::Services::GoogleAdsRow.new(
            customer_user_access: Google::Ads::GoogleAds::V17::Resources::CustomerUserAccess.new(
              email_address: email_address,
              inviter_user_email_address: inviter_user,
            ),
            change_event: Google::Ads::GoogleAds::V17::Resources::ChangeEvent.new(
  ...
  def test_logging_interceptor_sanitizes_search_stream_response
    ...
    response = li.server_streamer(
      ...
      [
        Google::Ads::GoogleAds::V17::Services::SearchGoogleAdsStreamResponse.new(
          field_mask: Google::Protobuf::FieldMask.new(
            paths: [
              "customer_user_access.email_address",
              "customer_user_access.inviter_user_email_address",
  ...
  def make_realistic_response_with_partial_error
    Google::Ads::GoogleAds::V17::Services::MutateCampaignsResponse.new(
      results: [],
  ...
  def make_small_request(customer_id: "123")
    Google::Ads::GoogleAds::V17::Services::MutateCampaignsRequest.new(
  ...
  def make_error_metadata(version)
    {
      "google.rpc.debuginfo-bin" => "\x12\xA9\x02[ORIGINAL ERROR] generic::invalid_argument: Invalid customer ID 'INSERT_CUSTOMER_ID_HERE'. [google.rpc.error_details_ext] { details { type_url: \"type.googleapis.com/google.ads.googleads.v17.errors.GoogleAdsFailure\" value: \"\\n4\\n\\002\\010\\020\\022.Invalid customer ID \\'INSERT_CUSTOMER_ID_HERE\\'.\" } }",
