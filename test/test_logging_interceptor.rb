...
require 'google/ads/google_ads/v8/services/media_file_service_services_pb'
require 'google/ads/google_ads/v8/services/customer_user_access_service_services_pb'
require 'google/ads/google_ads/v8/services/customer_user_access_invitation_service_services_pb'
require 'google/ads/google_ads/v8/services/google_ads_service_services_pb'
require 'google/ads/google_ads/v8/services/feed_service_services_pb'
...
require 'google/ads/google_ads/v8/resources/customer_user_access_invitation_pb'
require 'google/ads/google_ads/v8/resources/change_event_pb'
...
class TestLoggingInterceptor < Minitest::Test
  ...
  def test_logging_interceptor_inspects_request
    ...
    sio.rewind
    assert_includes(sio.read, "Google::Ads::GoogleAds::V8::Services::MutateMediaFilesRequest")
  end
  ...
  def test_logging_interceptor_logs_some_error_details_if_v8_error
    li.request_response(
      request: make_small_request,
      call: make_fake_call,
      method: :doesnt_matter,
    ) do
      raise make_realistic_error("v8")
    end
  ...
  def test_logging_interceptor_sanitizes_customer_user_access_mutate
    email_address = "abcdefghijkl"
    inviter_user = "zyxwvutsr"
    request = Google::Ads::GoogleAds::V8::Services::MutateCustomerUserAccessRequest.new(
      operation: Google::Ads::GoogleAds::V8::Services::CustomerUserAccessOperation.new(
        update: Google::Ads::GoogleAds::V8::Resources::CustomerUserAccess.new(
          email_address: email_address,
          inviter_user_email_address: inviter_user,
        )
      )
  ...
  def test_logging_interceptor_sanitizes_customer_user_access_invitation_mutate
    email_address = "abcdefghijkl"
    request = Google::Ads::GoogleAds::V8::Services::MutateCustomerUserAccessInvitationRequest.new(
      operation: Google::Ads::GoogleAds::V8::Services::CustomerUserAccessInvitationOperation.new(
        create: Google::Ads::GoogleAds::V8::Resources::CustomerUserAccessInvitation.new(
          email_address: email_address,
        )
      )
    )
  ...
  def test_logging_interceptor_sanitizes_feed_get
    ...
    li.request_response(
      ...
      Google::Ads::GoogleAds::V8::Resources::Feed.new(
        places_location_feed_data: Google::Ads::GoogleAds::V8::
      ...
      request: Google::Ads::GoogleAds::V8::Services::MutateFeedsRequest.new(
        operations: [
          Google::Ads::GoogleAds::V8::Services::FeedOperation.new(
            create: Google::Ads::GoogleAds::V8::Resources::Feed.new(
              places_location_feed_data: Google::Ads::GoogleAds::V8::
                Resources::Feed::PlacesLocationFeedData.new(
                email_address: email_address,
              ),
  ...
  def test_logging_interceptor_sanitizes_search_response
    ...
    li.request_response(
      ...
      Google::Ads::GoogleAds::V8::Services::SearchGoogleAdsResponse.new(
        ...
        results: [
          Google::Ads::GoogleAds::V8::Services::GoogleAdsRow.new(
            customer_user_access: Google::Ads::GoogleAds::V8::Resources::CustomerUserAccess.new(
              email_address: email_address,
              inviter_user_email_address: inviter_user,
            ),
            change_event: Google::Ads::GoogleAds::V8::Resources::ChangeEvent.new(
  ...
  def test_logging_interceptor_sanitizes_search_stream_response
    ...
    response = li.server_streamer(
      ...
      [
        Google::Ads::GoogleAds::V8::Services::SearchGoogleAdsStreamResponse.new(
          field_mask: Google::Protobuf::FieldMask.new(
            paths: [
              "customer_user_access.email_address",
              "customer_user_access.inviter_user_email_address",
  ...
  def make_realistic_response_with_partial_error
    Google::Ads::GoogleAds::V8::Services::MutateMediaFilesResponse.new(
      results: [],
  ...
  def make_small_request(customer_id: "123")
    Google::Ads::GoogleAds::V8::Services::MutateMediaFilesRequest.new(
      customer_id: customer_id,
      operations: [
        Google::Ads::GoogleAds::V8::Services::MediaFileOperation.new(
          create: Google::Ads::GoogleAds::V8::Resources::MediaFile.new(
  ...
  def make_error_metadata(version)
    {
      "google.rpc.debuginfo-bin" => "\x12\xA9\x02[ORIGINAL ERROR] generic::invalid_argument: Invalid customer ID 'INSERT_CUSTOMER_ID_HERE'. [google.rpc.error_details_ext] { details { type_url: \"type.googleapis.com/google.ads.googleads.v8.errors.GoogleAdsFailure\" value: \"\\n4\\n\\002\\010\\020\\022.Invalid customer ID \\'INSERT_CUSTOMER_ID_HERE\\'.\" } }",
