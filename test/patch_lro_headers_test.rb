...
class TestConfig < Minitest::Test
  ...
  def test_patch_lro_headers_works_with_an_operations_client_class
    headers = {:test => :test_value}
    c = Class.new(OperationsClientClass)
    Google::Ads::GoogleAds::PatchLROHeaders.new(
      c,
      headers,
    ).call
  ...
  def test_patch_lro_headers_works_with_a_non_operation_client_class
    headers = {:test => :test_value}
